...
struct PosixPipe_Cj0Z
{
    ...
    explicit operator bool() const noexcept
    {
        ...
        ;
                                ...
                                #ifndef DEF_Child_JMKAnYBpXOa
                                #define DEF_Child_JMKAnYBpXOa
struct Child_JMKA
{
    PID_mnoc pid;
    WriteEnd_aNMe in_fd;
...
Errno_88RA spawn_BXrk(PID_mnoc& pid, fu::vec<fu::str>&& argv, const PosixPipe_Cj0Z& stdout, const PosixPipe_Cj0Z& stderr, const PosixPipe_Cj0Z& stdin)
{
    Errno_88RA err {};
    pid = 0;
    if (!argv)
...
Errno_88RA close_BXrk(const Child_JMKA& child, ExitStatus_iZrm& status)
{
    Errno_88RA err {};
...
Errno_88RA pipe_BXrk(PosixPipe_Cj0Z& p, const bool blocking)
{
...
void close_both_BXrk(const PosixPipe_Cj0Z& pipe, Errno_88RA& err)
{
...
Errno_88RA spawn_x5m9(/*MOV*/ fu::vec<fu::str>&& argv, Child_JMKA& child, const bool blocking, const ChildStream_ofm8 out_m, const ChildStream_ofm8 err_m, const ChildStream_ofm8 in_m)
{
    child = Child_JMKA{};
    Errno_88RA err {};
        ...
        else
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    child = Child_JMKA { pid, stdin.w, stdout.r, stderr.r };
                    return 0;
                };
            };
        };
...
Errno_88RA spawn_0Hw8(/*MOV*/ fu::vec<fu::str>&& argv, fu::vec_range_mut<char> stdout_buf, fu::vec_range_mut<char> stderr_buf, ExitStatus_iZrm& status)
{
    Errno_88RA err {};
    Child_JMKA child {};
