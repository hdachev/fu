...
TEA_87LR& non_zero_lweH(TEA_87LR& tea)
{
    if (!tea)
        tea.v0 = 0xffffffffu;
...
void hash_lweH(TEA_87LR& res, const TEA_87LR& other)
{
    res.v0 ^= other.v1;
    res.v1 ^= other.v0;
    r16_lweH(res);
...
void hash_qRo1(TEA_87LR& res, const uint64_t v)
{
...
void hash_qw8S(TEA_87LR& res, const unsigned v)
{
    res.v0 ^= unsigned(v);
    r16_lweH(res);
}

void hash_l6RU(TEA_87LR& res, fu::vec_range<char> u8view)
{
...
TEA_87LR hash_s9RC(fu::vec_range<char> u8view)
{
    TEA_87LR res {};
