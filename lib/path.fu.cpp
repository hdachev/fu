...
inline int find_yd8BAtiL(fu::view<char> a, const char b, int start)
{
    ...
    return -1;
                                ...
                                #ifndef DEF_split_QtWcjvOJ
                                #define DEF_split_QtWcjvOJ
inline void split_QtWcjvOJ(const fu_STR& str, const char sep, fu_VEC<fu_STR>& result)
{
    int last = 0;
    int next = 0;
    const int N = 1;
