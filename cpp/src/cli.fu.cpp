...
static const fu::str str_SDOheza2PJb fu_INIT_PRIORITY(1016) { "   HINT Neither --bin nor --run options provided, doing nothing."_fu };
                                ...
                                #ifndef STR_J0GBEp5saW3
                                #define STR_J0GBEp5saW3
static const fu::str str_J0GBEp5saW3 fu_INIT_PRIORITY(1016) { "   HINT "_fu };
                                #endif

                                #ifndef STR_Mhu5bgTUo6k
                                #define STR_Mhu5bgTUo6k
static const fu::str str_Mhu5bgTUo6k fu_INIT_PRIORITY(1016) { " --hotswap is not very useful without both --watch and --run."_fu };
                                #endif
...
static void cli_handle_Dx4m(fu::view<fu::str> argv, fu::vec_range<char> cwd)
{
    ...
    else
    {
        ...
        if (BuildScheme_Vgo7((bflags & BuildScheme_Vgo7_hotswap)) && (!BuildScheme_Vgo7((bflags & BuildScheme_Vgo7_watch)) || !runmode))
        {
            ...
            const fu::str* x;
            const fu::str* x_1;
            fu::println(fu::view<fu::str> {{ fu::str((x = &(str_J0GBEp5saW3), (*x))), fu::str(self), fu::str((x_1 = &(str_Mhu5bgTUo6k), (*x_1))) }});
        };
    };
}
...
inline static void _UVSc(fu::view<fu::str> argv)
{
    cli_handle_Dx4m(argv, cwd_5u3x());
                                ...
                                #ifndef DEF_try_or_print_error_zTPV3TRfJ07
                                #define DEF_try_or_print_error_zTPV3TRfJ07
inline int try_or_print_error_zTPV(fu::view<fu::str> argv)
{
...
{
    return try_or_print_error_zTPV(argv);
}
