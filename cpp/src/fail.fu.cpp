...
inline constexpr bool SELF_TEST = true;
                                #endif
const fu::str& _fname_xQNS(const TokenIdx_5581&, const Context_Dujv&);
...
const fu::str& getModuleSrc_u9Gb(const int modid, const Context_Dujv& ctx)
{
...
fu::str formatTokenCoord_u9Gb(const TokenIdx_5581& token, const int from, const Context_Dujv& ctx)
{
...
fu::str formatCodeSnippet_k53p(fu::vec<TokenIdx_5581>&& tokens, const int from, const CodeFmt_snPx fmt, const Context_Dujv& ctx)
{
    sort_mysZ(tokens);
    /*MOV*/ fu::str append {};
...
fu::str FAIL_text_u9Gb(fu::vec_range<TokenIdx_5581> tokens, fu::view<char> reason, const Context_Dujv& ctx)
{
...
[[noreturn]] fu::never FAIL_u9Gb(fu::view<char> reason, fu::vec_range<TokenIdx_5581> tokens, const Context_Dujv& ctx)
{
...
[[noreturn]] fu::never BUG_u9Gb(fu::view<char> reason, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
