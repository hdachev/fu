...
inline constexpr bool SELF_TEST = true;
                                #endif
const fu::str& _fname_xQNS(const TokenIdx_5581&, const Context_Zsw9&);
fu::str relative_qZI0(fu::view<char>, fu::view<char>);
const Token_6M7a& _token_xQNS(const TokenIdx_5581&, const Context_Zsw9&);
fu::vec_range<char> dirname_qZI0(fu::vec_range<char>);
fu::vec_range<char> ext_qZI0(fu::vec_range<char>);
fu::str formatCodeSnippet_k53p(fu::vec<TokenIdx_5581>&&, int, CodeFmt_snPx, const Context_Zsw9&);
...
const fu::str& getModuleSrc_u9Gb(const int modid, const Context_Zsw9& ctx)
{
...
fu::str formatTokenCoord_u9Gb(const TokenIdx_5581& token, const int from, const Context_Zsw9& ctx)
{
...
fu::str formatCodeSnippet_u9Gb(fu::vec_range<char> src, fu::vec<LineColChars_6JiM>&& highlight, const CodeFmt_snPx fmt)
{
    ...
    {
        fu::vec<fu::str> lines = split_3se8(src, "\n"_view);
...
fu::str formatCodeSnippet_k53p(fu::vec<TokenIdx_5581>&& tokens, const int from, const CodeFmt_snPx fmt, const Context_Zsw9& ctx)
{
    sort_mysZ(tokens);
    /*MOV*/ fu::str append {};
...
fu::str FAIL_text_u9Gb(fu::vec_range<TokenIdx_5581> tokens, fu::view<char> reason, const Context_Zsw9& ctx)
{
...
[[noreturn]] fu::never FAIL_u9Gb(fu::view<char> reason, fu::vec_range<TokenIdx_5581> tokens, const Context_Zsw9& ctx)
{
...
[[noreturn]] fu::never BUG_u9Gb(fu::view<char> reason, const Context_Zsw9& ctx, const TokenIdx_5581& _here)
{
