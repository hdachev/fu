...
inline fu::str x7E_rA00(fu::view<char> a, fu::view<char> b)
{
    return a + b;
                                ...
                                #ifndef DEF___LbOZWKMK479
                                #define DEF___LbOZWKMK479
inline static Result_z5w0 _LbOZ(const int modid, const Context_noPA& ctx, const Options_TBgD& options)
{
...
;
                                ...
                                #ifndef DEF___4iSoZh7ahn9
                                #define DEF___4iSoZh7ahn9
inline static const Result_z5w0& _4iSo(const int i, fu::view<int> arr, fu::view_mut<Result_z5w0> result, const Context_noPA& ctx, const Options_TBgD& options)
{
    return (result.mutref(i) = _LbOZ(arr[i], ctx, options));
}
                                #endif

                                #ifndef DEF_parallel_for_OHg3fByiF49
                                #define DEF_parallel_for_OHg3fByiF49
inline static void parallel_for_OHg3(const int min, int end, fu::view<int> arr, fu::view_mut<Result_z5w0> result, const Context_noPA& ctx, const Options_TBgD& options)
{
    int start = (end & 0);
    (void) start;
    ...
    for (int i = start; i < end; i++)
        _4iSo(i, arr, result, ctx, options);
                                ...
                                #ifndef DEF_map_2jgPvjWvTj1
                                #define DEF_map_2jgPvjWvTj1
inline fu::vec<Result_z5w0> map_2jgP(fu::view<int> arr, const int min, const Context_noPA& ctx, const Options_TBgD& options)
{
    /*MOV*/ fu::vec<Result_z5w0> result {};
    result.grow<false>(arr.size());
    parallel_for_OHg3(min, arr.size(), arr, result, ctx, options);
    return /*NRVO*/ result;
}
                                #endif
...
void compile_Tsi8(fu::vec_range<char> fname, Context_noPA& ctx, const Options_TBgD& options)
{
    ...
    for (int i_1 = 0; i_1 < dep_order.size(); i_1++)
    {
        ...
        {
            fu::vec<Result_z5w0> results = map_2jgP(modids, 0, ctx, options);
            /*MOV*/ fu::str err {};
        ...
        { {
            ...
            if (!(loop_fd < 0))
            {
...

                {
                    ...
                    if (x6031B6)
                    {
                        x6031BA = watch_files_bgrB(fu::vec<fu::str>(x6031B6), event_loop, x6031B6);
