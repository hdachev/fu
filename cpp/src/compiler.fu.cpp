...
Module_cdtC& getModule_1qjp(fu::vec_range<char>, Context_Zsw9&);
fu::str FAIL_text_u9Gb(fu::vec_range<TokenIdx_5581>, fu::view<char>, const Context_Zsw9&);
fu::str getFile_1qjp(fu::vec_range<char>, Context_Zsw9&);
...
void setModule_1qjp(const Module_cdtC&, Context_Zsw9&);
fu::vec_range<char> dirname_qZI0(fu::vec_range<char>);
fu::str join_qZI0(fu::view<char>, fu::vec_range<char>);
fu::str resolveFile_SqDq(fu::vec_range<char>, Context_Zsw9&);
ModidAndOrder_itn0 compile_lexParseDeps_Tsi8(fu::vec_range<char>, fu::vec_range<TokenIdx_5581>, Context_Zsw9&, const Options_TBgD&);
SolverOutput_hA3T solve_gDsn(const Context_Zsw9&, Module_cdtC&, const Options_TBgD&);
fu::str inspect_wkVO(const Module_cdtC&);
CodegenOutput_qIMB cpp_codegen_i4S3(const Module_cdtC&, const Context_Zsw9&, const Options_TBgD&);
BuildOutput_zaam build_uGHE(fu::str&&, fu::str&&, fu::vec_range<char>, fu::str&&, fu::str&&, fu::str&&, fu::view<char>, DEV_OnFail_3YLB, RunMode_n0r3, int, BuildScheme_Vgo7, fu::view<fu::str>, fu::view<fu::str>, const Context_Zsw9&);
bool add_ZwXY(BitSet_mmp7&, int);
bool has_ZwXY(const BitSet_mmp7&, int);
static BuildOutput_zaam recompile_Tsi8(bool, bool, fu::vec_range<char>, fu::vec_range<char>, fu::vec_range<char>, fu::vec_range<char>, fu::vec_range<char>, fu::vec_range<char>, RunMode_n0r3, BuildScheme_Vgo7, fu::view<fu::str>, fu::view<fu::str>, BuildScheme_Vgo7, fu::vec_range<char>, fu::vec_range<char>, fu::vec<fu::str>&, bool&, double&, Context_Zsw9&, const Options_TBgD&);
double hr_0pZh();
...
inline constexpr uint64_t STATE_OFFSET = 4ull;
                                #endif
bool updateFile_1qjp(fu::vec_range<char>, const NukeOnRebuild_TLE7&, Context_Zsw9&);
...
struct ModidAndOrder_itn0
{
    ...
    explicit operator bool() const noexcept
    {
        ...
        ;
                                ...
                                #ifndef DEF_Result_SXm7DxXemub
                                #define DEF_Result_SXm7DxXemub
struct Result_SXm7
{
    Module_cdtC module;
    fu::str error;
    Result_SXm7(const Result_SXm7&) = delete;
    Result_SXm7(Result_SXm7&&) = default;
    Result_SXm7& operator=(const Result_SXm7&) = delete;
    Result_SXm7& operator=(Result_SXm7&&) = default;
    explicit operator bool() const noexcept
    {
        return false
            || module
...
inline const ModuleOrder_HMNg& clone_MUEx(const ModuleOrder_HMNg& a)
{
    return a;
                                ...
                                #ifndef DEF_clone_QddIVnZjNh4
                                #define DEF_clone_QddIVnZjNh4
inline fu::vec_range<UserType_lctk> clone_QddI(fu::vec_range<UserType_lctk> a)
{
    return a;
}
                                #endif
...
inline const CodegenOutput_qIMB& clone_wlt8(const CodegenOutput_qIMB& a)
{
    return a;
                                ...
                                #ifndef DEF_clone_FlqBqkqfUy5
                                #define DEF_clone_FlqBqkqfUy5
inline ModuleOutputs_GBmK clone_FlqB(const ModuleOutputs_GBmK& a)
{
    /*MOV*/ ModuleOutputs_GBmK res {};

    {
        res.types = clone_QddI(a.types);
...
inline const Profile_4UPJ& clone_AoTU(const Profile_4UPJ& a)
{
    return a;
                                ...
                                #ifndef DEF_clone_kM6O1O6R6sk
                                #define DEF_clone_kM6O1O6R6sk
inline Module_cdtC clone_kM6O(const Module_cdtC& a)
{
    /*MOV*/ Module_cdtC res {};
...
inline bool starts_ojop(fu::view<char> a, fu::view<char> with)
{
    return (a.size() >= with.size()) && (fu::get_view_start0(a, with.size()) == with);
                                ...
                                #ifndef DEF___45AyoAveA9k
                                #define DEF___45AyoAveA9k
inline static void _45Ay(Import_7CIJ& import, fu::view<TokenIdx_5581> via, fu::view<char> dir, Context_Zsw9& ctx, Module_cdtC& module, const Options_TBgD& options)
{
    const fu::str& pattern = import.pattern;
    fu::str pattern_1 = (starts_ojop(pattern, "."_view) ? join_qZI0(dir, pattern) : ((dir + '\v') + pattern));
    fu::str _0 {};
    const ModidAndOrder_itn0 other = (_0 = resolveFile_SqDq(pattern_1, ctx), compile_lexParseDeps_Tsi8(static_cast<fu::str&&>(_0), (via + TokenIdx_5581(import.token)), ctx, options));
    ...
    if ((module.order.dep_depth <= other.order.dep_depth))
        module.order.dep_depth = (other.order.dep_depth + 1);
                                ...
                                #ifndef DEF_each_DlvW04pJqH2
                                #define DEF_each_DlvW04pJqH2
inline void each_DlvW(fu::view_mut<Import_7CIJ> a, fu::view<TokenIdx_5581> via, fu::view<char> dir, Context_Zsw9& ctx, Module_cdtC& module, const Options_TBgD& options)
{
    for (int i = 0; i < a.size(); i++)
    {
        Import_7CIJ* _0;
        (_0 = &(a.mutref(i)), _45Ay(*_0, via, dir, ctx, module, options));
    };
}
                                #endif

ModidAndOrder_itn0 compile_lexParseDeps_Tsi8(fu::vec_range<char> fname, fu::vec_range<TokenIdx_5581> via, Context_Zsw9& ctx, const Options_TBgD& options)
{
    const Module_cdtC& module = getModule_1qjp(fname, ctx);
    if (module.in)
    {
        if (module.order)
        {
    ...
    {
        Module_cdtC module_1 = clone_kM6O(module);
        if (module_1.out)
        ...
        else
        {
            ...
            else
            {
                ...
                if (!module_1.order)
                {
                    ...
                    each_DlvW(imports, via, dir, ctx, module_1, options);
...
void compile_solveCodegen_Tsi8(Module_cdtC& module, const Options_TBgD& options, const Context_Zsw9& ctx)
{
    if (module.out)
...
inline fu::str x7E_rA00(fu::view<char> a, fu::view<char> b)
{
    return a + b;
                                ...
                                #ifndef DEF___CCPjX4RlXia
                                #define DEF___CCPjX4RlXia
inline static Result_SXm7 _CCPj(const int modid, const Context_Zsw9& ctx, const Options_TBgD& options)
{

    try
    {
    {
        const Module_cdtC& module = ctx.modules[modid];
        if (module.out)
        {
            return Result_SXm7{};
        }
        ...
        {
            /*MOV*/ Module_cdtC module_1 = clone_kM6O(module);
            compile_solveCodegen_Tsi8(module_1, options, ctx);
            return Result_SXm7 { static_cast<Module_cdtC&&>(module_1), fu::str{} };
        };
    }
    }
    ...
    {
        return Result_SXm7 { Module_cdtC{}, (error ? static_cast<fu::str&&>(error) : x7E_rA00("COMPILER BUG: Empty error string, modid="_view, fu::i64dec(modid))) };
    }
    }
;
}
                                ...
                                #ifndef DEF___bUp19XhmlRj
                                #define DEF___bUp19XhmlRj
inline static const Result_SXm7& _bUp1(const int i, fu::view<int> arr, fu::view_mut<Result_SXm7> result, const Context_Zsw9& ctx, const Options_TBgD& options)
{
    return (result.mutref(i) = _CCPj(arr[i], ctx, options));
}
                                #endif

                                #ifndef DEF_parallel_for_CfKouaPdff1
                                #define DEF_parallel_for_CfKouaPdff1
inline static void parallel_for_CfKo(const int min, int end, fu::view<int> arr, fu::view_mut<Result_SXm7> result, const Context_Zsw9& ctx, const Options_TBgD& options)
{
    int start = (end & 0);
    (void) start;
    ...
    for (int i = start; i < end; i++)
        _bUp1(i, arr, result, ctx, options);
                                ...
                                #ifndef DEF_map_EgOEKSWPXfc
                                #define DEF_map_EgOEKSWPXfc
inline fu::vec<Result_SXm7> map_EgOE(fu::view<int> arr, const int min, const Context_Zsw9& ctx, const Options_TBgD& options)
{
    /*MOV*/ fu::vec<Result_SXm7> result {};
    result.grow<false>(arr.size());
    parallel_for_CfKo(min, arr.size(), arr, result, ctx, options);
    return /*NRVO*/ result;
}
                                #endif

                                #ifndef DEF___RJyNTFCcAJ9
                                #define DEF___RJyNTFCcAJ9
inline static void _RJyN(const Result_SXm7& result, fu::str& err, Context_Zsw9& ctx)
{
    if (result.error)
    {
        if (!(err))
        ...
        setModule_1qjp(result.module, ctx);
                                ...
                                #ifndef DEF_each_0dIYGFiiatg
                                #define DEF_each_0dIYGFiiatg
inline void each_0dIY(fu::view<Result_SXm7> a, fu::str& err, Context_Zsw9& ctx)
{
    for (int i = 0; i < a.size(); i++)
        _RJyN(a[i], err, ctx);
                                ...
                                #ifndef DEF___XDOBg0AdTY9
                                #define DEF___XDOBg0AdTY9
inline static void _XDOB(const int modid, Context_Zsw9& ctx, const Options_TBgD& options)
{
    const Module_cdtC& module = ctx.modules[modid];
    if (!module.out)
    {
        ...
        setModule_1qjp(module_1, ctx);
                                ...
                                #ifndef DEF_each_xCZULtI39Tb
                                #define DEF_each_xCZULtI39Tb
inline void each_xCZU(fu::view<int> a, Context_Zsw9& ctx, const Options_TBgD& options)
{
    for (int i = 0; i < a.size(); i++)
        _XDOB(a[i], ctx, options);

}
                                #endif

void compile_Tsi8(fu::vec_range<char> fname, Context_Zsw9& ctx, const Options_TBgD& options)
{
    compile_lexParseDeps_Tsi8(fname, (*(fu::vec<TokenIdx_5581>*)fu::NIL), ctx, options);
    fu::vec<fu::vec<int>> dep_order {};
    for (int i = 0; i < ctx.modules.size(); i++)
    {
        const Module_cdtC& module = ctx.modules[i];
        ensure_M6xM(dep_order, module.order.dep_depth) += int(module.modid);
    };
    ...
    for (int i_1 = 0; i_1 < dep_order.size(); i_1++)
    {
        ...
        {
            fu::vec<Result_SXm7> results = map_EgOE(modids, 0, ctx, options);
            /*MOV*/ fu::str err {};
            each_0dIY(results, err, ctx);
            if (err)
                fu::fail(static_cast<fu::str&&>(err));

        }
        else
            each_xCZU(modids, ctx, options);

    };
}

extern const Context_Zsw9 CTX_PRELUDE;
                                #ifndef DEF_map_IJHjsCfdR02
                                #define DEF_map_IJHjsCfdR02
inline fu::vec<Module_cdtC> map_IJHj(fu::view<Module_cdtC> a)
{
    /*MOV*/ fu::vec<Module_cdtC> res {};
    res.grow<false>(a.size());
    for (int i = 0; i < a.size(); i++)
        res.mutref(i) = clone_kM6O(a[i]);

    return /*NRVO*/ res;
}
                                #endif

                                #ifndef DEF_clone_61WlEB9wL8h
                                #define DEF_clone_61WlEB9wL8h
inline fu::vec<Module_cdtC> clone_61Wl(fu::view<Module_cdtC> a)
{
    return map_IJHj(a);
}
                                #endif
...
inline const NukeOnRebuild_TLE7& clone_VKXB(const NukeOnRebuild_TLE7& a)
{
    return a;
                                ...
                                #ifndef DEF_clone_4uiEcVtX9qa
                                #define DEF_clone_4uiEcVtX9qa
inline Context_Zsw9 clone_4uiE(const Context_Zsw9& a)
{
    /*MOV*/ Context_Zsw9 res {};

    {
        res.fudir = clone_uMDn(a.fudir);
        res.base_dir = clone_uMDn(a.base_dir);
        res.modules = clone_61Wl(a.modules);
...
void clear_Tsi8(Module_cdtC& module)
{
    module = Module_cdtC { module.modid, fu::str(module.fname), ModuleInputs_iQIg{}, ModuleOrder_HMNg{}, ModuleOutputs_GBmK{}, ModuleStats_ANTR{}, Profile_4UPJ{} };
}

                                #ifndef DEF___WAhaAn8kT8j
                                #define DEF___WAhaAn8kT8j
inline static void _WAha(Module_cdtC& module, BitSet_mmp7& invalid)
{
    if (!module.out)
    {
        clear_Tsi8(module);
        add_ZwXY(invalid, module.modid);
                                ...
                                #ifndef DEF_eachButPrelude_0QrBp29fbOa
                                #define DEF_eachButPrelude_0QrBp29fbOa
inline static void eachButPrelude_0QrB(Context_Zsw9& ctx, BitSet_mmp7& invalid)
{
    for (int i = 1; i < ctx.modules.size(); i++)
        _WAha(ctx.modules.mutref(i), invalid);

}
                                #endif

                                #ifndef DEF_each_YSIn9kVmQD6
                                #define DEF_each_YSIn9kVmQD6
inline void each_YSIn(fu::view<Import_7CIJ> a, Module_cdtC& module, BitSet_mmp7& invalid, bool& repeat)
{
    for (int i = 0; i < a.size(); i++)
    {
        ...
        if (has_ZwXY(invalid, import.modid))
        {
            ...
            return;
                                ...
                                #ifndef DEF___s2HCYvMRngi
                                #define DEF___s2HCYvMRngi
inline static void _s2HC(Module_cdtC& module, BitSet_mmp7& invalid, bool& repeat)
{
    each_YSIn(module.in.parse.imports, module, invalid, repeat);
}
                                #endif

                                #ifndef DEF_eachButPrelude_ICHnBAB1SC2
                                #define DEF_eachButPrelude_ICHnBAB1SC2
inline static void eachButPrelude_ICHn(Context_Zsw9& ctx, BitSet_mmp7& invalid, bool& repeat)
{
    for (int i = 1; i < ctx.modules.size(); i++)
        _s2HC(ctx.modules.mutref(i), invalid, repeat);

}
                                #endif

void watch_pruneModules_Tsi8(Context_Zsw9& ctx)
{
    BitSet_mmp7 invalid {};
    eachButPrelude_0QrB(ctx, invalid);
    if (invalid)
    {
        for (; ; )
        {
            bool repeat = false;
            eachButPrelude_ICHn(ctx, invalid, repeat);
            if (!repeat)
                break;
...
void printSlowBuildDiagnostics_Tsi8(const Context_Zsw9& ctx)
{
    ModuleStat_sTmh lex {};
    ModuleStat_sTmh parse {};
    ModuleStat_sTmh solve {};
    ...
    int specs {};
    int types {};
    fu::view<Module_cdtC> m = ctx.modules;
    for (int i = 1; i < m.size(); i++)
    {
        const Module_cdtC& m_1 = m[i];
        lex += m_1.stats.lex;
...
;
    ...
    else
    {
        ...
        return /*NRVO*/ ret;
                                ...
                                #ifndef DEF___DPiAwuuqKPe
                                #define DEF___DPiAwuuqKPe
inline static void _DPiA(const Module_cdtC& module, fu::vec<fu::str>& watch_list)
{
    if (module.fname)
        watch_list += fu::str(module.fname);
                                ...
                                #ifndef DEF_eachButPrelude_F1BbpMyqGK9
                                #define DEF_eachButPrelude_F1BbpMyqGK9
inline static void eachButPrelude_F1Bb(const Context_Zsw9& ctx, fu::vec<fu::str>& watch_list)
{
    for (int i = 1; i < ctx.modules.size(); i++)
        _DPiA(ctx.modules[i], watch_list);
...
static bool watch_needsRebuild_Tsi8(Context_Zsw9& ctx)
{
    ...
    for (int i = 1; i < ctx.modules.size(); i++)
    {
        ...
        {
            Module_cdtC& module_1 = ctx.modules.mutref(i_1);
            fu::str x {};
...
{
    Context_Zsw9 ctx = clone_4uiE(CTX_PRELUDE);
    ...
    { {
        ...
        if (BuildScheme_Vgo7((bscheme & BuildScheme_Vgo7_watch)) && !watch_list)
            eachButPrelude_F1Bb(ctx, watch_list);
                    ...
                    for (int i = 0; i < num_new_events; i++)
                    {
                        ...
                        if ((_.kind >= Kind_2p91_child_process_pidfd) && (_.kind <= Kind_2p91_child_process_stderr))
                        {
                            ...
                            else
                            {
                                ...
                                x5Bx5D_Ai5N(event_loop.metas, _.event_id).meta.meta_u128 = __uint128_t(meta.meta.meta_u128);
                                int which_1;
                                int which_2;
                                int which_3;
