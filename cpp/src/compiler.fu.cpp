...
Module_nyjb& getModule_1qjp(fu::vec_range<char>, Context_GwtN&);
fu::str FAIL_text_u9Gb(fu::vec_range<TokenIdx_5581>, fu::view<char>, const Context_GwtN&);
fu::str getFile_1qjp(fu::vec_range<char>, Context_GwtN&);
...
void setModule_1qjp(const Module_nyjb&, Context_GwtN&);
fu::vec_range<char> dirname_qZI0(fu::vec_range<char>);
fu::str join_qZI0(fu::view<char>, fu::vec_range<char>);
fu::str resolveFile_SqDq(fu::vec_range<char>, Context_GwtN&);
ModidAndOrder_itn0 compile_lexParseDeps_Tsi8(fu::vec_range<char>, fu::vec_range<TokenIdx_5581>, Context_GwtN&, const Options_TBgD&);
SolverOutput_hA3T solve_gDsn(const Context_GwtN&, Module_nyjb&, const Options_TBgD&);
fu::str inspect_wkVO(const Module_nyjb&);
CodegenOutput_hNw4 cpp_codegen_i4S3(const Module_nyjb&, const Context_GwtN&, const Options_TBgD&);
BuildOutput_zaam build_uGHE(fu::str&&, fu::str&&, fu::vec_range<char>, fu::str&&, fu::str&&, fu::str&&, fu::view<char>, DEV_OnFail_3YLB, RunMode_n0r3, int, BuildScheme_Vgo7, fu::view<fu::str>, fu::view<fu::str>, const Context_GwtN&);
bool add_ZwXY(BitSet_mmp7&, int);
bool has_ZwXY(const BitSet_mmp7&, int);
static BuildOutput_zaam recompile_Tsi8(bool, bool, fu::vec_range<char>, fu::vec_range<char>, fu::vec_range<char>, fu::vec_range<char>, fu::vec_range<char>, fu::vec_range<char>, RunMode_n0r3, BuildScheme_Vgo7, fu::view<fu::str>, fu::view<fu::str>, BuildScheme_Vgo7, fu::vec_range<char>, fu::vec_range<char>, fu::vec<fu::str>&, Context_GwtN&, const Options_TBgD&);
double hr_0pZh();
...
inline constexpr uint64_t STATE_OFFSET = 4ull;
                                #endif
bool updateFile_1qjp(fu::vec_range<char>, const NukeOnRebuild_TLE7&, Context_GwtN&);
...
struct ModidAndOrder_itn0
{
    ...
    explicit operator bool() const noexcept
    {
        ...
        ;
                                ...
                                #ifndef DEF_Result_EuSCdlseKr5
                                #define DEF_Result_EuSCdlseKr5
struct Result_EuSC
{
    Module_nyjb module;
    fu::str error;
    Result_EuSC(const Result_EuSC&) = delete;
    Result_EuSC(Result_EuSC&&) = default;
    Result_EuSC& operator=(const Result_EuSC&) = delete;
    Result_EuSC& operator=(Result_EuSC&&) = default;
    explicit operator bool() const noexcept
    {
        return false
            || module
...
enum RunMode_n0r3: fu::u8
{
    ...
    RunMode_n0r3_CompilerTestcase = 2u,
    RunMode_n0r3_EnsureExecutableButDontRun = 3u,
};
                                #endif
...
inline constexpr BuildScheme_Vgo7 BuildScheme_Vgo7_watch = BuildScheme_Vgo7(16u);
inline constexpr BuildScheme_Vgo7 BuildScheme_Vgo7_debuggable = BuildScheme_Vgo7(32u);
inline constexpr BuildScheme_Vgo7 BuildScheme_Vgo7_unoptimized = BuildScheme_Vgo7(64u);
inline constexpr BuildScheme_Vgo7 BuildScheme_Vgo7_assertions = BuildScheme_Vgo7(128u);
inline constexpr BuildScheme_Vgo7 BuildScheme_Vgo7_TODO_FIX_retail = BuildScheme_Vgo7(256u);
...
static const fu::str str_ndOa8RnsyJi fu_INIT_PRIORITY(1013) { ") err("_fu };
                                ...
                                #ifndef STR_PpLZveFV7L7
                                #define STR_PpLZveFV7L7
static const fu::str str_PpLZveFV7L7 fu_INIT_PRIORITY(1013) { "  WATCH Spurious event, no change."_fu };
                                #endif
...
static const fu::str str_OoBdvQrJLb3 fu_INIT_PRIORITY(1013) { "HOTSWAP Could not signal pid("_fu };
        ...
        #include <stdio.h>          // perror
                                ...
                                #ifndef DEF___MP3lYatl2R5
                                #define DEF___MP3lYatl2R5
inline static fu::view<char> _MP3l(const TokenIdx_5581& token, const int i, fu::view<TokenIdx_5581> via, fu::str& error, const Context_GwtN& ctx)
{
    return (error += FAIL_text_u9Gb(fu::vec<TokenIdx_5581> {{ TokenIdx_5581(token) }}, ((i == (via.size() - 1)) ? "Resulting in an import circle, not currently supported."_view : "Imports:\n"_view), ctx));
                                ...
                                #ifndef DEF_each_WBJ7sLPLP3j
                                #define DEF_each_WBJ7sLPLP3j
inline void each_WBJ7(fu::vec_range<TokenIdx_5581> a, fu::view<TokenIdx_5581> via, fu::str& error, const Context_GwtN& ctx)
{
    for (int i = 0; i < a.size(); i++)
        _MP3l(a[i], i, via, error, ctx);
...
inline SolverOutput_hA3T clone_MA8G(const SolverOutput_hA3T& a)
{
    ...
    return /*NRVO*/ res;
                                ...
                                #ifndef DEF_clone_nmsOIKIJyC0
                                #define DEF_clone_nmsOIKIJyC0
inline const CodegenOutput_hNw4& clone_nmsO(const CodegenOutput_hNw4& a)
{
    return a;
}
                                #endif

                                #ifndef DEF_clone_LighQzXpAgi
                                #define DEF_clone_LighQzXpAgi
inline ModuleOutputs_65Tx clone_Ligh(const ModuleOutputs_65Tx& a)
{
    /*MOV*/ ModuleOutputs_65Tx res {};

    {
        res.types = clone_kDX3(a.types);
        res.solve = clone_MA8G(a.solve);
        res.cpp = clone_nmsO(a.cpp);
    };
    return /*NRVO*/ res;
}
                                #endif
...
inline const Profile_4UPJ& clone_AoTU(const Profile_4UPJ& a)
{
    return a;
                                ...
                                #ifndef DEF_clone_MWeW0elAtK7
                                #define DEF_clone_MWeW0elAtK7
inline Module_nyjb clone_MWeW(const Module_nyjb& a)
{
    /*MOV*/ Module_nyjb res {};
...
inline bool starts_ojop(fu::view<char> a, fu::view<char> with)
{
    return (a.size() >= with.size()) && (fu::get_view_start0(a, with.size()) == with);
                                ...
                                #ifndef DEF___U4CBshYLoUl
                                #define DEF___U4CBshYLoUl
inline static void _U4CB(Import_7CIJ& import, fu::view<TokenIdx_5581> via, fu::view<char> dir, Context_GwtN& ctx, Module_nyjb& module, const Options_TBgD& options)
{
    ...
    if ((module.order.dep_depth <= other.order.dep_depth))
        module.order.dep_depth = (other.order.dep_depth + 1);
                                ...
                                #ifndef DEF_each_4K6eq6jsQsl
                                #define DEF_each_4K6eq6jsQsl
inline void each_4K6e(fu::view_mut<Import_7CIJ> a, fu::view<TokenIdx_5581> via, fu::view<char> dir, Context_GwtN& ctx, Module_nyjb& module, const Options_TBgD& options)
{
    for (int i = 0; i < a.size(); i++)
    {
        Import_7CIJ* _0;
        (_0 = &(a.mutref(i)), _U4CB(*_0, via, dir, ctx, module, options));
    };
}
                                #endif

ModidAndOrder_itn0 compile_lexParseDeps_Tsi8(fu::vec_range<char> fname, fu::vec_range<TokenIdx_5581> via, Context_GwtN& ctx, const Options_TBgD& options)
{
    const Module_nyjb& module = getModule_1qjp(fname, ctx);
    if (module.in)
    {
        if (module.order)
        {
        ...
        {
            /*MOV*/ fu::str error {};
            each_WBJ7(via, via, error, ctx);
            fu::fail(static_cast<fu::str&&>(error));
        };
    }
    else
    {
        Module_nyjb module_1 = clone_MWeW(module);
        if (module_1.out)
        ...
        else
        {
            ...
            else
            {
                ...
                if (!module_1.order)
                {
                    ...
                    each_4K6e(imports, via, dir, ctx, module_1, options);
...
void compile_solveCodegen_Tsi8(Module_nyjb& module, const Options_TBgD& options, const Context_GwtN& ctx)
{
    if (module.out)
...
inline fu::str x7E_rA00(fu::view<char> a, fu::view<char> b)
{
    return a + b;
                                ...
                                #ifndef DEF___f1ODT2ebRW5
                                #define DEF___f1ODT2ebRW5
inline static Result_EuSC _f1OD(const int modid, const Context_GwtN& ctx, const Options_TBgD& options)
{

    try
    {
    {
        const Module_nyjb& module = ctx.modules[modid];
        if (module.out)
        {
            return Result_EuSC{};
        }
        ...
        {
            /*MOV*/ Module_nyjb module_1 = clone_MWeW(module);
            compile_solveCodegen_Tsi8(module_1, options, ctx);
            return Result_EuSC { static_cast<Module_nyjb&&>(module_1), fu::str{} };
        };
    }
    }
    ...
    {
        return Result_EuSC { Module_nyjb{}, (error ? static_cast<fu::str&&>(error) : x7E_rA00("COMPILER BUG: Empty error string, modid="_view, fu::i64dec(modid))) };
    }
    }
;
}
                                ...
                                #ifndef DEF___YigxSAPDg64
                                #define DEF___YigxSAPDg64
inline static const Result_EuSC& _Yigx(const int i, fu::view<int> arr, fu::view_mut<Result_EuSC> result, const Context_GwtN& ctx, const Options_TBgD& options)
{
    return (result.mutref(i) = _f1OD(arr[i], ctx, options));
}
                                #endif

                                #ifndef DEF_parallel_for_eItR8K9gsBh
                                #define DEF_parallel_for_eItR8K9gsBh
inline static void parallel_for_eItR(const int min, int end, fu::view<int> arr, fu::view_mut<Result_EuSC> result, const Context_GwtN& ctx, const Options_TBgD& options)
{
    int start = (end & 0);
    (void) start;
    ...
    for (int i = start; i < end; i++)
        _Yigx(i, arr, result, ctx, options);
                                ...
                                #ifndef DEF_map_xlwGTKE1i17
                                #define DEF_map_xlwGTKE1i17
inline fu::vec<Result_EuSC> map_xlwG(fu::view<int> arr, const int min, const Context_GwtN& ctx, const Options_TBgD& options)
{
    /*MOV*/ fu::vec<Result_EuSC> result {};
    result.grow<false>(arr.size());
    parallel_for_eItR(min, arr.size(), arr, result, ctx, options);
    return /*NRVO*/ result;
}
                                #endif

                                #ifndef DEF___XIOTVjrSU2k
                                #define DEF___XIOTVjrSU2k
inline static void _XIOT(const Result_EuSC& result, fu::str& err, Context_GwtN& ctx)
{
    if (result.error)
    {
        if (!(err))
        ...
        setModule_1qjp(result.module, ctx);
                                ...
                                #ifndef DEF_each_8v7jqlpOBv5
                                #define DEF_each_8v7jqlpOBv5
inline void each_8v7j(fu::view<Result_EuSC> a, fu::str& err, Context_GwtN& ctx)
{
    for (int i = 0; i < a.size(); i++)
        _XIOT(a[i], err, ctx);
                                ...
                                #ifndef DEF___ujV5nfoogMj
                                #define DEF___ujV5nfoogMj
inline static void _ujV5(const int modid, Context_GwtN& ctx, const Options_TBgD& options)
{
    const Module_nyjb& module = ctx.modules[modid];
    if (!module.out)
    {
        ...
        setModule_1qjp(module_1, ctx);
                                ...
                                #ifndef DEF_each_SlFenqUqo26
                                #define DEF_each_SlFenqUqo26
inline void each_SlFe(fu::view<int> a, Context_GwtN& ctx, const Options_TBgD& options)
{
    for (int i = 0; i < a.size(); i++)
        _ujV5(a[i], ctx, options);

}
                                #endif

void compile_Tsi8(fu::vec_range<char> fname, Context_GwtN& ctx, const Options_TBgD& options)
{
    compile_lexParseDeps_Tsi8(fname, (*(fu::vec<TokenIdx_5581>*)fu::NIL), ctx, options);
    fu::vec<fu::vec<int>> dep_order {};
    for (int i = 0; i < ctx.modules.size(); i++)
    {
        const Module_nyjb& module = ctx.modules[i];
    ...
    for (int i_1 = 0; i_1 < dep_order.size(); i_1++)
    {
        ...
        {
            fu::vec<Result_EuSC> results = map_xlwG(modids, 0, ctx, options);
            /*MOV*/ fu::str err {};
            each_8v7j(results, err, ctx);
            if (err)
                fu::fail(static_cast<fu::str&&>(err));

        }
        else
            each_SlFe(modids, ctx, options);

    };
}

extern const Context_GwtN CTX_PRELUDE;
                                #ifndef DEF_map_mAsyjVXhmr8
                                #define DEF_map_mAsyjVXhmr8
inline fu::vec<Module_nyjb> map_mAsy(fu::view<Module_nyjb> a)
{
    /*MOV*/ fu::vec<Module_nyjb> res {};
    res.grow<false>(a.size());
    for (int i = 0; i < a.size(); i++)
        res.mutref(i) = clone_MWeW(a[i]);

    return /*NRVO*/ res;
}
                                #endif

                                #ifndef DEF_clone_kLxzTjWt8q2
                                #define DEF_clone_kLxzTjWt8q2
inline fu::vec<Module_nyjb> clone_kLxz(fu::view<Module_nyjb> a)
{
    return map_mAsy(a);
}
                                #endif
...
inline const NukeOnRebuild_TLE7& clone_VKXB(const NukeOnRebuild_TLE7& a)
{
    return a;
                                ...
                                #ifndef DEF_clone_PIlERIIpoke
                                #define DEF_clone_PIlERIIpoke
inline Context_GwtN clone_PIlE(const Context_GwtN& a)
{
    /*MOV*/ Context_GwtN res {};

    {
        res.fudir = clone_uMDn(a.fudir);
        res.base_dir = clone_uMDn(a.base_dir);
        res.modules = clone_kLxz(a.modules);
...
void clear_Tsi8(Module_nyjb& module)
{
    module = Module_nyjb { module.modid, fu::str(module.fname), ModuleInputs_iQIg{}, ModuleOrder_HMNg{}, ModuleOutputs_65Tx{}, ModuleStats_ANTR{}, Profile_4UPJ{} };
}

                                #ifndef DEF___gsZ6HSMwKKk
                                #define DEF___gsZ6HSMwKKk
inline static void _gsZ6(Module_nyjb& module, BitSet_mmp7& invalid)
{
    if (!module.out)
    {
        clear_Tsi8(module);
        add_ZwXY(invalid, module.modid);
                                ...
                                #ifndef DEF_eachButPrelude_ZIGxHxLouhj
                                #define DEF_eachButPrelude_ZIGxHxLouhj
inline static void eachButPrelude_ZIGx(Context_GwtN& ctx, BitSet_mmp7& invalid)
{
    for (int i = 1; i < ctx.modules.size(); i++)
        _gsZ6(ctx.modules.mutref(i), invalid);

}
                                #endif

                                #ifndef DEF_each_4OvSpUybUhc
                                #define DEF_each_4OvSpUybUhc
inline void each_4OvS(fu::view<Import_7CIJ> a, Module_nyjb& module, BitSet_mmp7& invalid, bool& repeat)
{
    for (int i = 0; i < a.size(); i++)
    {
        ...
        if (has_ZwXY(invalid, import.modid))
        {
            ...
            return;
                                ...
                                #ifndef DEF___999n1V30ykc
                                #define DEF___999n1V30ykc
inline static void _999n(Module_nyjb& module, BitSet_mmp7& invalid, bool& repeat)
{
    each_4OvS(module.in.parse.imports, module, invalid, repeat);
}
                                #endif

                                #ifndef DEF_eachButPrelude_icuUzZjuscb
                                #define DEF_eachButPrelude_icuUzZjuscb
inline static void eachButPrelude_icuU(Context_GwtN& ctx, BitSet_mmp7& invalid, bool& repeat)
{
    for (int i = 1; i < ctx.modules.size(); i++)
        _999n(ctx.modules.mutref(i), invalid, repeat);

}
                                #endif

void watch_pruneModules_Tsi8(Context_GwtN& ctx)
{
    BitSet_mmp7 invalid {};
    eachButPrelude_ZIGx(ctx, invalid);
    if (invalid)
    {
        for (; ; )
        {
            bool repeat = false;
            eachButPrelude_icuU(ctx, invalid, repeat);
            if (!repeat)
                break;
...
void printSlowBuildDiagnostics_Tsi8(const Context_GwtN& ctx)
{
    ModuleStat_sTmh lex {};
    ModuleStat_sTmh parse {};
    ModuleStat_sTmh solve {};
    ...
    int specs {};
    int types {};
    fu::view<Module_nyjb> m = ctx.modules;
    for (int i = 1; i < m.size(); i++)
    {
        const Module_nyjb& m_1 = m[i];
        lex += m_1.stats.lex;
...
static BuildOutput_zaam HOTSWAP_build_Tsi8(const bool plugin, fu::view<char> fname, fu::vec_range<char> dir_wrk, fu::vec_range<char> bin, fu::vec_range<char> dir_obj, fu::vec_range<char> dir_src, fu::vec_range<char> dir_cpp, const RunMode_n0r3 runmode, const BuildScheme_Vgo7 bscheme, fu::view<fu::str> flags_cc, fu::view<fu::str> flags_ld, fu::vec_range<char> HOTSWAP_dirname, fu::vec_range<char> HOTSWAP_plugin, const Context_GwtN& ctx)
{
    ...
    fu::vec<fu::str> libs = fu::vec<fu::str> {{ fu::str("-L"_fu), fu::str(HOTSWAP_dirname), fu::str("-lfu"_fu) }};
    ...
    {
        return build_Tsi8(((flags_ld + libs) + fu::view<fu::str> {{ ("-Wl,-rpath,"_view + ORIGIN) }}), runmode, BuildScheme_Vgo7((bscheme & BuildScheme_Vgo7(~BuildScheme_Vgo7_shared))), bin, fname, dir_wrk, dir_obj, dir_src, dir_cpp, flags_cc, ctx);
    };
}

static BuildOutput_zaam recompile_Tsi8(const bool plugin, const bool dont_try_catch, fu::vec_range<char> fname, fu::vec_range<char> dir_wrk, fu::vec_range<char> bin, fu::vec_range<char> dir_obj, fu::vec_range<char> dir_src, fu::vec_range<char> dir_cpp, const RunMode_n0r3 runmode, const BuildScheme_Vgo7 bscheme, fu::view<fu::str> flags_cc, fu::view<fu::str> flags_ld, const BuildScheme_Vgo7 HOTSWAP, fu::vec_range<char> HOTSWAP_dirname, fu::vec_range<char> HOTSWAP_plugin, fu::vec<fu::str>& watch_list, Context_GwtN& ctx, const Options_TBgD& options)
{
    if (BuildScheme_Vgo7((bscheme & BuildScheme_Vgo7_watch)) && !dont_try_catch)
    {
        ...
        { {
            ...
            try
            {
                return recompile_Tsi8(plugin, true, fname, dir_wrk, bin, dir_obj, dir_src, dir_cpp, runmode, bscheme, flags_cc, flags_ld, HOTSWAP, HOTSWAP_dirname, HOTSWAP_plugin, watch_list, ctx, options);
            }
            catch (const std::exception& o_0)
            {
...
;
    ...
    else
    {
        ...
        return /*NRVO*/ ret;
                                ...
                                #ifndef DEF___vfkXQXwsTL1
                                #define DEF___vfkXQXwsTL1
inline static void _vfkX(const Module_nyjb& module, fu::vec<fu::str>& watch_list)
{
    if (module.fname)
        watch_list += fu::str(module.fname);
                                ...
                                #ifndef DEF_eachButPrelude_AQRY0ihzUcj
                                #define DEF_eachButPrelude_AQRY0ihzUcj
inline static void eachButPrelude_AQRY(const Context_GwtN& ctx, fu::vec<fu::str>& watch_list)
{
    for (int i = 1; i < ctx.modules.size(); i++)
        _vfkX(ctx.modules[i], watch_list);
...
inline bool ends_L30J(fu::view<char> a, const char with)
{
    return a.size() && (a[(a.size() - 1)] == with);
                                ...
                                #ifndef DEF_watch_files_bgrBjd6SsLl
                                #define DEF_watch_files_bgrBjd6SsLl
inline WatchID_fBDr watch_files_bgrB(fu::vec<fu::str>&& files, Loop_UQM7& event_loop, fu::view<fu::str> watch_list)
{
    ...
    SocketState_xV3L state;
    unsigned user32;
    const uint64_t user_data = (kind = Kind_2p91_watched_files, fd = FD_q1SK(int(watch_id)), state = SocketState_xV3L{}, user32 = 0u, fu_ASSERT(((fd >= 0) ? (fd <= 0xffffff) : false)), (((uint64_t(kind) | (uint64_t(FD_q1SK(fd)) << 8ull)) | ((uint64_t(state) & STATE_MASK) << STATE_OFFSET)) | (uint64_t(user32) << 32ull)));
...
static bool watch_needsRebuild_Tsi8(Context_GwtN& ctx)
{
    ...
    for (int i = 1; i < ctx.modules.size(); i++)
    {
        ...
        {
            Module_nyjb& module_1 = ctx.modules.mutref(i_1);
            fu::str x {};
...
inline Meta_igy4& x5Bx5D_Ai5N(Pool_X5U1& pool, const int i)
{
    ...
    return pool.items.mutref(i_1);
                                ...
                                #ifndef DEF_spawn_ZP6rORTD2Zh
                                #define DEF_spawn_ZP6rORTD2Zh
inline PID_05b1 spawn_ZP6r(/*MOV*/ fu::vec<fu::str>&& argv, const ChildStream_ofm8 stdout, const ChildStream_ofm8 stderr, const ChildStream_ofm8 stdin, Loop_UQM7& event_loop, fu::view<fu::str> argv_1)
{
    Child_elyG child {};
...
{
    const PID_05b1 pid = spawn_ZP6r(fu::vec<fu::str>(argv), ChildStream_ofm8_Parent, ChildStream_ofm8_Parent, ChildStream_ofm8{}, Loop_with_child_handlers, argv);
    return pid;
}
...
{
    Context_GwtN ctx = clone_PIlE(CTX_PRELUDE);
    ...
    for (; ; )
    { {
        /*MOV*/ BuildOutput_zaam ret = recompile_Tsi8(false, false, fname, dir_wrk, bin, dir_obj, dir_src, dir_cpp, runmode, bscheme, flags_cc, flags_ld, HOTSWAP, HOTSWAP_dirname, HOTSWAP_plugin, watch_list, ctx, options);
        if (BuildScheme_Vgo7((bscheme & BuildScheme_Vgo7_watch)) && !watch_list)
            eachButPrelude_AQRY(ctx, watch_list);
        ...
        { {
            ...
            const BuildOutput_zaam& x6031B7 = ret;
            WatchID_fBDr& x6031B8 = fswatch_wid;
            PID_05b1& x6031B9 = run_pid;
            Context_GwtN& ctx_1 = ctx;
            ...
            if (!(loop_fd < 0))
            {
                ...
                {
                    fu_ASSERT((!x6031B8 ? !x6031B9 : false));
                    if (x6031B6)
                    {
                        x6031B8 = watch_files_bgrB(fu::vec<fu::str>(x6031B6), event_loop, x6031B6);
                        if (watch_needsRebuild_Tsi8(ctx_1))
                            continue;

                    };
                    if (x6031BxF9xFFxFFxFFF && x6031B7.executable)
                    {
                        x6031B9 = spawn_Tsi8(fu::vec<fu::str> {{ fu::str(x6031B7.executable) }}, event_loop);
                    };
                    if (!x6031B9 && !x6031B8)
                        goto BL_5;
                ...
                for (; ; )
                {
                    ...
                    for (int i = 0; i < num_new_events; i++)
                    {
                        ...
                        else if (_.kind == Kind_2p91_watched_files)
                        {
                            ...
                            fu_ASSERT((watch_id == x6031B8));
                            if (!watch_needsRebuild_Tsi8(ctx_1))
                            {
                                const fu::str* x;
                                fu::println(fu::view<fu::str> {{ fu::str((x = &(str_PpLZveFV7L7), (*x))) }});
                            }
                            else
                            {
                                if (x6031B3 && x6031B9)
                                {
                                    BuildOutput_zaam ok = recompile_Tsi8(true, false, x6031BxFFxFFxFFxFFF, x6031BxFExFFxFFxFFF, x6031BxFDxFFxFFxFFF, x6031BxFCxFFxFFxFFF, x6031BxFBxFFxFFxFFF, x6031BxFAxFFxFFxFFF, x6031BxF9xFFxFFxFFF, x6031BxF8xFFxFFxFFF, x6031BxF7xFFxFFxFFF, x6031BxF6xFFxFFxFFF, x6031B3, x6031B4, x6031B5, x6031B6, ctx_1, options_1);
                                    if (ok)
                                    {
                                        const fu::str* x;
                                        fu::str x_1 {};
                                        const fu::str* x_2;
                                        fu::println(fu::view<fu::str> {{ fu::str((x = &(str_Gp2vjrxiwYh), (*x))), (x_1 = fu::i64dec(x6031B9), x_1).const_cast_mut().destructive_move(), fu::str((x_2 = &(str_OFL5YhAReEe), (*x_2))) }});
                                        const Errno_88RA err_1 = kill_wYYR(x6031B9, SIGUSR1);
                                        if (err_1)
                                        {
                                            const fu::str* x_3;
                                            fu::str x_4 {};
                                            ...
                                            fu::str x_6 {};
                                            const fu::str* x_7;
                                            fu::println(fu::view<fu::str> {{ fu::str((x_3 = &(str_OoBdvQrJLb3), (*x_3))), (x_4 = fu::i64dec(x6031B9), x_4).const_cast_mut().destructive_move(), fu::str((x_5 = &(str_ndOa8RnsyJi), (*x_5))), (x_6 = fu::i64dec(err_1), x_6).const_cast_mut().destructive_move(), fu::str((x_7 = &(str_vToKAcI3qHa), (*x_7))) }});
                                        }
                                        else
                                            continue;
