...
Module_BOS4& getModule_1qjp(fu::vec_range<char>, Context_Dujv&);
fu::str FAIL_text_u9Gb(fu::vec_range<TokenIdx_5581>, fu::view<char>, const Context_Dujv&);
fu::str getFile_1qjp(fu::vec_range<char>, Context_Dujv&);
...
void setModule_1qjp(const Module_BOS4&, Context_Dujv&);
fu::vec_range<char> dirname_qZI0(fu::vec_range<char>);
fu::str join_qZI0(fu::view<char>, fu::vec_range<char>);
fu::str resolveFile_SqDq(fu::vec_range<char>, Context_Dujv&);
ModidAndOrder_itn0 compile_lexParseDeps_Tsi8(fu::vec_range<char>, fu::vec_range<TokenIdx_5581>, Context_Dujv&, const Options_TBgD&);
SolverOutput_uWwi solve_gDsn(const Context_Dujv&, Module_BOS4&, const Options_TBgD&);
fu::str inspect_wkVO(const Module_BOS4&);
CodegenOutput_qIMB cpp_codegen_i4S3(const Module_BOS4&, const Context_Dujv&, const Options_TBgD&);
BuildOutput_zaam build_uGHE(fu::str&&, fu::str&&, fu::vec_range<char>, fu::str&&, fu::str&&, fu::str&&, fu::view<char>, DEV_OnFail_3YLB, RunMode_n0r3, int, BuildScheme_Vgo7, fu::view<fu::str>, fu::view<fu::str>, const Context_Dujv&);
bool add_ZwXY(BitSet_mmp7&, int);
bool has_ZwXY(const BitSet_mmp7&, int);
static BuildOutput_zaam recompile_Tsi8(bool, bool, fu::vec_range<char>, fu::vec_range<char>, fu::vec_range<char>, fu::vec_range<char>, fu::vec_range<char>, fu::vec_range<char>, RunMode_n0r3, BuildScheme_Vgo7, fu::view<fu::str>, fu::view<fu::str>, BuildScheme_Vgo7, fu::vec_range<char>, fu::vec_range<char>, fu::vec<fu::str>&, bool&, double&, Context_Dujv&, const Options_TBgD&);
double hr_0pZh();
...
inline constexpr uint64_t STATE_OFFSET = 4ull;
                                #endif
bool updateFile_1qjp(fu::vec_range<char>, const NukeOnRebuild_TLE7&, Context_Dujv&);
...
struct ModidAndOrder_itn0
{
    ...
    explicit operator bool() const noexcept
    {
        ...
        ;
                                ...
                                #ifndef DEF_Result_tABcplyjvZe
                                #define DEF_Result_tABcplyjvZe
struct Result_tABc
{
    Module_BOS4 module;
    fu::str error;
    Result_tABc(const Result_tABc&) = delete;
    Result_tABc(Result_tABc&&) = default;
    Result_tABc& operator=(const Result_tABc&) = delete;
    Result_tABc& operator=(Result_tABc&&) = default;
    explicit operator bool() const noexcept
    {
        return false
            || module
...
static const fu::str str_OoBdvQrJLb3 fu_INIT_PRIORITY(1013) { "HOTSWAP Could not signal pid("_fu };
        ...
        #include <stdio.h>          // perror
                                ...
                                #ifndef DEF___N1LetObpSmh
                                #define DEF___N1LetObpSmh
inline static fu::view<char> _N1Le(const TokenIdx_5581& token, const int i, fu::view<TokenIdx_5581> via, fu::str& error, const Context_Dujv& ctx)
{
    return (error += FAIL_text_u9Gb(fu::vec<TokenIdx_5581> {{ TokenIdx_5581(token) }}, ((i == (via.size() - 1)) ? "Resulting in an import circle, not currently supported."_view : "Imports:\n"_view), ctx));
                                ...
                                #ifndef DEF_each_BuVWp4WiYPg
                                #define DEF_each_BuVWp4WiYPg
inline void each_BuVW(fu::vec_range<TokenIdx_5581> a, fu::view<TokenIdx_5581> via, fu::str& error, const Context_Dujv& ctx)
{
    for (int i = 0; i < a.size(); i++)
        _N1Le(a[i], i, via, error, ctx);
...
inline bool starts_ojop(fu::view<char> a, fu::view<char> with)
{
    return (a.size() >= with.size()) && (fu::get_view_start0(a, with.size()) == with);
                                ...
                                #ifndef DEF___6ASQD8CMCng
                                #define DEF___6ASQD8CMCng
inline static void _6ASQ(Import_7CIJ& import, fu::view<TokenIdx_5581> via, fu::view<char> dir, Context_Dujv& ctx, Module_BOS4& module, const Options_TBgD& options)
{
    ...
    if ((module.order.dep_depth <= other.order.dep_depth))
        module.order.dep_depth = (other.order.dep_depth + 1);
                                ...
                                #ifndef DEF_each_QpZ89FpH964
                                #define DEF_each_QpZ89FpH964
inline void each_QpZ8(fu::view_mut<Import_7CIJ> a, fu::view<TokenIdx_5581> via, fu::view<char> dir, Context_Dujv& ctx, Module_BOS4& module, const Options_TBgD& options)
{
    for (int i = 0; i < a.size(); i++)
    {
        Import_7CIJ* _0;
        (_0 = &(a.mutref(i)), _6ASQ(*_0, via, dir, ctx, module, options));
    };
}
                                #endif

ModidAndOrder_itn0 compile_lexParseDeps_Tsi8(fu::vec_range<char> fname, fu::vec_range<TokenIdx_5581> via, Context_Dujv& ctx, const Options_TBgD& options)
{
    const Module_BOS4& module = getModule_1qjp(fname, ctx);
    if (module.in)
    {
        if (module.order)
        {
        ...
        {
            /*MOV*/ fu::str error {};
            each_BuVW(via, via, error, ctx);
            fu::fail(static_cast<fu::str&&>(error));
        };
    }
    else
    {
        Module_BOS4 module_1 = clone_h9KC(module);
        if (module_1.out)
        ...
        else
        {
            ...
            else
            {
                ...
                if (!module_1.order)
                {
                    ...
                    each_QpZ8(imports, via, dir, ctx, module_1, options);
...
void compile_solveCodegen_Tsi8(Module_BOS4& module, const Options_TBgD& options, const Context_Dujv& ctx)
{
    if (module.out)
...
inline fu::str x7E_rA00(fu::view<char> a, fu::view<char> b)
{
    return a + b;
                                ...
                                #ifndef DEF___uIc4XzdfsPh
                                #define DEF___uIc4XzdfsPh
inline static Result_tABc _uIc4(const int modid, const Context_Dujv& ctx, const Options_TBgD& options)
{

    try
    {
    {
        const Module_BOS4& module = ctx.modules[modid];
        if (module.out)
        {
            return Result_tABc{};
        }
        ...
        {
            /*MOV*/ Module_BOS4 module_1 = clone_h9KC(module);
            compile_solveCodegen_Tsi8(module_1, options, ctx);
            return Result_tABc { static_cast<Module_BOS4&&>(module_1), fu::str{} };
        };
    }
    }
    ...
    {
        return Result_tABc { Module_BOS4{}, (error ? static_cast<fu::str&&>(error) : x7E_rA00("COMPILER BUG: Empty error string, modid="_view, fu::i64dec(modid))) };
    }
    }
;
}
                                ...
                                #ifndef DEF___kwQwfRo77I4
                                #define DEF___kwQwfRo77I4
inline static const Result_tABc& _kwQw(const int i, fu::view<int> arr, fu::view_mut<Result_tABc> result, const Context_Dujv& ctx, const Options_TBgD& options)
{
    return (result.mutref(i) = _uIc4(arr[i], ctx, options));
}
                                #endif

                                #ifndef DEF_parallel_for_1ai6o3C7tf4
                                #define DEF_parallel_for_1ai6o3C7tf4
inline static void parallel_for_1ai6(const int min, int end, fu::view<int> arr, fu::view_mut<Result_tABc> result, const Context_Dujv& ctx, const Options_TBgD& options)
{
    int start = (end & 0);
    (void) start;
    ...
    for (int i = start; i < end; i++)
        _kwQw(i, arr, result, ctx, options);
                                ...
                                #ifndef DEF_map_McGFOUDw3X7
                                #define DEF_map_McGFOUDw3X7
inline fu::vec<Result_tABc> map_McGF(fu::view<int> arr, const int min, const Context_Dujv& ctx, const Options_TBgD& options)
{
    /*MOV*/ fu::vec<Result_tABc> result {};
    result.grow<false>(arr.size());
    parallel_for_1ai6(min, arr.size(), arr, result, ctx, options);
    return /*NRVO*/ result;
}
                                #endif

                                #ifndef DEF___QD8Tg5BaSWi
                                #define DEF___QD8Tg5BaSWi
inline static void _QD8T(const Result_tABc& result, fu::str& err, Context_Dujv& ctx)
{
    if (result.error)
    {
        if (!(err))
        ...
        setModule_1qjp(result.module, ctx);
                                ...
                                #ifndef DEF_each_6Ppul1AA1B7
                                #define DEF_each_6Ppul1AA1B7
inline void each_6Ppu(fu::view<Result_tABc> a, fu::str& err, Context_Dujv& ctx)
{
    for (int i = 0; i < a.size(); i++)
        _QD8T(a[i], err, ctx);
                                ...
                                #ifndef DEF___eDniDZRZTP4
                                #define DEF___eDniDZRZTP4
inline static void _eDni(const int modid, Context_Dujv& ctx, const Options_TBgD& options)
{
    const Module_BOS4& module = ctx.modules[modid];
    if (!module.out)
    {
        ...
        setModule_1qjp(module_1, ctx);
                                ...
                                #ifndef DEF_each_j01Rp9wxiqj
                                #define DEF_each_j01Rp9wxiqj
inline void each_j01R(fu::view<int> a, Context_Dujv& ctx, const Options_TBgD& options)
{
    for (int i = 0; i < a.size(); i++)
        _eDni(a[i], ctx, options);

}
                                #endif

void compile_Tsi8(fu::vec_range<char> fname, Context_Dujv& ctx, const Options_TBgD& options)
{
    compile_lexParseDeps_Tsi8(fname, (*(fu::vec<TokenIdx_5581>*)fu::NIL), ctx, options);
    fu::vec<fu::vec<int>> dep_order {};
    for (int i = 0; i < ctx.modules.size(); i++)
    {
        const Module_BOS4& module = ctx.modules[i];
    ...
    for (int i_1 = 0; i_1 < dep_order.size(); i_1++)
    {
        ...
        {
            fu::vec<Result_tABc> results = map_McGF(modids, 0, ctx, options);
            /*MOV*/ fu::str err {};
            each_6Ppu(results, err, ctx);
            if (err)
                fu::fail(static_cast<fu::str&&>(err));

        }
        else
            each_j01R(modids, ctx, options);

    };
}

extern const Context_Dujv CTX_PRELUDE;
                                #ifndef DEF_map_25NFwIx1Zqb
                                #define DEF_map_25NFwIx1Zqb
inline fu::vec<Module_BOS4> map_25NF(fu::view<Module_BOS4> a)
{
    /*MOV*/ fu::vec<Module_BOS4> res {};
    res.grow<false>(a.size());
    for (int i = 0; i < a.size(); i++)
        res.mutref(i) = clone_h9KC(a[i]);

    return /*NRVO*/ res;
}
                                #endif

                                #ifndef DEF_clone_40CJLgfAMZc
                                #define DEF_clone_40CJLgfAMZc
inline fu::vec<Module_BOS4> clone_40CJ(fu::view<Module_BOS4> a)
{
    return map_25NF(a);
}
                                #endif
...
inline const NukeOnRebuild_TLE7& clone_VKXB(const NukeOnRebuild_TLE7& a)
{
    return a;
                                ...
                                #ifndef DEF_clone_4EXuDNEPFBg
                                #define DEF_clone_4EXuDNEPFBg
inline Context_Dujv clone_4EXu(const Context_Dujv& a)
{
    /*MOV*/ Context_Dujv res {};

    {
        res.fudir = clone_uMDn(a.fudir);
        res.base_dir = clone_uMDn(a.base_dir);
        res.modules = clone_40CJ(a.modules);
...
void clear_Tsi8(Module_BOS4& module)
{
    module = Module_BOS4 { module.modid, fu::str(module.fname), ModuleInputs_iQIg{}, ModuleOrder_HMNg{}, ModuleOutputs_0BsN{}, ModuleStats_ANTR{}, Profile_4UPJ{} };
}

                                #ifndef DEF___PPdSdE2gt8c
                                #define DEF___PPdSdE2gt8c
inline static void _PPdS(Module_BOS4& module, BitSet_mmp7& invalid)
{
    if (!module.out)
    {
        clear_Tsi8(module);
        add_ZwXY(invalid, module.modid);
                                ...
                                #ifndef DEF_eachButPrelude_TPBxHI2bdT5
                                #define DEF_eachButPrelude_TPBxHI2bdT5
inline static void eachButPrelude_TPBx(Context_Dujv& ctx, BitSet_mmp7& invalid)
{
    for (int i = 1; i < ctx.modules.size(); i++)
        _PPdS(ctx.modules.mutref(i), invalid);

}
                                #endif

                                #ifndef DEF_each_vU5PmRcGX3c
                                #define DEF_each_vU5PmRcGX3c
inline void each_vU5P(fu::view<Import_7CIJ> a, Module_BOS4& module, BitSet_mmp7& invalid, bool& repeat)
{
    for (int i = 0; i < a.size(); i++)
    {
        ...
        if (has_ZwXY(invalid, import.modid))
        {
            ...
            return;
                                ...
                                #ifndef DEF___u3pmvzVyCU9
                                #define DEF___u3pmvzVyCU9
inline static void _u3pm(Module_BOS4& module, BitSet_mmp7& invalid, bool& repeat)
{
    each_vU5P(module.in.parse.imports, module, invalid, repeat);
}
                                #endif

                                #ifndef DEF_eachButPrelude_RFbGztPzDUd
                                #define DEF_eachButPrelude_RFbGztPzDUd
inline static void eachButPrelude_RFbG(Context_Dujv& ctx, BitSet_mmp7& invalid, bool& repeat)
{
    for (int i = 1; i < ctx.modules.size(); i++)
        _u3pm(ctx.modules.mutref(i), invalid, repeat);

}
                                #endif

void watch_pruneModules_Tsi8(Context_Dujv& ctx)
{
    BitSet_mmp7 invalid {};
    eachButPrelude_TPBx(ctx, invalid);
    if (invalid)
    {
        for (; ; )
        {
            bool repeat = false;
            eachButPrelude_RFbG(ctx, invalid, repeat);
            if (!repeat)
                break;
...
void printSlowBuildDiagnostics_Tsi8(const Context_Dujv& ctx)
{
    ModuleStat_sTmh lex {};
    ModuleStat_sTmh parse {};
    ModuleStat_sTmh solve {};
    ...
    int specs {};
    int types {};
    fu::view<Module_BOS4> m = ctx.modules;
    for (int i = 1; i < m.size(); i++)
    {
        const Module_BOS4& m_1 = m[i];
        lex += m_1.stats.lex;
...
;
    ...
    else
    {
        ...
        return /*NRVO*/ ret;
                                ...
                                #ifndef DEF___gJcoCZRkCii
                                #define DEF___gJcoCZRkCii
inline static void _gJco(const Module_BOS4& module, fu::vec<fu::str>& watch_list)
{
    if (module.fname)
        watch_list += fu::str(module.fname);
                                ...
                                #ifndef DEF_eachButPrelude_Q5UqJLHkhh3
                                #define DEF_eachButPrelude_Q5UqJLHkhh3
inline static void eachButPrelude_Q5Uq(const Context_Dujv& ctx, fu::vec<fu::str>& watch_list)
{
    for (int i = 1; i < ctx.modules.size(); i++)
        _gJco(ctx.modules[i], watch_list);
...
static bool watch_needsRebuild_Tsi8(Context_Dujv& ctx)
{
    ...
    for (int i = 1; i < ctx.modules.size(); i++)
    {
        ...
        {
            Module_BOS4& module_1 = ctx.modules.mutref(i_1);
            fu::str x {};
...
{
    Context_Dujv ctx = clone_4EXu(CTX_PRELUDE);
    ...
    { {
        ...
        if (BuildScheme_Vgo7((bscheme & BuildScheme_Vgo7_watch)) && !watch_list)
            eachButPrelude_Q5Uq(ctx, watch_list);
