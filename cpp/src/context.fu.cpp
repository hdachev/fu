...
fu::str resolveFile_1qjp(fu::vec_range<char>, fu::view<char>, Context_GwtN&);
...
Shape_fvCX getShape_1qjp(const ValueType_JtNg&, const Context_GwtN&, const TokenIdx_5581&, const Module_nyjb&);
...
Struct_LDkB& lookupUserType_mut_1qjp(fu::view<char> canon, Module_nyjb& module, const Context_GwtN& ctx, const TokenIdx_5581& _here)
{
...
static fu::str tryResolve_1qjp(fu::vec_range<char> from, fu::view<char> name, fu::vec_range<char> path, Context_GwtN& ctx)
{
...
fu::str resolveFile_1qjp(fu::vec_range<char> from, fu::view<char> name, Context_GwtN& ctx)
{
    ...
    else
    {
        ...
        return /*NRVO*/ resolve;
                                ...
                                #ifndef DEF_run_D8j728EujKe
                                #define DEF_run_D8j728EujKe
inline static fu::str run_D8j7(fu::vec_range<char> from, fu::view<char> name, fu::view<char> alt, fu::view<char> nested, Context_GwtN& ctx)
{
    fu::str _0 {};
...
fu::str testSuite_resolvePrepopulatedFile_1qjp(fu::view<char> from, fu::view<char> name, const Context_GwtN& ctx)
{
    ...
    else
    {
        return fu::str{};
                                ...
                                #ifndef DEF_run_plDgshfADkb
                                #define DEF_run_plDgshfADkb
inline static fu::str run_plDg(fu::view<char> from, fu::view<char> name, fu::view<char> alt, fu::view<char> nested, const Context_GwtN& ctx)
{
    fu::str _0 {};
...
fu::str resolveFile_SqDq(fu::vec_range<char> path, Context_GwtN& ctx)
{
    ...
    if ((fuz_idx > 0) && (fuz_idx < (path.size() - 1)) && (find_rkz0(path, '\v', (fuz_idx + 1)) < 0))
    {
        ...
        fu::str _0 {};
        /*MOV*/ fu::str file = ((_0 = run_D8j7(from, name, alt, nested, ctx)) ? static_cast<fu::str&&>(_0) : run_plDg(from, name, alt, nested, ctx));
        if (file)
            return /*NRVO*/ file;
...
fu::str getFile_1qjp(fu::vec_range<char> path, Context_GwtN& ctx)
{
...
Module_nyjb& getModule_1qjp(fu::vec_range<char> fname, Context_GwtN& ctx)
{
    ...
    ctx.modules.push(Module_nyjb { i_1, fu::str(fname), ModuleInputs_iQIg{}, ModuleOrder_HMNg{}, ModuleOutputs_65Tx{}, ModuleStats_ANTR{}, Profile_4UPJ{} });
...
void setModule_1qjp(const Module_nyjb& module, Context_GwtN& ctx)
{
    Module_nyjb& current = ctx.modules.mutref(module.modid);
    if (current.fname == module.fname)
        current = clone_MWeW(module);
    else
...
bool updateFile_1qjp(fu::vec_range<char> fname, const NukeOnRebuild_TLE7& old, Context_GwtN& ctx)
{
...
const Struct_LDkB& lookupUserType_1qjp(const StructCanon_TixV& scp, const Module_nyjb& module, const Context_GwtN& ctx, const TokenIdx_5581& _here)
{
    if (scp.modid == module.modid)
    {
...
const Struct_LDkB& lookupUserType_SqDq(const ValueType_JtNg& type, const Context_GwtN& ctx, const TokenIdx_5581& _here, const Module_nyjb& module)
{
    return lookupUserType_1qjp(parseStructCanon_p1TN(type.canon), module, ctx, _here);
}

bool is_trivial_1qjp(const ValueType_JtNg& type, const Context_GwtN& ctx, const TokenIdx_5581& _here, const Module_nyjb& module)
{
    return is_primitive_hxWW(type) || (isStruct_p1TN(type) ? !lookupUserType_SqDq(type, ctx, _here, module).shape.non_triv_mask : false);
}

bool is_reinterpretable_1qjp(const ValueType_JtNg& type, const Context_GwtN& ctx, const TokenIdx_5581& _here, const Module_nyjb& module)
{
...
const Struct_LDkB& tryLookupUserType_1qjp(const ValueType_JtNg& type, const Context_GwtN& ctx, const TokenIdx_5581& _here, const Module_nyjb& module)
{
    if (isStruct_p1TN(type) || (is_primitive_hxWW(type) ? (basePrimPrefixLen_hxWW(type.canon) < type.canon.size()) : false))
...
const Set_qOJY& lookupTypeImports_1qjp(const ValueType_JtNg& type, const Context_GwtN& ctx, const TokenIdx_5581& _here, const Module_nyjb& module)
{
    return tryLookupUserType_1qjp(type, ctx, _here, module).imports;
}

const fu::vec<Target_VZrr>& lookupTypeConverts_1qjp(const ValueType_JtNg& type, const Context_GwtN& ctx, const TokenIdx_5581& _here, const Module_nyjb& module)
{
...
int getFlatCount_1qjp(const ValueType_JtNg& type, const Context_GwtN& ctx, const TokenIdx_5581& _here, const Module_nyjb& module)
{
...
ValueType_JtNg parseType_1qjp(fu::view<char> str, const Context_GwtN& ctx, const TokenIdx_5581& _here, const Module_nyjb& module)
{
    int offset {};
...
Shape_fvCX getShape_1qjp(const ValueType_JtNg& type, const Context_GwtN& ctx, const TokenIdx_5581& _here, const Module_nyjb& module)
{
    const Struct_LDkB& s = tryLookupUserType_1qjp(type, ctx, _here, module);
    if (s)
...
bool is_zst_1qjp(const ValueType_JtNg& type, const Context_GwtN& ctx, const TokenIdx_5581& _here, const Module_nyjb& module)
{
    return !getFlatCount_1qjp(type, ctx, _here, module);
}

fu::vec_range<char> getShortModuleName_1qjp(fu::vec_range<char> fname, const Context_GwtN& ctx, const TokenIdx_5581& _here)
{
...
Type_OiTm tryClear_sliceable_1qjp(const ValueType_JtNg& type, const Context_GwtN& ctx, const TokenIdx_5581& _here, const Module_nyjb& module)
{
...
Type_OiTm clear_sliceable_1qjp(const ValueType_JtNg& type, const Context_GwtN& ctx, const TokenIdx_5581& _here, const Module_nyjb& module)
{
    if (is_sliceable_hxWW(type))
    {
        /*MOV*/ ValueType_JtNg vtype = parseType_1qjp(fu::get_view(type.canon, 1, (type.canon.size() - 1)), ctx, _here, module);
