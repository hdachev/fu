...
fu::str resolveFile_1qjp(fu::vec_range<char>, fu::view<char>, Context_Zsw9&);
...
Shape_fvCX getShape_1qjp(const ValueType_JtNg&, const Context_Zsw9&, const TokenIdx_5581&, const Module_cdtC&);
...
UserType_lctk& lookupUserType_mut_1qjp(fu::view<char> canon, Module_cdtC& module, const Context_Zsw9& ctx, const TokenIdx_5581& _here)
{
    const UserTypeCanon_rNcg scp = parseUserTypeCanon_27MV(canon);
...
static fu::str tryResolve_1qjp(fu::vec_range<char> from, fu::view<char> name, fu::vec_range<char> path, Context_Zsw9& ctx)
{
...
fu::str resolveFile_1qjp(fu::vec_range<char> from, fu::view<char> name, Context_Zsw9& ctx)
{
    ...
    else
    {
        ...
        return /*NRVO*/ resolve;
                                ...
                                #ifndef DEF_run_tyySNIFu1f9
                                #define DEF_run_tyySNIFu1f9
inline static fu::str run_tyyS(fu::vec_range<char> from, fu::view<char> name, fu::view<char> alt, fu::view<char> nested, Context_Zsw9& ctx)
{
    fu::str _0 {};
...
fu::str testSuite_resolvePrepopulatedFile_1qjp(fu::view<char> from, fu::view<char> name, const Context_Zsw9& ctx)
{
    ...
    else
    {
        return fu::str{};
                                ...
                                #ifndef DEF_run_6KBSTkPZ9K5
                                #define DEF_run_6KBSTkPZ9K5
inline static fu::str run_6KBS(fu::view<char> from, fu::view<char> name, fu::view<char> alt, fu::view<char> nested, const Context_Zsw9& ctx)
{
    fu::str _0 {};
...
fu::str resolveFile_SqDq(fu::vec_range<char> path, Context_Zsw9& ctx)
{
    ...
    if ((fuz_idx > 0) && (fuz_idx < (path.size() - 1)) && (find_rkz0(path, '\v', (fuz_idx + 1)) < 0))
    {
        ...
        fu::str _0 {};
        /*MOV*/ fu::str file = ((_0 = run_tyyS(from, name, alt, nested, ctx)) ? static_cast<fu::str&&>(_0) : run_6KBS(from, name, alt, nested, ctx));
        if (file)
            return /*NRVO*/ file;
...
fu::str getFile_1qjp(fu::vec_range<char> path, Context_Zsw9& ctx)
{
...
Module_cdtC& getModule_1qjp(fu::vec_range<char> fname, Context_Zsw9& ctx)
{
    ...
    ctx.modules.push(Module_cdtC { i_1, fu::str(fname), ModuleInputs_iQIg{}, ModuleOrder_HMNg{}, ModuleOutputs_GBmK{}, ModuleStats_ANTR{}, Profile_4UPJ{} });
...
void setModule_1qjp(const Module_cdtC& module, Context_Zsw9& ctx)
{
    Module_cdtC& current = ctx.modules.mutref(module.modid);
    if (current.fname == module.fname)
        current = clone_kM6O(module);
    else
...
bool updateFile_1qjp(fu::vec_range<char> fname, const NukeOnRebuild_TLE7& old, Context_Zsw9& ctx)
{
...
const UserType_lctk& lookupUserType_1qjp(const UserTypeCanon_rNcg& scp, const Module_cdtC& module, const Context_Zsw9& ctx, const TokenIdx_5581& _here)
{
    if (scp.modid == module.modid)
    {
        const UserType_lctk* _0;
...
const UserType_lctk& lookupUserType_SqDq(const ValueType_JtNg& type, const Context_Zsw9& ctx, const TokenIdx_5581& _here, const Module_cdtC& module)
{
    return lookupUserType_1qjp(parseUserTypeCanon_27MV(type.canon), module, ctx, _here);
}

bool is_trivial_1qjp(const ValueType_JtNg& type, const Context_Zsw9& ctx, const TokenIdx_5581& _here, const Module_cdtC& module)
{
    if (isUserType_27MV(type))
        return !lookupUserType_SqDq(type, ctx, _here, module).shape.non_triv_mask;
    else
        return !is_sliceable_hxWW(type);

}

bool is_reinterpretable_1qjp(const ValueType_JtNg& type, const Context_Zsw9& ctx, const TokenIdx_5581& _here, const Module_cdtC& module)
{
...
const UserType_lctk& tryLookupUserType_1qjp(const ValueType_JtNg& type, const Context_Zsw9& ctx, const TokenIdx_5581& _here, const Module_cdtC& module)
{
    if (isUserType_27MV(type) || (is_primitive_hxWW(type) ? (basePrimPrefixLen_hxWW(type.canon) < type.canon.size()) : false))
        return lookupUserType_SqDq(type, ctx, _here, module);
    else
        return (*(UserType_lctk*)fu::NIL);

}

const Set_qOJY& lookupTypeImports_1qjp(const ValueType_JtNg& type, const Context_Zsw9& ctx, const TokenIdx_5581& _here, const Module_cdtC& module)
{
    return tryLookupUserType_1qjp(type, ctx, _here, module).imports;
}

const fu::vec<Target_VZrr>& lookupTypeConverts_1qjp(const ValueType_JtNg& type, const Context_Zsw9& ctx, const TokenIdx_5581& _here, const Module_cdtC& module)
{
...
int getFlatCount_1qjp(const ValueType_JtNg& type, const Context_Zsw9& ctx, const TokenIdx_5581& _here, const Module_cdtC& module)
{
    const UserType_lctk& s = tryLookupUserType_1qjp(type, ctx, _here, module);
    if (s)
...
ValueType_JtNg parseType_1qjp(fu::view<char> str, const Context_Zsw9& ctx, const TokenIdx_5581& _here, const Module_cdtC& module)
{
    int offset {};
...
Shape_fvCX getShape_1qjp(const ValueType_JtNg& type, const Context_Zsw9& ctx, const TokenIdx_5581& _here, const Module_cdtC& module)
{
    const UserType_lctk& s = tryLookupUserType_1qjp(type, ctx, _here, module);
    if (s)
...
bool is_zst_1qjp(const ValueType_JtNg& type, const Context_Zsw9& ctx, const TokenIdx_5581& _here, const Module_cdtC& module)
{
    return !getFlatCount_1qjp(type, ctx, _here, module);
}

fu::vec_range<char> getShortModuleName_1qjp(fu::vec_range<char> fname, const Context_Zsw9& ctx, const TokenIdx_5581& _here)
{
...
Type_OiTm tryClear_sliceable_1qjp(const ValueType_JtNg& type, const Context_Zsw9& ctx, const TokenIdx_5581& _here, const Module_cdtC& module)
{
...
Type_OiTm clear_sliceable_1qjp(const ValueType_JtNg& type, const Context_Zsw9& ctx, const TokenIdx_5581& _here, const Module_cdtC& module)
{
    if (is_sliceable_hxWW(type))
    {
        /*MOV*/ ValueType_JtNg vtype = parseType_1qjp(fu::get_view(type.canon, 1, (type.canon.size() - 1)), ctx, _here, module);
