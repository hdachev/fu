...
ScopeItem_xiLD ScopeItem_z0Qq(fu::vec_range<char> id, const Target_VZrr& target, const bool shadows)
{
    return ScopeItem_xiLD { fu::str(id), ((target._packed & 0x3fffffffffffffffull) | (shadows ? 0x8000000000000000ull : 0ull)) };
                                ...
                                #ifndef DEF___1fhFbEmWImb
                                #define DEF___1fhFbEmWImb
inline static const fu::vec<ScopeItem_xiLD>& _1fhF(const Scope_2tPQ& _)
{
    return _.items;
}
                                #endif
...
static uint64_t ScopeItem_canSkipRest_clear_FjkY(ScopeItem_xiLD& si)
{
    return (si._packed &= ~0x4000000000000000ull);
                                ...
                                #ifndef DEF___YrgMxha3rUk
                                #define DEF___YrgMxha3rUk
inline static void _YrgM(/*MOV*/ ScopeItem_xiLD&& item, fu::vec_range_mut<ScopeItem_xiLD> pUblic, fu::vec_range_mut<ScopeItem_xiLD> pRivate, const Scope_2tPQ& scope, const int modid)
{
    Target_VZrr t;
    if (!((t = target_z0Qq(item), int(unsigned(((t._packed >> 40ull) & 0xfffffull)))) != modid))
    {
        ...
        ((overload.flags & Flags_Lzg8_F_PUB) ? pUblic : pRivate) += static_cast<ScopeItem_xiLD&&>(item);
                                ...
                                #ifndef DEF_each_v3l2D18FBIg
                                #define DEF_each_v3l2D18FBIg
inline void each_v3l2(fu::vec_range<ScopeItem_xiLD> a, fu::vec_range_mut<ScopeItem_xiLD> pUblic, fu::vec_range_mut<ScopeItem_xiLD> pRivate, const Scope_2tPQ& scope, const int modid)
{
    for (int i = 0; i < a.size(); i++)
        _YrgM(ScopeItem_xiLD(a[i]), pUblic, pRivate, scope, modid);

}
                                #endif

                                #ifndef DEF_collect_uG2d6G8LVAi
                                #define DEF_collect_uG2d6G8LVAi
inline static fu::vec<ScopeItem_xiLD> collect_uG2d(int& pub_cnt, /*MOV*/ fu::vec<ScopeItem_xiLD>&& pUblic, fu::vec<ScopeItem_xiLD>&& pRivate, const Scope_2tPQ& scope, const int modid)
{
    each_v3l2(_1fhF(scope), pUblic, pRivate, scope, modid);
    pub_cnt = pUblic.size();
    pUblic += pRivate;
    return pUblic.destructive_move();
                                ...
                                #ifndef DEF___8J6AkaBZX88
                                #define DEF___8J6AkaBZX88
inline static const fu::vec<ScopeItem_xiLD>& _8J6A(const Scope_2tPQ& _)
{
    return _.implicits;
}
                                #endif

                                #ifndef DEF_collect_TOJPugXpmZj
                                #define DEF_collect_TOJPugXpmZj
inline static fu::vec<ScopeItem_xiLD> collect_TOJP(int& pub_cnt, /*MOV*/ fu::vec<ScopeItem_xiLD>&& pUblic, fu::vec<ScopeItem_xiLD>&& pRivate, const Scope_2tPQ& scope, const int modid)
{
    each_v3l2(_8J6A(scope), pUblic, pRivate, scope, modid);
    pub_cnt = pUblic.size();
    pUblic += pRivate;
    return pUblic.destructive_move();
}
                                ...
                                #ifndef DEF___D4Jy1DMLKvc
                                #define DEF___D4Jy1DMLKvc
inline static const fu::vec<ScopeItem_xiLD>& _D4Jy(const Scope_2tPQ& _)
{
    return _.globals;
}
                                #endif

                                #ifndef DEF_collect_oJAUi4hAo2h
                                #define DEF_collect_oJAUi4hAo2h
inline static fu::vec<ScopeItem_xiLD> collect_oJAU(int& pub_cnt, /*MOV*/ fu::vec<ScopeItem_xiLD>&& pUblic, fu::vec<ScopeItem_xiLD>&& pRivate, const Scope_2tPQ& scope, const int modid)
{
    each_v3l2(_D4Jy(scope), pUblic, pRivate, scope, modid);
    pub_cnt = pUblic.size();
    pUblic += pRivate;
    return pUblic.destructive_move();
}
...
Scope_2tPQ Scope_exports_z0Qq(const Scope_2tPQ& scope, const int modid, fu::vec_range<int> pub_imports)
{
    int pub_items = 0;
    int pub_implicits = 0;
    int pub_globals = 0;
    /*MOV*/ fu::vec<ScopeItem_xiLD> items = collect_uG2d(pub_items, fu::vec<ScopeItem_xiLD>{}, fu::vec<ScopeItem_xiLD>{}, scope, modid);
    /*MOV*/ fu::vec<ScopeItem_xiLD> implicits = collect_TOJP(pub_implicits, fu::vec<ScopeItem_xiLD>{}, fu::vec<ScopeItem_xiLD>{}, scope, modid);
    /*MOV*/ fu::vec<ScopeItem_xiLD> globals = collect_oJAU(pub_globals, fu::vec<ScopeItem_xiLD>{}, fu::vec<ScopeItem_xiLD>{}, scope, modid);
...
Target_VZrr search_z0Qq(fu::view_mut<ScopeItem_xiLD> items, fu::view<char> id, int& scope_iterator, fu::view<ScopeSkip_iozY> scope_skip, bool& shadows, fu::view<Target_VZrr> extra_items, fu::view<ScopeItem_xiLD> field_items, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
    if ((scope_iterator >= 0))
    {
        shadows = false;
...
Target_VZrr search_KHWe(fu::view<ScopeItem_xiLD> items, fu::view<char> id, int& scope_iterator, fu::view<ScopeItem_xiLD> field_items)
{
    ...
    return Target_VZrr{};
                                ...
                                #ifndef DEF_ensure_EZ2dIQuNJh0
                                #define DEF_ensure_EZ2dIQuNJh0
inline Extended_wKyO& ensure_EZ2d(fu::vec_range_mut<Extended_wKyO> a, const int i)
{
    if ((a.size() <= i))
        a.grow((i + 1));
...
Target_VZrr Scope_create_z0Qq(Scope_2tPQ& scope, const Kind_Idfg kind, fu::vec_range<char> name, const Type_OiTm& type, const Flags_Lzg8 flags, const DeclAsserts_taUG asserts, const SolverStatus_h9em status, const int nest, const bool asArgument, const Module_BOS4& module)
{
    int position {};
    Extended_wKyO* ext;
    const Extended_wKyO* ext_1;
    fu::vec<Overload_aO3i>& overloads = (nest ? (ext = &(ensure_EZ2d(scope.extended, nest)), (position = (ext_1 = &((*ext)), (asArgument ? (-1 - (*ext_1).args_neg) : ((*ext_1).args_n_locals.size() + (1 - (*ext_1).args_neg))))), ((*ext).args_neg += (asArgument ? 1 : 0)), (*ext).args_n_locals) : ((position = (scope.overloads.size() + 1)), scope.overloads));
...
void Scope_set_z0Qq(Scope_2tPQ& scope, fu::vec_range<char> id, const Target_VZrr& target, const bool shadows)
{
