...
static void inspect_zVz2(const SolvedNode_efhg&, fu::view<char>, const Module_nyjb&, fu::str&, int);
...
static void inspect_zVz2(const SolvedNode_efhg& n, fu::view<char> indent, const Module_nyjb& module, fu::str& src, const int modid)
{
    src += (indent + "("_view);
    if (n)
    {
        if (n.kind == Kind_Idfg_call)
            src += qID_e44U(str_PbEq(n.kind));
        else if ((n.kind == Kind_Idfg_block) || (n.kind == Kind_Idfg_jump) || (n.kind == Kind_Idfg_defer))
            src += qLT_e44U(str_PbEq(n.kind));
        else if ((n.kind == Kind_Idfg_if) || (n.kind == Kind_Idfg_and) || (n.kind == Kind_Idfg_or) || (n.kind == Kind_Idfg_loop))
            src += qKW_e44U(str_PbEq(n.kind));
        else if (n.kind == Kind_Idfg_empty)
            src += qBAD_e44U(str_PbEq(n.kind));
        else
            x7Ex3D_w1za(src, str_PbEq(n.kind));
...
fu::str inspect_WenQ(const Module_nyjb& module, const SolvedNode_efhg& root)
{
...
fu::str inspect_wkVO(const Module_nyjb& module)
{
