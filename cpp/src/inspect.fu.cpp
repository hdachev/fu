...
static void inspect_zVz2(const SolvedNode_efhg&, fu::view<char>, const Module_wo7O&, fu::str&, int);
...
static void inspect_zVz2(const SolvedNode_efhg& n, fu::view<char> indent, const Module_wo7O& module, fu::str& src, const int modid)
{
    src += (indent + "("_view);
    if (n)
    {
...
fu::str inspect_WenQ(const Module_wo7O& module, const SolvedNode_efhg& root)
{
...
fu::str inspect_wkVO(const Module_wo7O& module)
{
