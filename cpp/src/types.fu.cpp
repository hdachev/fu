...
Lifetime_llCF Lifetime_op_field_7Yz9(const Lifetime_llCF&, int, int, const Context_Dujv&, const TokenIdx_5581&);
...
fu::vec_range<char> canon_trySuper_Ot6w(fu::vec_range<char>, fu::vec_range<char>, const Context_Dujv&, const TokenIdx_5581&);
...
fu::vec_range<char> canon_tryIntersect_Ot6w(fu::vec_range<char>, fu::vec_range<char>, const Context_Dujv&, const TokenIdx_5581&);
...
extern const Type_OiTm t_never_AssumingInfiniteRecursion fu_INIT_PRIORITY(1009) = VFactsAdd_9CJm(Type_OiTm(t_never), VFacts_xhRf_AssumingInfiniteRecursion);
...
Type_OiTm createArray_9CJm(const Type_OiTm& item)
{
    ...
    const unsigned quals = ((((item.vtype.quals & q_rx_copy) | q_rx_resize) | q_non_compund) | (is_void_9CJm(item.vtype) ? q_rx_copy : 0u));
...
extern const Type_OiTm t_string_literal fu_INIT_PRIORITY(1009) = set_lifetime_9CJm(Type_OiTm(t_string), Lifetime_static_immoveable);
                                #ifndef DEF_str_DKpSo7imWt0
                                #define DEF_str_DKpSo7imWt0
inline fu::str str_DKpS(const VFacts_xhRf n)
{
    /*MOV*/ fu::str res {};

    {
        ...
        if (n & VFacts_xhRf_AssumingInfiniteRecursion)
            res += ("AssumingInfiniteRecursion"_view + ", "_view);
...
bool propositionOK_9CJm(const Type_OiTm& type, const bool vfactsOK, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
    if (!vfactsOK && type.vtype.vfacts)
        BUG_u9Gb(x7E_rA00("propositionOK seeing vfacts: "_view, str_DKpS(type.vtype.vfacts)), ctx, _here);
...
bool is_void_or_propositionOK_9CJm(const Type_OiTm& type, const bool vfactsOK, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
    return propositionOK_9CJm(type, vfactsOK, ctx, _here) || is_void_9CJm(type.vtype);
}

VFacts_xhRf isAssumingInfiniteRecursion_9CJm(const ValueType_JtNg& t)
{
    return t.vfacts & VFacts_xhRf_AssumingInfiniteRecursion;
}
...
bool areVFactsAssignable_9CJm(const VFacts_xhRf host, const VFacts_xhRf guest, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{

    {
        ...
        if (!(VFacts_xhRf((h & g)) == h))
            BUG_u9Gb(x7E_rA00((x7E_rA00("areVFactsAssignable: vfacts mismatch: "_view, str_DKpS(host)) + " != "_view), str_DKpS(guest)), ctx, _here);
...
bool isAssignableAsArgument_9CJm(const ValueType_JtNg& host, const ValueType_JtNg& guest, const bool DONT_match_zeroes, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
    if (host && guest)
...
bool isAssignable_9CJm(const Type_OiTm& host, const Type_OiTm& guest, const bool DONT_match_zeroes, const bool asArgument, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
...
bool is_mutref_9CJm(const Type_OiTm& type, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
...
Type_OiTm add_ref_9CJm(/*MOV*/ Type_OiTm&& type, const Lifetime_llCF& lifetime, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
...
Type_OiTm add_mutref_9CJm(/*MOV*/ Type_OiTm&& type, const Lifetime_llCF& lifetime, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
...
Type_OiTm definitType_9CJm(/*MOV*/ Type_OiTm&& type, const bool asTypename, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
...
Type_OiTm tryClearRefs_9CJm(const Type_OiTm& type, const bool mutref, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
...
Type_OiTm tryClear_mutref_9CJm(const Type_OiTm& type, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
    return tryClearRefs_9CJm(type, true, ctx, _here);
}

Type_OiTm tryClear_ref_9CJm(const Type_OiTm& type, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
    return tryClearRefs_9CJm(type, false, ctx, _here);
}

Type_OiTm make_field_reference_9CJm(const unsigned quals, const Lifetime_llCF& lifetime, /*MOV*/ Type_OiTm&& to, const int memberFlatOffset, const int memberFlatCount, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
...
fu::str explainVFacts_9CJm(const VFacts_xhRf vfacts)
{
    ...
    if (vfacts & VFacts_xhRf_AssumingInfiniteRecursion)
        result += (qVFACTS_e44U("assuming-infinite-recursion"_view) + ' ');

    return /*NRVO*/ result;
}

Type_OiTm createSlice_9CJm(const Type_OiTm& item, const Lifetime_llCF& lifetime, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
...
Type_OiTm tryClear_array_9CJm(const Type_OiTm& type, const Context_Dujv& ctx, const TokenIdx_5581& _here, const Module_BOS4& module)
{
...
Type_OiTm type_trySuper_9CJm(const Type_OiTm& a, const Type_OiTm& b, const bool DONT_match_zeroes, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
...
Type_OiTm type_tryIntersect_9CJm(const Type_OiTm& a, const Type_OiTm& b, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
...
unsigned mask_retval_relaxable_9CJm(const Type_OiTm& type, const unsigned relaxed_quals, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
