...
void Paths_inter_7Yz9(fu::vec_range_mut<char>, fu::view<char>, fu::view<char>, const Context_Dujv&, const TokenIdx_5581&);
...
extern const fu::static_ref<Lifetime_llCF> Lifetime_worst fu_INIT_PRIORITY(1007) = Lifetime_temporary;
                                #ifndef DEF_onPathStart_sT443bGtrm8
                                #define DEF_onPathStart_sT443bGtrm8
inline static void onPathStart_sT44(int& pathDepth, int& numPaths, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
    pathDepth = 0;
    numPaths++;
    if (numPaths > 64)
...
inline fu::str x7E_rA00(fu::view<char> a, fu::view<char> b)
{
    return a + b;
                                ...
                                #ifndef DEF_onSubRegion_faWna9VeB6a
                                #define DEF_onSubRegion_faWna9VeB6a
inline static void onSubRegion_faWn(const int flatOffset, const int flatCount, const bool isLastSubRegion, const bool isFirstSubRegion, int& expect_flatCount, const int region_flatCount, const bool flatCountMismatchOK, int& pathDepth, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
    pathDepth++;
    if (pathDepth > 64)
            ...
            else
            {
                if (!(expect_flatCount == flatCount))
                    BUG_u9Gb((x7E_rA00(((x7E_rA00("assertPathsValid: expect_flatCount("_view, fu::i64dec(expect_flatCount)) + ")"_view) + " != flatCount("_view), fu::i64dec(flatCount)) + ")"_view), ctx, _here);
                                ...
                                #ifndef DEF_onPathDone_Rl3bSMoind5
                                #define DEF_onPathDone_Rl3bSMoind5
inline static void onPathDone_Rl3b(const int minPathDepth, const int pathDepth, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
...
void assertPathsValid_7Yz9(fu::view<char> str, int expect_flatCount, const int region_flatCount, const bool flatCountMismatchOK, const int minPathDepth, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
    int pathDepth = -1001;
    int numPaths = 0;
    int offset = 0;
    for (; ; )
    {
        ...
        onPathStart_sT44(pathDepth, numPaths, ctx, _here);
        for (; ; )
        {
            ...
            onSubRegion_faWn(flatOffset, flatCount, isLastSubRegion, isFirstSubRegion, expect_flatCount, region_flatCount, flatCountMismatchOK, pathDepth, ctx, _here);
            if (isLastSubRegion)
                break;
            else
        ...
        onPathDone_Rl3b(minPathDepth, pathDepth, ctx, _here);
        if (isLastPath)
            break;
...
inline unsigned uNsigned_lZb6(const unsigned v)
{
    return v;
                                ...
                                #ifndef DEF_onSubRegion_2lMmGfZWWyb
                                #define DEF_onSubRegion_2lMmGfZWWyb
inline static void onSubRegion_2lMm(const bool isFirstSubRegion, const bool isLastSubRegion, const int flatCount, const int flatOffset, const unsigned usage, unsigned& result, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
    if (!(!isFirstSubRegion))
    {
        if (!isLastSubRegion)
...
unsigned Lifetime_shiftUsage_7Yz9(fu::view<char> paths, const unsigned usage, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
    unsigned result {};
    int offset = 0;

    {
        for (; ; )
        {
            ...
            for (; ; )
            {
                ...
                const int flatCount = int((raw_flatCount >> 1u));
                const int flatOffset = int((raw_flatOffset >> 1u));
                onSubRegion_2lMm(isFirstSubRegion, isLastSubRegion, flatCount, flatOffset, usage, result, ctx, _here);
                if (isLastSubRegion)
                    break;
                else
                    isFirstSubRegion = false;
...
Lifetime_llCF Lifetime_from_7Yz9(const int locid, const int flatCount, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
    if (locid != 0)
    {
        /*MOV*/ fu::str uni0n {};
...
Lifetime_llCF Lifetime_from_UkiI(const int argidx, fu::view<char> paths, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
    if ((argidx >= 0))
    {
        /*MOV*/ fu::str uni0n {};
...
Lifetime_llCF Lifetime_AAR_7Yz9(const int locid, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
    if (locid < 0)
    {
        /*MOV*/ fu::str uni0n {};
...
fu::vec<fu::vec<SubRegion_jsU3>> parsePaths_7Yz9(fu::view<char> str, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
...
bool Paths_union_7Yz9(fu::vec_range_mut<fu::vec<SubRegion_jsU3>> result, fu::vec_range<SubRegion_jsU3> path, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
    ...
    return true;
                                ...
                                #ifndef DEF___lYoiGGA4kN2
                                #define DEF___lYoiGGA4kN2
inline static bool _lYoi(fu::vec_range<SubRegion_jsU3> b_path, fu::vec<fu::vec<SubRegion_jsU3>>& result, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
    return Paths_union_7Yz9(result, b_path, ctx, _here);
}
                                #endif

                                #ifndef DEF_onPathDone_j8V2xGRnVY1
                                #define DEF_onPathDone_j8V2xGRnVY1
inline static void onPathDone_j8V2(const fu::vec<SubRegion_jsU3>& path, fu::vec<fu::vec<SubRegion_jsU3>>& result, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
    _lYoi(path, result, ctx, _here);
}
                                #endif

                                #ifndef DEF_parsePaths_each_RMN24ktujgg
                                #define DEF_parsePaths_each_RMN24ktujgg
inline static void parsePaths_each_RMN2(fu::view<char> str, fu::vec<fu::vec<SubRegion_jsU3>>& result, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
    fu::vec<SubRegion_jsU3> path {};
    int _o = 0;
    for (; ; )
    {
        ...
        onPathDone_j8V2(path, result, ctx, _here);
        if (isLastPath)
            break;
...
void appendPaths_7Yz9(fu::vec_range_mut<char> str, fu::view<fu::vec<SubRegion_jsU3>> paths, const bool emptyOK, const bool flatCountMismatchOK, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
...
void Paths_union_UkiI(fu::vec_range_mut<char> str, fu::view<char> a, fu::view<char> b, const bool flatCountMismatchOK, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
    fu::vec<fu::vec<SubRegion_jsU3>> result = parsePaths_7Yz9(a, ctx, _here);
    parsePaths_each_RMN2(b, result, ctx, _here);
    appendPaths_7Yz9(str, result, false, flatCountMismatchOK, ctx, _here);
}

                                #ifndef DEF_both_1qNTLeXCYB8
                                #define DEF_both_1qNTLeXCYB8
inline static void both_1qNT(fu::view<char> r_both, fu::view<char> sr_left, fu::view<char> sr_right, const bool flatCountMismatchOK, Lifetime_llCF& result, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
    result.uni0n += r_both;
...
Lifetime_llCF Lifetime_union_7Yz9(const Lifetime_llCF& a, const Lifetime_llCF& b, const bool flatCountMismatchOK, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
        ...
        { {
            for (; ; )
            {
                ...
                fu::view<char> either_chars = ((cmp == 0) ? (__extension__ (
                {
                    l_dirty = true;
                    r_dirty = true;
                    both_1qNT(fu::get_view(l_chars, l_start, l_paths0), fu::get_view(l_chars, l_paths0, l_offset), fu::get_view(r_chars, r_paths0, r_offset), flatCountMismatchOK, result, ctx, _here);
                    continue;
                    (void)0;
...
inline int max_BjFA(const int a, const int b)
{
    if ((a >= b))
        ...
        return b;
                                ...
                                #ifndef DEF___EZBTzt2T9Wj
                                #define DEF___EZBTzt2T9Wj
inline static void _EZBT(fu::view<SubRegion_jsU3> b_path, fu::view<SubRegion_jsU3> a_path, fu::vec<fu::vec<SubRegion_jsU3>>& result, fu::vec<SubRegion_jsU3>& inter, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
    ...
    if (inter)
    {
        ...
        BUG_u9Gb("Paths_inter: empty inter, about to append suffix"_view, ctx, _here);
                                ...
                                #ifndef DEF_onPathDone_SLmbFQ3Mtud
                                #define DEF_onPathDone_SLmbFQ3Mtud
inline static void onPathDone_SLmb(fu::view<SubRegion_jsU3> path, fu::view<SubRegion_jsU3> a_path, fu::vec<fu::vec<SubRegion_jsU3>>& result, fu::vec<SubRegion_jsU3>& inter, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
    _EZBT(path, a_path, result, inter, ctx, _here);
}
                                #endif

                                #ifndef DEF_parsePaths_each_zH6ZkjfW899
                                #define DEF_parsePaths_each_zH6ZkjfW899
inline static void parsePaths_each_zH6Z(fu::view<char> str, fu::view<SubRegion_jsU3> a_path, fu::vec<fu::vec<SubRegion_jsU3>>& result, fu::vec<SubRegion_jsU3>& inter, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
    fu::vec<SubRegion_jsU3> path {};
    int _o = 0;
    for (; ; )
    {
        ...
        onPathDone_SLmb(path, a_path, result, inter, ctx, _here);
        if (isLastPath)
            break;
    ...
    if (!(_o == str.size()))
        BUG_u9Gb("walkPaths(!tailOK): excess bytes"_view, ctx, _here);
                                ...
                                #ifndef DEF___PYvKrqc66Db
                                #define DEF___PYvKrqc66Db
inline static void _PYvK(fu::view<SubRegion_jsU3> a_path, fu::view<char> b, fu::vec<fu::vec<SubRegion_jsU3>>& result, fu::vec<SubRegion_jsU3>& inter, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
    parsePaths_each_zH6Z(b, a_path, result, inter, ctx, _here);
}
                                #endif

                                #ifndef DEF_onPathDone_eOBxoEYjc25
                                #define DEF_onPathDone_eOBxoEYjc25
inline static void onPathDone_eOBx(fu::view<SubRegion_jsU3> path, fu::view<char> b, fu::vec<fu::vec<SubRegion_jsU3>>& result, fu::vec<SubRegion_jsU3>& inter, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
    _PYvK(path, b, result, inter, ctx, _here);
}
                                #endif

                                #ifndef DEF_parsePaths_each_C2jPz6MCRxc
                                #define DEF_parsePaths_each_C2jPz6MCRxc
inline static void parsePaths_each_C2jP(fu::view<char> str, fu::view<char> b, fu::vec<fu::vec<SubRegion_jsU3>>& result, fu::vec<SubRegion_jsU3>& inter, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
    fu::vec<SubRegion_jsU3> path {};
    int _o = 0;
    for (; ; )
    {
        ...
        onPathDone_eOBx(path, b, result, inter, ctx, _here);
        if (isLastPath)
            break;
...
void Paths_inter_7Yz9(fu::vec_range_mut<char> str, fu::view<char> a, fu::view<char> b, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
    if (a.size() < b.size())
    ...
    else
    {
        ...
        parsePaths_each_C2jP(a, b, result, inter, ctx, _here);
        appendPaths_7Yz9(str, result, true, true, ctx, _here);
    };
}

                                #ifndef DEF_both_sSspTm0aUJe
                                #define DEF_both_sSspTm0aUJe
inline static void both_sSsp(fu::view<char> r_both, fu::view<char> sr_left, fu::view<char> sr_right, Lifetime_llCF& result, fu::str& inter, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
    fu::view<char> BL_1_v {};
...
Lifetime_llCF Lifetime_inter_7Yz9(const Lifetime_llCF& a, const Lifetime_llCF& b, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
    /*MOV*/ Lifetime_llCF result {};
    fu::str inter {};
    ...
    { {
        ...
        for (; ; )
        {
            ...
            if (cmp == 0)
            {
                l_dirty = true;
                r_dirty = true;
                both_sSsp(fu::get_view(l_chars, l_start, l_paths0), fu::get_view(l_chars, l_paths0, l_offset), fu::get_view(r_chars, r_paths0, r_offset), result, inter, ctx, _here);
            }
            else if (cmp < 0)
                l_dirty = true;
            else
...
inline static bool Paths_hasInter_rjKF(fu::view<char> a, fu::view<char> b, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
    ...
    return false;
                                ...
                                #ifndef DEF_both_8yiM2meRpGd
                                #define DEF_both_8yiM2meRpGd
inline static void both_8yiM(const int locid, fu::view<char> sr_left, fu::view<char> sr_right, fu::vec<int>& result, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
    if (!(!locid))
    {
        if ((sr_left == sr_right) || (sr_left == SR_empty.ref) || (sr_right == SR_empty.ref) || Paths_hasInter_rjKF(sr_left, sr_right, ctx, _here))
            result += int(locid);
...
fu::vec<int> Lifetime_interLocids_7Yz9(const Lifetime_llCF& a, const Lifetime_llCF& b, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
    ...
    { {
        ...
        for (; ; )
        {
            ...
            if (cmp == 0)
            {
                ...
                unsigned r_7;
                unsigned v;
                both_8yiM((r_7 = r, ((r_7 & 1u) ? 0 : (v = (r_7 >> 1u), int(((v >> 1u) ^ ((v & 1u) ? 0xffffffffu : 0x0u)))))), fu::get_view(l_chars, l_paths0, l_offset), fu::get_view(r_chars, r_paths0, r_offset), result, ctx, _here);
            }
            else if (cmp < 0)
                l_dirty = true;
            else
...
void Lifetime_add_7Yz9(Lifetime_llCF& l, const Lifetime_llCF& r, const bool flatCountMismatchOK, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
    if (r)
    {
...
bool Lifetime_has_UkiI(const Lifetime_llCF& lifetime, const int search)
{
    return Lifetime_some_FUT6(lifetime, search);
                                ...
                                #ifndef DEF_onLastSubRegion_Dn7Hi0VepB7
                                #define DEF_onLastSubRegion_Dn7Hi0VepB7
inline static void onLastSubRegion_Dn7H(const bool isLastPath, fu::view<char> raw_prefix, const int parent_flatCount, const int parent_flatOffset, fu::vec_range_mut<char> result, const int deref_flatCount, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
    ...
    else
    {
        BUG_u9Gb((x7E_rA00("Lifetime_op_deref: parent_flatCount("_view, fu::i64dec(parent_flatCount)) + ") != 1"_view), ctx, _here);
                                ...
                                #ifndef DEF___25fVkxysQGl
                                #define DEF___25fVkxysQGl
inline static void _25fV(fu::view<char> paths, fu::vec_range_mut<char> result, const int deref_flatCount, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
    int offset = 0;
    for (; ; )
    {
        ...
        for (; ; )
        {
            ...
            if (isLastSubRegion)
            {
                onLastSubRegion_Dn7H(isLastPath, fu::get_view(paths, path0, subregion0), flatCount, flatOffset, result, deref_flatCount, ctx, _here);
                break;
            }
            else
                isFirstSubRegion = false;
    ...
    if (!(offset == paths.size()))
        BUG_u9Gb("walkPaths(!tailOK): excess bytes"_view, ctx, _here);
                                ...
                                #ifndef DEF___2UAHhIvsdEa
                                #define DEF___2UAHhIvsdEa
inline static void _2UAH(fu::view<char> r_raw, fu::view<char> paths, const int locid, const int minPathDepth, fu::str& result, const int deref_flatCount, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
    result += r_raw;
    ...
    else if (locid)
    {
        ...
        _25fV(paths, result, deref_flatCount, ctx, _here);
    ...
    else
    {
        BUG_u9Gb("Lifetime_op: non-locid non-x00x00 subregion."_view, ctx, _here);
                                ...
                                #ifndef DEF_Lifetime_each_mzFHAQT24I4
                                #define DEF_Lifetime_each_mzFHAQT24I4
inline void Lifetime_each_mzFH(const Lifetime_llCF& lifetime, const int minPathDepth, fu::str& result, const int deref_flatCount, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
    fu::view<char> chars = lifetime.uni0n;
    int offset = 0;
    while (offset < chars.size())
    {
        ...
        unsigned v;
        _2UAH(fu::get_view(chars, offset0, sr), fu::get_view(chars, sr, offset), ((r & 1u) ? 0 : (v = (r >> 1u), int(((v >> 1u) ^ ((v & 1u) ? 0xffffffffu : 0x0u))))), minPathDepth, result, deref_flatCount, ctx, _here);
    };
}
                                #endif

Lifetime_llCF Lifetime_op_deref_7Yz9(const Lifetime_llCF& lt, const int deref_flatCount, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
    const int minPathDepth = 2;
    /*MOV*/ fu::str result {};
    Lifetime_each_mzFH(lt, minPathDepth, result, deref_flatCount, ctx, _here);
    return Lifetime_llCF { static_cast<fu::str&&>(result) };
}

Lifetime_llCF Lifetime_makeShared_7Yz9(const Lifetime_llCF& lifetime, const int flatCount, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
    return Lifetime_union_7Yz9(Lifetime_op_deref_7Yz9(lifetime, flatCount, ctx, _here), Lifetime_static_immoveable, false, ctx, _here);
                                ...
                                #ifndef DEF_onLastSubRegion_D1Ztx09U8F7
                                #define DEF_onLastSubRegion_D1Ztx09U8F7
inline static void onLastSubRegion_D1Zt(const bool isLastSubRegion, const bool isLastPath, fu::view<char> raw_prefix, const int struct_flatCount, const int struct_flatOffset, fu::vec_range_mut<char> result, const int flatCount, const int flatOffset, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
    ...
    else
    {
        BUG_u9Gb((x7E_rA00(((x7E_rA00(((x7E_rA00("Lifetime_op_field: field.flatOffset("_view, fu::i64dec(flatOffset)) + ")"_view) + " + field.flatCount("_view), fu::i64dec(flatCount)) + ")"_view) + " !<= struct.flatCount("_view), fu::i64dec(struct_flatCount)) + ")"_view), ctx, _here);
                                ...
                                #ifndef DEF___8hXOqTLLOG4
                                #define DEF___8hXOqTLLOG4
inline static void _8hXO(fu::view<char> paths, fu::vec_range_mut<char> result, const int flatCount, const int flatOffset, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
    int offset = 0;
    for (; ; )
    {
        ...
        for (; ; )
        {
            ...
            if (isLastSubRegion)
            {
                onLastSubRegion_D1Zt(isLastSubRegion, isLastPath, fu::get_view(paths, path0, subregion0), flatCount_1, flatOffset_1, result, flatCount, flatOffset, ctx, _here);
                break;
            }
            else
                isFirstSubRegion = false;
    ...
    if (!(offset == paths.size()))
        BUG_u9Gb("walkPaths(!tailOK): excess bytes"_view, ctx, _here);
                                ...
                                #ifndef DEF___GWeszLmY2qh
                                #define DEF___GWeszLmY2qh
inline static void _GWes(fu::view<char> r_raw, fu::view<char> paths, const int locid, const int minPathDepth, fu::str& result, const int flatCount, const int flatOffset, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
    result += r_raw;
    if (paths == SR_empty.ref)
        result += paths;
    ...
    {
        const int result0 = result.size();
        _8hXO(paths, result, flatCount, flatOffset, ctx, _here);
        assertPathsValid_7Yz9(fu::get_view(result, result0), -1, -1, false, minPathDepth, ctx, _here);
    }
    else
    {
        BUG_u9Gb("Lifetime_op: non-locid non-x00x00 subregion."_view, ctx, _here);
                                ...
                                #ifndef DEF_Lifetime_each_8XbaLDlumVi
                                #define DEF_Lifetime_each_8XbaLDlumVi
inline void Lifetime_each_8Xba(const Lifetime_llCF& lifetime, const int minPathDepth, fu::str& result, const int flatCount, const int flatOffset, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
    fu::view<char> chars = lifetime.uni0n;
    int offset = 0;
    while (offset < chars.size())
    {
        ...
        unsigned v;
        _GWes(fu::get_view(chars, offset0, sr), fu::get_view(chars, sr, offset), ((r & 1u) ? 0 : (v = (r >> 1u), int(((v >> 1u) ^ ((v & 1u) ? 0xffffffffu : 0x0u))))), minPathDepth, result, flatCount, flatOffset, ctx, _here);
    };
}
                                #endif

Lifetime_llCF Lifetime_op_field_7Yz9(const Lifetime_llCF& lt, const int flatCount, const int flatOffset, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
    const int minPathDepth = 1;
    /*MOV*/ fu::str result {};
    Lifetime_each_8Xba(lt, minPathDepth, result, flatCount, flatOffset, ctx, _here);
    return Lifetime_llCF { static_cast<fu::str&&>(result) };
}

extern const unsigned q_USAGE;
Lifetime_llCF Lifetime_op_mask_7Yz9(const Lifetime_llCF& lt, const unsigned quals, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
    ...
    else
    {
        BUG_u9Gb((x7E_rA00((x7E_rA00((x7E_rA00((x7E_rA00((x7E_rA00("Lifetime_op_mask: flatCount("_view, fu::i64dec(flatCount)) + ") flatOffset("_view), fu::i64dec(flatOffset)) + ") clz("_view), fu::i64dec(clz)) + ") ctz("_view), fu::i64dec(ctz)) + ") usage("_view), fu::u64dec(usage)) + ")"_view), ctx, _here);
                                ...
                                #ifndef DEF_onSubRegion_QpDW2GODInb
                                #define DEF_onSubRegion_QpDW2GODInb
inline static void onSubRegion_QpDW(const bool child_isFirstSubRegion, const bool child_isLastSubRegion, const bool child_isLastPath, const int child_flatCount, const int child_flatOffset, const bool parent_isLastPath, const int parent_flatCount, const int parent_flatOffset, fu::view<char> parent_rawPrefix, fu::vec_range_mut<char> result, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
    ...
    if ((result_flatOffset >= 0) && (child_flatCount > 0) && (child_isLastSubRegion || (child_flatCount == 1)))
    {
        ...
        BUG_u9Gb((x7E_rA00(((x7E_rA00(((x7E_rA00("appendSubRegion: flatCount("_view, fu::i64dec(child_flatCount)) + ")"_view) + " flatOffset("_view), fu::i64dec(result_flatOffset)) + ")"_view) + " isLastSubRegion("_view), fu::booldec(child_isLastSubRegion)) + ")"_view), ctx, _here);
                                ...
                                #ifndef DEF_onLastSubRegion_UOU7e1fSkv2
                                #define DEF_onLastSubRegion_UOU7e1fSkv2
inline static void onLastSubRegion_UOU7(const bool parent_isLastPath, const int parent_flatCount, const int parent_flatOffset, fu::view<char> parent_rawPrefix, fu::vec_range_mut<char> result, fu::view<char> child, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
    int _c0 = 0;
    for (; ; )
    {
        ...
        for (; ; )
        {
            ...
            const int flatCount = int((raw_flatCount >> 1u));
            const int flatOffset = int((raw_flatOffset >> 1u));
            onSubRegion_QpDW(isFirstSubRegion, isLastSubRegion, isLastPath, flatCount, flatOffset, parent_isLastPath, parent_flatCount, parent_flatOffset, parent_rawPrefix, result, ctx, _here);
            if (isLastSubRegion)
                break;
            else
                isFirstSubRegion = false;
    ...
    if (!(_c0 == child.size()))
        BUG_u9Gb("walkPaths(!tailOK): excess bytes"_view, ctx, _here);
                                ...
                                #ifndef DEF___krLH7OvvKk7
                                #define DEF___krLH7OvvKk7
inline static void _krLH(fu::view<char> parent, fu::vec_range_mut<char> result, fu::view<char> child, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
    int _p0 = 0;
    for (; ; )
    {
        ...
        for (; ; )
        {
            ...
            if (isLastSubRegion)
            {
                onLastSubRegion_UOU7(isLastPath, flatCount, flatOffset, fu::get_view(parent, path0, subregion0), result, child, ctx, _here);
                break;
            }
            else
                isFirstSubRegion = false;
    ...
    if (!(_p0 == parent.size()))
        BUG_u9Gb("walkPaths(!tailOK): excess bytes"_view, ctx, _here);
                                ...
                                #ifndef DEF___kEXlEDX3aw7
                                #define DEF___kEXlEDX3aw7
inline static void _kEXl(fu::view<char> r_raw, fu::view<char> paths, const int locid, const int minPathDepth, fu::str& result, fu::view<char> child, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
    result += r_raw;
    if (paths == SR_empty.ref)
        result += paths;
    ...
    {
        const int result0 = result.size();
        _krLH(paths, result, child, ctx, _here);
        assertPathsValid_7Yz9(fu::get_view(result, result0), -1, -1, false, minPathDepth, ctx, _here);
    }
    else
    {
        BUG_u9Gb("Lifetime_op: non-locid non-x00x00 subregion."_view, ctx, _here);
                                ...
                                #ifndef DEF_Lifetime_each_gM7PQGzDfm2
                                #define DEF_Lifetime_each_gM7PQGzDfm2
inline void Lifetime_each_gM7P(const Lifetime_llCF& lifetime, const int minPathDepth, fu::str& result, fu::view<char> child, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
    fu::view<char> chars = lifetime.uni0n;
    int offset = 0;
    while (offset < chars.size())
    {
        ...
        unsigned v;
        _kEXl(fu::get_view(chars, offset0, sr), fu::get_view(chars, sr, offset), ((r & 1u) ? 0 : (v = (r >> 1u), int(((v >> 1u) ^ ((v & 1u) ? 0xffffffffu : 0x0u))))), minPathDepth, result, child, ctx, _here);
    };
}
                                #endif

Lifetime_llCF Lifetime_op_join_7Yz9(const Lifetime_llCF& lt, fu::view<char> child, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
    const int minPathDepth = 1;
    /*MOV*/ fu::str result {};
    Lifetime_each_gM7P(lt, minPathDepth, result, child, ctx, _here);
    return Lifetime_llCF { static_cast<fu::str&&>(result) };
}
...
fu::str printPaths_7Yz9(fu::view<char> str, const Context_Dujv& ctx, const TokenIdx_5581& _here)
{
    /*MOV*/ fu::str result {};
    int _o = 0;
    for (; ; )
