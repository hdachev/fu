...
static const fu::static_ref<fu::str> PRELUDE_SRC fu_INIT_PRIORITY(1012) = str_SGIvSPp07c2;

extern const fu::str FU_ROOT;
Context_Zsw9 solvePrelude_U0my()
{
    const fu::str& fname = str_nJyHUaSopRe;
    /*MOV*/ Context_Zsw9 ctx {};
    Module_cdtC module = clone_kM6O(getModule_1qjp(fname, ctx));
...
extern const Context_Zsw9 CTX_PRELUDE fu_INIT_PRIORITY(1012) = solvePrelude_U0my();
#endif
