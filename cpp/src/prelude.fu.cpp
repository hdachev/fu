...
static const fu::static_ref<fu::str> PRELUDE_SRC fu_INIT_PRIORITY(1012) = str_h3Jd1zmJ6yg;

extern const fu::str FU_ROOT;
Context_GwtN solvePrelude_U0my()
{
    const fu::str& fname = str_nJyHUaSopRe;
    /*MOV*/ Context_GwtN ctx {};
    Module_nyjb module = clone_MWeW(getModule_1qjp(fname, ctx));
...
extern const Context_GwtN CTX_PRELUDE fu_INIT_PRIORITY(1012) = solvePrelude_U0my();
#endif
