...
Context_Dujv solvePrelude_U0my()
{
    const fu::str& fname = str_nJyHUaSopRe;
    /*MOV*/ Context_Dujv ctx {};
    Module_BOS4 module = clone_h9KC(getModule_1qjp(fname, ctx));
...
extern const Context_Dujv CTX_PRELUDE fu_INIT_PRIORITY(1012) = solvePrelude_U0my();
#endif
