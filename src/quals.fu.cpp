...
bool is_primitive_hxWW(const ValueType_B8uC& t)
{
    const char c = t.canon[0];
    return (c == 'u') || (c == 'i') || (c == 'f') || (c == 'b') || (c == 'c') || (c == 'm') || (c == 'e');
}

bool is_arithmetic_hxWW(const ValueType_B8uC& t)
{
    const char c = t.canon[0];
    return (c == 'u') || (c == 'i') || (c == 'f');
}

bool is_bitfield_hxWW(const ValueType_B8uC& t)
{
    const char c = t.canon[0];
    return (c == 'u') || (c == 'i') || (c == 'm');
}

bool is_integral_hxWW(const ValueType_B8uC& t)
{
    const char c = t.canon[0];
    return (c == 'u') || (c == 'i');
}

bool is_unsigned_hxWW(const ValueType_B8uC& t)
{
    const char c = t.canon[0];
    return c == 'u';
}

bool is_floating_pt_hxWW(const ValueType_B8uC& t)
{
    const char c = t.canon[0];
    return c == 'f';
}

bool is_boolean_hxWW(const ValueType_B8uC& t)
{
    const char c = t.canon[0];
    return c == 'b';
}

bool is_enum_hxWW(const ValueType_B8uC& t)
{
    const char c = t.canon[0];
    return c == 'e';
}

bool is_flags_hxWW(const ValueType_B8uC& t)
{
    const char c = t.canon[0];
    return c == 'm';
}

bool is_sliceable_hxWW(const ValueType_B8uC& t)
{
    const char c = t.canon[0];
    return c == '[';
}

bool isPassByValue_hxWW(const ValueType_B8uC& t)
{
