...
static void cli_handle_Dx4mXF43(fu::view<fu::str> argv, const fu::str& cwd)
{
    ...
    else
    {
        ...
        {
            hints = true;
            fu::println((fu::slate<3, fu::str> { static_cast<fu::str&&>((x_6 = "   HINT "_fu, x_6)), fu::str(self), static_cast<fu::str&&>((x_7 = " --hotswap is not very useful without both --watch and --run."_fu, x_7)) }));
        };
    };
}
...
inline static void _nE7tAGdO(fu::view<fu::str> argv)
{
    cli_handle_Dx4mXF43(argv, cwd_5u3xiGA0());
                                ...
                                #ifndef DEF_try_or_print_error_ZiM0igWwzLk
                                #define DEF_try_or_print_error_ZiM0igWwzLk
inline int try_or_print_error_ZiM0igWw(fu::view<fu::str> argv)
{
    // Hoisted:
    fu::str x {};
...
{
    return try_or_print_error_ZiM0igWw(argv);
}
