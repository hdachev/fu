...
extern const fu::static_ref<s_Lifetime> Lifetime_worst fu_INIT_PRIORITY(1007) = Lifetime_temporary;
                                ...
                                #ifndef DEF___3wSowMZkKic
                                #define DEF___3wSowMZkKic
inline static void _3wSowMZk(int& pathDepth, int& numPaths, const s_TokenIdx& _here, const s_Context& ctx)
{
    pathDepth = 0;
    numPaths++;
    if (numPaths > 64)
...
inline fu::str x7E_3lDd4lqo(fu::view<char> a, fu::view<char> b)
{
    return a + b;
                                ...
                                #ifndef DEF___MvmjZMheIbk
                                #define DEF___MvmjZMheIbk
inline static void _MvmjZMhe(const int flatOffset, const int flatCount, const bool isLastSubRegion, const bool isFirstSubRegion, int& expect_flatCount, const int region_flatCount, const bool flatCountMismatchOK, int& pathDepth, const s_TokenIdx& _here, const s_Context& ctx)
{
    pathDepth++;
    if (pathDepth > 64)
            ...
            else
            {
                if (!(expect_flatCount == flatCount))
                    BUG_u9Gbkniv((x7E_3lDd4lqo(((x7E_3lDd4lqo("assertPathsValid: expect_flatCount("_fu, fu::i64dec(expect_flatCount)) + ")"_fu) + " != flatCount("_fu), fu::i64dec(flatCount)) + ")"_fu), _here, ctx);
                                ...
                                #ifndef DEF___5clRqObHmG1
                                #define DEF___5clRqObHmG1
inline static void _5clRqObH(const int minPathDepth, const int pathDepth, const s_TokenIdx& _here, const s_Context& ctx)
{
...
void assertPathsValid_7Yz9ezW2(fu::view<char> str, int expect_flatCount, const int region_flatCount, const bool flatCountMismatchOK, const int minPathDepth, const s_TokenIdx& _here, const s_Context& ctx)
{
    ...
    for (; ; )
    {
        ...
        _3wSowMZk(pathDepth, numPaths, _here, ctx);
        for (; ; )
        {
            ...
            _MvmjZMhe(flatOffset, flatCount, isLastSubRegion, isFirstSubRegion, expect_flatCount, region_flatCount, flatCountMismatchOK, pathDepth, _here, ctx);
            if (isLastSubRegion)
                break;
            else
        ...
        _5clRqObH(minPathDepth, pathDepth, _here, ctx);
        if (isLastPath)
            break;
...
inline unsigned uNsigned_67oZXI6U(const unsigned v)
{
    return v;
                                ...
                                #ifndef DEF___V1R5lBkql6c
                                #define DEF___V1R5lBkql6c
inline static void _V1R5lBkq(const bool isFirstSubRegion, const bool isLastSubRegion, const int flatCount, const int flatOffset, const unsigned usage, unsigned& result, const s_TokenIdx& _here, const s_Context& ctx)
{
    if (!(!isFirstSubRegion))
    {
        if (!isLastSubRegion)
...

    {
        for (; ; )
        {
            ...
            for (; ; )
            {
                ...
                const int flatCount = int((raw_flatCount >> 1u));
                const int flatOffset = int((raw_flatOffset >> 1u));
                _V1R5lBkq(isFirstSubRegion, isLastSubRegion, flatCount, flatOffset, usage, result, _here, ctx);
                if (isLastSubRegion)
                    break;
                else
                    isFirstSubRegion = false;
...
bool Paths_union(fu::vec<fu::vec<s_SubRegion>>& result, const fu::vec<s_SubRegion>& path, const s_TokenIdx& _here, const s_Context& ctx)
{
    ...
    return true;
                                ...
                                #ifndef DEF___UWQRaLuCUSd
                                #define DEF___UWQRaLuCUSd
inline static bool _UWQRaLuC(const fu::vec<s_SubRegion>& b_path, fu::vec<fu::vec<s_SubRegion>>& result, const s_TokenIdx& _here, const s_Context& ctx)
{
    return Paths_union(result, b_path, _here, ctx);
}
                                #endif

                                #ifndef DEF___r9VWTRkb1g0
                                #define DEF___r9VWTRkb1g0
inline static void _r9VWTRkb(const fu::vec<s_SubRegion>& path, fu::vec<fu::vec<s_SubRegion>>& result, const s_TokenIdx& _here, const s_Context& ctx)
{
    _UWQRaLuC(path, result, _here, ctx);
}
                                #endif

                                #ifndef DEF_parsePaths_each_Mg85AEekyFj
                                #define DEF_parsePaths_each_Mg85AEekyFj
inline static void parsePaths_each_Mg85AEek(fu::view<char> str, fu::vec<fu::vec<s_SubRegion>>& result, const s_TokenIdx& _here, const s_Context& ctx)
{
    fu::vec<s_SubRegion> path {};
    int _o = 0;
    for (; ; )
    {
        ...
        _r9VWTRkb(path, result, _here, ctx);
        if (isLastPath)
            break;
...
void Paths_union(fu::str& str, fu::view<char> a, fu::view<char> b, const bool flatCountMismatchOK, const s_TokenIdx& _here, const s_Context& ctx)
{
    ...
    parsePaths_each_Mg85AEek(b, result, _here, ctx);
    appendPaths(str, result, false, flatCountMismatchOK, _here, ctx);
}

                                #ifndef DEF___y1mSQYDp3Ik
                                #define DEF___y1mSQYDp3Ik
inline static void _y1mSQYDp(fu::view<char> r_both, fu::view<char> sr_left, fu::view<char> sr_right, const bool flatCountMismatchOK, s_Lifetime& result, const s_TokenIdx& _here, const s_Context& ctx)
{
    result.uni0n += r_both;
        ...
        { {
            for (; ; )
            {
                ...
                fu::view<char> either_chars = ((cmp == 0) ? (__extension__ (
                {
                    l_dirty = true;
                    r_dirty = true;
                    _y1mSQYDp(fu::get_view(l_chars, l_start, l_paths0), fu::get_view(l_chars, l_paths0, l_offset), fu::get_view(r_chars, r_paths0, r_offset), flatCountMismatchOK, result, _here, ctx);
                    continue;
...
inline int max_yeUdQhUA(const int a, const int b)
{
    if ((a >= b))
        ...
        return b;
                                ...
                                #ifndef DEF___jbt7MYp5dEh
                                #define DEF___jbt7MYp5dEh
inline static void _jbt7MYp5(fu::view<s_SubRegion> b_path, fu::view<s_SubRegion> a_path, fu::vec<fu::vec<s_SubRegion>>& result, fu::vec<s_SubRegion>& inter, const s_TokenIdx& _here, const s_Context& ctx)
{
    ...
    if (inter)
    {
        ...
        BUG_u9Gbkniv("Paths_inter: empty inter, about to append suffix"_fu, _here, ctx);
                                ...
                                #ifndef DEF___BxyTbpyTFh0
                                #define DEF___BxyTbpyTFh0
inline static void _BxyTbpyT(fu::view<s_SubRegion> path, fu::view<s_SubRegion> a_path, fu::vec<fu::vec<s_SubRegion>>& result, fu::vec<s_SubRegion>& inter, const s_TokenIdx& _here, const s_Context& ctx)
{
    _jbt7MYp5(path, a_path, result, inter, _here, ctx);
}
                                #endif

                                #ifndef DEF_parsePaths_each_FVCvkWqYwll
                                #define DEF_parsePaths_each_FVCvkWqYwll
inline static void parsePaths_each_FVCvkWqY(fu::view<char> str, fu::view<s_SubRegion> a_path, fu::vec<fu::vec<s_SubRegion>>& result, fu::vec<s_SubRegion>& inter, const s_TokenIdx& _here, const s_Context& ctx)
{
    fu::vec<s_SubRegion> path {};
    int _o = 0;
    for (; ; )
    {
        ...
        _BxyTbpyT(path, a_path, result, inter, _here, ctx);
        if (isLastPath)
            break;
    ...
    if (!(_o == str.size()))
        BUG_u9Gbkniv("walkPaths(!tailOK): excess bytes"_fu, _here, ctx);
                                ...
                                #ifndef DEF___NkrgPzAgiB6
                                #define DEF___NkrgPzAgiB6
inline static void _NkrgPzAg(fu::view<s_SubRegion> a_path, fu::view<char> b, fu::vec<fu::vec<s_SubRegion>>& result, fu::vec<s_SubRegion>& inter, const s_TokenIdx& _here, const s_Context& ctx)
{
    parsePaths_each_FVCvkWqY(b, a_path, result, inter, _here, ctx);
}
                                #endif

                                #ifndef DEF___Mw5AHUHoKzf
                                #define DEF___Mw5AHUHoKzf
inline static void _Mw5AHUHo(fu::view<s_SubRegion> path, fu::view<char> b, fu::vec<fu::vec<s_SubRegion>>& result, fu::vec<s_SubRegion>& inter, const s_TokenIdx& _here, const s_Context& ctx)
{
    _NkrgPzAg(path, b, result, inter, _here, ctx);
}
                                #endif

                                #ifndef DEF_parsePaths_each_iLx2TrbjCd9
                                #define DEF_parsePaths_each_iLx2TrbjCd9
inline static void parsePaths_each_iLx2Trbj(fu::view<char> str, fu::view<char> b, fu::vec<fu::vec<s_SubRegion>>& result, fu::vec<s_SubRegion>& inter, const s_TokenIdx& _here, const s_Context& ctx)
{
    fu::vec<s_SubRegion> path {};
    int _o = 0;
    for (; ; )
    {
        ...
        _Mw5AHUHo(path, b, result, inter, _here, ctx);
        if (isLastPath)
            break;
...
void Paths_inter(fu::str& str, fu::view<char> a, fu::view<char> b, const s_TokenIdx& _here, const s_Context& ctx)
{
    ...
    else
    {
        ...
        parsePaths_each_iLx2Trbj(a, b, result, inter, _here, ctx);
        appendPaths(str, result, true, true, _here, ctx);
    };
}

                                #ifndef DEF___G2AviDwlQZg
                                #define DEF___G2AviDwlQZg
inline static void _G2AviDwl(fu::view<char> r_both, fu::view<char> sr_left, fu::view<char> sr_right, s_Lifetime& result, fu::str& inter, const s_TokenIdx& _here, const s_Context& ctx)
{
    fu::view<char> BL_1_v {};
...
s_Lifetime Lifetime_inter_7Yz9ezW2(const s_Lifetime& a, const s_Lifetime& b, const s_TokenIdx& _here, const s_Context& ctx)
{
    ...
    { {
        ...
        for (; ; )
        {
            ...
            if (cmp == 0)
            {
                l_dirty = true;
                r_dirty = true;
                _G2AviDwl(fu::get_view(l_chars, l_start, l_paths0), fu::get_view(l_chars, l_paths0, l_offset), fu::get_view(r_chars, r_paths0, r_offset), result, inter, _here, ctx);
            }
            else if (cmp < 0)
                l_dirty = true;
            else
    ...
    return /*NRVO*/ result;
                                ...
                                #ifndef DEF_Paths_hasInter_tIO90I4qUy1
                                #define DEF_Paths_hasInter_tIO90I4qUy1
inline static bool Paths_hasInter_tIO90I4q(fu::view<char> a, fu::view<char> b, const s_TokenIdx& _here, const s_Context& ctx)
{
    ...
    return false;
                                ...
                                #ifndef DEF___mqs7FsqkBJa
                                #define DEF___mqs7FsqkBJa
inline static void _mqs7Fsqk(const int locid, fu::view<char> sr_left, fu::view<char> sr_right, fu::vec<int>& result, const s_TokenIdx& _here, const s_Context& ctx)
{
    if (!(!locid))
    {
        if ((sr_left == sr_right) || (sr_left == SR_empty) || (sr_right == SR_empty) || Paths_hasInter_tIO90I4q(sr_left, sr_right, _here, ctx))
            result += locid;
...
bool Lifetime_has_UkiI9X8L(const s_Lifetime& lifetime, const int search)
{
    return Lifetime_some_NyZgybmE(lifetime, search);
                                ...
                                #ifndef DEF___Rt0kP8pASxj
                                #define DEF___Rt0kP8pASxj
inline static void _Rt0kP8pA(const bool isLastPath, fu::view<char> raw_prefix, const int parent_flatCount, const int parent_flatOffset, fu::str& result, const int deref_flatCount, const s_TokenIdx& _here, const s_Context& ctx)
{
    ...
    else
    {
        BUG_u9Gbkniv((x7E_3lDd4lqo("Lifetime_op_deref: parent_flatCount("_fu, fu::i64dec(parent_flatCount)) + ") != 1"_fu), _here, ctx);
                                ...
                                #ifndef DEF___bCWt8zVfnP6
                                #define DEF___bCWt8zVfnP6
inline static void _bCWt8zVf(fu::view<char> paths, fu::str& result, const int deref_flatCount, const s_TokenIdx& _here, const s_Context& ctx)
{
    int offset = 0;
    for (; ; )
    {
        ...
        for (; ; )
        {
            ...
            if (isLastSubRegion)
            {
                _Rt0kP8pA(isLastPath, fu::get_view(paths, path0, subregion0), flatCount, flatOffset, result, deref_flatCount, _here, ctx);
                break;
            }
            else
                isFirstSubRegion = false;
    ...
    if (!(offset == paths.size()))
        BUG_u9Gbkniv("walkPaths(!tailOK): excess bytes"_fu, _here, ctx);
                                ...
                                #ifndef DEF___U8cxWE0T3m6
                                #define DEF___U8cxWE0T3m6
inline static void _U8cxWE0T(fu::view<char> r_raw, fu::view<char> paths, const int locid, const int minPathDepth, fu::str& result, const int deref_flatCount, const s_TokenIdx& _here, const s_Context& ctx)
{
    result += r_raw;
    if (paths == SR_empty)
        result += paths;
    else if (locid)
    {
        ...
        _bCWt8zVf(paths, result, deref_flatCount, _here, ctx);
    ...
    else
    {
        BUG_u9Gbkniv("Lifetime_op: non-locid non-x00x00 subregion."_fu, _here, ctx);
                                ...
                                #ifndef DEF_Lifetime_each_amfrXsspfof
                                #define DEF_Lifetime_each_amfrXsspfof
inline void Lifetime_each_amfrXssp(const s_Lifetime& lifetime, const int minPathDepth, fu::str& result, const int deref_flatCount, const s_TokenIdx& _here, const s_Context& ctx)
{
    // Hoisted:
    int offset0_1;
    ...
    while (offset < chars.size())
    {
        ...
        (void)0;}), BL_3_v);
        int BL_11_v {};
        _U8cxWE0T(fu::get_view(chars, offset0, sr), fu::get_view(chars, sr, offset), ((r & 1u) ? 0 : (__extension__ (
        {
            const unsigned v = (r >> 1u);
            BL_11_v = (int(((v >> 1u) ^ ((v & 1u) ? 0xffffffffu : 0x0u))));
...
s_Lifetime Lifetime_op_deref_7Yz9ezW2(const s_Lifetime& lt, const int deref_flatCount, const s_TokenIdx& _here, const s_Context& ctx)
{
    ...
    /*MOV*/ fu::str result {};
    Lifetime_each_amfrXssp(lt, minPathDepth, result, deref_flatCount, _here, ctx);
...
s_Lifetime Lifetime_makeShared_7Yz9ezW2(const s_Lifetime& lifetime, const int flatCount, const s_TokenIdx& _here, const s_Context& ctx)
{
    return Lifetime_union_7Yz9ezW2(Lifetime_op_deref_7Yz9ezW2(lifetime, flatCount, _here, ctx), Lifetime_static_immoveable, false, _here, ctx);
                                ...
                                #ifndef DEF___ieoQqLsbEzi
                                #define DEF___ieoQqLsbEzi
inline static void _ieoQqLsb(const bool isLastSubRegion, const bool isLastPath, fu::view<char> raw_prefix, const int struct_flatCount, const int struct_flatOffset, fu::str& result, const int flatCount, const int flatOffset, const s_TokenIdx& _here, const s_Context& ctx)
{
    ...
    else
    {
        BUG_u9Gbkniv((x7E_3lDd4lqo(((x7E_3lDd4lqo(((x7E_3lDd4lqo("Lifetime_op_field: field.flatOffset("_fu, fu::i64dec(flatOffset)) + ")"_fu) + " + field.flatCount("_fu), fu::i64dec(flatCount)) + ")"_fu) + " !<= struct.flatCount("_fu), fu::i64dec(struct_flatCount)) + ")"_fu), _here, ctx);
                                ...
                                #ifndef DEF___RdfyTbgZiS4
                                #define DEF___RdfyTbgZiS4
inline static void _RdfyTbgZ(fu::view<char> paths, fu::str& result, const int flatCount, const int flatOffset, const s_TokenIdx& _here, const s_Context& ctx)
{
    int offset = 0;
    for (; ; )
    {
        ...
        for (; ; )
        {
            ...
            if (isLastSubRegion)
            {
                _ieoQqLsb(isLastSubRegion, isLastPath, fu::get_view(paths, path0, subregion0), flatCount_1, flatOffset_1, result, flatCount, flatOffset, _here, ctx);
                break;
            }
            else
                isFirstSubRegion = false;
    ...
    if (!(offset == paths.size()))
        BUG_u9Gbkniv("walkPaths(!tailOK): excess bytes"_fu, _here, ctx);
                                ...
                                #ifndef DEF___WPi2TvVRYqf
                                #define DEF___WPi2TvVRYqf
inline static void _WPi2TvVR(fu::view<char> r_raw, fu::view<char> paths, const int locid, const int minPathDepth, fu::str& result, const int flatCount, const int flatOffset, const s_TokenIdx& _here, const s_Context& ctx)
{
    result += r_raw;
    if (paths == SR_empty)
        result += paths;
    ...
    {
        const int result0 = result.size();
        _RdfyTbgZ(paths, result, flatCount, flatOffset, _here, ctx);
        assertPathsValid_7Yz9ezW2(fu::get_view(result, result0), -1, -1, false, minPathDepth, _here, ctx);
    }
    else
    {
        BUG_u9Gbkniv("Lifetime_op: non-locid non-x00x00 subregion."_fu, _here, ctx);
                                ...
                                #ifndef DEF_Lifetime_each_8iD9OGnxT6g
                                #define DEF_Lifetime_each_8iD9OGnxT6g
inline void Lifetime_each_8iD9OGnx(const s_Lifetime& lifetime, const int minPathDepth, fu::str& result, const int flatCount, const int flatOffset, const s_TokenIdx& _here, const s_Context& ctx)
{
    // Hoisted:
    int offset0_1;
    ...
    while (offset < chars.size())
    {
        ...
        (void)0;}), BL_3_v);
        int BL_11_v {};
        _WPi2TvVR(fu::get_view(chars, offset0, sr), fu::get_view(chars, sr, offset), ((r & 1u) ? 0 : (__extension__ (
        {
            const unsigned v = (r >> 1u);
            BL_11_v = (int(((v >> 1u) ^ ((v & 1u) ? 0xffffffffu : 0x0u))));
...
s_Lifetime Lifetime_op_field_7Yz9ezW2(const s_Lifetime& lt, const int flatCount, const int flatOffset, const s_TokenIdx& _here, const s_Context& ctx)
{
    ...
    /*MOV*/ fu::str result {};
    Lifetime_each_8iD9OGnx(lt, minPathDepth, result, flatCount, flatOffset, _here, ctx);
    return s_Lifetime { static_cast<fu::str&&>(result) };
}
...
s_Lifetime Lifetime_op_mask_7Yz9ezW2(const s_Lifetime& lt, const unsigned quals, const s_TokenIdx& _here, const s_Context& ctx)
{
    ...
    else
    {
        BUG_u9Gbkniv((x7E_3lDd4lqo((x7E_3lDd4lqo((x7E_3lDd4lqo((x7E_3lDd4lqo((x7E_3lDd4lqo("Lifetime_op_mask: flatCount("_fu, fu::i64dec(flatCount)) + ") flatOffset("_fu), fu::i64dec(flatOffset)) + ") clz("_fu), fu::i64dec(clz)) + ") ctz("_fu), fu::i64dec(ctz)) + ") usage("_fu), fu::u64dec(usage)) + ")"_fu), _here, ctx);
                                ...
                                #ifndef DEF___zSJ1DSaNizc
                                #define DEF___zSJ1DSaNizc
inline static void _zSJ1DSaN(const bool child_isFirstSubRegion, const bool child_isLastSubRegion, const bool child_isLastPath, const int child_flatCount, const int child_flatOffset, const bool parent_isLastPath, const int parent_flatCount, const int parent_flatOffset, fu::view<char> parent_rawPrefix, fu::str& result, const s_TokenIdx& _here, const s_Context& ctx)
{
    ...
    if ((result_flatOffset >= 0) && (child_flatCount > 0) && (child_isLastSubRegion || (child_flatCount == 1)))
    {
        ...
        BUG_u9Gbkniv((x7E_3lDd4lqo(((x7E_3lDd4lqo(((x7E_3lDd4lqo("appendSubRegion: flatCount("_fu, fu::i64dec(child_flatCount)) + ")"_fu) + " flatOffset("_fu), fu::i64dec(result_flatOffset)) + ")"_fu) + " isLastSubRegion("_fu), fu::booldec(child_isLastSubRegion)) + ")"_fu), _here, ctx);
                                ...
                                #ifndef DEF___bv0WQ13qJjk
                                #define DEF___bv0WQ13qJjk
inline static void _bv0WQ13q(const bool parent_isLastPath, const int parent_flatCount, const int parent_flatOffset, fu::view<char> parent_rawPrefix, fu::str& result, fu::view<char> child, const s_TokenIdx& _here, const s_Context& ctx)
{
    int _c0 = 0;
    for (; ; )
    {
        ...
        for (; ; )
        {
            ...
            const int flatCount = int((raw_flatCount >> 1u));
            const int flatOffset = int((raw_flatOffset >> 1u));
            _zSJ1DSaN(isFirstSubRegion, isLastSubRegion, isLastPath, flatCount, flatOffset, parent_isLastPath, parent_flatCount, parent_flatOffset, parent_rawPrefix, result, _here, ctx);
            if (isLastSubRegion)
                break;
            else
                isFirstSubRegion = false;
    ...
    if (!(_c0 == child.size()))
        BUG_u9Gbkniv("walkPaths(!tailOK): excess bytes"_fu, _here, ctx);
                                ...
                                #ifndef DEF___VWtoHPWW5U8
                                #define DEF___VWtoHPWW5U8
inline static void _VWtoHPWW(fu::view<char> parent, fu::str& result, fu::view<char> child, const s_TokenIdx& _here, const s_Context& ctx)
{
    int _p0 = 0;
    for (; ; )
    {
        ...
        for (; ; )
        {
            ...
            if (isLastSubRegion)
            {
                _bv0WQ13q(isLastPath, flatCount, flatOffset, fu::get_view(parent, path0, subregion0), result, child, _here, ctx);
                break;
            }
            else
                isFirstSubRegion = false;
    ...
    if (!(_p0 == parent.size()))
        BUG_u9Gbkniv("walkPaths(!tailOK): excess bytes"_fu, _here, ctx);
                                ...
                                #ifndef DEF___vE9dY3ba3z1
                                #define DEF___vE9dY3ba3z1
inline static void _vE9dY3ba(fu::view<char> r_raw, fu::view<char> paths, const int locid, const int minPathDepth, fu::str& result, fu::view<char> child, const s_TokenIdx& _here, const s_Context& ctx)
{
    result += r_raw;
    if (paths == SR_empty)
        result += paths;
    ...
    {
        const int result0 = result.size();
        _VWtoHPWW(paths, result, child, _here, ctx);
        assertPathsValid_7Yz9ezW2(fu::get_view(result, result0), -1, -1, false, minPathDepth, _here, ctx);
    }
    else
    {
        BUG_u9Gbkniv("Lifetime_op: non-locid non-x00x00 subregion."_fu, _here, ctx);
                                ...
                                #ifndef DEF_Lifetime_each_IQag3bJAvqi
                                #define DEF_Lifetime_each_IQag3bJAvqi
inline void Lifetime_each_IQag3bJA(const s_Lifetime& lifetime, const int minPathDepth, fu::str& result, fu::view<char> child, const s_TokenIdx& _here, const s_Context& ctx)
{
    // Hoisted:
    int offset0_1;
    ...
    while (offset < chars.size())
    {
        ...
        (void)0;}), BL_3_v);
        int BL_11_v {};
        _vE9dY3ba(fu::get_view(chars, offset0, sr), fu::get_view(chars, sr, offset), ((r & 1u) ? 0 : (__extension__ (
        {
            const unsigned v = (r >> 1u);
            BL_11_v = (int(((v >> 1u) ^ ((v & 1u) ? 0xffffffffu : 0x0u))));
...
s_Lifetime Lifetime_op_join_7Yz9ezW2(const s_Lifetime& lt, fu::view<char> child, const s_TokenIdx& _here, const s_Context& ctx)
{
    const int minPathDepth = 1;
    /*MOV*/ fu::str result {};
    Lifetime_each_IQag3bJA(lt, minPathDepth, result, child, _here, ctx);
    return s_Lifetime { static_cast<fu::str&&>(result) };
}
