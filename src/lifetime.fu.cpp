...
extern const fu::static_ref<s_Lifetime> Lifetime_worst fu_INIT_PRIORITY(1007) = Lifetime_temporary;
                                ...
                                #ifndef DEF___pcgtbly4ZH8
                                #define DEF___pcgtbly4ZH8
inline static void _pcgtbly4(int& pathDepth, int& numPaths, const s_TokenIdx& _here, const s_Context& ctx)
{
    pathDepth = 0;
    numPaths++;
    if (numPaths > 64)
...
inline fu::str x7E_3lDd4lqo(fu::view<char> a, fu::view<char> b)
{
    return a + b;
                                ...
                                #ifndef DEF___jw60YExUYM9
                                #define DEF___jw60YExUYM9
inline static void _jw60YExU(const int flatOffset, const int flatCount, const bool isLastSubRegion, const bool isFirstSubRegion, int& expect_flatCount, const int region_flatCount, const bool flatCountMismatchOK, int& pathDepth, const s_TokenIdx& _here, const s_Context& ctx)
{
    pathDepth++;
    if (pathDepth > 64)
            ...
            else
            {
                if (!(expect_flatCount == flatCount))
                    BUG_u9Gbkniv((x7E_3lDd4lqo(((x7E_3lDd4lqo("assertPathsValid: expect_flatCount("_fu, fu::i64dec(expect_flatCount)) + ")"_fu) + " != flatCount("_fu), fu::i64dec(flatCount)) + ")"_fu), _here, ctx);
                                ...
                                #ifndef DEF___9lcDvpZHVqb
                                #define DEF___9lcDvpZHVqb
inline static void _9lcDvpZH(const int minPathDepth, const int pathDepth, const s_TokenIdx& _here, const s_Context& ctx)
{
...
void assertPathsValid_7Yz9ezW2(fu::view<char> str, int expect_flatCount, const int region_flatCount, const bool flatCountMismatchOK, const int minPathDepth, const s_TokenIdx& _here, const s_Context& ctx)
{
    ...
    for (; ; )
    {
        ...
        _pcgtbly4(pathDepth, numPaths, _here, ctx);
        for (; ; )
        {
            ...
            _jw60YExU(flatOffset, flatCount, isLastSubRegion, isFirstSubRegion, expect_flatCount, region_flatCount, flatCountMismatchOK, pathDepth, _here, ctx);
            if (isLastSubRegion)
                break;
            else
        ...
        _9lcDvpZH(minPathDepth, pathDepth, _here, ctx);
        if (isLastPath)
            break;
...
inline unsigned uNsigned_67oZXI6U(const unsigned v)
{
    return v;
                                ...
                                #ifndef DEF___aWeH495vJ6h
                                #define DEF___aWeH495vJ6h
inline static void _aWeH495v(const bool isFirstSubRegion, const bool isLastSubRegion, const int flatCount, const int flatOffset, const unsigned usage, unsigned& result, const s_TokenIdx& _here, const s_Context& ctx)
{
    if (!(!isFirstSubRegion))
    {
        if (!isLastSubRegion)
...

    {
        for (; ; )
        {
            ...
            for (; ; )
            {
                ...
                const int flatCount = int((raw_flatCount >> 1u));
                const int flatOffset = int((raw_flatOffset >> 1u));
                _aWeH495v(isFirstSubRegion, isLastSubRegion, flatCount, flatOffset, usage, result, _here, ctx);
                if (isLastSubRegion)
                    break;
                else
                    isFirstSubRegion = false;
...
bool Paths_union(fu::vec<fu::vec<s_SubRegion>>& result, const fu::vec<s_SubRegion>& path, const s_TokenIdx& _here, const s_Context& ctx)
{
    ...
    return true;
                                ...
                                #ifndef DEF___opIACycMAc0
                                #define DEF___opIACycMAc0
inline static bool _opIACycM(const fu::vec<s_SubRegion>& b_path, fu::vec<fu::vec<s_SubRegion>>& result, const s_TokenIdx& _here, const s_Context& ctx)
{
    return Paths_union(result, b_path, _here, ctx);
}
                                #endif

                                #ifndef DEF___B8SQa7JAP6i
                                #define DEF___B8SQa7JAP6i
inline static void _B8SQa7JA(const fu::vec<s_SubRegion>& path, fu::vec<fu::vec<s_SubRegion>>& result, const s_TokenIdx& _here, const s_Context& ctx)
{
    _opIACycM(path, result, _here, ctx);
}
                                #endif

                                #ifndef DEF_parsePaths_each_SJ5w5CBsqml
                                #define DEF_parsePaths_each_SJ5w5CBsqml
inline static void parsePaths_each_SJ5w5CBs(fu::view<char> str, fu::vec<fu::vec<s_SubRegion>>& result, const s_TokenIdx& _here, const s_Context& ctx)
{
    fu::vec<s_SubRegion> path {};
    int _o = 0;
    for (; ; )
    {
        ...
        _B8SQa7JA(path, result, _here, ctx);
        if (isLastPath)
            break;
...
void Paths_union(fu::str& str, fu::view<char> a, fu::view<char> b, const bool flatCountMismatchOK, const s_TokenIdx& _here, const s_Context& ctx)
{
    ...
    parsePaths_each_SJ5w5CBs(b, result, _here, ctx);
    appendPaths(str, result, false, flatCountMismatchOK, _here, ctx);
}

                                #ifndef DEF___GiJWAEjrqF6
                                #define DEF___GiJWAEjrqF6
inline static void _GiJWAEjr(fu::view<char> r_both, fu::view<char> sr_left, fu::view<char> sr_right, const bool flatCountMismatchOK, s_Lifetime& result, const s_TokenIdx& _here, const s_Context& ctx)
{
    result.uni0n += r_both;
        ...
        { {
            for (; ; )
            {
                ...
                fu::view<char> either_chars = ((cmp == 0) ? (__extension__ (
                {
                    l_dirty = true;
                    r_dirty = true;
                    _GiJWAEjr(fu::get_view(l_chars, l_start, l_paths0), fu::get_view(l_chars, l_paths0, l_offset), fu::get_view(r_chars, r_paths0, r_offset), flatCountMismatchOK, result, _here, ctx);
                    continue;
...
inline int max_yeUdQhUA(const int a, const int b)
{
    if ((a >= b))
        ...
        return b;
                                ...
                                #ifndef DEF___qS7QVNTuDj3
                                #define DEF___qS7QVNTuDj3
inline static void _qS7QVNTu(fu::view<s_SubRegion> b_path, fu::view<s_SubRegion> a_path, fu::vec<fu::vec<s_SubRegion>>& result, fu::vec<s_SubRegion>& inter, const s_TokenIdx& _here, const s_Context& ctx)
{
    ...
    if (inter)
    {
        ...
        BUG_u9Gbkniv("Paths_inter: empty inter, about to append suffix"_fu, _here, ctx);
                                ...
                                #ifndef DEF___NOhSl174nU0
                                #define DEF___NOhSl174nU0
inline static void _NOhSl174(fu::view<s_SubRegion> path, fu::view<s_SubRegion> a_path, fu::vec<fu::vec<s_SubRegion>>& result, fu::vec<s_SubRegion>& inter, const s_TokenIdx& _here, const s_Context& ctx)
{
    _qS7QVNTu(path, a_path, result, inter, _here, ctx);
}
                                #endif

                                #ifndef DEF_parsePaths_each_F3lSkoLhIde
                                #define DEF_parsePaths_each_F3lSkoLhIde
inline static void parsePaths_each_F3lSkoLh(fu::view<char> str, fu::view<s_SubRegion> a_path, fu::vec<fu::vec<s_SubRegion>>& result, fu::vec<s_SubRegion>& inter, const s_TokenIdx& _here, const s_Context& ctx)
{
    fu::vec<s_SubRegion> path {};
    int _o = 0;
    for (; ; )
    {
        ...
        _NOhSl174(path, a_path, result, inter, _here, ctx);
        if (isLastPath)
            break;
    ...
    if (!(_o == str.size()))
        BUG_u9Gbkniv("walkPaths(!tailOK): excess bytes"_fu, _here, ctx);
                                ...
                                #ifndef DEF___OUoNehXnx67
                                #define DEF___OUoNehXnx67
inline static void _OUoNehXn(fu::view<s_SubRegion> a_path, fu::view<char> b, fu::vec<fu::vec<s_SubRegion>>& result, fu::vec<s_SubRegion>& inter, const s_TokenIdx& _here, const s_Context& ctx)
{
    parsePaths_each_F3lSkoLh(b, a_path, result, inter, _here, ctx);
}
                                #endif

                                #ifndef DEF___jCU6PgJ4b86
                                #define DEF___jCU6PgJ4b86
inline static void _jCU6PgJ4(fu::view<s_SubRegion> path, fu::view<char> b, fu::vec<fu::vec<s_SubRegion>>& result, fu::vec<s_SubRegion>& inter, const s_TokenIdx& _here, const s_Context& ctx)
{
    _OUoNehXn(path, b, result, inter, _here, ctx);
}
                                #endif

                                #ifndef DEF_parsePaths_each_g6EaS23j9vj
                                #define DEF_parsePaths_each_g6EaS23j9vj
inline static void parsePaths_each_g6EaS23j(fu::view<char> str, fu::view<char> b, fu::vec<fu::vec<s_SubRegion>>& result, fu::vec<s_SubRegion>& inter, const s_TokenIdx& _here, const s_Context& ctx)
{
    fu::vec<s_SubRegion> path {};
    int _o = 0;
    for (; ; )
    {
        ...
        _jCU6PgJ4(path, b, result, inter, _here, ctx);
        if (isLastPath)
            break;
...
void Paths_inter(fu::str& str, fu::view<char> a, fu::view<char> b, const s_TokenIdx& _here, const s_Context& ctx)
{
    ...
    else
    {
        ...
        parsePaths_each_g6EaS23j(a, b, result, inter, _here, ctx);
        appendPaths(str, result, true, true, _here, ctx);
    };
}

                                #ifndef DEF___LvO945ntln7
                                #define DEF___LvO945ntln7
inline static void _LvO945nt(fu::view<char> r_both, fu::view<char> sr_left, fu::view<char> sr_right, s_Lifetime& result, fu::str& inter, const s_TokenIdx& _here, const s_Context& ctx)
{
    fu::view<char> BL_1_v {};
...
s_Lifetime Lifetime_inter_7Yz9ezW2(const s_Lifetime& a, const s_Lifetime& b, const s_TokenIdx& _here, const s_Context& ctx)
{
    ...
    { {
        ...
        for (; ; )
        {
            ...
            if (cmp == 0)
            {
                l_dirty = true;
                r_dirty = true;
                _LvO945nt(fu::get_view(l_chars, l_start, l_paths0), fu::get_view(l_chars, l_paths0, l_offset), fu::get_view(r_chars, r_paths0, r_offset), result, inter, _here, ctx);
            }
            else if (cmp < 0)
                l_dirty = true;
            else
    ...
    return /*NRVO*/ result;
                                ...
                                #ifndef DEF_Paths_hasInter_6uOGeFHG5Mb
                                #define DEF_Paths_hasInter_6uOGeFHG5Mb
inline static bool Paths_hasInter_6uOGeFHG(fu::view<char> a, fu::view<char> b, const s_TokenIdx& _here, const s_Context& ctx)
{
    ...
    return false;
                                ...
                                #ifndef DEF___2O2udtLgpGb
                                #define DEF___2O2udtLgpGb
inline static void _2O2udtLg(const int locid, fu::view<char> sr_left, fu::view<char> sr_right, fu::vec<int>& result, const s_TokenIdx& _here, const s_Context& ctx)
{
    if (!(!locid))
    {
        if ((sr_left == sr_right) || (sr_left == SR_empty) || (sr_right == SR_empty) || Paths_hasInter_6uOGeFHG(sr_left, sr_right, _here, ctx))
            result += locid;
...
bool Lifetime_has_UkiI9X8L(const s_Lifetime& lifetime, const int search)
{
    return Lifetime_some_NyZgybmE(lifetime, search);
                                ...
                                #ifndef DEF___We3iJ49fy2d
                                #define DEF___We3iJ49fy2d
inline static void _We3iJ49f(const bool isLastPath, fu::view<char> raw_prefix, const int parent_flatCount, const int parent_flatOffset, fu::str& result, const int deref_flatCount, const s_TokenIdx& _here, const s_Context& ctx)
{
    ...
    else
    {
        BUG_u9Gbkniv((x7E_3lDd4lqo("Lifetime_op_deref: parent_flatCount("_fu, fu::i64dec(parent_flatCount)) + ") != 1"_fu), _here, ctx);
                                ...
                                #ifndef DEF___U6VM7vc1Uad
                                #define DEF___U6VM7vc1Uad
inline static void _U6VM7vc1(fu::view<char> paths, fu::str& result, const int deref_flatCount, const s_TokenIdx& _here, const s_Context& ctx)
{
    int offset = 0;
    for (; ; )
    {
        ...
        for (; ; )
        {
            ...
            if (isLastSubRegion)
            {
                _We3iJ49f(isLastPath, fu::get_view(paths, path0, subregion0), flatCount, flatOffset, result, deref_flatCount, _here, ctx);
                break;
            }
            else
                isFirstSubRegion = false;
    ...
    if (!(offset == paths.size()))
        BUG_u9Gbkniv("walkPaths(!tailOK): excess bytes"_fu, _here, ctx);
                                ...
                                #ifndef DEF___t5AVkyJSxkb
                                #define DEF___t5AVkyJSxkb
inline static void _t5AVkyJS(fu::view<char> r_raw, fu::view<char> paths, const int locid, const int minPathDepth, fu::str& result, const int deref_flatCount, const s_TokenIdx& _here, const s_Context& ctx)
{
    result += r_raw;
    if (paths == SR_empty)
        result += paths;
    else if (locid)
    {
        ...
        _U6VM7vc1(paths, result, deref_flatCount, _here, ctx);
    ...
    else
    {
        BUG_u9Gbkniv("Lifetime_op: non-locid non-x00x00 subregion."_fu, _here, ctx);
                                ...
                                #ifndef DEF_Lifetime_each_w2ohjR2ccW9
                                #define DEF_Lifetime_each_w2ohjR2ccW9
inline void Lifetime_each_w2ohjR2c(const s_Lifetime& lifetime, const int minPathDepth, fu::str& result, const int deref_flatCount, const s_TokenIdx& _here, const s_Context& ctx)
{
    // Hoisted:
    int offset0_1;
    ...
    while (offset < chars.size())
    {
        ...
        (void)0;}), BL_3_v);
        int BL_11_v {};
        _t5AVkyJS(fu::get_view(chars, offset0, sr), fu::get_view(chars, sr, offset), ((r & 1u) ? 0 : (__extension__ (
        {
            const unsigned v = (r >> 1u);
            BL_11_v = (int(((v >> 1u) ^ ((v & 1u) ? 0xffffffffu : 0x0u))));
...
s_Lifetime Lifetime_op_deref_7Yz9ezW2(const s_Lifetime& lt, const int deref_flatCount, const s_TokenIdx& _here, const s_Context& ctx)
{
    ...
    /*MOV*/ fu::str result {};
    Lifetime_each_w2ohjR2c(lt, minPathDepth, result, deref_flatCount, _here, ctx);
...
s_Lifetime Lifetime_makeShared_7Yz9ezW2(const s_Lifetime& lifetime, const int flatCount, const s_TokenIdx& _here, const s_Context& ctx)
{
    return Lifetime_union_7Yz9ezW2(Lifetime_op_deref_7Yz9ezW2(lifetime, flatCount, _here, ctx), Lifetime_static_immoveable, false, _here, ctx);
                                ...
                                #ifndef DEF___VkqZ1HMNDPf
                                #define DEF___VkqZ1HMNDPf
inline static void _VkqZ1HMN(const bool isLastSubRegion, const bool isLastPath, fu::view<char> raw_prefix, const int struct_flatCount, const int struct_flatOffset, fu::str& result, const int flatCount, const int flatOffset, const s_TokenIdx& _here, const s_Context& ctx)
{
    ...
    else
    {
        BUG_u9Gbkniv((x7E_3lDd4lqo(((x7E_3lDd4lqo(((x7E_3lDd4lqo("Lifetime_op_field: field.flatOffset("_fu, fu::i64dec(flatOffset)) + ")"_fu) + " + field.flatCount("_fu), fu::i64dec(flatCount)) + ")"_fu) + " !<= struct.flatCount("_fu), fu::i64dec(struct_flatCount)) + ")"_fu), _here, ctx);
                                ...
                                #ifndef DEF___yOR1mNLzrSk
                                #define DEF___yOR1mNLzrSk
inline static void _yOR1mNLz(fu::view<char> paths, fu::str& result, const int flatCount, const int flatOffset, const s_TokenIdx& _here, const s_Context& ctx)
{
    int offset = 0;
    for (; ; )
    {
        ...
        for (; ; )
        {
            ...
            if (isLastSubRegion)
            {
                _VkqZ1HMN(isLastSubRegion, isLastPath, fu::get_view(paths, path0, subregion0), flatCount_1, flatOffset_1, result, flatCount, flatOffset, _here, ctx);
                break;
            }
            else
                isFirstSubRegion = false;
    ...
    if (!(offset == paths.size()))
        BUG_u9Gbkniv("walkPaths(!tailOK): excess bytes"_fu, _here, ctx);
                                ...
                                #ifndef DEF___KeuioIzrE6c
                                #define DEF___KeuioIzrE6c
inline static void _KeuioIzr(fu::view<char> r_raw, fu::view<char> paths, const int locid, const int minPathDepth, fu::str& result, const int flatCount, const int flatOffset, const s_TokenIdx& _here, const s_Context& ctx)
{
    result += r_raw;
    if (paths == SR_empty)
        result += paths;
    ...
    {
        const int result0 = result.size();
        _yOR1mNLz(paths, result, flatCount, flatOffset, _here, ctx);
        assertPathsValid_7Yz9ezW2(fu::get_view(result, result0), -1, -1, false, minPathDepth, _here, ctx);
    }
    else
    {
        BUG_u9Gbkniv("Lifetime_op: non-locid non-x00x00 subregion."_fu, _here, ctx);
                                ...
                                #ifndef DEF_Lifetime_each_pWvEzOWr9xa
                                #define DEF_Lifetime_each_pWvEzOWr9xa
inline void Lifetime_each_pWvEzOWr(const s_Lifetime& lifetime, const int minPathDepth, fu::str& result, const int flatCount, const int flatOffset, const s_TokenIdx& _here, const s_Context& ctx)
{
    // Hoisted:
    int offset0_1;
    ...
    while (offset < chars.size())
    {
        ...
        (void)0;}), BL_3_v);
        int BL_11_v {};
        _KeuioIzr(fu::get_view(chars, offset0, sr), fu::get_view(chars, sr, offset), ((r & 1u) ? 0 : (__extension__ (
        {
            const unsigned v = (r >> 1u);
            BL_11_v = (int(((v >> 1u) ^ ((v & 1u) ? 0xffffffffu : 0x0u))));
...
s_Lifetime Lifetime_op_field_7Yz9ezW2(const s_Lifetime& lt, const int flatCount, const int flatOffset, const s_TokenIdx& _here, const s_Context& ctx)
{
    ...
    /*MOV*/ fu::str result {};
    Lifetime_each_pWvEzOWr(lt, minPathDepth, result, flatCount, flatOffset, _here, ctx);
    return s_Lifetime { static_cast<fu::str&&>(result) };
}
...
s_Lifetime Lifetime_op_mask_7Yz9ezW2(const s_Lifetime& lt, const unsigned quals, const s_TokenIdx& _here, const s_Context& ctx)
{
    ...
    else
    {
        BUG_u9Gbkniv((x7E_3lDd4lqo((x7E_3lDd4lqo((x7E_3lDd4lqo((x7E_3lDd4lqo((x7E_3lDd4lqo("Lifetime_op_mask: flatCount("_fu, fu::i64dec(flatCount)) + ") flatOffset("_fu), fu::i64dec(flatOffset)) + ") clz("_fu), fu::i64dec(clz)) + ") ctz("_fu), fu::i64dec(ctz)) + ") usage("_fu), fu::u64dec(usage)) + ")"_fu), _here, ctx);
                                ...
                                #ifndef DEF___TckRRYFWq3d
                                #define DEF___TckRRYFWq3d
inline static void _TckRRYFW(const bool child_isFirstSubRegion, const bool child_isLastSubRegion, const bool child_isLastPath, const int child_flatCount, const int child_flatOffset, const bool parent_isLastPath, const int parent_flatCount, const int parent_flatOffset, fu::view<char> parent_rawPrefix, fu::str& result, const s_TokenIdx& _here, const s_Context& ctx)
{
    ...
    if ((result_flatOffset >= 0) && (child_flatCount > 0) && (child_isLastSubRegion || (child_flatCount == 1)))
    {
        ...
        BUG_u9Gbkniv((x7E_3lDd4lqo(((x7E_3lDd4lqo(((x7E_3lDd4lqo("appendSubRegion: flatCount("_fu, fu::i64dec(child_flatCount)) + ")"_fu) + " flatOffset("_fu), fu::i64dec(result_flatOffset)) + ")"_fu) + " isLastSubRegion("_fu), fu::booldec(child_isLastSubRegion)) + ")"_fu), _here, ctx);
                                ...
                                #ifndef DEF___DxYy2c4V81j
                                #define DEF___DxYy2c4V81j
inline static void _DxYy2c4V(const bool parent_isLastPath, const int parent_flatCount, const int parent_flatOffset, fu::view<char> parent_rawPrefix, fu::str& result, fu::view<char> child, const s_TokenIdx& _here, const s_Context& ctx)
{
    int _c0 = 0;
    for (; ; )
    {
        ...
        for (; ; )
        {
            ...
            const int flatCount = int((raw_flatCount >> 1u));
            const int flatOffset = int((raw_flatOffset >> 1u));
            _TckRRYFW(isFirstSubRegion, isLastSubRegion, isLastPath, flatCount, flatOffset, parent_isLastPath, parent_flatCount, parent_flatOffset, parent_rawPrefix, result, _here, ctx);
            if (isLastSubRegion)
                break;
            else
                isFirstSubRegion = false;
    ...
    if (!(_c0 == child.size()))
        BUG_u9Gbkniv("walkPaths(!tailOK): excess bytes"_fu, _here, ctx);
                                ...
                                #ifndef DEF___hMNcn0m5LK8
                                #define DEF___hMNcn0m5LK8
inline static void _hMNcn0m5(fu::view<char> parent, fu::str& result, fu::view<char> child, const s_TokenIdx& _here, const s_Context& ctx)
{
    int _p0 = 0;
    for (; ; )
    {
        ...
        for (; ; )
        {
            ...
            if (isLastSubRegion)
            {
                _DxYy2c4V(isLastPath, flatCount, flatOffset, fu::get_view(parent, path0, subregion0), result, child, _here, ctx);
                break;
            }
            else
                isFirstSubRegion = false;
    ...
    if (!(_p0 == parent.size()))
        BUG_u9Gbkniv("walkPaths(!tailOK): excess bytes"_fu, _here, ctx);
                                ...
                                #ifndef DEF___qdi2PlztqEi
                                #define DEF___qdi2PlztqEi
inline static void _qdi2Plzt(fu::view<char> r_raw, fu::view<char> paths, const int locid, const int minPathDepth, fu::str& result, fu::view<char> child, const s_TokenIdx& _here, const s_Context& ctx)
{
    result += r_raw;
    if (paths == SR_empty)
        result += paths;
    ...
    {
        const int result0 = result.size();
        _hMNcn0m5(paths, result, child, _here, ctx);
        assertPathsValid_7Yz9ezW2(fu::get_view(result, result0), -1, -1, false, minPathDepth, _here, ctx);
    }
    else
    {
        BUG_u9Gbkniv("Lifetime_op: non-locid non-x00x00 subregion."_fu, _here, ctx);
                                ...
                                #ifndef DEF_Lifetime_each_6CsdmqG8JQ3
                                #define DEF_Lifetime_each_6CsdmqG8JQ3
inline void Lifetime_each_6CsdmqG8(const s_Lifetime& lifetime, const int minPathDepth, fu::str& result, fu::view<char> child, const s_TokenIdx& _here, const s_Context& ctx)
{
    // Hoisted:
    int offset0_1;
    ...
    while (offset < chars.size())
    {
        ...
        (void)0;}), BL_3_v);
        int BL_11_v {};
        _qdi2Plzt(fu::get_view(chars, offset0, sr), fu::get_view(chars, sr, offset), ((r & 1u) ? 0 : (__extension__ (
        {
            const unsigned v = (r >> 1u);
            BL_11_v = (int(((v >> 1u) ^ ((v & 1u) ? 0xffffffffu : 0x0u))));
...
s_Lifetime Lifetime_op_join_7Yz9ezW2(const s_Lifetime& lt, fu::view<char> child, const s_TokenIdx& _here, const s_Context& ctx)
{
    const int minPathDepth = 1;
    /*MOV*/ fu::str result {};
    Lifetime_each_6CsdmqG8(lt, minPathDepth, result, child, _here, ctx);
    return s_Lifetime { static_cast<fu::str&&>(result) };
}
