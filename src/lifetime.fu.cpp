...
extern const fu::static_ref<s_Lifetime> Lifetime_worst fu_INIT_PRIORITY(1007) = Lifetime_temporary;
                                ...
                                #ifndef DEF___NrK6s6VJueh
                                #define DEF___NrK6s6VJueh
inline static void _NrK6s6VJ(int& pathDepth, int& numPaths, const s_TokenIdx& _here, const s_Context& ctx)
{
    pathDepth = 0;
    numPaths++;
    if (numPaths > 64)
...
inline fu::str x7E_3lDd4lqo(fu::view<char> a, fu::view<char> b)
{
    return a + b;
                                ...
                                #ifndef DEF___ppBr7WibVte
                                #define DEF___ppBr7WibVte
inline static void _ppBr7Wib(const int flatOffset, const int flatCount, const bool isLastSubRegion, const bool isFirstSubRegion, int& expect_flatCount, const int region_flatCount, const bool flatCountMismatchOK, int& pathDepth, const s_TokenIdx& _here, const s_Context& ctx)
{
    pathDepth++;
    if (pathDepth > 64)
            ...
            else
            {
                if (!(expect_flatCount == flatCount))
                    BUG_u9Gbkniv((x7E_3lDd4lqo(((x7E_3lDd4lqo("assertPathsValid: expect_flatCount("_fu, fu::i64dec(expect_flatCount)) + ")"_fu) + " != flatCount("_fu), fu::i64dec(flatCount)) + ")"_fu), _here, ctx);
                                ...
                                #ifndef DEF___fjvj9yxrAf7
                                #define DEF___fjvj9yxrAf7
inline static void _fjvj9yxr(const int minPathDepth, const int pathDepth, const s_TokenIdx& _here, const s_Context& ctx)
{
...
void assertPathsValid_7Yz9ezW2(fu::view<char> str, int expect_flatCount, const int region_flatCount, const bool flatCountMismatchOK, const int minPathDepth, const s_TokenIdx& _here, const s_Context& ctx)
{
    ...
    for (; ; )
    {
        ...
        _NrK6s6VJ(pathDepth, numPaths, _here, ctx);
        for (; ; )
        {
            ...
            _ppBr7Wib(flatOffset, flatCount, isLastSubRegion, isFirstSubRegion, expect_flatCount, region_flatCount, flatCountMismatchOK, pathDepth, _here, ctx);
            if (isLastSubRegion)
                break;
            else
        ...
        _fjvj9yxr(minPathDepth, pathDepth, _here, ctx);
        if (isLastPath)
            break;
...
inline unsigned uNsigned_67oZXI6U(const unsigned v)
{
    return v;
                                ...
                                #ifndef DEF___OTgJ0MSAb2k
                                #define DEF___OTgJ0MSAb2k
inline static void _OTgJ0MSA(const bool isFirstSubRegion, const bool isLastSubRegion, const int flatCount, const int flatOffset, const unsigned usage, unsigned& result, const s_TokenIdx& _here, const s_Context& ctx)
{
    if (!(!isFirstSubRegion))
    {
        if (!isLastSubRegion)
...

    {
        for (; ; )
        {
            ...
            for (; ; )
            {
                ...
                const int flatCount = int((raw_flatCount >> 1u));
                const int flatOffset = int((raw_flatOffset >> 1u));
                _OTgJ0MSA(isFirstSubRegion, isLastSubRegion, flatCount, flatOffset, usage, result, _here, ctx);
                if (isLastSubRegion)
                    break;
                else
                    isFirstSubRegion = false;
...
bool Paths_union(fu::vec<fu::vec<s_SubRegion>>& result, const fu::vec<s_SubRegion>& path, const s_TokenIdx& _here, const s_Context& ctx)
{
    ...
    return true;
                                ...
                                #ifndef DEF___cMl642QXoN7
                                #define DEF___cMl642QXoN7
inline static bool _cMl642QX(const fu::vec<s_SubRegion>& b_path, fu::vec<fu::vec<s_SubRegion>>& result, const s_TokenIdx& _here, const s_Context& ctx)
{
    return Paths_union(result, b_path, _here, ctx);
}
                                #endif

                                #ifndef DEF___vT8NjLCCXPd
                                #define DEF___vT8NjLCCXPd
inline static void _vT8NjLCC(const fu::vec<s_SubRegion>& path, fu::vec<fu::vec<s_SubRegion>>& result, const s_TokenIdx& _here, const s_Context& ctx)
{
    _cMl642QX(path, result, _here, ctx);
}
                                #endif

                                #ifndef DEF_parsePaths_each_92zVmo0Ti72
                                #define DEF_parsePaths_each_92zVmo0Ti72
inline static void parsePaths_each_92zVmo0T(fu::view<char> str, fu::vec<fu::vec<s_SubRegion>>& result, const s_TokenIdx& _here, const s_Context& ctx)
{
    fu::vec<s_SubRegion> path {};
    int _o = 0;
    for (; ; )
    {
        ...
        _vT8NjLCC(path, result, _here, ctx);
        if (isLastPath)
            break;
...
void Paths_union(fu::str& str, fu::view<char> a, fu::view<char> b, const bool flatCountMismatchOK, const s_TokenIdx& _here, const s_Context& ctx)
{
    ...
    parsePaths_each_92zVmo0T(b, result, _here, ctx);
    appendPaths(str, result, false, flatCountMismatchOK, _here, ctx);
}

                                #ifndef DEF___Kc1nxGcssjh
                                #define DEF___Kc1nxGcssjh
inline static void _Kc1nxGcs(fu::view<char> r_both, fu::view<char> sr_left, fu::view<char> sr_right, const bool flatCountMismatchOK, s_Lifetime& result, const s_TokenIdx& _here, const s_Context& ctx)
{
    result.uni0n += r_both;
        ...
        { {
            for (; ; )
            {
                ...
                fu::view<char> either_chars = ((cmp == 0) ? (__extension__ (
                {
                    l_dirty = true;
                    r_dirty = true;
                    _Kc1nxGcs(fu::get_view(l_chars, l_start, l_paths0), fu::get_view(l_chars, l_paths0, l_offset), fu::get_view(r_chars, r_paths0, r_offset), flatCountMismatchOK, result, _here, ctx);
                    continue;
...
inline int max_yeUdQhUA(const int a, const int b)
{
    if ((a >= b))
        ...
        return b;
                                ...
                                #ifndef DEF___0HbBqBXbO1b
                                #define DEF___0HbBqBXbO1b
inline static void _0HbBqBXb(fu::view<s_SubRegion> b_path, fu::view<s_SubRegion> a_path, fu::vec<fu::vec<s_SubRegion>>& result, fu::vec<s_SubRegion>& inter, const s_TokenIdx& _here, const s_Context& ctx)
{
    ...
    if (inter)
    {
        ...
        BUG_u9Gbkniv("Paths_inter: empty inter, about to append suffix"_fu, _here, ctx);
                                ...
                                #ifndef DEF___Kr7pMfvn1O4
                                #define DEF___Kr7pMfvn1O4
inline static void _Kr7pMfvn(fu::view<s_SubRegion> path, fu::view<s_SubRegion> a_path, fu::vec<fu::vec<s_SubRegion>>& result, fu::vec<s_SubRegion>& inter, const s_TokenIdx& _here, const s_Context& ctx)
{
    _0HbBqBXb(path, a_path, result, inter, _here, ctx);
}
                                #endif

                                #ifndef DEF_parsePaths_each_abvpIgR7qX4
                                #define DEF_parsePaths_each_abvpIgR7qX4
inline static void parsePaths_each_abvpIgR7(fu::view<char> str, fu::view<s_SubRegion> a_path, fu::vec<fu::vec<s_SubRegion>>& result, fu::vec<s_SubRegion>& inter, const s_TokenIdx& _here, const s_Context& ctx)
{
    fu::vec<s_SubRegion> path {};
    int _o = 0;
    for (; ; )
    {
        ...
        _Kr7pMfvn(path, a_path, result, inter, _here, ctx);
        if (isLastPath)
            break;
    ...
    if (!(_o == str.size()))
        BUG_u9Gbkniv("walkPaths(!tailOK): excess bytes"_fu, _here, ctx);
                                ...
                                #ifndef DEF___wzeZSYWjb62
                                #define DEF___wzeZSYWjb62
inline static void _wzeZSYWj(fu::view<s_SubRegion> a_path, fu::view<char> b, fu::vec<fu::vec<s_SubRegion>>& result, fu::vec<s_SubRegion>& inter, const s_TokenIdx& _here, const s_Context& ctx)
{
    parsePaths_each_abvpIgR7(b, a_path, result, inter, _here, ctx);
}
                                #endif

                                #ifndef DEF___eVRvg5TmxF2
                                #define DEF___eVRvg5TmxF2
inline static void _eVRvg5Tm(fu::view<s_SubRegion> path, fu::view<char> b, fu::vec<fu::vec<s_SubRegion>>& result, fu::vec<s_SubRegion>& inter, const s_TokenIdx& _here, const s_Context& ctx)
{
    _wzeZSYWj(path, b, result, inter, _here, ctx);
}
                                #endif

                                #ifndef DEF_parsePaths_each_3Y9qs3EE0kg
                                #define DEF_parsePaths_each_3Y9qs3EE0kg
inline static void parsePaths_each_3Y9qs3EE(fu::view<char> str, fu::view<char> b, fu::vec<fu::vec<s_SubRegion>>& result, fu::vec<s_SubRegion>& inter, const s_TokenIdx& _here, const s_Context& ctx)
{
    fu::vec<s_SubRegion> path {};
    int _o = 0;
    for (; ; )
    {
        ...
        _eVRvg5Tm(path, b, result, inter, _here, ctx);
        if (isLastPath)
            break;
...
void Paths_inter(fu::str& str, fu::view<char> a, fu::view<char> b, const s_TokenIdx& _here, const s_Context& ctx)
{
    ...
    else
    {
        ...
        parsePaths_each_3Y9qs3EE(a, b, result, inter, _here, ctx);
        appendPaths(str, result, true, true, _here, ctx);
    };
}

                                #ifndef DEF___R9H4KG0qO08
                                #define DEF___R9H4KG0qO08
inline static void _R9H4KG0q(fu::view<char> r_both, fu::view<char> sr_left, fu::view<char> sr_right, s_Lifetime& result, fu::str& inter, const s_TokenIdx& _here, const s_Context& ctx)
{
    fu::view<char> BL_1_v {};
    ...
    { {
        ...
        for (; ; )
        {
            ...
            if (cmp == 0)
            {
                l_dirty = true;
                r_dirty = true;
                _R9H4KG0q(fu::get_view(l_chars, l_start, l_paths0), fu::get_view(l_chars, l_paths0, l_offset), fu::get_view(r_chars, r_paths0, r_offset), result, inter, _here, ctx);
            }
            else if (cmp < 0)
                l_dirty = true;
            else
...
inline static bool Paths_hasInter_1Eirzmpy(fu::view<char> a, fu::view<char> b, const s_TokenIdx& _here, const s_Context& ctx)
{
    ...
    return false;
                                ...
                                #ifndef DEF___R7LESGxjNfl
                                #define DEF___R7LESGxjNfl
inline static void _R7LESGxj(const int locid, fu::view<char> sr_left, fu::view<char> sr_right, fu::vec<int>& result, const s_TokenIdx& _here, const s_Context& ctx)
{
    if (!(!locid))
    {
        if ((sr_left == sr_right) || (sr_left == SR_empty) || (sr_right == SR_empty) || Paths_hasInter_1Eirzmpy(sr_left, sr_right, _here, ctx))
            result += locid;
...
bool Lifetime_has_UkiI9X8L(const s_Lifetime& lifetime, const int search)
{
    return Lifetime_some_NyZgybmE(lifetime, search);
                                ...
                                #ifndef DEF___ftuzssfBGQ6
                                #define DEF___ftuzssfBGQ6
inline static void _ftuzssfB(const bool isLastPath, fu::view<char> raw_prefix, const int parent_flatCount, const int parent_flatOffset, fu::str& result, const int deref_flatCount, const s_TokenIdx& _here, const s_Context& ctx)
{
    ...
    else
    {
        BUG_u9Gbkniv((x7E_3lDd4lqo("Lifetime_op_deref: parent_flatCount("_fu, fu::i64dec(parent_flatCount)) + ") != 1"_fu), _here, ctx);
                                ...
                                #ifndef DEF___IyPboECqd58
                                #define DEF___IyPboECqd58
inline static void _IyPboECq(fu::view<char> paths, fu::str& result, const int deref_flatCount, const s_TokenIdx& _here, const s_Context& ctx)
{
    int offset = 0;
    for (; ; )
    {
        ...
        for (; ; )
        {
            ...
            if (isLastSubRegion)
            {
                _ftuzssfB(isLastPath, fu::get_view(paths, path0, subregion0), flatCount, flatOffset, result, deref_flatCount, _here, ctx);
                break;
            }
            else
                isFirstSubRegion = false;
    ...
    if (!(offset == paths.size()))
        BUG_u9Gbkniv("walkPaths(!tailOK): excess bytes"_fu, _here, ctx);
                                ...
                                #ifndef DEF___BxPS5tOgTXg
                                #define DEF___BxPS5tOgTXg
inline static void _BxPS5tOg(fu::view<char> r_raw, fu::view<char> paths, const int locid, const int minPathDepth, fu::str& result, const int deref_flatCount, const s_TokenIdx& _here, const s_Context& ctx)
{
    result += r_raw;
    if (paths == SR_empty)
        result += paths;
    else if (locid)
    {
        ...
        _IyPboECq(paths, result, deref_flatCount, _here, ctx);
    ...
    else
    {
        BUG_u9Gbkniv("Lifetime_op: non-locid non-x00x00 subregion."_fu, _here, ctx);
                                ...
                                #ifndef DEF_Lifetime_each_o5D7nIKiDcc
                                #define DEF_Lifetime_each_o5D7nIKiDcc
inline void Lifetime_each_o5D7nIKi(const s_Lifetime& lifetime, const int minPathDepth, fu::str& result, const int deref_flatCount, const s_TokenIdx& _here, const s_Context& ctx)
{
    // Hoisted:
    int offset0_1;
    ...
    while (offset < chars.size())
    {
        ...
        (void)0;}), BL_3_v);
        int BL_11_v {};
        _BxPS5tOg(fu::get_view(chars, offset0, sr), fu::get_view(chars, sr, offset), ((r & 1u) ? 0 : (__extension__ (
        {
            const unsigned v = (r >> 1u);
            BL_11_v = (int(((v >> 1u) ^ ((v & 1u) ? 0xffffffffu : 0x0u))));
...
s_Lifetime Lifetime_op_deref_7Yz9ezW2(const s_Lifetime& lt, const int deref_flatCount, const s_TokenIdx& _here, const s_Context& ctx)
{
    ...
    /*MOV*/ fu::str result {};
    Lifetime_each_o5D7nIKi(lt, minPathDepth, result, deref_flatCount, _here, ctx);
...
s_Lifetime Lifetime_makeShared_7Yz9ezW2(const s_Lifetime& lifetime, const int flatCount, const s_TokenIdx& _here, const s_Context& ctx)
{
    return Lifetime_union_7Yz9ezW2(Lifetime_op_deref_7Yz9ezW2(lifetime, flatCount, _here, ctx), Lifetime_static_immoveable, false, _here, ctx);
                                ...
                                #ifndef DEF___8YCEC2K7cxb
                                #define DEF___8YCEC2K7cxb
inline static void _8YCEC2K7(const bool isLastSubRegion, const bool isLastPath, fu::view<char> raw_prefix, const int struct_flatCount, const int struct_flatOffset, fu::str& result, const int flatCount, const int flatOffset, const s_TokenIdx& _here, const s_Context& ctx)
{
    ...
    else
    {
        BUG_u9Gbkniv((x7E_3lDd4lqo(((x7E_3lDd4lqo(((x7E_3lDd4lqo("Lifetime_op_field: field.flatOffset("_fu, fu::i64dec(flatOffset)) + ")"_fu) + " + field.flatCount("_fu), fu::i64dec(flatCount)) + ")"_fu) + " !<= struct.flatCount("_fu), fu::i64dec(struct_flatCount)) + ")"_fu), _here, ctx);
                                ...
                                #ifndef DEF___HSIIN3ygLYa
                                #define DEF___HSIIN3ygLYa
inline static void _HSIIN3yg(fu::view<char> paths, fu::str& result, const int flatCount, const int flatOffset, const s_TokenIdx& _here, const s_Context& ctx)
{
    int offset = 0;
    for (; ; )
    {
        ...
        for (; ; )
        {
            ...
            if (isLastSubRegion)
            {
                _8YCEC2K7(isLastSubRegion, isLastPath, fu::get_view(paths, path0, subregion0), flatCount_1, flatOffset_1, result, flatCount, flatOffset, _here, ctx);
                break;
            }
            else
                isFirstSubRegion = false;
    ...
    if (!(offset == paths.size()))
        BUG_u9Gbkniv("walkPaths(!tailOK): excess bytes"_fu, _here, ctx);
                                ...
                                #ifndef DEF___3u6oKBdt5b2
                                #define DEF___3u6oKBdt5b2
inline static void _3u6oKBdt(fu::view<char> r_raw, fu::view<char> paths, const int locid, const int minPathDepth, fu::str& result, const int flatCount, const int flatOffset, const s_TokenIdx& _here, const s_Context& ctx)
{
    result += r_raw;
    if (paths == SR_empty)
        result += paths;
    ...
    {
        const int result0 = result.size();
        _HSIIN3yg(paths, result, flatCount, flatOffset, _here, ctx);
        assertPathsValid_7Yz9ezW2(fu::get_view(result, result0), -1, -1, false, minPathDepth, _here, ctx);
    }
    else
    {
        BUG_u9Gbkniv("Lifetime_op: non-locid non-x00x00 subregion."_fu, _here, ctx);
                                ...
                                #ifndef DEF_Lifetime_each_MtC8U3oy0o0
                                #define DEF_Lifetime_each_MtC8U3oy0o0
inline void Lifetime_each_MtC8U3oy(const s_Lifetime& lifetime, const int minPathDepth, fu::str& result, const int flatCount, const int flatOffset, const s_TokenIdx& _here, const s_Context& ctx)
{
    // Hoisted:
    int offset0_1;
    ...
    while (offset < chars.size())
    {
        ...
        (void)0;}), BL_3_v);
        int BL_11_v {};
        _3u6oKBdt(fu::get_view(chars, offset0, sr), fu::get_view(chars, sr, offset), ((r & 1u) ? 0 : (__extension__ (
        {
            const unsigned v = (r >> 1u);
            BL_11_v = (int(((v >> 1u) ^ ((v & 1u) ? 0xffffffffu : 0x0u))));
...
s_Lifetime Lifetime_op_field_7Yz9ezW2(const s_Lifetime& lt, const int flatCount, const int flatOffset, const s_TokenIdx& _here, const s_Context& ctx)
{
    ...
    /*MOV*/ fu::str result {};
    Lifetime_each_MtC8U3oy(lt, minPathDepth, result, flatCount, flatOffset, _here, ctx);
    return s_Lifetime { static_cast<fu::str&&>(result) };
}
...
inline static void _ifWEydLn(const bool child_isFirstSubRegion, const bool child_isLastSubRegion, const bool child_isLastPath, const int child_flatCount, const int child_flatOffset, const bool parent_isLastPath, const int parent_flatCount, const int parent_flatOffset, fu::view<char> parent_rawPrefix, fu::str& result, const s_TokenIdx& _here, const s_Context& ctx)
{
    ...
    if ((result_flatOffset >= 0) && (child_flatCount > 0) && (child_isLastSubRegion || (child_flatCount == 1)))
    {
        ...
        BUG_u9Gbkniv((x7E_3lDd4lqo(((x7E_3lDd4lqo(((x7E_3lDd4lqo("appendSubRegion: flatCount("_fu, fu::i64dec(child_flatCount)) + ")"_fu) + " flatOffset("_fu), fu::i64dec(result_flatOffset)) + ")"_fu) + " isLastSubRegion("_fu), fu::booldec(child_isLastSubRegion)) + ")"_fu), _here, ctx);
                                ...
                                #ifndef DEF___SeyRWJ2spu9
                                #define DEF___SeyRWJ2spu9
inline static void _SeyRWJ2s(const bool parent_isLastPath, const int parent_flatCount, const int parent_flatOffset, fu::view<char> parent_rawPrefix, fu::str& result, fu::view<char> child, const s_TokenIdx& _here, const s_Context& ctx)
{
    int _c0 = 0;
    for (; ; )
    {
        ...
        for (; ; )
        {
            ...
            const int flatCount = int((raw_flatCount >> 1u));
            const int flatOffset = int((raw_flatOffset >> 1u));
            _ifWEydLn(isFirstSubRegion, isLastSubRegion, isLastPath, flatCount, flatOffset, parent_isLastPath, parent_flatCount, parent_flatOffset, parent_rawPrefix, result, _here, ctx);
            if (isLastSubRegion)
                break;
            else
                isFirstSubRegion = false;
    ...
    if (!(_c0 == child.size()))
        BUG_u9Gbkniv("walkPaths(!tailOK): excess bytes"_fu, _here, ctx);
                                ...
                                #ifndef DEF___Q4AEkf2OnNf
                                #define DEF___Q4AEkf2OnNf
inline static void _Q4AEkf2O(fu::view<char> parent, fu::str& result, fu::view<char> child, const s_TokenIdx& _here, const s_Context& ctx)
{
    int _p0 = 0;
    for (; ; )
    {
        ...
        for (; ; )
        {
            ...
            if (isLastSubRegion)
            {
                _SeyRWJ2s(isLastPath, flatCount, flatOffset, fu::get_view(parent, path0, subregion0), result, child, _here, ctx);
                break;
            }
            else
                isFirstSubRegion = false;
    ...
    if (!(_p0 == parent.size()))
        BUG_u9Gbkniv("walkPaths(!tailOK): excess bytes"_fu, _here, ctx);
                                ...
                                #ifndef DEF___7hE26XaNJi6
                                #define DEF___7hE26XaNJi6
inline static void _7hE26XaN(fu::view<char> r_raw, fu::view<char> paths, const int locid, const int minPathDepth, fu::str& result, fu::view<char> child, const s_TokenIdx& _here, const s_Context& ctx)
{
    result += r_raw;
    if (paths == SR_empty)
        result += paths;
    ...
    {
        const int result0 = result.size();
        _Q4AEkf2O(paths, result, child, _here, ctx);
        assertPathsValid_7Yz9ezW2(fu::get_view(result, result0), -1, -1, false, minPathDepth, _here, ctx);
    }
    else
    {
        BUG_u9Gbkniv("Lifetime_op: non-locid non-x00x00 subregion."_fu, _here, ctx);
                                ...
                                #ifndef DEF_Lifetime_each_nAn61USELX8
                                #define DEF_Lifetime_each_nAn61USELX8
inline void Lifetime_each_nAn61USE(const s_Lifetime& lifetime, const int minPathDepth, fu::str& result, fu::view<char> child, const s_TokenIdx& _here, const s_Context& ctx)
{
    // Hoisted:
    int offset0_1;
    ...
    while (offset < chars.size())
    {
        ...
        (void)0;}), BL_3_v);
        int BL_11_v {};
        _7hE26XaN(fu::get_view(chars, offset0, sr), fu::get_view(chars, sr, offset), ((r & 1u) ? 0 : (__extension__ (
        {
            const unsigned v = (r >> 1u);
            BL_11_v = (int(((v >> 1u) ^ ((v & 1u) ? 0xffffffffu : 0x0u))));
...
s_Lifetime Lifetime_op_join_7Yz9ezW2(const s_Lifetime& lt, fu::view<char> child, const s_TokenIdx& _here, const s_Context& ctx)
{
    const int minPathDepth = 1;
    /*MOV*/ fu::str result {};
    Lifetime_each_nAn61USE(lt, minPathDepth, result, child, _here, ctx);
    return s_Lifetime { static_cast<fu::str&&>(result) };
}
