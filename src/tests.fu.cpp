...
fu::str serialize_pXriHDvy(const s_TestDiffs&);
s_Errno write_VWJwj7Fs(fu::str&&, fu::view<char>, unsigned);
s_Context ZERO_5TaNJXGQ(const fu::str&, s_TestDiffs&);
...
void runTests()
{
    /*MOV*/ fu::str TESTDIFFS_FILE = (FU_ROOT + "testdiff/now.td"_fu);
    s_TestDiffs testdiffs = s_TestDiffs{};
    fu_DEFER_IF_OK(write_VWJwj7Fs(static_cast<fu::str&&>(TESTDIFFS_FILE), serialize_pXriHDvy(testdiffs), RW_RW_RW));
