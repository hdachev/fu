...
static const fu::str str_AqvjbvzTLqd fu_INIT_PRIORITY(1004) { "Target: bad modid/index/locid"_fu };
                                #endif

                                #ifndef STR_bg9HgDuJKb5
                                #define STR_bg9HgDuJKb5
static const fu::str str_bg9HgDuJKb5 fu_INIT_PRIORITY(1004) { "appendLocalOrGlobal: bad modid/globid/locid"_fu };
                                #endif

                                #ifndef STR_hUQu2sji4gh
                                #define STR_hUQu2sji4gh
static const fu::str str_hUQu2sji4gh fu_INIT_PRIORITY(1004) { "appendGlobal: bad modid/globid/locid"_fu };
                                #endif
...
bool isRTL_xQNS(const Overload_OYmb& o)
{
    return !!SolverStatus_h9em((o.status & SolverStatus_h9em_SS_FN_OOE_RTL));
}

void isRTL_set_xQNS(Overload_OYmb& o, const bool rtl)
{
    if (rtl)
...
const Token_RpL8& _token_xQNS(const TokenIdx_5b85& idx, const Context_UXD9& ctx)
{
    return ctx.modules[idx.modid].in.lex.tokens[idx.tokidx];
}

const fu::str& _fname_xQNS(const TokenIdx_5b85& idx, const Context_UXD9& ctx)
{
