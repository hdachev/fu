...
fu::str serialize_UvH3(const ClosureID_qHEW& _, const Context_AtCH& ctx, const TokenIdx_5581& _here)
{
...
ClosureID_qHEW tryParseClosureID_UvH3(fu::view<char> id, const Context_AtCH& ctx, const TokenIdx_5581& _here)
{
    if ((id.size() > 3) && (id[0] == '`'))
    {
        int offset = 1;
