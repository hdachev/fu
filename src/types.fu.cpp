...
bool isCanonAssignable_Ot6w(fu::view<char>, fu::view<char>, const Context_AtCH&, const TokenIdx_5581&);
void Lifetime_add_7Yz9(Lifetime_llCF&, const Lifetime_llCF&, bool, const Context_AtCH&, const TokenIdx_5581&);
bool is_sliceable_hxWW(const ValueType_JtNg&);
Lifetime_llCF Lifetime_op_field_7Yz9(const Lifetime_llCF&, int, int, const Context_AtCH&, const TokenIdx_5581&);
...
fu::vec_range<char> canon_trySuper_Ot6w(fu::vec_range<char>, fu::vec_range<char>, const Context_AtCH&, const TokenIdx_5581&);
Type_OiTm type_trySuper_9CJm(const Type_OiTm&, const Type_OiTm&, bool, const Context_AtCH&, const TokenIdx_5581&);
Lifetime_llCF Lifetime_union_7Yz9(const Lifetime_llCF&, const Lifetime_llCF&, bool, const Context_AtCH&, const TokenIdx_5581&);
fu::vec_range<char> canon_tryIntersect_Ot6w(fu::vec_range<char>, fu::vec_range<char>, const Context_AtCH&, const TokenIdx_5581&);
Lifetime_llCF Lifetime_inter_7Yz9(const Lifetime_llCF&, const Lifetime_llCF&, const Context_AtCH&, const TokenIdx_5581&);
...
bool propositionOK_9CJm(const Type_OiTm& type, const bool vfactsOK, const Context_AtCH& ctx, const TokenIdx_5581& _here)
{
...
bool is_void_or_propositionOK_9CJm(const Type_OiTm& type, const bool vfactsOK, const Context_AtCH& ctx, const TokenIdx_5581& _here)
{
...
bool areVFactsAssignable_9CJm(const VFacts_xhRf host, const VFacts_xhRf guest, const Context_AtCH& ctx, const TokenIdx_5581& _here)
{
...
bool isAssignableAsArgument_9CJm(const ValueType_JtNg& host, const ValueType_JtNg& guest, const bool DONT_match_zeroes, const Context_AtCH& ctx, const TokenIdx_5581& _here)
{
    if (host && guest)
...
bool isAssignable_9CJm(const Type_OiTm& host, const Type_OiTm& guest, const bool DONT_match_zeroes, const bool asArgument, const Context_AtCH& ctx, const TokenIdx_5581& _here)
{
...
bool is_mutref_9CJm(const Type_OiTm& type, const Context_AtCH& ctx, const TokenIdx_5581& _here)
{
...
Type_OiTm add_ref_9CJm(/*MOV*/ Type_OiTm&& type, const Lifetime_llCF& lifetime, const Context_AtCH& ctx, const TokenIdx_5581& _here)
{
...
Type_OiTm add_mutref_9CJm(/*MOV*/ Type_OiTm&& type, const Lifetime_llCF& lifetime, const Context_AtCH& ctx, const TokenIdx_5581& _here)
{
...
Type_OiTm definitType_9CJm(/*MOV*/ Type_OiTm&& type, const bool asTypename, const Context_AtCH& ctx, const TokenIdx_5581& _here)
{
...
Type_OiTm tryClearRefs_9CJm(const Type_OiTm& type, const bool mutref, const Context_AtCH& ctx, const TokenIdx_5581& _here)
{
...
Type_OiTm tryClear_mutref_9CJm(const Type_OiTm& type, const Context_AtCH& ctx, const TokenIdx_5581& _here)
{
    return tryClearRefs_9CJm(type, true, ctx, _here);
}

Type_OiTm tryClear_ref_9CJm(const Type_OiTm& type, const Context_AtCH& ctx, const TokenIdx_5581& _here)
{
    return tryClearRefs_9CJm(type, false, ctx, _here);
}

Type_OiTm make_field_reference_9CJm(const unsigned quals, const Lifetime_llCF& lifetime, /*MOV*/ Type_OiTm&& to, const int memberFlatOffset, const int memberFlatCount, const Context_AtCH& ctx, const TokenIdx_5581& _here)
{
...
Type_OiTm createSlice_9CJm(const Type_OiTm& item, const Lifetime_llCF& lifetime, const Context_AtCH& ctx, const TokenIdx_5581& _here)
{
...
Type_OiTm tryClear_array_9CJm(const Type_OiTm& type, const Context_AtCH& ctx, const TokenIdx_5581& _here, const Module_GQwr& module)
{
...
Type_OiTm type_trySuper_9CJm(const Type_OiTm& a, const Type_OiTm& b, const bool DONT_match_zeroes, const Context_AtCH& ctx, const TokenIdx_5581& _here)
{
...
Type_OiTm type_tryIntersect_9CJm(const Type_OiTm& a, const Type_OiTm& b, const Context_AtCH& ctx, const TokenIdx_5581& _here)
{
...
unsigned mask_retval_relaxable_9CJm(const Type_OiTm& type, const unsigned relaxed_quals, const Context_AtCH& ctx, const TokenIdx_5581& _here)
{
