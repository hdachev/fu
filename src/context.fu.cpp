...
fu::str resolveFile_1qjp(fu::vec_range<char>, fu::view<char>, Context_AtCH&);
...
Shape_fvCX getShape_1qjp(const ValueType_JtNg&, const Context_AtCH&, const TokenIdx_5581&, const Module_GQwr&);
...
Struct_LDkB& lookupUserType_mut_1qjp(fu::view<char> canon, Module_GQwr& module, const Context_AtCH& ctx, const TokenIdx_5581& _here)
{
...
static fu::str tryResolve_1qjp(fu::vec_range<char> from, fu::view<char> name, fu::vec_range<char> path, Context_AtCH& ctx)
{
...
fu::str resolveFile_1qjp(fu::vec_range<char> from, fu::view<char> name, Context_AtCH& ctx)
{
    fu::str path = (from + name);
    fu::vec_range<char> cached = get_5pgj(ctx.fuzzy, path);
    if (cached)
    {
        if (cached == "\v"_view)
        {
    ...
    else
    {
        ...
        set_Z3Rq(ctx.fuzzy, path, (resolve ? resolve : str_DtiAaUK6319));
        return /*NRVO*/ resolve;
    };
}

                                #ifndef DEF_run_OZhyAPQeG2d
                                #define DEF_run_OZhyAPQeG2d
inline static fu::str run_OZhy(fu::vec_range<char> from, fu::view<char> name, fu::view<char> alt, fu::view<char> nested, Context_AtCH& ctx)
{
    fu::str _0 {};
...
fu::str testSuite_resolvePrepopulatedFile_1qjp(fu::view<char> from, fu::view<char> name, const Context_AtCH& ctx)
{
    /*MOV*/ fu::str prepopulated = (from + name);
    if (has_xfOV(ctx.files, prepopulated))
    ...
    else
    {
        return fu::str{};
                                ...
                                #ifndef DEF_run_pACRHxQQvge
                                #define DEF_run_pACRHxQQvge
inline static fu::str run_pACR(fu::view<char> from, fu::view<char> name, fu::view<char> alt, fu::view<char> nested, const Context_AtCH& ctx)
{
    fu::str _0 {};
...
fu::str resolveFile_SqDq(fu::vec_range<char> path, Context_AtCH& ctx)
{
    ...
    if ((fuz_idx > 0) && (fuz_idx < (path.size() - 1)) && (find_rkz0(path, '\v', (fuz_idx + 1)) < 0))
    {
        ...
        fu::str _0 {};
        /*MOV*/ fu::str file = ((_0 = run_OZhy(from, name, alt, nested, ctx)) ? static_cast<fu::str&&>(_0) : run_pACR(from, name, alt, nested, ctx));
        if (file)
            return /*NRVO*/ file;
...
fu::str getFile_1qjp(fu::vec_range<char> path, Context_AtCH& ctx)
{
    fu::vec_range<char> cached = get_5pgj(ctx.files, path);
    if (cached)
    {
        if (cached == "\v"_view)
        {
    ...
    else
    {
        ...
        {
            set_Z3Rq(ctx.files, path, (data ? data : str_DtiAaUK6319));
            return /*NRVO*/ data;
        };
    };
}

Module_GQwr& getModule_1qjp(fu::vec_range<char> fname, Context_AtCH& ctx)
{
    ...
    ctx.modules.push(Module_GQwr { i_1, fu::str(fname), ModuleInputs_iQIg{}, ModuleOrder_HMNg{}, ModuleOutputs_mPlY{}, ModuleStats_ANTR{}, Profile_4UPJ{} });
...
void setModule_1qjp(const Module_GQwr& module, Context_AtCH& ctx)
{
    Module_GQwr& current = ctx.modules.mutref(module.modid);
    if (current.fname == module.fname)
        current = clone_WZpR(module);
    else
        fu::fail(fu::str(str_jE83FbiGwHf));

}

const Struct_LDkB& lookupUserType_1qjp(const StructCanon_TixV& scp, const Module_GQwr& module, const Context_AtCH& ctx, const TokenIdx_5581& _here)
{
    if (scp.modid == module.modid)
    {
...
const Struct_LDkB& lookupUserType_SqDq(const ValueType_JtNg& type, const Context_AtCH& ctx, const TokenIdx_5581& _here, const Module_GQwr& module)
{
    return lookupUserType_1qjp(parseStructCanon_p1TN(type.canon), module, ctx, _here);
}

bool is_trivial_1qjp(const ValueType_JtNg& type, const Context_AtCH& ctx, const TokenIdx_5581& _here, const Module_GQwr& module)
{
    return is_primitive_hxWW(type) || (isStruct_p1TN(type) ? !lookupUserType_SqDq(type, ctx, _here, module).shape.non_triv_mask : false);
}

bool is_reinterpretable_1qjp(const ValueType_JtNg& type, const Context_AtCH& ctx, const TokenIdx_5581& _here, const Module_GQwr& module)
{
...
const Struct_LDkB& tryLookupUserType_1qjp(const ValueType_JtNg& type, const Context_AtCH& ctx, const TokenIdx_5581& _here, const Module_GQwr& module)
{
    if (isStruct_p1TN(type) || (is_primitive_hxWW(type) ? (basePrimPrefixLen_hxWW(type.canon) < type.canon.size()) : false))
...
const Set_qOJY& lookupTypeImports_1qjp(const ValueType_JtNg& type, const Context_AtCH& ctx, const TokenIdx_5581& _here, const Module_GQwr& module)
{
    return tryLookupUserType_1qjp(type, ctx, _here, module).imports;
}

const fu::vec<Target_VZrr>& lookupTypeConverts_1qjp(const ValueType_JtNg& type, const Context_AtCH& ctx, const TokenIdx_5581& _here, const Module_GQwr& module)
{
...
int getFlatCount_1qjp(const ValueType_JtNg& type, const Context_AtCH& ctx, const TokenIdx_5581& _here, const Module_GQwr& module)
{
...
ValueType_JtNg parseType_1qjp(fu::view<char> str, const Context_AtCH& ctx, const TokenIdx_5581& _here, const Module_GQwr& module)
{
    int offset {};
...
Shape_fvCX getShape_1qjp(const ValueType_JtNg& type, const Context_AtCH& ctx, const TokenIdx_5581& _here, const Module_GQwr& module)
{
    const Struct_LDkB& s = tryLookupUserType_1qjp(type, ctx, _here, module);
    if (s)
...
bool is_zst_1qjp(const ValueType_JtNg& type, const Context_AtCH& ctx, const TokenIdx_5581& _here, const Module_GQwr& module)
{
    return !getFlatCount_1qjp(type, ctx, _here, module);
}

fu::vec_range<char> getShortModuleName_1qjp(fu::vec_range<char> fname, const Context_AtCH& ctx, const TokenIdx_5581& _here)
{
...
Type_OiTm tryClear_sliceable_1qjp(const ValueType_JtNg& type, const Context_AtCH& ctx, const TokenIdx_5581& _here, const Module_GQwr& module)
{
...
Type_OiTm clear_sliceable_1qjp(const ValueType_JtNg& type, const Context_AtCH& ctx, const TokenIdx_5581& _here, const Module_GQwr& module)
{
    if (is_sliceable_hxWW(type))
    {
        /*MOV*/ ValueType_JtNg vtype = parseType_1qjp(fu::get_view(type.canon, 1, (type.canon.size() - 1)), ctx, _here, module);
