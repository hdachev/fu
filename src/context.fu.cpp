...
fu::str resolveFile(const fu::str& from, fu::view<char> name, s_Context& ctx)
{
    ...
    else
    {
        ...
        return /*NRVO*/ resolve;
                                ...
                                #ifndef DEF_run_2WzbWlU8C1f
                                #define DEF_run_2WzbWlU8C1f
inline static fu::str run_2WzbWlU8(const fu::str& from, fu::view<char> name, fu::view<char> alt, fu::view<char> nested, s_Context& ctx)
{
    fu::str _0 {};
...
fu::str testSuite_resolvePrepopulatedFile(fu::view<char> from, fu::view<char> name, const s_Context& ctx)
{
    ...
    else
    {
        return fu::str{};
                                ...
                                #ifndef DEF_run_zuA4oGnSQa4
                                #define DEF_run_zuA4oGnSQa4
inline static fu::str run_zuA4oGnS(fu::view<char> from, fu::view<char> name, fu::view<char> alt, fu::view<char> nested, const s_Context& ctx)
{
    fu::str _0 {};
...
fu::str resolveFile_SqDqFcFw(const fu::str& path, s_Context& ctx)
{
    ...
    if ((fuz_idx > 0) && (fuz_idx < (path.size() - 1)) && (find_tnDs1wBz(path, '\v', (fuz_idx + 1)) < 0))
    {
        ...
        fu::str _0 {};
        /*MOV*/ fu::str file = ((_0 = run_2WzbWlU8(from, name, alt, nested, ctx)) ? static_cast<fu::str&&>(_0) : run_zuA4oGnS(from, name, alt, nested, ctx));
        if (file)
            return /*NRVO*/ file;
