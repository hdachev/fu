...
s_UserType& lookupUserType_mut_1qjplDUo(fu::view<char> canon, s_Module& module, const s_TokenIdx& _here, const s_Context& ctx)
{
    const s_UserTypeCanon scp = parseUserTypeCanon_27MV22ZA(canon);
...
fu::str resolveFile(const fu::str& from, fu::view<char> name, s_Context& ctx)
{
    ...
    else
    {
        ...
        return /*NRVO*/ resolve;
                                ...
                                #ifndef DEF_run_7CrMMUv0h2g
                                #define DEF_run_7CrMMUv0h2g
inline static fu::str run_7CrMMUv0(const fu::str& from, fu::view<char> name, fu::view<char> alt, fu::view<char> nested, s_Context& ctx)
{
    fu::str _0 {};
...
fu::str testSuite_resolvePrepopulatedFile(fu::view<char> from, fu::view<char> name, const s_Context& ctx)
{
    ...
    else
    {
        return fu::str{};
                                ...
                                #ifndef DEF_run_BEu5Cmr6p64
                                #define DEF_run_BEu5Cmr6p64
inline static fu::str run_BEu5Cmr6(fu::view<char> from, fu::view<char> name, fu::view<char> alt, fu::view<char> nested, const s_Context& ctx)
{
    fu::str _0 {};
...
fu::str resolveFile_SqDqFcFw(const fu::str& path, s_Context& ctx)
{
    ...
    if ((fuz_idx > 0) && (fuz_idx < (path.size() - 1)) && (find_tnDs1wBz(path, '\v', (fuz_idx + 1)) < 0))
    {
        ...
        fu::str _0 {};
        /*MOV*/ fu::str file = ((_0 = run_7CrMMUv0(from, name, alt, nested, ctx)) ? static_cast<fu::str&&>(_0) : run_BEu5Cmr6(from, name, alt, nested, ctx));
        if (file)
            return /*NRVO*/ file;
