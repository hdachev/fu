...
inline constexpr s_DEV_OnFail MASK_s_DEV_OnFail
    ...
    | s_DEV_OnFail_OnFail_WriteRepro;
                                ...
                                #ifndef DEF___HE5kQwvjAj0
                                #define DEF___HE5kQwvjAj0
inline static fu::view<char> _HE5kQwvj(const s_TokenIdx& token, const int i, fu::view<s_TokenIdx> via, fu::str& error, const s_Context& ctx)
{
    return (error += FAIL_text_u9Gbkniv(fu::vec<s_TokenIdx> { fu::slate<1, s_TokenIdx> { s_TokenIdx(token) } }, ((i == (via.size() - 1)) ? "Resulting in an import circle, not currently supported."_fu : "Imports:\n"_fu), ctx));
                                ...
                                #ifndef DEF_each_9LJzH3BIdvb
                                #define DEF_each_9LJzH3BIdvb
inline void each_9LJzH3BI(fu::view<s_TokenIdx> a, fu::view<s_TokenIdx> via, fu::str& error, const s_Context& ctx)
{
    for (int i = 0; i < a.size(); i++)
        _HE5kQwvj(a[i], i, via, error, ctx);
...
inline const s_ModuleOrder& clone_BW5ZEuMh(const s_ModuleOrder& a)
{
    return a;
                                ...
                                #ifndef DEF_clone_Pxs7DpInv1e
                                #define DEF_clone_Pxs7DpInv1e
inline const fu::vec<s_UserType>& clone_Pxs7DpIn(const fu::vec<s_UserType>& a)
{
    return a;
}
                                #endif
...
inline const s_CodegenOutput& clone_nZUtjGKt(const s_CodegenOutput& a)
{
    return a;
                                ...
                                #ifndef DEF_clone_SclEafBRKfj
                                #define DEF_clone_SclEafBRKfj
inline s_ModuleOutputs clone_SclEafBR(const s_ModuleOutputs& a)
{
    /*MOV*/ s_ModuleOutputs res {};

    {
        res.types = clone_Pxs7DpIn(a.types);
...
inline const s_Profile& clone_HRvYlzuk(const s_Profile& a)
{
    return a;
                                ...
                                #ifndef DEF_clone_0v1CBXDy1I8
                                #define DEF_clone_0v1CBXDy1I8
inline s_Module clone_0v1CBXDy(const s_Module& a)
{
    /*MOV*/ s_Module res {};
...
inline bool starts_hRi5tkxn(fu::view<char> a, fu::view<char> with)
{
    return (a.size() >= with.size()) && (fu::get_view_start0(a, with.size()) == with);
                                ...
                                #ifndef DEF___2ejNNCVzXZ2
                                #define DEF___2ejNNCVzXZ2
inline static void _2ejNNCVz(s_Import& import, fu::view<s_TokenIdx> via, fu::view<char> dir, s_Context& ctx, s_Module& module, const s_Options& options)
{
    ...
    if ((module.order.dep_depth <= other.order.dep_depth))
        module.order.dep_depth = (other.order.dep_depth + 1);
                                ...
                                #ifndef DEF_each_gXf39OZPhz7
                                #define DEF_each_gXf39OZPhz7
inline void each_gXf39OZP(fu::view_mut<s_Import> a, fu::view<s_TokenIdx> via, fu::view<char> dir, s_Context& ctx, s_Module& module, const s_Options& options)
{
    for (int i = 0; i < a.size(); i++)
    {
        s_Import* _0;
        (_0 = &(a.mutref(i)), _2ejNNCVz(*_0, via, dir, ctx, module, options));
    };
}
                                #endif
...
s_ModidAndOrder compile_lexParseDeps(const fu::str& fname, fu::view<s_TokenIdx> via, s_Context& ctx, const s_Options& options)
{
    ...
    if (module.in)
    {
        ...
        else
        {
            ...
            each_9LJzH3BI(via, via, error, ctx);
            fu::fail(static_cast<fu::str&&>(error));
        };
    }
    else
    {
        s_Module module_1 = clone_0v1CBXDy(module);
        if (module_1.out)
        ...
        else
        {
            ...
            else
            {
                ...
                if (!module_1.order)
                {
                    ...
                    each_gXf39OZP(imports, via, dir, ctx, module_1, options);
...
inline fu::str x7E_3lDd4lqo(fu::view<char> a, fu::view<char> b)
{
    return a + b;
                                ...
                                #ifndef DEF___Ul6Jcw0U9xc
                                #define DEF___Ul6Jcw0U9xc
inline static s_Result _Ul6Jcw0U(const int modid, const s_Context& ctx, const s_Options& options)
{
    ...
    {
    {
        ...
        {
            /*MOV*/ s_Module module_1 = clone_0v1CBXDy(module);
...
;
                                ...
                                #ifndef DEF___I2lcUA9M8xa
                                #define DEF___I2lcUA9M8xa
inline static const s_Result& _I2lcUA9M(const int i, fu::view<int> arr, fu::view_mut<s_Result> result, const s_Context& ctx, const s_Options& options)
{
    return (result.mutref(i) = _Ul6Jcw0U(arr[i], ctx, options));
}
                                #endif

                                #ifndef DEF_parallel_for_mpUDgbUphb0
                                #define DEF_parallel_for_mpUDgbUphb0
inline static void parallel_for_mpUDgbUp(const int min, int end, fu::view<int> arr, fu::view_mut<s_Result> result, const s_Context& ctx, const s_Options& options)
{
    int start = (end & 0);
    (void) start;
    ...
    for (int i = start; i < end; i++)
        _I2lcUA9M(i, arr, result, ctx, options);
                                ...
                                #ifndef DEF_map_m9tusTUiq22
                                #define DEF_map_m9tusTUiq22
inline fu::vec<s_Result> map_m9tusTUi(fu::view<int> arr, const int min, const s_Context& ctx, const s_Options& options)
{
    /*MOV*/ fu::vec<s_Result> result {};
    result.grow<false>(arr.size());
    parallel_for_mpUDgbUp(min, arr.size(), arr, result, ctx, options);
    return /*NRVO*/ result;
}
                                #endif

                                #ifndef DEF___he52MU7zdqb
                                #define DEF___he52MU7zdqb
inline static void _he52MU7z(const s_Result& result, fu::str& err, s_Context& ctx)
{
    if (result.error)
    {
        if (!(err))
        ...
        setModule_1qjplDUo(result.module, ctx);
                                ...
                                #ifndef DEF_each_DaxQlDFqYLe
                                #define DEF_each_DaxQlDFqYLe
inline void each_DaxQlDFq(fu::view<s_Result> a, fu::str& err, s_Context& ctx)
{
    for (int i = 0; i < a.size(); i++)
        _he52MU7z(a[i], err, ctx);

}
                                #endif

                                #ifndef DEF___MEPC4HBSCp6
                                #define DEF___MEPC4HBSCp6
inline static void _MEPC4HBS(const int modid, s_Context& ctx, const s_Options& options)
{
    const s_Module& module = ctx.modules[modid];
    if (!module.out)
    {
        ...
        setModule_1qjplDUo(module_1, ctx);
                                ...
                                #ifndef DEF_each_XWtBehihAi3
                                #define DEF_each_XWtBehihAi3
inline void each_XWtBehih(fu::view<int> a, s_Context& ctx, const s_Options& options)
{
    for (int i = 0; i < a.size(); i++)
        _MEPC4HBS(a[i], ctx, options);
...
void compile_Tsi8gRTk(const fu::str& fname, s_Context& ctx, const s_Options& options)
{
    ...
    for (int i_1 = 0; i_1 < dep_order.size(); i_1++)
    {
        ...
        {
            fu::vec<s_Result> results = map_m9tusTUi(modids, int{}, ctx, options);
            /*MOV*/ fu::str err {};
            each_DaxQlDFq(results, err, ctx);
            if (err)
                fu::fail(static_cast<fu::str&&>(err));

        }
        else
            each_XWtBehih(modids, ctx, options);
...
extern const s_Context CTX_PRELUDE;
                                ...
                                #ifndef DEF_map_9LWRBzEl1Hh
                                #define DEF_map_9LWRBzEl1Hh
inline fu::vec<s_Module> map_9LWRBzEl(fu::view<s_Module> a)
{
    /*MOV*/ fu::vec<s_Module> res {};
    res.grow<false>(a.size());
    for (int i = 0; i < a.size(); i++)
        res.mutref(i) = clone_0v1CBXDy(a[i]);

    return /*NRVO*/ res;
}
                                #endif

                                #ifndef DEF_clone_NUCRWWItcP1
                                #define DEF_clone_NUCRWWItcP1
inline fu::vec<s_Module> clone_NUCRWWIt(fu::view<s_Module> a)
{
    return map_9LWRBzEl(a);
}
                                #endif
...
inline const s_NukeOnRebuild& clone_HrcxkI04(const s_NukeOnRebuild& a)
{
    return a;
                                ...
                                #ifndef DEF_clone_0ld3xnyzIWc
                                #define DEF_clone_0ld3xnyzIWc
inline s_Context clone_0ld3xnyz(const s_Context& a)
{
    /*MOV*/ s_Context res {};

    {
        ...
        res.modules = clone_NUCRWWIt(a.modules);
...
void clear(s_Module& module)
{
    module = s_Module { module.modid, fu::str(module.fname), s_ModuleInputs{}, s_ModuleOrder{}, s_ModuleOutputs{}, s_ModuleStats{}, s_Profile{} };
                                ...
                                #ifndef DEF___rAs53ywUKeh
                                #define DEF___rAs53ywUKeh
inline static void _rAs53ywU(s_Module& module, s_BitSet& invalid)
{
    if (!module.out)
    {
        clear(module);
        add_ZwXYCruz(invalid, module.modid);
                                ...
                                #ifndef DEF_eachButPrelude_a6m28dadb71
                                #define DEF_eachButPrelude_a6m28dadb71
inline static void eachButPrelude_a6m28dad(s_Context& ctx, s_BitSet& invalid)
{
    for (int i = 1; i < ctx.modules.size(); i++)
        _rAs53ywU(ctx.modules.mutref(i), invalid);

}
                                #endif

                                #ifndef DEF_each_88yLr3zJSrk
                                #define DEF_each_88yLr3zJSrk
inline void each_88yLr3zJ(fu::view<s_Import> a, s_Module& module, s_BitSet& invalid, bool& repeat)
{
    // Hoisted:
    fu::str x {};
    ...
    for (int i = 0; i < a.size(); i++)
    {
        ...
        if (has_ZwXYCruz(invalid, import.modid))
        {
            ...
            return;
                                ...
                                #ifndef DEF___6YEiQD4q76g
                                #define DEF___6YEiQD4q76g
inline static void _6YEiQD4q(s_Module& module, s_BitSet& invalid, bool& repeat)
{
    each_88yLr3zJ(module.in.parse.imports, module, invalid, repeat);
}
                                #endif

                                #ifndef DEF_eachButPrelude_ZxF2sGk60Sh
                                #define DEF_eachButPrelude_ZxF2sGk60Sh
inline static void eachButPrelude_ZxF2sGk6(s_Context& ctx, s_BitSet& invalid, bool& repeat)
{
    for (int i = 1; i < ctx.modules.size(); i++)
        _6YEiQD4q(ctx.modules.mutref(i), invalid, repeat);
...
{
    s_BitSet invalid {};
    eachButPrelude_a6m28dad(ctx, invalid);
    if (invalid)
    {
        for (; ; )
        {
            bool repeat = false;
            eachButPrelude_ZxF2sGk6(ctx, invalid, repeat);
            if (!repeat)
                break;
...
;
    ...
    else
    {
        ...
        return /*NRVO*/ ret;
                                ...
                                #ifndef DEF___KOvU9rw0GMb
                                #define DEF___KOvU9rw0GMb
inline static void _KOvU9rw0(const s_Module& module, fu::vec<fu::str>& watch_list)
{
    if (module.fname)
        watch_list += fu::str(module.fname);
                                ...
                                #ifndef DEF_eachButPrelude_hhP6QFZfeih
                                #define DEF_eachButPrelude_hhP6QFZfeih
inline static void eachButPrelude_hhP6QFZf(const s_Context& ctx, fu::vec<fu::str>& watch_list)
{
    for (int i = 1; i < ctx.modules.size(); i++)
        _KOvU9rw0(ctx.modules[i], watch_list);
...
{
    s_Context ctx = clone_0ld3xnyz(CTX_PRELUDE);
    ...
    for (; ; )
    {
        ...
        if (s_BuildScheme((bscheme & s_BuildScheme_watch)) && !watch_list)
            eachButPrelude_hhP6QFZf(ctx, watch_list);
