...
static s_BuildOutput recompile_Tsi8gRTk(bool, bool, const fu::str&, const fu::str&, const fu::str&, const fu::str&, const fu::str&, const fu::str&, s_RunMode, s_BuildScheme, fu::view<fu::str>, fu::view<fu::str>, s_BuildScheme, const fu::str&, const fu::str&, fu::vec<fu::str>&, s_Context&, const s_Options&);
double hr_0pZhUWR4();
...
inline constexpr s_DEV_OnFail MASK_s_DEV_OnFail
    ...
    | s_DEV_OnFail_OnFail_WriteRepro;
                                ...
                                #ifndef DEF___MaqdkbH5Chd
                                #define DEF___MaqdkbH5Chd
inline static fu::view<char> _MaqdkbH5(const s_TokenIdx& token, const int i, fu::view<s_TokenIdx> via, fu::str& error, const s_Context& ctx)
{
    return (error += FAIL_text_u9Gbkniv(fu::vec<s_TokenIdx> { fu::slate<1, s_TokenIdx> { s_TokenIdx(token) } }, ((i == (via.size() - 1)) ? "Resulting in an import circle, not currently supported."_fu : "Imports:\n"_fu), ctx));
                                ...
                                #ifndef DEF_each_HLHN94Hr76b
                                #define DEF_each_HLHN94Hr76b
inline void each_HLHN94Hr(fu::view<s_TokenIdx> a, fu::view<s_TokenIdx> via, fu::str& error, const s_Context& ctx)
{
    for (int i = 0; i < a.size(); i++)
        _MaqdkbH5(a[i], i, via, error, ctx);
...
inline s_SolverOutput clone_TxoZPH7q(const s_SolverOutput& a)
{
    ...
    return /*NRVO*/ res;
                                ...
                                #ifndef DEF_clone_WkNVAjskDpa
                                #define DEF_clone_WkNVAjskDpa
inline const s_CodegenOutput& clone_WkNVAjsk(const s_CodegenOutput& a)
{
    return a;
}
                                #endif

                                #ifndef DEF_clone_Sm9sAChXGqc
                                #define DEF_clone_Sm9sAChXGqc
inline s_ModuleOutputs clone_Sm9sAChX(const s_ModuleOutputs& a)
{
...
inline const s_Profile& clone_HRvYlzuk(const s_Profile& a)
{
    return a;
                                ...
                                #ifndef DEF_clone_Psrufvubpq2
                                #define DEF_clone_Psrufvubpq2
inline s_Module clone_Psrufvub(const s_Module& a)
{
    /*MOV*/ s_Module res {};
...
inline bool starts_hRi5tkxn(fu::view<char> a, fu::view<char> with)
{
    return (a.size() >= with.size()) && (fu::get_view_start0(a, with.size()) == with);
                                ...
                                #ifndef DEF___QdVLIpWakdh
                                #define DEF___QdVLIpWakdh
inline static void _QdVLIpWa(s_Import& import, fu::view<s_TokenIdx> via, fu::view<char> dir, s_Context& ctx, s_Module& module, const s_Options& options)
{
    ...
    if ((module.order.dep_depth <= other.order.dep_depth))
        module.order.dep_depth = (other.order.dep_depth + 1);
                                ...
                                #ifndef DEF_each_j5AVdPGFyS1
                                #define DEF_each_j5AVdPGFyS1
inline void each_j5AVdPGF(fu::view_mut<s_Import> a, fu::view<s_TokenIdx> via, fu::view<char> dir, s_Context& ctx, s_Module& module, const s_Options& options)
{
    for (int i = 0; i < a.size(); i++)
    {
        s_Import* _0;
        (_0 = &(a.mutref(i)), _QdVLIpWa(*_0, via, dir, ctx, module, options));
    };
}
                                #endif
...
s_ModidAndOrder compile_lexParseDeps(const fu::str& fname, fu::view<s_TokenIdx> via, s_Context& ctx, const s_Options& options)
{
    ...
    if (module.in)
    {
        ...
        else
        {
            ...
            each_HLHN94Hr(via, via, error, ctx);
            fu::fail(static_cast<fu::str&&>(error));
        };
    }
    else
    {
        s_Module module_1 = clone_Psrufvub(module);
        if (module_1.out)
        ...
        else
        {
            ...
            else
            {
                ...
                if (!module_1.order)
                {
                    ...
                    each_j5AVdPGF(imports, via, dir, ctx, module_1, options);
...
inline fu::str x7E_3lDd4lqo(fu::view<char> a, fu::view<char> b)
{
    return a + b;
                                ...
                                #ifndef DEF___mC5N874qWD6
                                #define DEF___mC5N874qWD6
inline static s_Result _mC5N874q(const int modid, const s_Context& ctx, const s_Options& options)
{
    ...
    {
    {
        ...
        {
            /*MOV*/ s_Module module_1 = clone_Psrufvub(module);
...
;
                                ...
                                #ifndef DEF___kNhp15JvVL6
                                #define DEF___kNhp15JvVL6
inline static const s_Result& _kNhp15Jv(const int i, fu::view<int> arr, fu::view_mut<s_Result> result, const s_Context& ctx, const s_Options& options)
{
    return (result.mutref(i) = _mC5N874q(arr[i], ctx, options));
}
                                #endif

                                #ifndef DEF_parallel_for_KQXuRBUfuQ2
                                #define DEF_parallel_for_KQXuRBUfuQ2
inline static void parallel_for_KQXuRBUf(const int min, int end, fu::view<int> arr, fu::view_mut<s_Result> result, const s_Context& ctx, const s_Options& options)
{
    int start = (end & 0);
    (void) start;
    ...
    for (int i = start; i < end; i++)
        _kNhp15Jv(i, arr, result, ctx, options);
                                ...
                                #ifndef DEF_map_VNnmyfelR78
                                #define DEF_map_VNnmyfelR78
inline fu::vec<s_Result> map_VNnmyfel(fu::view<int> arr, const int min, const s_Context& ctx, const s_Options& options)
{
    /*MOV*/ fu::vec<s_Result> result {};
    result.grow<false>(arr.size());
    parallel_for_KQXuRBUf(min, arr.size(), arr, result, ctx, options);
    return /*NRVO*/ result;
}
                                #endif

                                #ifndef DEF___2joUKHvJDua
                                #define DEF___2joUKHvJDua
inline static void _2joUKHvJ(const s_Result& result, fu::str& err, s_Context& ctx)
{
    if (result.error)
    {
        if (!(err))
        ...
        setModule_1qjplDUo(result.module, ctx);
                                ...
                                #ifndef DEF_each_toCZUjjQZJl
                                #define DEF_each_toCZUjjQZJl
inline void each_toCZUjjQ(fu::view<s_Result> a, fu::str& err, s_Context& ctx)
{
    for (int i = 0; i < a.size(); i++)
        _2joUKHvJ(a[i], err, ctx);

}
                                #endif

                                #ifndef DEF___X8BLpMbgIJj
                                #define DEF___X8BLpMbgIJj
inline static void _X8BLpMbg(const int modid, s_Context& ctx, const s_Options& options)
{
    const s_Module& module = ctx.modules[modid];
    if (!module.out)
    {
        ...
        setModule_1qjplDUo(module_1, ctx);
                                ...
                                #ifndef DEF_each_kVoMSiG7YY7
                                #define DEF_each_kVoMSiG7YY7
inline void each_kVoMSiG7(fu::view<int> a, s_Context& ctx, const s_Options& options)
{
    for (int i = 0; i < a.size(); i++)
        _X8BLpMbg(a[i], ctx, options);
...
void compile_Tsi8gRTk(const fu::str& fname, s_Context& ctx, const s_Options& options)
{
    ...
    for (int i_1 = 0; i_1 < dep_order.size(); i_1++)
    {
        ...
        {
            fu::vec<s_Result> results = map_VNnmyfel(modids, int{}, ctx, options);
            /*MOV*/ fu::str err {};
            each_toCZUjjQ(results, err, ctx);
            if (err)
                fu::fail(static_cast<fu::str&&>(err));

        }
        else
            each_kVoMSiG7(modids, ctx, options);
...
extern const s_Context CTX_PRELUDE;
                                ...
                                #ifndef DEF_map_IsAfpalrhlb
                                #define DEF_map_IsAfpalrhlb
inline fu::vec<s_Module> map_IsAfpalr(fu::view<s_Module> a)
{
    /*MOV*/ fu::vec<s_Module> res {};
    res.grow<false>(a.size());
    for (int i = 0; i < a.size(); i++)
        res.mutref(i) = clone_Psrufvub(a[i]);

    return /*NRVO*/ res;
}
                                #endif

                                #ifndef DEF_clone_gj7atjwwpca
                                #define DEF_clone_gj7atjwwpca
inline fu::vec<s_Module> clone_gj7atjww(fu::view<s_Module> a)
{
    return map_IsAfpalr(a);
}
                                #endif
...
inline const s_NukeOnRebuild& clone_HrcxkI04(const s_NukeOnRebuild& a)
{
    return a;
                                ...
                                #ifndef DEF_clone_RvZs6BK0ON9
                                #define DEF_clone_RvZs6BK0ON9
inline s_Context clone_RvZs6BK0(const s_Context& a)
{
    /*MOV*/ s_Context res {};

    {
        ...
        res.modules = clone_gj7atjww(a.modules);
...
void clear(s_Module& module)
{
    module = s_Module { module.modid, fu::str(module.fname), s_ModuleInputs{}, s_ModuleOrder{}, s_ModuleOutputs{}, s_ModuleStats{}, s_Profile{} };
                                ...
                                #ifndef DEF___DgJuYVUZdBh
                                #define DEF___DgJuYVUZdBh
inline static void _DgJuYVUZ(s_Module& module, s_BitSet& invalid)
{
    if (!module.out)
    {
        clear(module);
        add_ZwXYCruz(invalid, module.modid);
                                ...
                                #ifndef DEF_eachButPrelude_YesdwO1EPWf
                                #define DEF_eachButPrelude_YesdwO1EPWf
inline static void eachButPrelude_YesdwO1E(s_Context& ctx, s_BitSet& invalid)
{
    for (int i = 1; i < ctx.modules.size(); i++)
        _DgJuYVUZ(ctx.modules.mutref(i), invalid);

}
                                #endif

                                #ifndef DEF_each_jsvliU5KmNa
                                #define DEF_each_jsvliU5KmNa
inline void each_jsvliU5K(fu::view<s_Import> a, s_Module& module, s_BitSet& invalid, bool& repeat)
{
    // Hoisted:
    fu::str x {};
    ...
    for (int i = 0; i < a.size(); i++)
    {
        ...
        if (has_ZwXYCruz(invalid, import.modid))
        {
            ...
            return;
                                ...
                                #ifndef DEF___wAFkYE0xJUa
                                #define DEF___wAFkYE0xJUa
inline static void _wAFkYE0x(s_Module& module, s_BitSet& invalid, bool& repeat)
{
    each_jsvliU5K(module.in.parse.imports, module, invalid, repeat);
}
                                #endif

                                #ifndef DEF_eachButPrelude_qzS1ZZL25u4
                                #define DEF_eachButPrelude_qzS1ZZL25u4
inline static void eachButPrelude_qzS1ZZL2(s_Context& ctx, s_BitSet& invalid, bool& repeat)
{
    for (int i = 1; i < ctx.modules.size(); i++)
        _wAFkYE0x(ctx.modules.mutref(i), invalid, repeat);
...
{
    s_BitSet invalid {};
    eachButPrelude_YesdwO1E(ctx, invalid);
    if (invalid)
    {
        for (; ; )
        {
            bool repeat = false;
            eachButPrelude_qzS1ZZL2(ctx, invalid, repeat);
            if (!repeat)
                break;
...
static s_BuildOutput HOTSWAP_build_Tsi8gRTk(const bool plugin, fu::view<char> fname, const fu::str& dir_wrk, const fu::str& bin, const fu::str& dir_obj, const fu::str& dir_src, const fu::str& dir_cpp, const s_RunMode runmode, const s_BuildScheme bscheme, fu::view<fu::str> flags_cc, fu::view<fu::str> flags_ld, const fu::str& HOTSWAP_dirname, const fu::str& HOTSWAP_plugin, const s_Context& ctx)
{
    ...
    fu::vec<fu::str> libs = fu::vec<fu::str> { fu::slate<3, fu::str> { "-L"_fu, fu::str(HOTSWAP_dirname), "-lfu"_fu } };
    ...
    {
        return build_Tsi8gRTk(((flags_ld + libs) + (fu::slate<1, fu::str> { ("-Wl,-rpath,"_fu + ORIGIN) })), runmode, s_BuildScheme((bscheme & s_BuildScheme(~s_BuildScheme_shared))), bin, fname, dir_wrk, dir_obj, dir_src, dir_cpp, flags_cc, ctx);
    };
}

static s_BuildOutput recompile_Tsi8gRTk(const bool plugin, const bool dont_try_catch, const fu::str& fname, const fu::str& dir_wrk, const fu::str& bin, const fu::str& dir_obj, const fu::str& dir_src, const fu::str& dir_cpp, const s_RunMode runmode, const s_BuildScheme bscheme, fu::view<fu::str> flags_cc, fu::view<fu::str> flags_ld, const s_BuildScheme HOTSWAP, const fu::str& HOTSWAP_dirname, const fu::str& HOTSWAP_plugin, fu::vec<fu::str>& watch_list, s_Context& ctx, const s_Options& options)
{
    // Hoisted:
    fu::str x {};
    fu::str x_1 {};
    ...
    if (s_BuildScheme((bscheme & s_BuildScheme_watch)) && !dont_try_catch)
    {
        ...
        { {
            ...
            try
            {
                return recompile_Tsi8gRTk(plugin, true, fname, dir_wrk, bin, dir_obj, dir_src, dir_cpp, runmode, bscheme, flags_cc, flags_ld, HOTSWAP, HOTSWAP_dirname, HOTSWAP_plugin, watch_list, ctx, options);
            }
            catch (const std::exception& o_0)
            {
...
;
    ...
    else
    {
        ...
        return /*NRVO*/ ret;
                                ...
                                #ifndef DEF___f31Nub9KLuc
                                #define DEF___f31Nub9KLuc
inline static void _f31Nub9K(const s_Module& module, fu::vec<fu::str>& watch_list)
{
    if (module.fname)
        watch_list += fu::str(module.fname);
                                ...
                                #ifndef DEF_eachButPrelude_Z0I5FHnzSg9
                                #define DEF_eachButPrelude_Z0I5FHnzSg9
inline static void eachButPrelude_Z0I5FHnz(const s_Context& ctx, fu::vec<fu::str>& watch_list)
{
    for (int i = 1; i < ctx.modules.size(); i++)
        _f31Nub9K(ctx.modules[i], watch_list);
...
{
    s_Context ctx = clone_RvZs6BK0(CTX_PRELUDE);
    ...
    for (; ; )
    {
        /*MOV*/ s_BuildOutput ret = recompile_Tsi8gRTk(false, false, fname, dir_wrk, bin, dir_obj, dir_src, dir_cpp, runmode, bscheme, flags_cc, flags_ld, HOTSWAP, HOTSWAP_dirname, HOTSWAP_plugin, watch_list, ctx, options);
        if (s_BuildScheme((bscheme & s_BuildScheme_watch)) && !watch_list)
            eachButPrelude_Z0I5FHnz(ctx, watch_list);
