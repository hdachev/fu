...
inline constexpr s_DEV_OnFail MASK_s_DEV_OnFail
    ...
    | s_DEV_OnFail_OnFail_WriteRepro;
                                ...
                                #ifndef DEF___Xgg2snLq9ai
                                #define DEF___Xgg2snLq9ai
inline static fu::view<char> _Xgg2snLq(const s_TokenIdx& token, const int i, fu::view<s_TokenIdx> via, fu::str& error, const s_Context& ctx)
{
    return (error += FAIL_text_u9Gbkniv(fu::vec<s_TokenIdx> { fu::slate<1, s_TokenIdx> { s_TokenIdx(token) } }, ((i == (via.size() - 1)) ? "Resulting in an import circle, not currently supported."_fu : "Imports:\n"_fu), ctx));
                                ...
                                #ifndef DEF_each_ohoWBE5WiDh
                                #define DEF_each_ohoWBE5WiDh
inline void each_ohoWBE5W(fu::view<s_TokenIdx> a, fu::view<s_TokenIdx> via, fu::str& error, const s_Context& ctx)
{
    for (int i = 0; i < a.size(); i++)
        _Xgg2snLq(a[i], i, via, error, ctx);
...
inline const s_ModuleOrder& clone_BW5ZEuMh(const s_ModuleOrder& a)
{
    return a;
                                ...
                                #ifndef DEF_clone_PBuqb5MeANk
                                #define DEF_clone_PBuqb5MeANk
inline const fu::vec<s_UserType>& clone_PBuqb5Me(const fu::vec<s_UserType>& a)
{
    return a;
}
                                #endif
...
inline const fu::vec<s_Overload>& clone_u3cG3iHT(const fu::vec<s_Overload>& a)
{
    return a;
                                ...
                                #ifndef DEF_clone_R7FLGWRHEha
                                #define DEF_clone_R7FLGWRHEha
inline const fu::vec<s_Extended>& clone_R7FLGWRH(const fu::vec<s_Extended>& a)
{
    return a;
}
                                #endif
...
inline const fu::vec<s_Target>& clone_gjeoYDys(const fu::vec<s_Target>& a)
{
    return a;
                                ...
                                #ifndef DEF_clone_bOAdFT80Qc3
                                #define DEF_clone_bOAdFT80Qc3
inline s_Scope clone_bOAdFT80(const s_Scope& a)
{
    /*MOV*/ s_Scope res {};

    {
        res.overloads = clone_u3cG3iHT(a.overloads);
        res.extended = clone_R7FLGWRH(a.extended);
...
inline s_SolverNotes clone_C1Qhlqa3(const s_SolverNotes a)
{
    return a;
                                ...
                                #ifndef DEF_clone_OqZYSjOZFwd
                                #define DEF_clone_OqZYSjOZFwd
inline s_SolverOutput clone_OqZYSjOZ(const s_SolverOutput& a)
{
    /*MOV*/ s_SolverOutput res {};

    {
        res.root = clone_CW5VJZd6(a.root);
        res.scope = clone_bOAdFT80(a.scope);
...
inline const s_CodegenOutput& clone_nZUtjGKt(const s_CodegenOutput& a)
{
    return a;
                                ...
                                #ifndef DEF_clone_1FTYsTFuUR0
                                #define DEF_clone_1FTYsTFuUR0
inline s_ModuleOutputs clone_1FTYsTFu(const s_ModuleOutputs& a)
{
    /*MOV*/ s_ModuleOutputs res {};

    {
        res.types = clone_PBuqb5Me(a.types);
        res.solve = clone_OqZYSjOZ(a.solve);
...
inline const s_Profile& clone_HRvYlzuk(const s_Profile& a)
{
    return a;
                                ...
                                #ifndef DEF_clone_z9srUSlZ6Sh
                                #define DEF_clone_z9srUSlZ6Sh
inline s_Module clone_z9srUSlZ(const s_Module& a)
{
    /*MOV*/ s_Module res {};
...
inline bool starts_hRi5tkxn(fu::view<char> a, fu::view<char> with)
{
    return (a.size() >= with.size()) && (fu::get_view_start0(a, with.size()) == with);
                                ...
                                #ifndef DEF___ZwxufJJrRRe
                                #define DEF___ZwxufJJrRRe
inline static void _ZwxufJJr(s_Import& import, fu::view<s_TokenIdx> via, fu::view<char> dir, s_Context& ctx, s_Module& module, const s_Options& options)
{
    ...
    if ((module.order.dep_depth <= other.order.dep_depth))
        module.order.dep_depth = (other.order.dep_depth + 1);
                                ...
                                #ifndef DEF_each_CpbQokTXUc2
                                #define DEF_each_CpbQokTXUc2
inline void each_CpbQokTX(fu::view_mut<s_Import> a, fu::view<s_TokenIdx> via, fu::view<char> dir, s_Context& ctx, s_Module& module, const s_Options& options)
{
    for (int i = 0; i < a.size(); i++)
    {
        s_Import* _0;
        (_0 = &(a.mutref(i)), _ZwxufJJr(*_0, via, dir, ctx, module, options));
    };
}
                                #endif
...
s_ModidAndOrder compile_lexParseDeps(const fu::str& fname, fu::view<s_TokenIdx> via, s_Context& ctx, const s_Options& options)
{
    ...
    if (module.in)
    {
        ...
        else
        {
            ...
            each_ohoWBE5W(via, via, error, ctx);
            fu::fail(static_cast<fu::str&&>(error));
        };
    }
    else
    {
        s_Module module_1 = clone_z9srUSlZ(module);
        if (module_1.out)
        ...
        else
        {
            ...
            else
            {
                ...
                if (!module_1.order)
                {
                    ...
                    each_CpbQokTX(imports, via, dir, ctx, module_1, options);
...
inline fu::str x7E_3lDd4lqo(fu::view<char> a, fu::view<char> b)
{
    return a + b;
                                ...
                                #ifndef DEF___jYHCqhlzRs4
                                #define DEF___jYHCqhlzRs4
inline static s_Result _jYHCqhlz(const int modid, const s_Context& ctx, const s_Options& options)
{
    ...
    {
    {
        ...
        {
            /*MOV*/ s_Module module_1 = clone_z9srUSlZ(module);
...
;
                                ...
                                #ifndef DEF___VbzecQFkNng
                                #define DEF___VbzecQFkNng
inline static const s_Result& _VbzecQFk(const int i, fu::view<int> arr, fu::view_mut<s_Result> result, const s_Context& ctx, const s_Options& options)
{
    return (result.mutref(i) = _jYHCqhlz(arr[i], ctx, options));
}
                                #endif

                                #ifndef DEF_parallel_for_fUhSfwGGWj4
                                #define DEF_parallel_for_fUhSfwGGWj4
inline static void parallel_for_fUhSfwGG(const int min, int end, fu::view<int> arr, fu::view_mut<s_Result> result, const s_Context& ctx, const s_Options& options)
{
    int start = (end & 0);
    (void) start;
    ...
    for (int i = start; i < end; i++)
        _VbzecQFk(i, arr, result, ctx, options);
                                ...
                                #ifndef DEF_map_CbsYfJDJY24
                                #define DEF_map_CbsYfJDJY24
inline fu::vec<s_Result> map_CbsYfJDJ(fu::view<int> arr, const int min, const s_Context& ctx, const s_Options& options)
{
    /*MOV*/ fu::vec<s_Result> result {};
    result.grow<false>(arr.size());
    parallel_for_fUhSfwGG(min, arr.size(), arr, result, ctx, options);
    return /*NRVO*/ result;
}
                                #endif

                                #ifndef DEF___sNhc3eBpRZf
                                #define DEF___sNhc3eBpRZf
inline static void _sNhc3eBp(const s_Result& result, fu::str& err, s_Context& ctx)
{
    if (result.error)
    {
        if (!(err))
        ...
        setModule_1qjplDUo(result.module, ctx);
                                ...
                                #ifndef DEF_each_bCURUIj0SDh
                                #define DEF_each_bCURUIj0SDh
inline void each_bCURUIj0(fu::view<s_Result> a, fu::str& err, s_Context& ctx)
{
    for (int i = 0; i < a.size(); i++)
        _sNhc3eBp(a[i], err, ctx);

}
                                #endif

                                #ifndef DEF___EeZj1k7Khb6
                                #define DEF___EeZj1k7Khb6
inline static void _EeZj1k7K(const int modid, s_Context& ctx, const s_Options& options)
{
    const s_Module& module = ctx.modules[modid];
    if (!module.out)
    {
        ...
        setModule_1qjplDUo(module_1, ctx);
                                ...
                                #ifndef DEF_each_RDyyEOYGEn5
                                #define DEF_each_RDyyEOYGEn5
inline void each_RDyyEOYG(fu::view<int> a, s_Context& ctx, const s_Options& options)
{
    for (int i = 0; i < a.size(); i++)
        _EeZj1k7K(a[i], ctx, options);
...
void compile_Tsi8gRTk(const fu::str& fname, s_Context& ctx, const s_Options& options)
{
    ...
    for (int i_1 = 0; i_1 < dep_order.size(); i_1++)
    {
        ...
        {
            fu::vec<s_Result> results = map_CbsYfJDJ(modids, int{}, ctx, options);
            /*MOV*/ fu::str err {};
            each_bCURUIj0(results, err, ctx);
            if (err)
                fu::fail(static_cast<fu::str&&>(err));

        }
        else
            each_RDyyEOYG(modids, ctx, options);
...
extern const s_Context CTX_PRELUDE;
                                ...
                                #ifndef DEF_map_XXsWTa0A02j
                                #define DEF_map_XXsWTa0A02j
inline fu::vec<s_Module> map_XXsWTa0A(fu::view<s_Module> a)
{
    /*MOV*/ fu::vec<s_Module> res {};
    res.grow<false>(a.size());
    for (int i = 0; i < a.size(); i++)
        res.mutref(i) = clone_z9srUSlZ(a[i]);

    return /*NRVO*/ res;
}
                                #endif

                                #ifndef DEF_clone_inJKts2ycQb
                                #define DEF_clone_inJKts2ycQb
inline fu::vec<s_Module> clone_inJKts2y(fu::view<s_Module> a)
{
    return map_XXsWTa0A(a);
}
                                #endif
...
inline const s_NukeOnRebuild& clone_HrcxkI04(const s_NukeOnRebuild& a)
{
    return a;
                                ...
                                #ifndef DEF_clone_Vu5hNB9BG30
                                #define DEF_clone_Vu5hNB9BG30
inline s_Context clone_Vu5hNB9B(const s_Context& a)
{
    /*MOV*/ s_Context res {};

    {
        ...
        res.modules = clone_inJKts2y(a.modules);
...
void clear(s_Module& module)
{
    module = s_Module { module.modid, fu::str(module.fname), s_ModuleInputs{}, s_ModuleOrder{}, s_ModuleOutputs{}, s_ModuleStats{}, s_Profile{} };
                                ...
                                #ifndef DEF___1BqOBkY8Er1
                                #define DEF___1BqOBkY8Er1
inline static void _1BqOBkY8(s_Module& module, s_BitSet& invalid)
{
    if (!module.out)
    {
        clear(module);
        add_ZwXYCruz(invalid, module.modid);
                                ...
                                #ifndef DEF_eachButPrelude_y99M0LzV78h
                                #define DEF_eachButPrelude_y99M0LzV78h
inline static void eachButPrelude_y99M0LzV(s_Context& ctx, s_BitSet& invalid)
{
    for (int i = 1; i < ctx.modules.size(); i++)
        _1BqOBkY8(ctx.modules.mutref(i), invalid);

}
                                #endif

                                #ifndef DEF_each_rTBD6V9MvA1
                                #define DEF_each_rTBD6V9MvA1
inline void each_rTBD6V9M(fu::view<s_Import> a, s_Module& module, s_BitSet& invalid, bool& repeat)
{
    // Hoisted:
    fu::str x {};
    ...
    for (int i = 0; i < a.size(); i++)
    {
        ...
        if (has_ZwXYCruz(invalid, import.modid))
        {
            ...
            return;
                                ...
                                #ifndef DEF___iRUCuSgRM55
                                #define DEF___iRUCuSgRM55
inline static void _iRUCuSgR(s_Module& module, s_BitSet& invalid, bool& repeat)
{
    each_rTBD6V9M(module.in.parse.imports, module, invalid, repeat);
}
                                #endif

                                #ifndef DEF_eachButPrelude_EBRV1ErBUfk
                                #define DEF_eachButPrelude_EBRV1ErBUfk
inline static void eachButPrelude_EBRV1ErB(s_Context& ctx, s_BitSet& invalid, bool& repeat)
{
    for (int i = 1; i < ctx.modules.size(); i++)
        _iRUCuSgR(ctx.modules.mutref(i), invalid, repeat);
...
{
    s_BitSet invalid {};
    eachButPrelude_y99M0LzV(ctx, invalid);
    if (invalid)
    {
        for (; ; )
        {
            bool repeat = false;
            eachButPrelude_EBRV1ErB(ctx, invalid, repeat);
            if (!repeat)
                break;
...
;
    ...
    else
    {
        ...
        return /*NRVO*/ ret;
                                ...
                                #ifndef DEF___Vt7102m2LQ6
                                #define DEF___Vt7102m2LQ6
inline static void _Vt7102m2(const s_Module& module, fu::vec<fu::str>& watch_list)
{
    if (module.fname)
        watch_list += fu::str(module.fname);
                                ...
                                #ifndef DEF_eachButPrelude_YG2Dq7gNIxd
                                #define DEF_eachButPrelude_YG2Dq7gNIxd
inline static void eachButPrelude_YG2Dq7gN(const s_Context& ctx, fu::vec<fu::str>& watch_list)
{
    for (int i = 1; i < ctx.modules.size(); i++)
        _Vt7102m2(ctx.modules[i], watch_list);
...
{
    s_Context ctx = clone_Vu5hNB9B(CTX_PRELUDE);
    ...
    for (; ; )
    {
        ...
        if (s_BuildScheme((bscheme & s_BuildScheme_watch)) && !watch_list)
            eachButPrelude_YG2Dq7gN(ctx, watch_list);
