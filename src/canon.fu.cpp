...
bool isCanonAssignable_Ot6w(fu::view<char> host, fu::view<char> guest, const Context_AtCH& ctx, const TokenIdx_5581& _here)
{
...
fu::vec_range<char> canon_tryIntersect_Ot6w(fu::vec_range<char> a, fu::vec_range<char> b, const Context_AtCH& ctx, const TokenIdx_5581& _here)
{
    if (a.size() < b.size())
...
fu::vec_range<char> canon_trySuper_Ot6w(fu::vec_range<char> a, fu::vec_range<char> b, const Context_AtCH& ctx, const TokenIdx_5581& _here)
{
    if (a.size() > b.size())
