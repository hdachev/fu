...
static fu_VEC<s_Node> parseBlockLike_a2fqWS3u(fu::view<char>, fu::view<char>, bool, bool, int&, fu::view<s_Token>, int&, fu_VEC<fu_STR>&, const s_Options&, const fu_STR&, const fu_STR&, int&, int&, int, int&, fu_VEC<fu_STR>&, int&, bool&, fu_VEC<fu_STR>&, int&);
...
static s_Node parseArrayLiteral_0FflmhUj(fu::view<s_Token>, int&, const fu_STR&, const fu_STR&, int&, int&, int&, fu_VEC<fu_STR>&, const s_Options&, int, int&, fu_VEC<fu_STR>&, int&, bool&, fu_VEC<fu_STR>&, int&);
static s_Node parseBlock_6GTsIxpa(int&, fu::view<s_Token>, int&, fu_VEC<fu_STR>&, const s_Options&, const fu_STR&, const fu_STR&, int&, int&, int, int&, fu_VEC<fu_STR>&, int&, bool&, fu_VEC<fu_STR>&, int&);
static s_Node parseConversionDecl_Ymjs1Q6V(fu::view<s_Token>, int&, const fu_STR&, const fu_STR&, int, int&, int&, fu_VEC<fu_STR>&, int&, int&, int&, fu_VEC<fu_STR>&, const s_Options&, bool&, fu_VEC<fu_STR>&, int&);
...
static s_Node parseExpressionStatement_6ScTKJdc(int&, int&, int&, int&, fu::view<s_Token>, fu_VEC<fu_STR>&, const s_Options&, const fu_STR&, const fu_STR&, int, int&, fu_VEC<fu_STR>&, int&, bool&, fu_VEC<fu_STR>&, int&);
...
static s_Node parseLabelledStatement_bBivss9s(fu::view<s_Token>, int&, const fu_STR&, const fu_STR&, int&, int&, fu_VEC<fu_STR>&, const s_Options&, int&, int, int&, fu_VEC<fu_STR>&, int&, bool&, fu_VEC<fu_STR>&, int&);
static s_Node parseLetOrExpressionStatement_R38NSHBa(fu::view<s_Token>, int&, const fu_STR&, const fu_STR&, int&, int&, int&, fu_VEC<fu_STR>&, const s_Options&, int, int&, fu_VEC<fu_STR>&, int&, bool&, fu_VEC<fu_STR>&, int&);
...
static s_Node parsePrimDecl_UUHpCQvR(bool, fu::view<s_Token>, int&, int&, int&, int&, fu_VEC<fu_STR>&, const s_Options&, const fu_STR&, const fu_STR&, int, int&, fu_VEC<fu_STR>&, int&, bool&, fu_VEC<fu_STR>&, int&);
static s_Node parsePub_5u8fUDSk(int&, fu::view<s_Token>, int&, const fu_STR&, const fu_STR&, int&, int&, fu_VEC<fu_STR>&, const s_Options&, int&, int, fu_VEC<fu_STR>&, int&, bool&, fu_VEC<fu_STR>&, int&);
static s_Node parsePureDecl_3EiBDZ3u(int, fu::view<s_Token>, int&, const fu_STR&, const fu_STR&, int, int&, int&, fu_VEC<fu_STR>&, int&, int&, int&, fu_VEC<fu_STR>&, const s_Options&, bool&, fu_VEC<fu_STR>&, int&);
static s_Node parseShadow_mhOGRJxt(int&, fu::view<s_Token>, int&, const fu_STR&, const fu_STR&, int&, fu_VEC<fu_STR>&, const s_Options&, int&, int, int&, fu_VEC<fu_STR>&, int&, bool&, fu_VEC<fu_STR>&, int&);
static s_Node parseStatement_TnImdy8H(int&, fu::view<s_Token>, int&, const fu_STR&, const fu_STR&, int&, fu_VEC<fu_STR>&, const s_Options&, int&, int, int&, fu_VEC<fu_STR>&, int&, bool&, fu_VEC<fu_STR>&, int&);
static s_Node parseStructDecl_BBYoeFzV(int, fu::view<s_Token>, int&, const fu_STR&, const fu_STR&, int&, fu_VEC<fu_STR>&, const s_Options&, int&, int&, int, int&, fu_VEC<fu_STR>&, int&, bool&, fu_VEC<fu_STR>&, int&);
static s_Node parseStructItem_mXtKbJLa(fu::view<s_Token>, int&, const fu_STR&, const fu_STR&, int&, int&, int&, fu_VEC<fu_STR>&, const s_Options&, int, int&, fu_VEC<fu_STR>&, int&, bool&, fu_VEC<fu_STR>&, int&);
...
static s_Node parseTypedef_b1dJ9Rbd(fu::view<s_Token>, int&, const fu_STR&, const fu_STR&, int&, int&, int&, fu_VEC<fu_STR>&, const s_Options&, int, int&, fu_VEC<fu_STR>&, int&, bool&, fu_VEC<fu_STR>&, int&);
...
static s_BINOP setupOperators_J2h3fYmf()
{
    ...
    binop_1aBpSVJr((fu::slate<5, fu_STR> { "<"_fu, "<="_fu, ">"_fu, ">="_fu, "<=>"_fu }), precedence, out, rightToLeft);
    binop_1aBpSVJr((fu::slate<2, fu_STR> { "=="_fu, "!="_fu }), precedence, out, rightToLeft);
    binop_1aBpSVJr((fu::slate<1, fu_STR> { "&&"_fu }), precedence, out, rightToLeft);
    binop_1aBpSVJr((fu::slate<1, fu_STR> { "||"_fu }), precedence, out, rightToLeft);
    rightToLeft = true;
...
[[noreturn]] static fu::never fail_qdlHeyRs(fu_STR&& reason, fu::view<s_Token> tokens, const int _idx, fu::view<char> fname, const fu_STR& src)
{
...
static const s_Token& consume_cXsTfP3W(fu::view<char> kind, fu::view<char> value, const fu_STR& err, fu::view<s_Token> tokens, int& _idx, fu::view<char> fname, const fu_STR& src)
{
    const s_Token& token = tokens[_idx];
    ...
    fail_qdlHeyRs(((((((err ? fu_STR(err) : "Expected"_fu) + " `"_fu) + (value ? value : kind)) + "`, got `"_fu) + token.value) + "`."_fu), tokens, _idx, fname, src);
}
...
static fu_STR fail_compose_1IwkX2uk(fu_STR&& reason, fu::view<s_Token> tokens, const int _loc, const int _idx, fu::view<char> fname)
{
...
static void warn_E50qN7lA(const fu_STR& reason, fu_VEC<fu_STR>& warnings, const s_Options& options, fu::view<s_Token> tokens, const int _idx, fu::view<char> fname, const fu_STR& src, const int _loc)
{
    if (warnings.size() == options.lint.maxwarn)
        fail_qdlHeyRs(fu_STR(reason), tokens, _idx, fname, src);

    warnings += fail_compose_1IwkX2uk(fu_STR(reason), tokens, _loc, _idx, fname);
}

static const s_Token& tryConsume_atxtlpan(fu::view<char> kind, fu::view<char> value, fu::view<s_Token> tokens, int& _idx)
{
    const s_Token& token = tokens[_idx];
    if ((token.kind == kind) && (!value || (token.value == value)))
    {
...
static s_Node make_YUyWsb6L(const fu_STR& kind, const fu_VEC<s_Node>& items, const int flags, const fu_STR& value, const int modid, const int _loc)
{
...
{
    return make_YUyWsb6L(kind, (*(const fu_VEC<s_Node>*)fu::NIL), 0, value, modid, _loc);
}
...
inline bool has_8ZmEqwXy(fu::view<fu_STR> keys, fu::view<char> item)
{
    int lo = 0;
    int hi = keys.size();
    while (lo < hi)
...
inline bool has_cl8EZmVy(const s_Map_dkLG9gW8& _, fu::view<char> key)
{
...
{
    return make_YUyWsb6L("addroffn"_fu, (*(const fu_VEC<s_Node>*)fu::NIL), flags, name, modid, _loc);
}
...
static int parseArgsDecl_Qbb3brKi(fu_VEC<s_Node>& outArgs, fu::view<char> endk, fu::view<char> endv, int& _dollarAuto, fu_VEC<fu_STR>& _dollars, fu::view<s_Token> tokens, int& _idx, const fu_STR& fname, const fu_STR& src, int& _precedence, int& _loc, int& _col0, fu_VEC<fu_STR>& warnings, const s_Options& options, const int modid, int& _fnDepth, bool& _hasPUB, fu_VEC<fu_STR>& fuzimports, int& _anonFns)
{
    ...
    for (; ; )
    {
        if (tryConsume_atxtlpan(endk, endv, tokens, _idx))
            break;

        if (!first)
            consume_cXsTfP3W("op"_fu, ","_fu, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src);

        first = false;
        const bool isInline = !!tryConsume_atxtlpan("id"_fu, "inline"_fu, tokens, _idx);
        int insertAt = -1;
        ...
        if (arg.items[LET_INIT])
        {
            if (arg.flags & F_IMPLICIT)
                fail_qdlHeyRs("TODO default implicit arguments"_fu, tokens, _idx, fname, src);
        ...
        else if (defaults)
        {
            if (!(arg.flags & F_MUSTNAME))
                fail_qdlHeyRs("TODO non-trailing default arguments"_fu, tokens, _idx, fname, src);
...
static s_Node createBlock_fTMQ53tq(const fu_VEC<s_Node>& items, const fu_STR& label, const int modid, const int _loc)
{
    return make_YUyWsb6L("block"_fu, items, 0, label, modid, _loc);
}

static s_Node parseBlock_6GTsIxpa(int& _idx, fu::view<s_Token> tokens, int& _col0, fu_VEC<fu_STR>& warnings, const s_Options& options, const fu_STR& fname, const fu_STR& src, int& _loc, int& _precedence, const int modid, int& _fnDepth, fu_VEC<fu_STR>& _dollars, int& _dollarAuto, bool& _hasPUB, fu_VEC<fu_STR>& fuzimports, int& _anonFns)
{
    fu_VEC<s_Node> _0 {};
    return (_0 = parseBlockLike_a2fqWS3u("op"_fu, "}"_fu, false, false, _idx, tokens, _col0, warnings, options, fname, src, _loc, _precedence, modid, _fnDepth, _dollars, _dollarAuto, _hasPUB, fuzimports, _anonFns), createBlock_fTMQ53tq(static_cast<fu_VEC<s_Node>&&>(_0), (*(const fu_STR*)fu::NIL), modid, _loc));
}

static s_Node parseLabelledStatement_bBivss9s(fu::view<s_Token> tokens, int& _idx, const fu_STR& fname, const fu_STR& src, int& _loc, int& _col0, fu_VEC<fu_STR>& warnings, const s_Options& options, int& _precedence, const int modid, int& _fnDepth, fu_VEC<fu_STR>& _dollars, int& _dollarAuto, bool& _hasPUB, fu_VEC<fu_STR>& fuzimports, int& _anonFns)
{
    const fu_STR& label = consume_cXsTfP3W("id"_fu, fu::view<char>{}, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src).value;
    /*MOV*/ s_Node stmt = parseStatement_TnImdy8H(_loc, tokens, _idx, fname, src, _col0, warnings, options, _precedence, modid, _fnDepth, _dollars, _dollarAuto, _hasPUB, fuzimports, _anonFns);
    if ((stmt.kind == "loop"_fu) || (stmt.kind == "block"_fu))
    {
        if (stmt.value)
            fail_qdlHeyRs((((("Label `"_fu + label) + "`: statement already labeled as `"_fu) + stmt.value) + "`."_fu), tokens, _idx, fname, src);

        stmt.value = label;
        return /*NRVO*/ stmt;
    };
    return createBlock_fTMQ53tq(fu_VEC<s_Node> { fu::slate<1, s_Node> { s_Node(stmt) } }, label, modid, _loc);
}

static void softSemi_UdzY4MwP(fu::view<s_Token> tokens, int& _idx, const int _col0, fu_VEC<fu_STR>& warnings, const s_Options& options, fu::view<char> fname, const fu_STR& src, const int _loc)
{
    ...
    warn_E50qN7lA((("Missing semicollon before `"_fu + peek.value) + "`."_fu), warnings, options, tokens, _idx, fname, src, _loc);
}
...
static s_Node parseLetStmt_Q72lNbf5(fu::view<s_Token> tokens, int& _idx, const fu_STR& fname, const fu_STR& src, int& _precedence, int& _loc, int& _col0, fu_VEC<fu_STR>& warnings, const s_Options& options, const int modid, int& _fnDepth, fu_VEC<fu_STR>& _dollars, int& _dollarAuto, bool& _hasPUB, fu_VEC<fu_STR>& fuzimports, int& _anonFns)
{
    ...
    softSemi_UdzY4MwP(tokens, _idx, _col0, warnings, options, fname, src, _loc);
    return /*NRVO*/ ret;
}
...
static s_Node pipelineLeft_jSPHxmTB(/*MOV*/ s_Node&& left, const s_Node& right, fu::view<s_Token> tokens, const int _idx, fu::view<char> fname, const fu_STR& src)
{
    if (left.kind != "call"_fu)
        fail_qdlHeyRs("Cannot pipeline: not a call expr."_fu, tokens, _idx, fname, src);
...
static s_Node parseExpressionStatement_6ScTKJdc(int& _precedence, int& _loc, int& _idx, int& _col0, fu::view<s_Token> tokens, fu_VEC<fu_STR>& warnings, const s_Options& options, const fu_STR& fname, const fu_STR& src, const int modid, int& _fnDepth, fu_VEC<fu_STR>& _dollars, int& _dollarAuto, bool& _hasPUB, fu_VEC<fu_STR>& fuzimports, int& _anonFns)
{
    ...
    if (tryConsume_atxtlpan("op"_fu, ":"_fu, tokens, _idx))
    {
        if (!(expr.kind == "call"_fu))
            fail_qdlHeyRs("Cannot pipeline: expression is not a call."_fu, tokens, _idx, fname, src);
...
static s_Node parseLetOrExpressionStatement_R38NSHBa(fu::view<s_Token> tokens, int& _idx, const fu_STR& fname, const fu_STR& src, int& _precedence, int& _loc, int& _col0, fu_VEC<fu_STR>& warnings, const s_Options& options, const int modid, int& _fnDepth, fu_VEC<fu_STR>& _dollars, int& _dollarAuto, bool& _hasPUB, fu_VEC<fu_STR>& fuzimports, int& _anonFns)
{
    const s_Token& token = tokens[_idx++];
    ...
    _idx--;
    if (!_fnDepth)
        fail_qdlHeyRs(fu_STR{}, tokens, _idx, fname, src);

    return parseExpressionStatement_6ScTKJdc(_precedence, _loc, _idx, _col0, tokens, warnings, options, fname, src, modid, _fnDepth, _dollars, _dollarAuto, _hasPUB, fuzimports, _anonFns);
}
...
{
    return make_YUyWsb6L("call"_fu, args, flags, id, modid, _loc);
}
...
{
    return make_YUyWsb6L("if"_fu, fu_VEC<s_Node> { fu::slate<3, s_Node> { s_Node(cond), s_Node(cons), s_Node(alt) } }, 0, (*(const fu_STR*)fu::NIL), modid, _loc);
}
...
static s_Node flattenIfSame_cmDoLEpS(const fu_STR& kind, const s_Node& left, const s_Node& right, const int modid, const int _loc)
{
    ...
    return make_YUyWsb6L(kind, items, 0, (*(const fu_STR*)fu::NIL), modid, _loc);
}
...
static s_Node parseIf_1ZTKJr5O(fu::view<s_Token> tokens, int& _idx, const fu_STR& fname, const fu_STR& src, int& _precedence, int& _loc, int& _col0, fu_VEC<fu_STR>& warnings, const s_Options& options, const int modid, int& _fnDepth, fu_VEC<fu_STR>& _dollars, int& _dollarAuto, bool& _hasPUB, fu_VEC<fu_STR>& fuzimports, int& _anonFns)
{
    ...
    const s_Token& nOt = tryConsume_atxtlpan("op"_fu, "!"_fu, tokens, _idx);
    consume_cXsTfP3W("op"_fu, "("_fu, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src);
    s_Node cond = parseLetOrExpressionStatement_R38NSHBa(tokens, _idx, fname, src, _precedence, _loc, _col0, warnings, options, modid, _fnDepth, _dollars, _dollarAuto, _hasPUB, fuzimports, _anonFns);
    consume_cXsTfP3W("op"_fu, ")"_fu, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src);
    if (nOt)
        cond = createPrefix_eVKcrEsN("!"_fu, s_Node(cond), modid, _loc);

    s_Node cons = parseStatement_TnImdy8H(_loc, tokens, _idx, fname, src, _col0, warnings, options, _precedence, modid, _fnDepth, _dollars, _dollarAuto, _hasPUB, fuzimports, _anonFns);
    const s_Token& eLse = tryConsume_atxtlpan("id"_fu, "else"_fu, tokens, _idx);
    if (eLse)
    {
        if (!((eLse.line == token_1.line) || (eLse.col == token_1.col)))
            warn_E50qN7lA((x7E((x7E((x7E("Inconsistent indent at `else`: expected "_fu, fu::i64dec(token_1.col)) + ", got "_fu), fu::i64dec(eLse.col)) + ". `if` starts on line "_fu), fu::i64dec(token_1.line)) + "."_fu), warnings, options, tokens, _idx, fname, src, _loc);

        s_Node alt = parseStatement_TnImdy8H(_loc, tokens, _idx, fname, src, _col0, warnings, options, _precedence, modid, _fnDepth, _dollars, _dollarAuto, _hasPUB, fuzimports, _anonFns);
...
{
    return make_YUyWsb6L("loop"_fu, fu_VEC<s_Node> { fu::slate<5, s_Node> { s_Node(init), s_Node(pre_cond), s_Node(body), s_Node(post_cond), s_Node(post) } }, 0, (*(const fu_STR*)fu::NIL), modid, _loc);
}
...
{
    consume_cXsTfP3W("op"_fu, "("_fu, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src);
    if (tryConsume_atxtlpan("id"_fu, "fieldname"_fu, tokens, _idx))
    {
        const fu_STR& placeholder = consume_cXsTfP3W("id"_fu, fu::view<char>{}, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src).value;
        consume_cXsTfP3W("op"_fu, ":"_fu, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src);
        ...
        consume_cXsTfP3W("op"_fu, ")"_fu, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src);
        s_Node body = parseStatement_TnImdy8H(_loc, tokens, _idx, fname, src, _col0, warnings, options, _precedence, modid, _fnDepth, _dollars, _dollarAuto, _hasPUB, fuzimports, _anonFns);
        return make_YUyWsb6L("forfieldsof"_fu, fu_VEC<s_Node> { fu::slate<2, s_Node> { s_Node(type), s_Node(body) } }, 0, placeholder, modid, _loc);
    };
    s_Node init = (!tryConsume_atxtlpan("op"_fu, ";"_fu, tokens, _idx) ? parseStatement_TnImdy8H(_loc, tokens, _idx, fname, src, _col0, warnings, options, _precedence, modid, _fnDepth, _dollars, _dollarAuto, _hasPUB, fuzimports, _anonFns) : s_Node{});
    if (init && (init.kind != "let"_fu))
        fail_qdlHeyRs((("`for` expects a `let` statement, got a `"_fu + init.kind) + "`."_fu), tokens, _idx, fname, src);

    s_Node pre_cond = (!tryConsume_atxtlpan("op"_fu, ";"_fu, tokens, _idx) ? parseLetOrExpressionStatement_R38NSHBa(tokens, _idx, fname, src, _precedence, _loc, _col0, warnings, options, modid, _fnDepth, _dollars, _dollarAuto, _hasPUB, fuzimports, _anonFns) : s_Node{});
    const s_Token& token = tokens[_idx];
    s_Node post = (!((token.kind == "op"_fu) && (token.value == ")"_fu)) ? parseParens_ys7cvKtm(_precedence, _loc, _idx, _col0, tokens, warnings, options, fname, src, modid, _fnDepth, _dollars, _dollarAuto, _hasPUB, fuzimports, _anonFns) : ((void)(consume_cXsTfP3W("op"_fu, ")"_fu, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src) ? void() : void()), s_Node{}));
    s_Node body = parseStatement_TnImdy8H(_loc, tokens, _idx, fname, src, _col0, warnings, options, _precedence, modid, _fnDepth, _dollars, _dollarAuto, _hasPUB, fuzimports, _anonFns);
...
{
    consume_cXsTfP3W("op"_fu, "("_fu, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src);
    s_Node pre_cond = parseLetOrExpressionStatement_R38NSHBa(tokens, _idx, fname, src, _precedence, _loc, _col0, warnings, options, modid, _fnDepth, _dollars, _dollarAuto, _hasPUB, fuzimports, _anonFns);
    consume_cXsTfP3W("op"_fu, ")"_fu, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src);
    s_Node body = parseStatement_TnImdy8H(_loc, tokens, _idx, fname, src, _col0, warnings, options, _precedence, modid, _fnDepth, _dollars, _dollarAuto, _hasPUB, fuzimports, _anonFns);
...
{
    s_Node body = parseStatement_TnImdy8H(_loc, tokens, _idx, fname, src, _col0, warnings, options, _precedence, modid, _fnDepth, _dollars, _dollarAuto, _hasPUB, fuzimports, _anonFns);
    consume_cXsTfP3W("id"_fu, "while"_fu, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src);
    consume_cXsTfP3W("op"_fu, "("_fu, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src);
    s_Node post_cond = parseLetOrExpressionStatement_R38NSHBa(tokens, _idx, fname, src, _precedence, _loc, _col0, warnings, options, modid, _fnDepth, _dollars, _dollarAuto, _hasPUB, fuzimports, _anonFns);
    consume_cXsTfP3W("op"_fu, ")"_fu, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src);
    softSemi_UdzY4MwP(tokens, _idx, _col0, warnings, options, fname, src, _loc);
...
{
    return make_YUyWsb6L(kind, (expr ? fu_VEC<s_Node> { fu::slate<1, s_Node> { s_Node(expr) } } : fu_VEC<s_Node>{}), flags, label, modid, _loc);
}
...
static s_Node parseJump_Pkk6l58R(const fu_STR& kind, int& _fnDepth, int& _idx, fu::view<s_Token> tokens, const fu_STR& fname, const fu_STR& src, int& _precedence, int& _loc, int& _col0, fu_VEC<fu_STR>& warnings, const s_Options& options, const int modid, fu_VEC<fu_STR>& _dollars, int& _dollarAuto, bool& _hasPUB, fu_VEC<fu_STR>& fuzimports, int& _anonFns)
{
    ...
    const fu_STR& label = (tryConsume_atxtlpan("op"_fu, ":"_fu, tokens, _idx) ? consume_cXsTfP3W("id"_fu, fu::view<char>{}, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src).value : (*(const fu_STR*)fu::NIL));
    s_Node expr {};
    if (!tryConsume_atxtlpan("op"_fu, ";"_fu, tokens, _idx))
    {
...
{
    return createCall_1w7rGfTT((id ? id : fail_qdlHeyRs(fu_STR{}, tokens, _idx, fname, src)), F_ID, (*(const fu_VEC<s_Node>*)fu::NIL), modid, _loc);
}
...
{
    return make_YUyWsb6L("let"_fu, fu_VEC<s_Node> { fu::slate<2, s_Node> { s_Node(type), s_Node(init) } }, flags, id, modid, _loc);
}
...
{
    const fu_STR& id = consume_cXsTfP3W("id"_fu, fu::view<char>{}, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src).value;
...
static s_Node parseTryCatch_v9KP5fed(int& _fnDepth, int& _idx, fu::view<s_Token> tokens, const fu_STR& fname, const fu_STR& src, int& _loc, int& _col0, fu_VEC<fu_STR>& warnings, const s_Options& options, int& _precedence, const int modid, fu_VEC<fu_STR>& _dollars, int& _dollarAuto, bool& _hasPUB, fu_VEC<fu_STR>& fuzimports, int& _anonFns)
{
    ...
    s_Node tRy = parseStatement_TnImdy8H(_loc, tokens, _idx, fname, src, _col0, warnings, options, _precedence, modid, _fnDepth, _dollars, _dollarAuto, _hasPUB, fuzimports, _anonFns);
    consume_cXsTfP3W("id"_fu, "catch"_fu, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src);
    consume_cXsTfP3W("op"_fu, "("_fu, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src);
    s_Node err = parseCatchErrvar_QTXAXvAY(tokens, _idx, fname, src, modid, _loc);
    consume_cXsTfP3W("op"_fu, ")"_fu, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src);
    s_Node cAtch = parseStatement_TnImdy8H(_loc, tokens, _idx, fname, src, _col0, warnings, options, _precedence, modid, _fnDepth, _dollars, _dollarAuto, _hasPUB, fuzimports, _anonFns);
    return make_YUyWsb6L("try"_fu, fu_VEC<s_Node> { fu::slate<3, s_Node> { s_Node(tRy), s_Node(err), s_Node(cAtch) } }, 0, (*(const fu_STR*)fu::NIL), modid, _loc);
}

                                #ifndef DEFt_each_aGxjHmJe
                                #define DEFt_each_aGxjHmJe
inline void each_aGxjHmJe(fu_VEC<s_Node>& a)
{
    for (int i = 0; i < a.size(); i++)
    {
...
static s_Node parseStructDecl_BBYoeFzV(const int flags, fu::view<s_Token> tokens, int& _idx, const fu_STR& fname, const fu_STR& src, int& _col0, fu_VEC<fu_STR>& warnings, const s_Options& options, int& _loc, int& _precedence, const int modid, int& _fnDepth, fu_VEC<fu_STR>& _dollars, int& _dollarAuto, bool& _hasPUB, fu_VEC<fu_STR>& fuzimports, int& _anonFns)
{
    const fu_STR& name = tryConsume_atxtlpan("id"_fu, fu::view<char>{}, tokens, _idx).value;
    consume_cXsTfP3W("op"_fu, "{"_fu, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src);
    fu_VEC<s_Node> items = parseBlockLike_a2fqWS3u("op"_fu, "}"_fu, true, false, _idx, tokens, _col0, warnings, options, fname, src, _loc, _precedence, modid, _fnDepth, _dollars, _dollarAuto, _hasPUB, fuzimports, _anonFns);
    ...
    return make_YUyWsb6L("struct"_fu, items, flags, name, modid, _loc);
}

static s_Node parseTypedef_b1dJ9Rbd(fu::view<s_Token> tokens, int& _idx, const fu_STR& fname, const fu_STR& src, int& _precedence, int& _loc, int& _col0, fu_VEC<fu_STR>& warnings, const s_Options& options, const int modid, int& _fnDepth, fu_VEC<fu_STR>& _dollars, int& _dollarAuto, bool& _hasPUB, fu_VEC<fu_STR>& fuzimports, int& _anonFns)
{
    const fu_STR& name = consume_cXsTfP3W("id"_fu, fu::view<char>{}, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src).value;
    consume_cXsTfP3W("op"_fu, "="_fu, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src);
    ...
    softSemi_UdzY4MwP(tokens, _idx, _col0, warnings, options, fname, src, _loc);
    return make_YUyWsb6L("typedef"_fu, fu_VEC<s_Node> { fu::slate<1, s_Node> { s_Node(annot) } }, 0, name, modid, _loc);
}

static void set_PUB_l6mGzOMy(int& flags, fu::view<s_Token> tokens, const int _idx, fu::view<char> fname, const fu_STR& src, bool& _hasPUB)
{
    flags |= F_PUB;
    if (flags & F_SHADOW)
        fail_qdlHeyRs("Cannot pub a shadow."_fu, tokens, _idx, fname, src);

    _hasPUB = true;
}

static s_Node parsePub_5u8fUDSk(int& _fnDepth, fu::view<s_Token> tokens, int& _idx, const fu_STR& fname, const fu_STR& src, int& _loc, int& _col0, fu_VEC<fu_STR>& warnings, const s_Options& options, int& _precedence, const int modid, fu_VEC<fu_STR>& _dollars, int& _dollarAuto, bool& _hasPUB, fu_VEC<fu_STR>& fuzimports, int& _anonFns)
{
    if (_fnDepth)
        fail_qdlHeyRs("Cannot pub from within a fn."_fu, tokens, _idx, fname, src);

    /*MOV*/ s_Node out = parseStatement_TnImdy8H(_loc, tokens, _idx, fname, src, _col0, warnings, options, _precedence, modid, _fnDepth, _dollars, _dollarAuto, _hasPUB, fuzimports, _anonFns);
    set_PUB_l6mGzOMy(out.flags, tokens, _idx, fname, src, _hasPUB);
    return /*NRVO*/ out;
}

static s_Node parseShadow_mhOGRJxt(int& _loc, fu::view<s_Token> tokens, int& _idx, const fu_STR& fname, const fu_STR& src, int& _col0, fu_VEC<fu_STR>& warnings, const s_Options& options, int& _precedence, const int modid, int& _fnDepth, fu_VEC<fu_STR>& _dollars, int& _dollarAuto, bool& _hasPUB, fu_VEC<fu_STR>& fuzimports, int& _anonFns)
{
    /*MOV*/ s_Node out = parseStatement_TnImdy8H(_loc, tokens, _idx, fname, src, _col0, warnings, options, _precedence, modid, _fnDepth, _dollars, _dollarAuto, _hasPUB, fuzimports, _anonFns);
    out.flags |= F_SHADOW;
    if (out.flags & F_PUB)
        fail_qdlHeyRs("Cannot shadow a pub."_fu, tokens, _idx, fname, src);
...
static s_Node parseFixityDecl_959qKhDh(const int flags, const bool expr, fu::view<s_Token> tokens, int& _idx, const fu_STR& fname, const fu_STR& src, const int modid, int& _loc, int& _fnDepth, fu_VEC<fu_STR>& _dollars, int& _dollarAuto, int& _precedence, int& _col0, fu_VEC<fu_STR>& warnings, const s_Options& options, bool& _hasPUB, fu_VEC<fu_STR>& fuzimports, int& _anonFns)
{
    if ((flags & F_CONVERSION) && (flags & ((F_INFIX | F_PREFIX) | F_POSTFIX)))
        fail_qdlHeyRs("`implicit` functions can't be operators."_fu, tokens, _idx, fname, src);

    consume_cXsTfP3W("id"_fu, "fn"_fu, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src);
...
{
    flags |= F;
    fu::view<char> v = consume_cXsTfP3W("id"_fu, fu::view<char>{}, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src).value;
    if (v == "infix"_fu)
...
static s_Node parsePureDecl_3EiBDZ3u(const int flags, fu::view<s_Token> tokens, int& _idx, const fu_STR& fname, const fu_STR& src, const int modid, int& _loc, int& _fnDepth, fu_VEC<fu_STR>& _dollars, int& _dollarAuto, int& _precedence, int& _col0, fu_VEC<fu_STR>& warnings, const s_Options& options, bool& _hasPUB, fu_VEC<fu_STR>& fuzimports, int& _anonFns)
{
    return parseInlineDecl_UHbAuHnk(int(flags), F_PURE, tokens, _idx, fname, src, modid, _loc, _fnDepth, _dollars, _dollarAuto, _precedence, _col0, warnings, options, _hasPUB, fuzimports, _anonFns);
}

static s_Node parseConversionDecl_Ymjs1Q6V(fu::view<s_Token> tokens, int& _idx, const fu_STR& fname, const fu_STR& src, const int modid, int& _loc, int& _fnDepth, fu_VEC<fu_STR>& _dollars, int& _dollarAuto, int& _precedence, int& _col0, fu_VEC<fu_STR>& warnings, const s_Options& options, bool& _hasPUB, fu_VEC<fu_STR>& fuzimports, int& _anonFns)
{
    fu::view<char> v = consume_cXsTfP3W("id"_fu, fu::view<char>{}, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src).value;
    if (v == "pure"_fu)
        return parsePureDecl_3EiBDZ3u(int(F_CONVERSION), tokens, _idx, fname, src, modid, _loc, _fnDepth, _dollars, _dollarAuto, _precedence, _col0, warnings, options, _hasPUB, fuzimports, _anonFns);
...
static s_Node parseNoCopy_nMKB3E06(fu::view<s_Token> tokens, int& _idx, const fu_STR& fname, const fu_STR& src, int& _col0, fu_VEC<fu_STR>& warnings, const s_Options& options, int& _loc, int& _precedence, const int modid, int& _fnDepth, fu_VEC<fu_STR>& _dollars, int& _dollarAuto, bool& _hasPUB, fu_VEC<fu_STR>& fuzimports, int& _anonFns)
{
    consume_cXsTfP3W("id"_fu, "struct"_fu, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src);
    return parseStructDecl_BBYoeFzV(F_NOCOPY, tokens, _idx, fname, src, _col0, warnings, options, _loc, _precedence, modid, _fnDepth, _dollars, _dollarAuto, _hasPUB, fuzimports, _anonFns);
}

static s_Node parseNovec_P5Vw1YxD(fu::view<s_Token> tokens, int& _idx, const fu_STR& fname, const fu_STR& src, const int modid, int& _loc, int& _fnDepth, fu_VEC<fu_STR>& _dollars, int& _dollarAuto, int& _precedence, int& _col0, fu_VEC<fu_STR>& warnings, const s_Options& options, bool& _hasPUB, fu_VEC<fu_STR>& fuzimports, int& _anonFns)
{
    return parseInlineDecl_UHbAuHnk(0, F_NOVEC, tokens, _idx, fname, src, modid, _loc, _fnDepth, _dollars, _dollarAuto, _precedence, _col0, warnings, options, _hasPUB, fuzimports, _anonFns);
}
...
static fu_STR registerImport_gWKzh8Ab(/*MOV*/ fu_STR&& value, const fu_STR& fname, fu_VEC<fu_STR>& fuzimports)
{
...
static s_Node parseImport_8ljzO6nU(fu::view<s_Token> tokens, int& _idx, const fu_STR& fname, const fu_STR& src, const int _col0, fu_VEC<fu_STR>& warnings, const s_Options& options, const int _loc, fu_VEC<fu_STR>& fuzimports, const int modid)
{
    fu_STR value { tryConsume_atxtlpan("id"_fu, fu::view<char>{}, tokens, _idx).value };
    if (value)
    {
        while (tryConsume_atxtlpan("op"_fu, "::"_fu, tokens, _idx))
            value += ("/"_fu + consume_cXsTfP3W("id"_fu, fu::view<char>{}, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src).value);

    }
    else
        value = consume_cXsTfP3W("str"_fu, fu::view<char>{}, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src).value;

    softSemi_UdzY4MwP(tokens, _idx, _col0, warnings, options, fname, src, _loc);
    value = registerImport_gWKzh8Ab(fu_STR(value), fname, fuzimports);
    return make_YUyWsb6L("import"_fu, (*(const fu_VEC<s_Node>*)fu::NIL), 0, value, modid, _loc);
}

static s_Node parseCompilerPragma_wp5VWpcA(fu::view<s_Token> tokens, int& _idx, fu::view<char> fname, const fu_STR& src, const int modid, const int _loc, const int _col0, fu_VEC<fu_STR>& warnings, const s_Options& options)
{
    /*MOV*/ s_Node ret = make_YUyWsb6L("compiler"_fu, (*(const fu_VEC<s_Node>*)fu::NIL), 0, consume_cXsTfP3W("id"_fu, fu::view<char>{}, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src).value, modid, _loc);
    softSemi_UdzY4MwP(tokens, _idx, _col0, warnings, options, fname, src, _loc);
    return /*NRVO*/ ret;
}
...
static s_Node parsePrimDecl_UUHpCQvR(const bool eNum, fu::view<s_Token> tokens, int& _idx, int& _precedence, int& _loc, int& _col0, fu_VEC<fu_STR>& warnings, const s_Options& options, const fu_STR& fname, const fu_STR& src, const int modid, int& _fnDepth, fu_VEC<fu_STR>& _dollars, int& _dollarAuto, bool& _hasPUB, fu_VEC<fu_STR>& fuzimports, int& _anonFns)
{
    const fu_STR& name = tryConsume_atxtlpan("id"_fu, fu::view<char>{}, tokens, _idx).value;
    ...
    fu_VEC<s_Node> items = (tryConsume_atxtlpan("op"_fu, "{"_fu, tokens, _idx) ? parseBlockLike_a2fqWS3u("op"_fu, "}"_fu, false, true, _idx, tokens, _col0, warnings, options, fname, src, _loc, _precedence, modid, _fnDepth, _dollars, _dollarAuto, _hasPUB, fuzimports, _anonFns) : fu_VEC<s_Node>{});
    if (eNum)
    {
        if (!(items))
            fail_qdlHeyRs("`enum` declarations require a non-empty { list of variants }."_fu, tokens, _idx, fname, src);

    }
    else
    {
        if (!(annot))
            fail_qdlHeyRs("`primitive` declarations require a base type annotation."_fu, tokens, _idx, fname, src);

    };
    return make_YUyWsb6L("primdecl"_fu, fu_VEC<s_Node> { fu::slate<2, s_Node> { s_Node(annot), (items ? make_YUyWsb6L("items"_fu, items, 0, (*(const fu_STR*)fu::NIL), modid, _loc) : s_Node{}) } }, (eNum ? F_ENUM : (*(const int*)fu::NIL)), name, modid, _loc);
}

static s_Node parseStatement_TnImdy8H(int& _loc, fu::view<s_Token> tokens, int& _idx, const fu_STR& fname, const fu_STR& src, int& _col0, fu_VEC<fu_STR>& warnings, const s_Options& options, int& _precedence, const int modid, int& _fnDepth, fu_VEC<fu_STR>& _dollars, int& _dollarAuto, bool& _hasPUB, fu_VEC<fu_STR>& fuzimports, int& _anonFns)
{
    const int loc0 = _loc;
    fu_DEFER(_loc = loc0);
    const s_Token* _0;
    const s_Token& token = (*(_0 = &(tokens[(_loc = _idx++)])) ? *_0 : fail_qdlHeyRs(fu_STR{}, tokens, _idx, fname, src));
    if (token.kind == "op"_fu)
    {
        fu::view<char> v = token.value;
        if (v == "{"_fu)
            return parseBlock_6GTsIxpa(_idx, tokens, _col0, warnings, options, fname, src, _loc, _precedence, modid, _fnDepth, _dollars, _dollarAuto, _hasPUB, fuzimports, _anonFns);

        if (v == ":"_fu)
            return parseLabelledStatement_bBivss9s(tokens, _idx, fname, src, _loc, _col0, warnings, options, _precedence, modid, _fnDepth, _dollars, _dollarAuto, _hasPUB, fuzimports, _anonFns);
    ...
    else if (token.kind == "id"_fu)
    {
        ...
        if (peek.kind == "op"_fu)
        {
            if ((peek.value == "{"_fu) && (v == "struct"_fu))
                return parseStructDecl_BBYoeFzV(0, tokens, _idx, fname, src, _col0, warnings, options, _loc, _precedence, modid, _fnDepth, _dollars, _dollarAuto, _hasPUB, fuzimports, _anonFns);
        ...
        if (peek.kind == "id"_fu)
        {
            ...
            if (v == "type"_fu)
                return parseTypedef_b1dJ9Rbd(tokens, _idx, fname, src, _precedence, _loc, _col0, warnings, options, modid, _fnDepth, _dollars, _dollarAuto, _hasPUB, fuzimports, _anonFns);

            if (v == "pub"_fu)
                return parsePub_5u8fUDSk(_fnDepth, tokens, _idx, fname, src, _loc, _col0, warnings, options, _precedence, modid, _dollars, _dollarAuto, _hasPUB, fuzimports, _anonFns);

            if (v == "shadow"_fu)
                return parseShadow_mhOGRJxt(_loc, tokens, _idx, fname, src, _col0, warnings, options, _precedence, modid, _fnDepth, _dollars, _dollarAuto, _hasPUB, fuzimports, _anonFns);

            if (v == "using"_fu)
                return parseConversionDecl_Ymjs1Q6V(tokens, _idx, fname, src, modid, _loc, _fnDepth, _dollars, _dollarAuto, _precedence, _col0, warnings, options, _hasPUB, fuzimports, _anonFns);

            if (v == "nocopy"_fu)
                return parseNoCopy_nMKB3E06(tokens, _idx, fname, src, _col0, warnings, options, _loc, _precedence, modid, _fnDepth, _dollars, _dollarAuto, _hasPUB, fuzimports, _anonFns);

            if (v == "novec"_fu)
                return parseNovec_P5Vw1YxD(tokens, _idx, fname, src, modid, _loc, _fnDepth, _dollars, _dollarAuto, _precedence, _col0, warnings, options, _hasPUB, fuzimports, _anonFns);

            if (v == "import"_fu)
                return parseImport_8ljzO6nU(tokens, _idx, fname, src, _col0, warnings, options, _loc, fuzimports, modid);

            if (v == "compiler"_fu)
                return parseCompilerPragma_wp5VWpcA(tokens, _idx, fname, src, modid, _loc, _col0, warnings, options);

            if (v == "pure"_fu)
                return parsePureDecl_3EiBDZ3u(0, tokens, _idx, fname, src, modid, _loc, _fnDepth, _dollars, _dollarAuto, _precedence, _col0, warnings, options, _hasPUB, fuzimports, _anonFns);
            ...
            if (v == "primitive"_fu)
                return parsePrimDecl_UUHpCQvR(false, tokens, _idx, _precedence, _loc, _col0, warnings, options, fname, src, modid, _fnDepth, _dollars, _dollarAuto, _hasPUB, fuzimports, _anonFns);

            if (v == "enum"_fu)
                return parsePrimDecl_UUHpCQvR(true, tokens, _idx, _precedence, _loc, _col0, warnings, options, fname, src, modid, _fnDepth, _dollars, _dollarAuto, _hasPUB, fuzimports, _anonFns);

            if (v == "effect"_fu)
                return parseStructDecl_BBYoeFzV(F_EFFECT, tokens, _idx, fname, src, _col0, warnings, options, _loc, _precedence, modid, _fnDepth, _dollars, _dollarAuto, _hasPUB, fuzimports, _anonFns);

        };
    };
    _idx--;
    return parseLetOrExpressionStatement_R38NSHBa(tokens, _idx, fname, src, _precedence, _loc, _col0, warnings, options, modid, _fnDepth, _dollars, _dollarAuto, _hasPUB, fuzimports, _anonFns);
}
...
{
    tryConsume_atxtlpan("op"_fu, "="_fu, tokens, _idx);
    /*MOV*/ s_Node body = (expr ? parseExpression_V9QrobCn(_precedence, 0, _precedence, _loc, _idx, _col0, tokens, warnings, options, fname, src, modid, _fnDepth, _dollars, _dollarAuto, _hasPUB, fuzimports, _anonFns) : parseStatement_TnImdy8H(_loc, tokens, _idx, fname, src, _col0, warnings, options, _precedence, modid, _fnDepth, _dollars, _dollarAuto, _hasPUB, fuzimports, _anonFns));
    if (body.kind == "block"_fu)
    {
        if (body.items && (last_LRqPEddz(body.items).kind != "return"_fu))
            body.items += make_YUyWsb6L("void"_fu, (*(const fu_VEC<s_Node>*)fu::NIL), 0, (*(const fu_STR*)fu::NIL), modid, _loc);

        return /*NRVO*/ body;
    };
    if (body.kind == "return"_fu)
        return createBlock_fTMQ53tq(fu_VEC<s_Node> { fu::slate<1, s_Node> { s_Node(body) } }, (*(const fu_STR*)fu::NIL), modid, _loc);

    if ((body.kind == "call"_fu) && (body.value == "__native"_fu))
        return /*NRVO*/ body;

    return createBlock_fTMQ53tq(fu_VEC<s_Node> { fu::slate<1, s_Node> { createReturn_URxia6JW(body, F_SINGLE_STMT, modid, _loc) } }, (*(const fu_STR*)fu::NIL), modid, _loc);
}

static void parseBranch_vQbNqtQj(const bool noCond, int& _precedence, int& _loc, int& _idx, int& _col0, fu::view<s_Token> tokens, fu_VEC<fu_STR>& warnings, const s_Options& options, const fu_STR& fname, const fu_STR& src, const int modid, int& _fnDepth, fu_VEC<fu_STR>& _dollars, int& _dollarAuto, bool& _hasPUB, fu_VEC<fu_STR>& fuzimports, int& _anonFns, fu_VEC<s_Node>& branches)
{
    ...
    branches.push(make_YUyWsb6L("fnbranch"_fu, fu_VEC<s_Node> { fu::slate<3, s_Node> { s_Node(cond), s_Node(type), s_Node(cons) } }, 0, (*(const fu_STR*)fu::NIL), modid, _loc));
}
...
static int parseFnBodyOrPattern_0EBJAg0U(fu_VEC<s_Node>& out_push_body, const bool expr, fu::view<s_Token> tokens, int& _idx, int& _precedence, int& _loc, int& _col0, fu_VEC<fu_STR>& warnings, const s_Options& options, const fu_STR& fname, const fu_STR& src, const int modid, int& _fnDepth, fu_VEC<fu_STR>& _dollars, int& _dollarAuto, bool& _hasPUB, fu_VEC<fu_STR>& fuzimports, int& _anonFns)
{
    ...
    s_Node body {};
    if (!expr && tryConsume_atxtlpan("id"_fu, "case"_fu, tokens, _idx))
    {
        fu_VEC<s_Node> branches {};
        do
            parseBranch_vQbNqtQj(bool{}, _precedence, _loc, _idx, _col0, tokens, warnings, options, fname, src, modid, _fnDepth, _dollars, _dollarAuto, _hasPUB, fuzimports, _anonFns, branches);
        while (tryConsume_atxtlpan("id"_fu, "case"_fu, tokens, _idx));
        if (tryConsume_atxtlpan("id"_fu, "default"_fu, tokens, _idx))
            parseBranch_vQbNqtQj(true, _precedence, _loc, _idx, _col0, tokens, warnings, options, fname, src, modid, _fnDepth, _dollars, _dollarAuto, _hasPUB, fuzimports, _anonFns, branches);

        body = make_YUyWsb6L("pattern"_fu, branches, 0, (*(const fu_STR*)fu::NIL), modid, _loc);
    }
    else
...
static s_Node parseFnDecl_cont_A5K0e9oP(const fu_STR& name, int flags, const bool expr, const fu_STR& endv, int& _fnDepth, fu_VEC<fu_STR>& _dollars, int& _dollarAuto, fu::view<s_Token> tokens, int& _idx, const fu_STR& fname, const fu_STR& src, int& _precedence, int& _loc, int& _col0, fu_VEC<fu_STR>& warnings, const s_Options& options, const int modid, bool& _hasPUB, fu_VEC<fu_STR>& fuzimports, int& _anonFns)
{
    ...
    if ((name == "main"_fu) && (_fnDepth == 1))
    {
        if (!type)
            ...
            fail_qdlHeyRs("fn main() must return i32."_fu, tokens, _idx, fname, src);

        set_PUB_l6mGzOMy(flags, tokens, _idx, fname, src, _hasPUB);
        flags |= F_EXTERN;
    };
    if (_dollars.size() > dollars0)
        flags |= F_TEMPLATE;

    return make_YUyWsb6L("fn"_fu, items, flags, name, modid, _loc);
}
...
{
    fu_STR name { tryConsume_atxtlpan("id"_fu, fu::view<char>{}, tokens, _idx).value };
    if (!name)
    {
        const int postfix = (flags & F_POSTFIX);
        name = consume_cXsTfP3W("op"_fu, fu::view<char>{}, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src).value;
        if (postfix)
        {
            if (!((name == "++"_fu) || (name == "--"_fu)))
                fail_qdlHeyRs((("No such postfix operator: `"_fu + name) + "`."_fu), tokens, _idx, fname, src);
        ...
        else if (flags & F_INFIX)
        {
            if (!(has_cl8EZmVy(BINOP.PRECEDENCE, name)))
                fail_qdlHeyRs((("No such infix operator: `"_fu + name) + "`."_fu), tokens, _idx, fname, src);

        }
        else if (flags & F_PREFIX)
        {
            if (!(has_1sVrc6q5(PREFIX, name)))
                fail_qdlHeyRs((("No such prefix operator: `"_fu + name) + "`."_fu), tokens, _idx, fname, src);
        ...
        fail_qdlHeyRs((("Not an operator: `"_fu + name) + "`."_fu), tokens, _idx, fname, src);

    fu_STR endv = (tryConsume_atxtlpan("op"_fu, "("_fu, tokens, _idx) ? ")"_fu : fu_STR{});
    if (!endv)
    {
        if (expr)
...
static fu_STR getAutoName_KAlYx4Jf(const s_Node& expr, fu::view<s_Token> tokens, const int _idx, fu::view<char> fname, const fu_STR& src)
{
    ...
    fail_qdlHeyRs("Can't :autoname this expression."_fu, tokens, _idx, fname, src);
}

static s_Node createArgID_awhk0E5J(const fu_STR& id, const s_Node& expr, const int flags, const int modid, const int _loc)
{
    return make_YUyWsb6L("argid"_fu, fu_VEC<s_Node> { fu::slate<1, s_Node> { s_Node(expr) } }, flags, id, modid, _loc);
}
...
static int parseCallArgs_yL7Kcldy(fu::view<char> endop, fu_VEC<s_Node>& out_args, fu::view<s_Token> tokens, int& _idx, const fu_STR& fname, const fu_STR& src, int& _precedence, int& _loc, int& _col0, fu_VEC<fu_STR>& warnings, const s_Options& options, const int modid, int& _fnDepth, fu_VEC<fu_STR>& _dollars, int& _dollarAuto, bool& _hasPUB, fu_VEC<fu_STR>& fuzimports, int& _anonFns)
{
    ...
    for (; ; )
    {
        if (tryConsume_atxtlpan("op"_fu, endop, tokens, _idx))
            break;

        if (!first)
        {
            consume_cXsTfP3W("op"_fu, ","_fu, (("Call expr expected `"_fu + endop) + "` or"_fu), tokens, _idx, fname, src);
            if (tryConsume_atxtlpan("op"_fu, endop, tokens, _idx))
                break;
...
{
    return make_YUyWsb6L("arrlit"_fu, items, argFlags, (*(const fu_STR*)fu::NIL), modid, _loc);
}
...
{
    return make_YUyWsb6L("typeparam"_fu, (*(const fu_VEC<s_Node>*)fu::NIL), 0, value, modid, _loc);
}
...
{
    const fu_STR& value = consume_cXsTfP3W("id"_fu, fu::view<char>{}, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src).value;
...
static s_Node parseLambda_nebDZ2Q3(const bool noArgs_noClosingPipe, const int mode, int& _precedence, fu_VEC<fu_STR>& warnings, const s_Options& options, fu::view<s_Token> tokens, int& _idx, const fu_STR& fname, const fu_STR& src, int& _loc, const int modid, int& _anonFns, int& _fnDepth, fu_VEC<fu_STR>& _dollars, int& _dollarAuto, int& _col0, bool& _hasPUB, fu_VEC<fu_STR>& fuzimports)
{
    if (noArgs_noClosingPipe && (_precedence > P_RESET) && (_precedence < P_PREFIX_UNARY))
        warn_E50qN7lA("Unparenthesized `|| lambda` within a binary expression."_fu, warnings, options, tokens, _idx, fname, src, _loc);
...
{
    return make_YUyWsb6L("definit"_fu, (*(const fu_VEC<s_Node>*)fu::NIL), 0, (*(const fu_STR*)fu::NIL), modid, _loc);
}
...
{
    return make_YUyWsb6L("typetag"_fu, (*(const fu_VEC<s_Node>*)fu::NIL), 0, value, modid, _loc);
}

static s_Node typeAssert_iEMS4yi7(const s_Node& actual, const s_Node& expect, const int modid, const int _loc)
{
    return make_YUyWsb6L("typeassert"_fu, fu_VEC<s_Node> { fu::slate<2, s_Node> { s_Node(actual), s_Node(expect) } }, 0, (*(const fu_STR*)fu::NIL), modid, _loc);
}
...
static s_Node parseQualifierChain_cWKmhBJP(/*MOV*/ s_Node&& expr, int& _idx, fu::view<s_Token> tokens, const fu_STR& fname, const fu_STR& src, const int modid, const int _loc, fu_VEC<fu_STR>& fuzimports)
{
    ...
    for (; ; )
    {
        ...
        if (!tryConsume_atxtlpan("op"_fu, "::"_fu, tokens, _idx))
        {
            ...
            path = registerImport_gWKzh8Ab(fu_STR(path), fname, fuzimports);
...
static s_Node parsePrefix_fsyJV3Rb(fu_STR&& op, int& _idx, fu::view<s_Token> tokens, const fu_STR& fname, const fu_STR& src, int& _precedence, int& _loc, int& _col0, fu_VEC<fu_STR>& warnings, const s_Options& options, const int modid, int& _fnDepth, fu_VEC<fu_STR>& _dollars, int& _dollarAuto, bool& _hasPUB, fu_VEC<fu_STR>& fuzimports, int& _anonFns)
{
    ...
    if ((op == "&"_fu) && tryConsume_atxtlpan("id"_fu, "mut"_fu, tokens, _idx))
        op = "&mut"_fu;
...
static s_Node miss_ReyK06G0()
{
    return s_Node{};
}

static void lint_YUC82AKI(const int mode, fu_VEC<fu_STR>& warnings, const s_Options& options, fu::view<s_Token> tokens, const int _idx, fu::view<char> fname, const fu_STR& src, const int _loc)
{
    if (mode & M_LINT_UNARY_PRECEDENCE)
        warn_E50qN7lA((("Here the unary -/+ separates from the numeric literal,"_fu + " and wraps around the whole expression."_fu) + " Please parenthesize explicitly to make this obvious."_fu), warnings, options, tokens, _idx, fname, src, _loc);
...
{
    s_Token id { tryConsume_atxtlpan("id"_fu, fu::view<char>{}, tokens, _idx) };
    if (!id)
    {
        consume_cXsTfP3W("op"_fu, "::"_fu, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src);
        id = consume_cXsTfP3W("id"_fu, fu::view<char>{}, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src);
        _idx -= 2;
    };
...
static s_Node parseCallExpression_hgG412wH(const s_Node& expr, fu::view<s_Token> tokens, int& _idx, const fu_STR& fname, const fu_STR& src, int& _precedence, int& _loc, int& _col0, fu_VEC<fu_STR>& warnings, const s_Options& options, const int modid, int& _fnDepth, fu_VEC<fu_STR>& _dollars, int& _dollarAuto, bool& _hasPUB, fu_VEC<fu_STR>& fuzimports, int& _anonFns)
{
    ...
    {
        const s_Node* _0;
        const s_Node& head = (expr.items && (expr.items.size() == 1) && *(_0 = &(expr.items[0])) ? *_0 : fail_qdlHeyRs(fu_STR{}, tokens, _idx, fname, src));
        args.unshift(s_Node(head));
        return createCall_1w7rGfTT((expr.value ? expr.value : fail_qdlHeyRs(fu_STR{}, tokens, _idx, fname, src)), ((F_METHOD | argFlags) | (expr.flags & ~F_ACCESS)), args, modid, _loc);
    };
    if ((expr.kind == "call"_fu) && (expr.flags & F_ID))
        return createCall_1w7rGfTT((expr.value ? expr.value : fail_qdlHeyRs(fu_STR{}, tokens, _idx, fname, src)), (argFlags | (expr.flags & ~F_ID)), args, modid, _loc);

    if (expr.kind == "typeparam"_fu)
        return createCall_1w7rGfTT(("$"_fu + (expr.value ? expr.value : fail_qdlHeyRs(fu_STR{}, tokens, _idx, fname, src))), argFlags, args, modid, _loc);

    fail_qdlHeyRs("TODO dynamic call"_fu, tokens, _idx, fname, src);
}
...
inline int get_AKCmZ9Ga(fu::view<fu_STR> keys, fu::view<char> item, fu::view<int> extras)
{
    int lo = 0;
    int hi = keys.size();
    while (lo < hi)
...
inline int get_kmw0Guz3(const s_Map_dkLG9gW8& _, fu::view<char> key)
{
...
static s_Node tryParseBinary_daxTJat7(const s_Node& left, const fu_STR& op, const int p1, int& _precedence, int& _idx, int& _loc, int& _col0, fu::view<s_Token> tokens, fu_VEC<fu_STR>& warnings, const s_Options& options, const fu_STR& fname, const fu_STR& src, const int modid, int& _fnDepth, fu_VEC<fu_STR>& _dollars, int& _dollarAuto, bool& _hasPUB, fu_VEC<fu_STR>& fuzimports, int& _anonFns)
{
    ...
    if ((left.kind == "and"_fu) || (left.kind == "or"_fu))
    {
        if (!(left.flags & F_PARENS))
            warn_E50qN7lA((((("Unparenthesized `"_fu + left.kind) + "` on the left side of an `"_fu) + op) + "`."_fu), warnings, options, tokens, _idx, fname, src, _loc);
...
static s_Node tryParseExpressionTail_XuirQgfT(const s_Node& head, const int mode, fu::view<s_Token> tokens, int& _idx, fu_VEC<fu_STR>& warnings, const s_Options& options, const fu_STR& fname, const fu_STR& src, int& _loc, const int modid, int& _precedence, int& _col0, int& _fnDepth, fu_VEC<fu_STR>& _dollars, int& _dollarAuto, bool& _hasPUB, fu_VEC<fu_STR>& fuzimports, int& _anonFns)
{
    ...
    if (token.kind == "op"_fu)
    {
        const fu_STR& v = token.value;
        if (v == ";"_fu)
            return ((void)_idx--, miss_ReyK06G0());

        if (v == "."_fu)
            return ((void)lint_YUC82AKI(mode, warnings, options, tokens, _idx, fname, src, _loc), parseAccessExpression_5drr0q7m(head, tokens, _idx, fname, src, modid, _loc));

        if (v == "("_fu)
            return ((void)lint_YUC82AKI(mode, warnings, options, tokens, _idx, fname, src, _loc), parseCallExpression_hgG412wH(head, tokens, _idx, fname, src, _precedence, _loc, _col0, warnings, options, modid, _fnDepth, _dollars, _dollarAuto, _hasPUB, fuzimports, _anonFns));

        if (v == "["_fu)
            return ((void)lint_YUC82AKI(mode, warnings, options, tokens, _idx, fname, src, _loc), parseIndexExpression_dC2tNjCf(head, tokens, _idx, fname, src, _precedence, _loc, _col0, warnings, options, modid, _fnDepth, _dollars, _dollarAuto, _hasPUB, fuzimports, _anonFns));
...
static s_Node parseExpression_V9QrobCn(const int p1, const int mode, int& _precedence, int& _loc, int& _idx, int& _col0, fu::view<s_Token> tokens, fu_VEC<fu_STR>& warnings, const s_Options& options, const fu_STR& fname, const fu_STR& src, const int modid, int& _fnDepth, fu_VEC<fu_STR>& _dollars, int& _dollarAuto, bool& _hasPUB, fu_VEC<fu_STR>& fuzimports, int& _anonFns)
{
    ...
    if (mode & M_LINT_ENSURE_INDENT)
    {
        if (!(tokens[_idx].col > _col0))
            warn_E50qN7lA(x7E((x7E((("Ambiguous indent at `"_fu + tokens[_idx].value) + "`: expected more than "_fu), fu::i64dec(_col0)) + ", got "_fu), fu::i64dec(tokens[_idx].col)), warnings, options, tokens, _idx, fname, src, _loc);
...

    {
        ...
        while ((out = tryParseExpressionTail_XuirQgfT(head, mode_1, tokens, _idx, warnings, options, fname, src, _loc, modid, _precedence, _col0, _fnDepth, _dollars, _dollarAuto, _hasPUB, fuzimports, _anonFns)))
        {

            {
                ...
                if (!(t1.col > col00))
                    warn_E50qN7lA(x7E((x7E((("Ambiguous indent at `"_fu + t1.value) + "`: expected more than "_fu), fu::i64dec(col00)) + ", got "_fu), fu::i64dec(t1.col)), warnings, options, tokens, _idx, fname, src, _loc);
...
{
    return (tryConsume_atxtlpan("op"_fu, ":"_fu, tokens, _idx) ? parseTypeAnnot_eQUQXGkb(_precedence, _loc, _idx, _col0, tokens, warnings, options, fname, src, modid, _fnDepth, _dollars, _dollarAuto, _hasPUB, fuzimports, _anonFns) : miss_ReyK06G0());
}
...
{
    return tryConsume_atxtlpan("op"_fu, "="_fu, tokens, _idx) ? parseExpression_V9QrobCn(P_RESET, 0, _precedence, _loc, _idx, _col0, tokens, warnings, options, fname, src, modid, _fnDepth, _dollars, _dollarAuto, _hasPUB, fuzimports, _anonFns) : s_Node{};
}
...
{
    int flags = 0;
    if (tryConsume_atxtlpan("id"_fu, "using"_fu, tokens, _idx))
        flags |= F_USING;

    if (tryConsume_atxtlpan("id"_fu, "implicit"_fu, tokens, _idx))
        flags |= F_IMPLICIT;

    if (tryConsume_atxtlpan("id"_fu, "lax"_fu, tokens, _idx))
        flags |= F_LAX;

    if (tryConsume_atxtlpan("id"_fu, "shadow"_fu, tokens, _idx))
        flags |= F_SHADOW;

    if (tryConsume_atxtlpan("id"_fu, "mut"_fu, tokens, _idx))
        flags |= F_MUT;

    if (tryConsume_atxtlpan("id"_fu, "ref"_fu, tokens, _idx))
        flags |= F_REF;

    fu_STR id { consume_cXsTfP3W("id"_fu, fu::view<char>{}, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src).value };
    if (id == "_"_fu)
        flags |= F_LAX;

    if (xqmark && tryConsume_atxtlpan("op"_fu, "!"_fu, tokens, _idx))
    {
        flags |= F_MUSTNAME;
        const fu_STR& inner_id = tryConsume_atxtlpan("id"_fu, fu::view<char>{}, tokens, _idx).value;
        if (inner_id)
        {
            flags |= F_COMPOUND_ID;
            id += ("!"_fu + inner_id);
    ...
    {
        flags |= F_COMPOUND_ID;
        id += ("."_fu + consume_cXsTfP3W("id"_fu, fu::view<char>{}, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src).value);
        while (tryConsume_atxtlpan("op"_fu, "::"_fu, tokens, _idx))
            id += ("\t"_fu + consume_cXsTfP3W("id"_fu, fu::view<char>{}, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src).value);
    ...
    const s_Token& optional = (xqmark ? tryConsume_atxtlpan("op"_fu, "?"_fu, tokens, _idx) : (*(const s_Token*)fu::NIL));
    s_Node type = tryPopTypeAnnot_lzEenSx7(tokens, _idx, _precedence, _loc, _col0, warnings, options, fname, src, modid, _fnDepth, _dollars, _dollarAuto, _hasPUB, fuzimports, _anonFns);
...
static s_Node parseStructItem_mXtKbJLa(fu::view<s_Token> tokens, int& _idx, const fu_STR& fname, const fu_STR& src, int& _precedence, int& _loc, int& _col0, fu_VEC<fu_STR>& warnings, const s_Options& options, const int modid, int& _fnDepth, fu_VEC<fu_STR>& _dollars, int& _dollarAuto, bool& _hasPUB, fu_VEC<fu_STR>& fuzimports, int& _anonFns)
{
    const s_Token& isPredicate = tryConsume_atxtlpan("id"_fu, "true"_fu, tokens, _idx);
...
static s_Node parseEnumItem_8sRDF3aX(fu::view<s_Token> tokens, int& _idx, const fu_STR& fname, const fu_STR& src, int& _precedence, int& _loc, int& _col0, fu_VEC<fu_STR>& warnings, const s_Options& options, const int modid, int& _fnDepth, fu_VEC<fu_STR>& _dollars, int& _dollarAuto, bool& _hasPUB, fu_VEC<fu_STR>& fuzimports, int& _anonFns)
{
    const fu_STR& id = consume_cXsTfP3W("id"_fu, fu::view<char>{}, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src).value;
...
{
    const s_Token* _0;
    const fu_STR& value = (tryConsume_atxtlpan("op"_fu, ":"_fu, tokens, _idx) ? (*(_0 = &(tryConsume_atxtlpan("id"_fu, "err"_fu, tokens, _idx))) ? *_0 : consume_cXsTfP3W("id"_fu, "ok"_fu, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src)).value : (*(const fu_STR*)fu::NIL));
    if (!(_fnDepth > 0))
    {
        _idx--;
        fail_qdlHeyRs(fu_STR{}, tokens, _idx, fname, src);
    ...
    fu_VEC<s_Node> _1 {};
    return (_1 = fu_VEC<s_Node> { fu::slate<1, s_Node> { parseStatement_TnImdy8H(_loc, tokens, _idx, fname, src, _col0, warnings, options, _precedence, modid, _fnDepth, _dollars, _dollarAuto, _hasPUB, fuzimports, _anonFns) } }, make_YUyWsb6L("defer"_fu, static_cast<fu_VEC<s_Node>&&>(_1), 0, value, modid, _loc));
}

static s_Node parseStatementOrDefer_4rIpZRjS(fu::view<s_Token> tokens, int& _idx, const fu_STR& fname, const fu_STR& src, int& _fnDepth, int& _loc, int& _col0, fu_VEC<fu_STR>& warnings, const s_Options& options, int& _precedence, const int modid, fu_VEC<fu_STR>& _dollars, int& _dollarAuto, bool& _hasPUB, fu_VEC<fu_STR>& fuzimports, int& _anonFns)
{
    const s_Token& peek = tokens[_idx];
    if (peek.kind == "id"_fu)
    {
    ...
    return parseStatement_TnImdy8H(_loc, tokens, _idx, fname, src, _col0, warnings, options, _precedence, modid, _fnDepth, _dollars, _dollarAuto, _hasPUB, fuzimports, _anonFns);
}

static fu_VEC<s_Node> parseBlockLike_a2fqWS3u(fu::view<char> endKind, fu::view<char> endVal, const bool sTruct, const bool eNum, int& _idx, fu::view<s_Token> tokens, int& _col0, fu_VEC<fu_STR>& warnings, const s_Options& options, const fu_STR& fname, const fu_STR& src, int& _loc, int& _precedence, const int modid, int& _fnDepth, fu_VEC<fu_STR>& _dollars, int& _dollarAuto, bool& _hasPUB, fu_VEC<fu_STR>& fuzimports, int& _anonFns)
{
    ...
    for (; ; )
    {
        ...
        if ((token.kind == endKind) && (token.value == endVal))
        {
            ...
            if (!((line1 == line0) || (col1 == _col0)))
                warn_E50qN7lA((x7E((x7E((x7E((("Inconsistent indent at closing `"_fu + token.value) + "`: expected "_fu), fu::i64dec((_col0 - 1))) + ", got "_fu), fu::i64dec((col1 - 1))) + ". Block starts on line "_fu), fu::i64dec(line0)) + "."_fu), warnings, options, tokens, _idx, fname, src, _loc);

            break;
        };
        _col0 = token.col;
        if (!(_col0 > col00))
            warn_E50qN7lA((x7E((x7E((x7E((("Inconsistent indent at `"_fu + token.value) + "`: expected more than "_fu), fu::i64dec(col00)) + ", got "_fu), fu::i64dec(_col0)) + ". Block starts on line "_fu), fu::i64dec(line0)) + "."_fu), warnings, options, tokens, _idx, fname, src, _loc);

        if (!((colNN < 0) || (colNN == _col0) || (token.line == lineNN)))
            warn_E50qN7lA((x7E((x7E((x7E((("Inconsistent indent at `"_fu + token.value) + "`: expected exactly "_fu), fu::i64dec(colNN)) + ", got "_fu), fu::i64dec(_col0)) + ". Previous statement starts on line "_fu), fu::i64dec(lineNN)) + "."_fu), warnings, options, tokens, _idx, fname, src, _loc);

        if (colNN < 0)
            colNN = _col0;

        lineNN = token.line;
        s_Node expr = (sTruct ? parseStructItem_mXtKbJLa(tokens, _idx, fname, src, _precedence, _loc, _col0, warnings, options, modid, _fnDepth, _dollars, _dollarAuto, _hasPUB, fuzimports, _anonFns) : (eNum ? parseEnumItem_8sRDF3aX(tokens, _idx, fname, src, _precedence, _loc, _col0, warnings, options, modid, _fnDepth, _dollars, _dollarAuto, _hasPUB, fuzimports, _anonFns) : parseStatementOrDefer_4rIpZRjS(tokens, _idx, fname, src, _fnDepth, _loc, _col0, warnings, options, _precedence, modid, _dollars, _dollarAuto, _hasPUB, fuzimports, _anonFns)));
        if (!((expr.kind != "call"_fu) || ((expr.flags & (F_ID | F_ACCESS)) == 0) || (expr.items.size() > 1) || (tokens[_idx].value == endVal)))
            warn_E50qN7lA("Orphan pure-looking expression."_fu, warnings, options, tokens, _idx, fname, src, _loc);
...
static s_Node parseRoot_6AK9CGR8(fu::view<s_Token> tokens, int& _idx, const fu_STR& fname, const fu_STR& src, int& _loc, int& _col0, fu_VEC<fu_STR>& warnings, const s_Options& options, int& _precedence, const int modid, int& _fnDepth, fu_VEC<fu_STR>& _dollars, int& _dollarAuto, bool& _hasPUB, fu_VEC<fu_STR>& fuzimports, int& _anonFns)
{
    consume_cXsTfP3W("sof"_fu, "sof"_fu, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src);
    _loc = _idx;
    fu_VEC<s_Node> _0 {};
    /*MOV*/ s_Node out = (_0 = parseBlockLike_a2fqWS3u("eof"_fu, "eof"_fu, false, false, _idx, tokens, _col0, warnings, options, fname, src, _loc, _precedence, modid, _fnDepth, _dollars, _dollarAuto, _hasPUB, fuzimports, _anonFns), make_YUyWsb6L("root"_fu, static_cast<fu_VEC<s_Node>&&>(_0), 0, (*(const fu_STR*)fu::NIL), modid, _loc));
    if (use_AUTOPUB && !_hasPUB)
    {
        for (int i = 0; i < out.items.size(); i++)
        {
            ...
            if (((k == "fn"_fu) || (k == "let"_fu) || (k == "typedef"_fu) || (k == "struct"_fu)) && !(item.flags & F_SHADOW))
                set_PUB_l6mGzOMy(item.flags, tokens, _idx, fname, src, _hasPUB);
...
s_ParserOutput parse_yGirzZ4O(const int modid, const fu_STR& fname, const fu_STR& src, fu::view<s_Token> tokens, const s_Options& options)
{
    ...
    if (!(tokens[(tokens.size() - 1)].kind == "eof"_fu))
        fail_qdlHeyRs("Missing `eof` token."_fu, tokens, _idx, fname, src);

    s_Node root = parseRoot_6AK9CGR8(tokens, _idx, fname, src, _loc, _col0, warnings, options, _precedence, modid, _fnDepth, _dollars, _dollarAuto, _hasPUB, fuzimports, _anonFns);
