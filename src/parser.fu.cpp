...
struct s_Options;
struct s_Lint;
[[noreturn]] fu::never FAIL_gktpJKx6(fu::view<char>, const fu_STR&, const s_Token&, fu::view<char>);
fu_STR ext_KqRBcvmh(const fu_STR&);
fu_STR dirname_KqRBcvmh(const fu_STR&);
fu_STR join_Lfq50XKd(fu::view<char>, const fu_STR&);
static int parseArgsDecl_6JVxBqBt(fu_VEC<s_Node>&, fu::view<char>, fu::view<char>, int&, bool&, fu_VEC<fu_STR>&, fu::view<s_Token>, int&, const fu_STR&, const fu_STR&, fu_VEC<fu_STR>&, int, int&, int&, int&, fu_VEC<fu_STR>&, const s_Options&, int&, bool&, int&);
...
static s_Node parseJump_Axc9VBjK(const fu_STR&, int&, int&, fu::view<s_Token>, const fu_STR&, const fu_STR&, int&, int&, int&, fu_VEC<fu_STR>&, const s_Options&, int, fu_VEC<fu_STR>&, bool&, int&, fu_VEC<fu_STR>&, bool&, int&);
...
static fu_STR getAutoName_iQDqaj9x(const s_Node&, fu::view<s_Token>, int, fu::view<char>, const fu_STR&);
static int parseCallArgs_jb3WHS0P(fu::view<char>, fu_VEC<s_Node>&, bool, fu::view<s_Token>, int&, const fu_STR&, const fu_STR&, fu_VEC<fu_STR>&, const s_Options&, int&, int&, int&, int, int&, fu_VEC<fu_STR>&, bool&, int&, fu_VEC<fu_STR>&, bool&, int&);
...
static s_Node parsePrimDecl_RDkgnfRi(const fu_STR&, fu::view<s_Token>, int&, int&, int&, int&, fu_VEC<fu_STR>&, const s_Options&, const fu_STR&, const fu_STR&, int, int&, fu_VEC<fu_STR>&, bool&, int&, fu_VEC<fu_STR>&, bool&, int&);
...
static int parseFnBodyOrPattern_1WIyFAf4(fu_VEC<s_Node>&, bool, fu::view<s_Token>, int&, bool&, int&, int&, int&, fu_VEC<fu_STR>&, const s_Options&, const fu_STR&, const fu_STR&, int, int&, fu_VEC<fu_STR>&, int&, fu_VEC<fu_STR>&, bool&, int&);
...
static s_Node tryParseBinary_wzqpZRvh(const s_Node&, const fu_STR&, int, int&, int&, int&, int&, fu::view<s_Token>, fu_VEC<fu_STR>&, const s_Options&, const fu_STR&, const fu_STR&, int, int&, fu_VEC<fu_STR>&, bool&, int&, fu_VEC<fu_STR>&, bool&, int&);
static s_Node tryParseExpressionTail_R95181Oi(const s_Node&, int, fu::view<s_Token>, int&, fu_VEC<fu_STR>&, const s_Options&, const fu_STR&, const fu_STR&, int&, int, int&, int&, int&, fu_VEC<fu_STR>&, bool&, int&, fu_VEC<fu_STR>&, bool&, int&);
...
static fu_VEC<s_Node> parseBlockLike_3TimIhXP(fu::view<char>, fu::view<char>, bool, bool, int&, fu::view<s_Token>, int&, fu_VEC<fu_STR>&, const s_Options&, const fu_STR&, const fu_STR&, int&, fu_VEC<fu_STR>&, int, int&, int&, fu_VEC<fu_STR>&, bool&, int&, bool&, int&);
...
inline int x3Cx3E_pN4jXVBE(fu::view<char> a, fu::view<char> b)
{
    ...
    return /*NRVO*/ cmp;
                                ...
                                #ifndef DEF_update_xdmRIh5g
                                #define DEF_update_xdmRIh5g
inline bool update_xdmRIh5g(const fu_STR& item, const int extra, s_Map_guWsCK25& _)
{
    int lo = 0;
    int hi = _.keys.size();
    while (lo < hi)
    ...
    return true;
                                ...
                                #ifndef DEF_set_jCZXGJaG
                                #define DEF_set_jCZXGJaG
inline bool set_jCZXGJaG(s_Map_guWsCK25& _, const fu_STR& key, const int value)
{
    return update_xdmRIh5g(key, value, _);
}
                                #endif
...
static void binop_ylvqtwnD(fu::view<fu_STR> ops, int& precedence, s_BINOP& out, const bool rightToLeft)
{
    ...
    for (int i = 0; i < ops.size(); i++)
        set_jCZXGJaG(out.PRECEDENCE, ops[i], precedence);
...
static const s_Token& consume_9MEMifh3(fu::view<char> kind, fu::view<char> value, const fu_STR& err, fu::view<s_Token> tokens, int& _idx, fu::view<char> fname, const fu_STR& src)
{
    const s_Token& token = tokens[_idx];
    ...
    fail_DFmt4Umh(((((((err ? fu_STR(err) : "Expected"_fu) + " `"_fu) + (value ? value : kind)) + "`, got `"_fu) + token.value) + "`."_fu), tokens, _idx, fname, src);
}
...
static const s_Token& tryConsume_KA4ZXnBr(fu::view<char> kind, fu::view<char> value, fu::view<s_Token> tokens, int& _idx)
{
    const s_Token& token = tokens[_idx];
    if ((token.kind == kind) && (!value || (token.value == value)))
    {
...
static s_Node make_ZhSDnjVw(const fu_STR& kind, const fu_VEC<s_Node>& items, const int flags, const fu_STR& value, const int modid, const int _loc)
{
...
static s_Node createCall_6I9XL8Me(const fu_STR& id, const int flags, const fu_VEC<s_Node>& args, const int modid, const int _loc)
{
    return make_ZhSDnjVw("call"_fu, args, flags, id, modid, _loc);
}
...
static s_Node createRead_ozmPyYop(const fu_STR& id, const int flags, const int modid, const int _loc, fu::view<s_Token> tokens, const int _idx, fu::view<char> fname, const fu_STR& src)
{
    if ((id == "true"_fu) || (id == "false"_fu))
        return make_ZhSDnjVw("bool"_fu, (*(const fu_VEC<s_Node>*)fu::NIL), 0, id, modid, _loc);

    return createCall_6I9XL8Me((id ? id : fail_DFmt4Umh(fu_STR{}, tokens, _idx, fname, src)), (F_ID | flags), (*(const fu_VEC<s_Node>*)fu::NIL), modid, _loc);
}

static s_Node createLeaf_BsemsVaz(const fu_STR& kind, const fu_STR& value, const int modid, const int _loc)
{
    return make_ZhSDnjVw(kind, (*(const fu_VEC<s_Node>*)fu::NIL), 0, value, modid, _loc);
}
...
inline bool has_e0rvubQU(fu::view<fu_STR> keys, fu::view<char> item)
{
    ...
    return false;
                                ...
                                #ifndef DEF_has_Lzdj3u2q
                                #define DEF_has_Lzdj3u2q
inline bool has_Lzdj3u2q(const s_Map_guWsCK25& _, fu::view<char> key)
{
...
{
    return make_ZhSDnjVw("addroffn"_fu, (*(const fu_VEC<s_Node>*)fu::NIL), flags, name, modid, _loc);
}
...
static int parseArgsDecl_6JVxBqBt(fu_VEC<s_Node>& outArgs, fu::view<char> endk, fu::view<char> endv, int& _dollarAuto, bool& _TODO_FIX_dollarOk, fu_VEC<fu_STR>& _dollars, fu::view<s_Token> tokens, int& _idx, const fu_STR& fname, const fu_STR& src, fu_VEC<fu_STR>& fuzimports, const int modid, int& _loc, int& _precedence, int& _col0, fu_VEC<fu_STR>& warnings, const s_Options& options, int& _fnDepth, bool& _hasPUB, int& _anonFns)
{
    bool first = true;
    /*MOV*/ int outFlags = 0;
    ...
    for (; ; )
    {
        if (tryConsume_KA4ZXnBr(endk, endv, tokens, _idx))
            break;

        if (!first)
            consume_9MEMifh3("op"_fu, ","_fu, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src);

        first = false;
        const bool isInline = !!tryConsume_KA4ZXnBr("id"_fu, "inline"_fu, tokens, _idx);
        int insertAt = -1;
        ...
        if ((_dollars.size() > dollars0) || (arg.items[LET_TYPE].kind == "typeunion"_fu))
...
static s_Node createBlock_HmSCaXEA(const fu_VEC<s_Node>& items, const fu_STR& label, const int modid, const int _loc)
{
    return make_ZhSDnjVw("block"_fu, items, 0, label, modid, _loc);
}
...
{
    fu_VEC<s_Node> _0 {};
    return (_0 = parseBlockLike_3TimIhXP("op"_fu, "}"_fu, false, false, _idx, tokens, _col0, warnings, options, fname, src, _loc, fuzimports, modid, _precedence, _fnDepth, _dollars, _TODO_FIX_dollarOk, _dollarAuto, _hasPUB, _anonFns), createBlock_HmSCaXEA(static_cast<fu_VEC<s_Node>&&>(_0), (*(const fu_STR*)fu::NIL), modid, _loc));
}
...
{
    const fu_STR& label = consume_9MEMifh3("id"_fu, fu::view<char>{}, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src).value;
    ...
    return createBlock_HmSCaXEA(fu_VEC<s_Node> { fu::slate<1, s_Node> { s_Node(stmt) } }, label, modid, _loc);
}
...
static s_Node pipelineLeft_pmCii9ji(/*MOV*/ s_Node&& left, const s_Node& right, fu::view<s_Token> tokens, const int _idx, fu::view<char> fname, const fu_STR& src)
{
...
static s_Node parseExpressionStatement_qJXqP7tq(int& _precedence, int& _loc, int& _idx, int& _col0, fu::view<s_Token> tokens, fu_VEC<fu_STR>& warnings, const s_Options& options, const fu_STR& fname, const fu_STR& src, const int modid, int& _fnDepth, fu_VEC<fu_STR>& _dollars, bool& _TODO_FIX_dollarOk, int& _dollarAuto, fu_VEC<fu_STR>& fuzimports, bool& _hasPUB, int& _anonFns)
{
    ...
    if (tryConsume_KA4ZXnBr("op"_fu, ":"_fu, tokens, _idx))
    {
        ...
        return pipelineLeft_pmCii9ji(s_Node(expr), right, tokens, _idx, fname, src);
    };
    softSemi_qUCXLPGA(tokens, _idx, _col0, warnings, options, fname, src, _loc);
    return /*NRVO*/ expr;
}
...
static s_Node createPrefix_ABYm5yA1(const fu_STR& op, /*MOV*/ s_Node&& expr, const int modid, const int _loc)
{
    ...
    return createCall_6I9XL8Me(op, (F_PREFIX | F_OPERATOR), fu_VEC<s_Node> { fu::slate<1, s_Node> { s_Node(expr) } }, modid, _loc);
}

static s_Node createIf_vPWWRbaz(const s_Node& cond, const s_Node& cons, const s_Node& alt, const int modid, const int _loc)
{
    return make_ZhSDnjVw("if"_fu, fu_VEC<s_Node> { fu::slate<3, s_Node> { s_Node(cond), s_Node(cons), s_Node(alt) } }, 0, (*(const fu_STR*)fu::NIL), modid, _loc);
}

static s_Node flattenIfSame_wt8l3tBV(const fu_STR& kind, const s_Node& left, const s_Node& right, const int modid, const int _loc)
{
    ...
    return make_ZhSDnjVw(kind, items, 0, (*(const fu_STR*)fu::NIL), modid, _loc);
}

static s_Node createAnd_9b9wU7tg(const s_Node& left, const s_Node& right, const int modid, const int _loc)
{
    return flattenIfSame_wt8l3tBV("and"_fu, left, right, modid, _loc);
}
...
static s_Node parseIf_w4zhCCjQ(fu::view<s_Token> tokens, int& _idx, const fu_STR& fname, const fu_STR& src, fu_VEC<fu_STR>& fuzimports, const int modid, int& _loc, int& _precedence, int& _col0, fu_VEC<fu_STR>& warnings, const s_Options& options, int& _fnDepth, fu_VEC<fu_STR>& _dollars, bool& _TODO_FIX_dollarOk, int& _dollarAuto, bool& _hasPUB, int& _anonFns)
{
    ...
    const s_Token& nOt = tryConsume_KA4ZXnBr("op"_fu, "!"_fu, tokens, _idx);
    consume_9MEMifh3("op"_fu, "("_fu, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src);
    ...
    consume_9MEMifh3("op"_fu, ")"_fu, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src);
    if (nOt)
        cond = createPrefix_ABYm5yA1("!"_fu, s_Node(cond), modid, _loc);
    ...
    const s_Token& eLse = tryConsume_KA4ZXnBr("id"_fu, "else"_fu, tokens, _idx);
    if (eLse)
    {
        ...
        return createIf_vPWWRbaz(cond, cons, alt, modid, _loc);
    };
    return createAnd_9b9wU7tg(cond, cons, modid, _loc);
}
...
static s_Node createLoop_AzF1FOkg(const s_Node& init, const s_Node& pre_cond, const s_Node& body, const s_Node& post_cond, const s_Node& post, const int modid, const int _loc)
{
    return make_ZhSDnjVw("loop"_fu, fu_VEC<s_Node> { fu::slate<5, s_Node> { s_Node(init), s_Node(pre_cond), s_Node(body), s_Node(post_cond), s_Node(post) } }, 0, (*(const fu_STR*)fu::NIL), modid, _loc);
}
...
{
    consume_9MEMifh3("op"_fu, "("_fu, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src);
    if (tryConsume_KA4ZXnBr("id"_fu, "fieldname"_fu, tokens, _idx))
    {
        const fu_STR& placeholder = consume_9MEMifh3("id"_fu, fu::view<char>{}, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src).value;
        consume_9MEMifh3("op"_fu, ":"_fu, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src);
        ...
        return make_ZhSDnjVw("forfieldsof"_fu, fu_VEC<s_Node> { fu::slate<2, s_Node> { s_Node(type), s_Node(body) } }, 0, placeholder, modid, _loc);
    };
    s_Node init = (!tryConsume_KA4ZXnBr("op"_fu, ";"_fu, tokens, _idx) ? parseStatement_gygIW4zW(_loc, tokens, _idx, fname, src, _col0, warnings, options, fuzimports, modid, _precedence, _fnDepth, _dollars, _TODO_FIX_dollarOk, _dollarAuto, _hasPUB, _anonFns) : s_Node{});
    if (init && (init.kind != "let"_fu))
        fail_DFmt4Umh((("`for` expects a `let` statement, got a `"_fu + init.kind) + "`."_fu), tokens, _idx, fname, src);

    s_Node pre_cond = (!tryConsume_KA4ZXnBr("op"_fu, ";"_fu, tokens, _idx) ? parseLetOrExpressionStatement_No5eJMdY(tokens, _idx, fname, src, fuzimports, modid, _loc, _precedence, _col0, warnings, options, _fnDepth, _dollars, _TODO_FIX_dollarOk, _dollarAuto, _hasPUB, _anonFns) : s_Node{});
    const s_Token& token = tokens[_idx];
    s_Node post = (!((token.kind == "op"_fu) && (token.value == ")"_fu)) ? parseParens_ReyK06G0(_precedence, _loc, _idx, _col0, tokens, warnings, options, fname, src, modid, _fnDepth, _dollars, _TODO_FIX_dollarOk, _dollarAuto, fuzimports, _hasPUB, _anonFns) : ((void)(consume_9MEMifh3("op"_fu, ")"_fu, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src) ? void() : void()), s_Node{}));
    s_Node body = parseStatement_gygIW4zW(_loc, tokens, _idx, fname, src, _col0, warnings, options, fuzimports, modid, _precedence, _fnDepth, _dollars, _TODO_FIX_dollarOk, _dollarAuto, _hasPUB, _anonFns);
    return createLoop_AzF1FOkg(init, pre_cond, body, (*(const s_Node*)fu::NIL), post, modid, _loc);
}
...
static s_Node parseWhile_cl3fXBiS(fu::view<s_Token> tokens, int& _idx, const fu_STR& fname, const fu_STR& src, fu_VEC<fu_STR>& fuzimports, const int modid, int& _loc, int& _precedence, int& _col0, fu_VEC<fu_STR>& warnings, const s_Options& options, int& _fnDepth, fu_VEC<fu_STR>& _dollars, bool& _TODO_FIX_dollarOk, int& _dollarAuto, bool& _hasPUB, int& _anonFns)
{
    ...
    consume_9MEMifh3("op"_fu, ")"_fu, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src);
    s_Node body = parseStatement_gygIW4zW(_loc, tokens, _idx, fname, src, _col0, warnings, options, fuzimports, modid, _precedence, _fnDepth, _dollars, _TODO_FIX_dollarOk, _dollarAuto, _hasPUB, _anonFns);
    return createLoop_AzF1FOkg((*(const s_Node*)fu::NIL), pre_cond, body, (*(const s_Node*)fu::NIL), (*(const s_Node*)fu::NIL), modid, _loc);
}
...
{
    s_Node body = parseStatement_gygIW4zW(_loc, tokens, _idx, fname, src, _col0, warnings, options, fuzimports, modid, _precedence, _fnDepth, _dollars, _TODO_FIX_dollarOk, _dollarAuto, _hasPUB, _anonFns);
    consume_9MEMifh3("id"_fu, "while"_fu, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src);
    consume_9MEMifh3("op"_fu, "("_fu, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src);
    ...
    consume_9MEMifh3("op"_fu, ")"_fu, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src);
    softSemi_qUCXLPGA(tokens, _idx, _col0, warnings, options, fname, src, _loc);
    return createLoop_AzF1FOkg((*(const s_Node*)fu::NIL), (*(const s_Node*)fu::NIL), body, post_cond, (*(const s_Node*)fu::NIL), modid, _loc);
}

static s_Node createJump_lMn3xnq6(const fu_STR& kind, const fu_STR& label, const s_Node& expr, const int flags, const int modid, const int _loc)
{
    return make_ZhSDnjVw(kind, (expr ? fu_VEC<s_Node> { fu::slate<1, s_Node> { s_Node(expr) } } : fu_VEC<s_Node>{}), flags, label, modid, _loc);
}

static s_Node parseJump_Axc9VBjK(const fu_STR& kind, int& _fnDepth, int& _idx, fu::view<s_Token> tokens, const fu_STR& fname, const fu_STR& src, int& _precedence, int& _loc, int& _col0, fu_VEC<fu_STR>& warnings, const s_Options& options, const int modid, fu_VEC<fu_STR>& _dollars, bool& _TODO_FIX_dollarOk, int& _dollarAuto, fu_VEC<fu_STR>& fuzimports, bool& _hasPUB, int& _anonFns)
{
    if (!(_fnDepth > 0))
    {
        _idx--;
    ...
    const fu_STR& label = (tryConsume_KA4ZXnBr("op"_fu, ":"_fu, tokens, _idx) ? consume_9MEMifh3("id"_fu, fu::view<char>{}, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src).value : (*(const fu_STR*)fu::NIL));
    s_Node expr {};
    if (!tryConsume_KA4ZXnBr("op"_fu, ";"_fu, tokens, _idx))
    {
    ...
    return createJump_lMn3xnq6(kind, label, expr, 0, modid, _loc);
}

static s_Node createLet_kXyj3e6e(const fu_STR& id, const int flags, const s_Node& type, const s_Node& init, const int modid, const int _loc)
{
    return make_ZhSDnjVw("let"_fu, fu_VEC<s_Node> { fu::slate<2, s_Node> { s_Node(type), s_Node(init) } }, flags, id, modid, _loc);
}
...
{
    const fu_STR& id = consume_9MEMifh3("id"_fu, fu::view<char>{}, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src).value;
    return createLet_kXyj3e6e(id, 0, createRead_ozmPyYop("string"_fu, 0, modid, _loc, tokens, _idx, fname, src), s_Node{}, modid, _loc);
}
...
static s_Node parseTryCatch_6ScTKJdc(int& _fnDepth, int& _idx, fu::view<s_Token> tokens, const fu_STR& fname, const fu_STR& src, int& _loc, int& _col0, fu_VEC<fu_STR>& warnings, const s_Options& options, fu_VEC<fu_STR>& fuzimports, const int modid, int& _precedence, fu_VEC<fu_STR>& _dollars, bool& _TODO_FIX_dollarOk, int& _dollarAuto, bool& _hasPUB, int& _anonFns)
{
    ...
    consume_9MEMifh3("id"_fu, "catch"_fu, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src);
    consume_9MEMifh3("op"_fu, "("_fu, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src);
    ...
    return make_ZhSDnjVw("try"_fu, fu_VEC<s_Node> { fu::slate<3, s_Node> { s_Node(tRy), s_Node(err), s_Node(cAtch) } }, 0, (*(const fu_STR*)fu::NIL), modid, _loc);
}
...
extern const int F_PREDICATE;
                                ...
                                #ifndef DEF_each_oxuXaxcQ
                                #define DEF_each_oxuXaxcQ
inline void each_oxuXaxcQ(fu::view_mut<s_Node> a)
{
    for (int i = 0; i < a.size(); i++)
    {
...
{
    const fu_STR& name = tryConsume_KA4ZXnBr("id"_fu, fu::view<char>{}, tokens, _idx).value;
    consume_9MEMifh3("op"_fu, "{"_fu, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src);
    fu_VEC<s_Node> items = parseBlockLike_3TimIhXP("op"_fu, "}"_fu, true, false, _idx, tokens, _col0, warnings, options, fname, src, _loc, fuzimports, modid, _precedence, _fnDepth, _dollars, _TODO_FIX_dollarOk, _dollarAuto, _hasPUB, _anonFns);
    ...
    return make_ZhSDnjVw("struct"_fu, fu_VEC<s_Node> { fu::slate<2, s_Node> { s_Node{}, make_ZhSDnjVw("members"_fu, items, 0, (*(const fu_STR*)fu::NIL), modid, _loc) } }, flags, name, modid, _loc);
}
...
{
    const fu_STR& name = consume_9MEMifh3("id"_fu, fu::view<char>{}, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src).value;
    consume_9MEMifh3("op"_fu, "="_fu, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src);
    ...
    softSemi_qUCXLPGA(tokens, _idx, _col0, warnings, options, fname, src, _loc);
    return make_ZhSDnjVw("typedef"_fu, fu_VEC<s_Node> { fu::slate<1, s_Node> { s_Node(annot) } }, 0, name, modid, _loc);
}
...
static void add_EGqWbgIM(const int flag, int& flags, const fu_STR& v, fu::view<s_Token> tokens, const int _idx, fu::view<char> fname, const fu_STR& src)
{
    if (flags & flag)
...
static s_Node parseFixityDecl_Nf1io5En(const int flags, const bool expr, fu::view<s_Token> tokens, int& _idx, const fu_STR& fname, const fu_STR& src, const int modid, int& _loc, int& _fnDepth, fu_VEC<fu_STR>& _dollars, bool& _TODO_FIX_dollarOk, int& _dollarAuto, fu_VEC<fu_STR>& fuzimports, int& _precedence, int& _col0, fu_VEC<fu_STR>& warnings, const s_Options& options, bool& _hasPUB, int& _anonFns)
{
    ...
    consume_9MEMifh3("id"_fu, "fn"_fu, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src);
...
{
    flags |= F;
    fu::view<char> v = consume_9MEMifh3("id"_fu, fu::view<char>{}, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src).value;
    if (v == "infix"_fu)
...
static s_Node parseExoticDecl_Wx2NLzXd(int flags, fu::view<s_Token> tokens, int& _idx, const fu_STR& fname, const fu_STR& src, const int modid, int& _loc, int& _fnDepth, fu_VEC<fu_STR>& _dollars, bool& _TODO_FIX_dollarOk, int& _dollarAuto, fu_VEC<fu_STR>& fuzimports, int& _precedence, int& _col0, fu_VEC<fu_STR>& warnings, const s_Options& options, bool& _hasPUB, int& _anonFns)
{
    for (; ; )
    {
        const fu_STR& v = consume_9MEMifh3("id"_fu, fu::view<char>{}, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src).value;
        if (v == "pure"_fu)
            add_EGqWbgIM(F_PURE, flags, v, tokens, _idx, fname, src);
        else if (v == "purectx"_fu)
            add_EGqWbgIM(F_PURE_CTX, flags, v, tokens, _idx, fname, src);
        else if (v == "novec"_fu)
            add_EGqWbgIM(F_NOVEC, flags, v, tokens, _idx, fname, src);
        else if (v == "noflow"_fu)
            add_EGqWbgIM(F_NOFLOW, flags, v, tokens, _idx, fname, src);
        else if (v == "extern"_fu)
            add_EGqWbgIM(F_EXTERN, flags, v, tokens, _idx, fname, src);
        else if (v == "hotswap"_fu)
            add_EGqWbgIM(F_HOTSWAP, flags, v, tokens, _idx, fname, src);
        else if (v == "fn"_fu)
...
{
    consume_9MEMifh3("id"_fu, "struct"_fu, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src);
...
{
    fu_STR value { tryConsume_KA4ZXnBr("id"_fu, fu::view<char>{}, tokens, _idx).value };
    if (value)
    {
        while (tryConsume_KA4ZXnBr("op"_fu, "::"_fu, tokens, _idx))
            value += ("/"_fu + consume_9MEMifh3("id"_fu, fu::view<char>{}, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src).value);

    }
    else
        value = consume_9MEMifh3("str"_fu, fu::view<char>{}, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src).value;

    softSemi_qUCXLPGA(tokens, _idx, _col0, warnings, options, fname, src, _loc);
    value = registerImport_1IF84QCG(fu_STR(value), fname, fuzimports);
    return make_ZhSDnjVw("import"_fu, (*(const fu_VEC<s_Node>*)fu::NIL), 0, value, modid, _loc);
}
...
static fu_STR getAutoName_iQDqaj9x(const s_Node& expr, fu::view<s_Token> tokens, const int _idx, fu::view<char> fname, const fu_STR& src)
{
    if ((expr.kind == "call"_fu) && hasIdentifierChars_ZCtM7908(expr.value))
        return fu_STR(expr.value);

    if (expr.items)
    {
        const int i = (((expr.kind == "and"_fu) && (expr.items.size() - 1)) ? ((expr.kind == "if"_fu) ? 1 : int{}) : 0);
        return getAutoName_iQDqaj9x(expr.items[i], tokens, _idx, fname, src);
    };
...
static s_Node createArgID_zK5PNkbf(const fu_STR& id, const s_Node& expr, const int flags, const int modid, const int _loc)
{
    return make_ZhSDnjVw("argid"_fu, fu_VEC<s_Node> { fu::slate<1, s_Node> { s_Node(expr) } }, flags, id, modid, _loc);
}

static int parseCallArgs_jb3WHS0P(fu::view<char> endop, fu_VEC<s_Node>& out_args, const bool experimental_sliceAnnots, fu::view<s_Token> tokens, int& _idx, const fu_STR& fname, const fu_STR& src, fu_VEC<fu_STR>& warnings, const s_Options& options, int& _loc, int& _precedence, int& _col0, const int modid, int& _fnDepth, fu_VEC<fu_STR>& _dollars, bool& _TODO_FIX_dollarOk, int& _dollarAuto, fu_VEC<fu_STR>& fuzimports, bool& _hasPUB, int& _anonFns)
{
    /*MOV*/ int flags = 0;
    bool first = true;
    for (; ; )
    {
        if (experimental_sliceAnnots && tryConsume_KA4ZXnBr("op"_fu, ";"_fu, tokens, _idx))
        {
            consume_9MEMifh3("op"_fu, endop, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src);
            break;
        };
        if (!first)
            softComma_FeR7VjxS(endop, tokens, _idx, warnings, options, fname, src, _loc);

        if (tryConsume_KA4ZXnBr("op"_fu, endop, tokens, _idx))
            break;
        ...
        if (autoName)
            name = getAutoName_iQDqaj9x(expr, tokens, _idx, fname, src);

        if (name)
            flags |= F_NAMED_ARGS;

        out_args.push((name ? createArgID_zK5PNkbf(name, expr, (optional ? F_OPT_ARG : (*(const int*)fu::NIL)), modid, _loc) : s_Node(expr)));
    };
    return /*NRVO*/ flags;
}
...
{
    const fu_STR& value = consume_9MEMifh3("id"_fu, fu::view<char>{}, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src).value;
    if (value != "break"_fu)
    {
        fu_VEC<s_Node> items {};
        consume_9MEMifh3("op"_fu, "("_fu, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src);
        parseCallArgs_jb3WHS0P(")"_fu, items, bool{}, tokens, _idx, fname, src, warnings, options, _loc, _precedence, _col0, modid, _fnDepth, _dollars, _TODO_FIX_dollarOk, _dollarAuto, fuzimports, _hasPUB, _anonFns);
        return make_ZhSDnjVw("pragma"_fu, items, 0, value, modid, _loc);
    };
    /*MOV*/ s_Node ret = make_ZhSDnjVw("pragma"_fu, (*(const fu_VEC<s_Node>*)fu::NIL), 0, value, modid, _loc);
    softSemi_qUCXLPGA(tokens, _idx, _col0, warnings, options, fname, src, _loc);
    return /*NRVO*/ ret;
}

static s_Node parsePrimDecl_RDkgnfRi(const fu_STR& kind, fu::view<s_Token> tokens, int& _idx, int& _precedence, int& _loc, int& _col0, fu_VEC<fu_STR>& warnings, const s_Options& options, const fu_STR& fname, const fu_STR& src, const int modid, int& _fnDepth, fu_VEC<fu_STR>& _dollars, bool& _TODO_FIX_dollarOk, int& _dollarAuto, fu_VEC<fu_STR>& fuzimports, bool& _hasPUB, int& _anonFns)
{
    const fu_STR& name = tryConsume_KA4ZXnBr("id"_fu, fu::view<char>{}, tokens, _idx).value;
    ...
    fu_VEC<s_Node> items = (tryConsume_KA4ZXnBr("op"_fu, "{"_fu, tokens, _idx) ? parseBlockLike_3TimIhXP("op"_fu, "}"_fu, false, true, _idx, tokens, _col0, warnings, options, fname, src, _loc, fuzimports, modid, _precedence, _fnDepth, _dollars, _TODO_FIX_dollarOk, _dollarAuto, _hasPUB, _anonFns) : fu_VEC<s_Node>{});
    if ((kind != "enum"_fu) && (kind != "flags"_fu))
    {
        if (!(annot))
            fail_DFmt4Umh("`primitive` declarations require a base type annotation."_fu, tokens, _idx, fname, src);

    };
    return make_ZhSDnjVw(kind, fu_VEC<s_Node> { fu::slate<2, s_Node> { s_Node(annot), (items ? make_ZhSDnjVw("variants"_fu, items, 0, (*(const fu_STR*)fu::NIL), modid, _loc) : s_Node{}) } }, 0, name, modid, _loc);
}
...
static s_Node parseStatement_gygIW4zW(int& _loc, fu::view<s_Token> tokens, int& _idx, const fu_STR& fname, const fu_STR& src, int& _col0, fu_VEC<fu_STR>& warnings, const s_Options& options, fu_VEC<fu_STR>& fuzimports, const int modid, int& _precedence, int& _fnDepth, fu_VEC<fu_STR>& _dollars, bool& _TODO_FIX_dollarOk, int& _dollarAuto, bool& _hasPUB, int& _anonFns)
{
    ...
    else if (token.kind == "id"_fu)
    {
        ...
        if (_fnDepth)
        {
            ...
            if (v == "return"_fu)
                return parseJump_Axc9VBjK("return"_fu, _fnDepth, _idx, tokens, fname, src, _precedence, _loc, _col0, warnings, options, modid, _dollars, _TODO_FIX_dollarOk, _dollarAuto, fuzimports, _hasPUB, _anonFns);

            if (v == "break"_fu)
                return parseJump_Axc9VBjK("break"_fu, _fnDepth, _idx, tokens, fname, src, _precedence, _loc, _col0, warnings, options, modid, _dollars, _TODO_FIX_dollarOk, _dollarAuto, fuzimports, _hasPUB, _anonFns);

            if (v == "continue"_fu)
                return parseJump_Axc9VBjK("continue"_fu, _fnDepth, _idx, tokens, fname, src, _precedence, _loc, _col0, warnings, options, modid, _dollars, _TODO_FIX_dollarOk, _dollarAuto, fuzimports, _hasPUB, _anonFns);
        ...
        if (peek.kind == "id"_fu)
        {
            ...
            if (v == "primitive"_fu)
                return parsePrimDecl_RDkgnfRi(v, tokens, _idx, _precedence, _loc, _col0, warnings, options, fname, src, modid, _fnDepth, _dollars, _TODO_FIX_dollarOk, _dollarAuto, fuzimports, _hasPUB, _anonFns);
...
static s_Node createReturn_5QvxaARB(const s_Node& expr, const int flags, const int modid, const int _loc)
{
    return createJump_lMn3xnq6("return"_fu, (*(const fu_STR*)fu::NIL), expr, flags, modid, _loc);
}
...
{
    tryConsume_KA4ZXnBr("op"_fu, "="_fu, tokens, _idx);
    ...
    if (body.kind == "block"_fu)
    {
        if (body.items && (last_jhr9I4Fb(body.items).kind != "return"_fu))
            body.items += make_ZhSDnjVw("void"_fu, (*(const fu_VEC<s_Node>*)fu::NIL), 0, (*(const fu_STR*)fu::NIL), modid, _loc);

        return /*NRVO*/ body;
    };
    if (body.kind == "return"_fu)
        return createBlock_HmSCaXEA(fu_VEC<s_Node> { fu::slate<1, s_Node> { s_Node(body) } }, (*(const fu_STR*)fu::NIL), modid, _loc);

    if ((body.kind == "call"_fu) && (body.value == "__native"_fu))
        return /*NRVO*/ body;

    return createBlock_HmSCaXEA(fu_VEC<s_Node> { fu::slate<1, s_Node> { createReturn_5QvxaARB(body, F_SINGLE_STMT, modid, _loc) } }, (*(const fu_STR*)fu::NIL), modid, _loc);
}

static void parseBranch_9bzfU6Qa(const bool noCond, bool& _TODO_FIX_dollarOk, int& _precedence, int& _loc, int& _idx, int& _col0, fu::view<s_Token> tokens, fu_VEC<fu_STR>& warnings, const s_Options& options, const fu_STR& fname, const fu_STR& src, const int modid, int& _fnDepth, fu_VEC<fu_STR>& _dollars, int& _dollarAuto, fu_VEC<fu_STR>& fuzimports, bool& _hasPUB, int& _anonFns, fu_VEC<s_Node>& branches)
{
    _TODO_FIX_dollarOk = true;
    ...
    branches.push(make_ZhSDnjVw("fnbranch"_fu, fu_VEC<s_Node> { fu::slate<3, s_Node> { s_Node(cond), s_Node(type), s_Node(cons) } }, 0, (*(const fu_STR*)fu::NIL), modid, _loc));
}

static int parseFnBodyOrPattern_1WIyFAf4(fu_VEC<s_Node>& out_push_body, const bool expr, fu::view<s_Token> tokens, int& _idx, bool& _TODO_FIX_dollarOk, int& _precedence, int& _loc, int& _col0, fu_VEC<fu_STR>& warnings, const s_Options& options, const fu_STR& fname, const fu_STR& src, const int modid, int& _fnDepth, fu_VEC<fu_STR>& _dollars, int& _dollarAuto, fu_VEC<fu_STR>& fuzimports, bool& _hasPUB, int& _anonFns)
{
    /*MOV*/ const int flags = 0;
    s_Node body {};
    if (!expr && tryConsume_KA4ZXnBr("id"_fu, "case"_fu, tokens, _idx))
    {
        fu_VEC<s_Node> branches {};
        do
            parseBranch_9bzfU6Qa(bool{}, _TODO_FIX_dollarOk, _precedence, _loc, _idx, _col0, tokens, warnings, options, fname, src, modid, _fnDepth, _dollars, _dollarAuto, fuzimports, _hasPUB, _anonFns, branches);
        while (tryConsume_KA4ZXnBr("id"_fu, "case"_fu, tokens, _idx));
        if (tryConsume_KA4ZXnBr("id"_fu, "default"_fu, tokens, _idx))
            parseBranch_9bzfU6Qa(true, _TODO_FIX_dollarOk, _precedence, _loc, _idx, _col0, tokens, warnings, options, fname, src, modid, _fnDepth, _dollars, _dollarAuto, fuzimports, _hasPUB, _anonFns, branches);

        body = make_ZhSDnjVw("pattern"_fu, branches, 0, (*(const fu_STR*)fu::NIL), modid, _loc);
    }
    else
...
static s_Node parseFnDecl_cont_s4SpAbJN(const fu_STR& name, int flags, const bool expr, const fu_STR& endv, int& _fnDepth, fu_VEC<fu_STR>& _dollars, bool& _TODO_FIX_dollarOk, int& _dollarAuto, fu::view<s_Token> tokens, int& _idx, const fu_STR& fname, const fu_STR& src, fu_VEC<fu_STR>& fuzimports, const int modid, int& _loc, int& _precedence, int& _col0, fu_VEC<fu_STR>& warnings, const s_Options& options, bool& _hasPUB, int& _anonFns)
{
    ...
    flags |= (endv ? parseArgsDecl_6JVxBqBt(items, "op"_fu, endv, _dollarAuto, _TODO_FIX_dollarOk, _dollars, tokens, _idx, fname, src, fuzimports, modid, _loc, _precedence, _col0, warnings, options, _fnDepth, _hasPUB, _anonFns) : int{});
    s_Node type = tryPopTypeAnnot_CnS8LGj7(false, tokens, _idx, _precedence, _loc, _col0, warnings, options, fname, src, modid, _fnDepth, _dollars, _TODO_FIX_dollarOk, _dollarAuto, fuzimports, _hasPUB, _anonFns);
    const int retIdx = items.size();
    items.push(s_Node(type));
    flags |= parseFnBodyOrPattern_1WIyFAf4(items, expr, tokens, _idx, _TODO_FIX_dollarOk, _precedence, _loc, _col0, warnings, options, fname, src, modid, _fnDepth, _dollars, _dollarAuto, fuzimports, _hasPUB, _anonFns);
    ...
    return make_ZhSDnjVw("fn"_fu, items, flags, name, modid, _loc);
}
...
{
    fu_STR name { tryConsume_KA4ZXnBr("id"_fu, fu::view<char>{}, tokens, _idx).value };
    if (!name)
    {
        const int postfix = (flags & F_POSTFIX);
        name = consume_9MEMifh3("op"_fu, fu::view<char>{}, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src).value;
        if (postfix)
        {
        ...
        {
            if (!(has_Lzdj3u2q(BINOP.PRECEDENCE, name)))
    ...
    fu_STR endv = (tryConsume_KA4ZXnBr("op"_fu, "("_fu, tokens, _idx) ? ")"_fu : fu_STR{});
    if (!endv)
    {
        if (expr)
...
static s_Node createArrayLiteral_XVuVqcRD(const int argFlags, const fu_VEC<s_Node>& items, const int modid, const int _loc)
{
    return make_ZhSDnjVw("arrlit"_fu, items, argFlags, (*(const fu_STR*)fu::NIL), modid, _loc);
}
...
{
    fu_VEC<s_Node> args {};
    const int argFlags = parseCallArgs_jb3WHS0P("]"_fu, args, true, tokens, _idx, fname, src, warnings, options, _loc, _precedence, _col0, modid, _fnDepth, _dollars, _TODO_FIX_dollarOk, _dollarAuto, fuzimports, _hasPUB, _anonFns);
    return createArrayLiteral_XVuVqcRD(argFlags, args, modid, _loc);
}
...
{
    return make_ZhSDnjVw("typeparam"_fu, (*(const fu_VEC<s_Node>*)fu::NIL), 0, value, modid, _loc);
}
...
{
    return make_ZhSDnjVw("definit"_fu, (*(const fu_VEC<s_Node>*)fu::NIL), 0, (*(const fu_STR*)fu::NIL), modid, _loc);
}
...
{
    return make_ZhSDnjVw("typetag"_fu, (*(const fu_VEC<s_Node>*)fu::NIL), 0, value, modid, _loc);
}

static s_Node typeCheck_a34PdnUn(const s_Node& actual, const s_Node& expect, const int modid, const int _loc)
{
    return make_ZhSDnjVw("typeassert"_fu, fu_VEC<s_Node> { fu::slate<2, s_Node> { s_Node(actual), s_Node(expect) } }, 0, (*(const fu_STR*)fu::NIL), modid, _loc);
}

static s_Node parseQualifierChain_RjHK3USz(/*MOV*/ s_Node&& expr, int& _idx, fu::view<s_Token> tokens, const fu_STR& fname, const fu_STR& src, const int modid, const int _loc, fu_VEC<fu_STR>& fuzimports)
{
    ...
    for (; ; )
    {
        ...
        if (!tryConsume_KA4ZXnBr("op"_fu, "::"_fu, tokens, _idx))
        {
            if ((path == "is"_fu) && (expr.items.size() == 1))
            {
                ...
                return typeCheck_a34PdnUn(left, right, modid, _loc);
            };
...
static s_Node parsePrefix_xiYbiI7o(fu_STR&& op, int& _idx, fu::view<s_Token> tokens, const fu_STR& fname, const fu_STR& src, int& _precedence, int& _loc, int& _col0, fu_VEC<fu_STR>& warnings, const s_Options& options, const int modid, int& _fnDepth, fu_VEC<fu_STR>& _dollars, bool& _TODO_FIX_dollarOk, int& _dollarAuto, fu_VEC<fu_STR>& fuzimports, bool& _hasPUB, int& _anonFns)
{
    ...
    if ((op == "&"_fu) && tryConsume_KA4ZXnBr("id"_fu, "mut"_fu, tokens, _idx))
        op = "&mut"_fu;

    const int mode = (((op == "-"_fu) || (op == "+"_fu)) ? int(M_LINT_UNARY_PRECEDENCE) : 0);
    s_Node _0 {};
    return (_0 = parseUnaryExpression_JSzKkS2X(mode, _precedence, _loc, _idx, _col0, tokens, warnings, options, fname, src, modid, _fnDepth, _dollars, _TODO_FIX_dollarOk, _dollarAuto, fuzimports, _hasPUB, _anonFns), createPrefix_ABYm5yA1(op, static_cast<s_Node&&>(_0), modid, _loc));
}
...
static s_Node parseExpressionHead_gerHnNqN(const int mode, fu::view<s_Token> tokens, int& _idx, const int modid, int& _loc, const fu_STR& fname, const fu_STR& src, int& _fnDepth, fu_VEC<fu_STR>& _dollars, bool& _TODO_FIX_dollarOk, int& _dollarAuto, fu_VEC<fu_STR>& fuzimports, int& _precedence, int& _col0, fu_VEC<fu_STR>& warnings, const s_Options& options, bool& _hasPUB, int& _anonFns)
{
...

    {
        ...
        if ((k == "int"_fu) || (k == "real"_fu) || (k == "str"_fu) || (k == "char"_fu))
            return createLeaf_BsemsVaz(k, v, modid, _loc);
        ...
        if (k == "op"_fu)
        {
            ...
            if (v == "::"_fu)
            {
                const fu_STR& id = consume_9MEMifh3("id"_fu, fu::view<char>{}, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src).value;
                _idx--;
                return parseQualifierChain_RjHK3USz(createRead_ozmPyYop(id, 0, modid, _loc, tokens, _idx, fname, src), _idx, tokens, fname, src, modid, _loc, fuzimports);
            };
            if (v == "."_fu)
            {
                const fu_STR& id = consume_9MEMifh3("id"_fu, fu::view<char>{}, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src).value;
...
static void lint_xOTRoYRd(const int mode, fu_VEC<fu_STR>& warnings, const s_Options& options, fu::view<s_Token> tokens, const int _idx, fu::view<char> fname, const fu_STR& src, const int _loc)
{
...
static s_Node parseAccessExpression_V26AGhef(const s_Node& expr, fu::view<s_Token> tokens, int& _idx, fu::view<char> fname, const fu_STR& src, const int modid, const int _loc)
{
    s_Token id { tryConsume_KA4ZXnBr("id"_fu, fu::view<char>{}, tokens, _idx) };
    if (!id)
    {
        consume_9MEMifh3("op"_fu, "::"_fu, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src);
        id = consume_9MEMifh3("id"_fu, fu::view<char>{}, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src);
        _idx -= 2;
    };
    return createCall_6I9XL8Me(id.value, F_ACCESS, fu_VEC<s_Node> { fu::slate<1, s_Node> { s_Node(expr) } }, modid, _loc);
}
...
static s_Node parseCallExpression_6ppKTM7y(const s_Node& expr, fu::view<s_Token> tokens, int& _idx, const fu_STR& fname, const fu_STR& src, fu_VEC<fu_STR>& warnings, const s_Options& options, int& _loc, int& _precedence, int& _col0, const int modid, int& _fnDepth, fu_VEC<fu_STR>& _dollars, bool& _TODO_FIX_dollarOk, int& _dollarAuto, fu_VEC<fu_STR>& fuzimports, bool& _hasPUB, int& _anonFns)
{
    fu_VEC<s_Node> args {};
    const int argFlags = parseCallArgs_jb3WHS0P(")"_fu, args, bool{}, tokens, _idx, fname, src, warnings, options, _loc, _precedence, _col0, modid, _fnDepth, _dollars, _TODO_FIX_dollarOk, _dollarAuto, fuzimports, _hasPUB, _anonFns);
    if ((expr.kind == "call"_fu) && (expr.flags & F_ACCESS))
    {
        ...
        return createCall_6I9XL8Me((expr.value ? expr.value : fail_DFmt4Umh(fu_STR{}, tokens, _idx, fname, src)), ((F_METHOD | argFlags) | (expr.flags & ~F_ACCESS)), args, modid, _loc);
    };
    if ((expr.kind == "call"_fu) && (expr.flags & F_ID))
        return createCall_6I9XL8Me((expr.value ? expr.value : fail_DFmt4Umh(fu_STR{}, tokens, _idx, fname, src)), (argFlags | (expr.flags & ~F_ID)), args, modid, _loc);

    if (expr.kind == "typeparam"_fu)
        return createCall_6I9XL8Me(("$"_fu + (expr.value ? expr.value : fail_DFmt4Umh(fu_STR{}, tokens, _idx, fname, src))), argFlags, args, modid, _loc);

    fail_DFmt4Umh("TODO dynamic call"_fu, tokens, _idx, fname, src);
}

static s_Node parseIndexExpression_lK3iexuw(const s_Node& expr, fu::view<s_Token> tokens, int& _idx, const fu_STR& fname, const fu_STR& src, fu_VEC<fu_STR>& warnings, const s_Options& options, int& _loc, int& _precedence, int& _col0, const int modid, int& _fnDepth, fu_VEC<fu_STR>& _dollars, bool& _TODO_FIX_dollarOk, int& _dollarAuto, fu_VEC<fu_STR>& fuzimports, bool& _hasPUB, int& _anonFns)
{
    fu_VEC<s_Node> args {};
    const int argFlags = parseCallArgs_jb3WHS0P("]"_fu, args, bool{}, tokens, _idx, fname, src, warnings, options, _loc, _precedence, _col0, modid, _fnDepth, _dollars, _TODO_FIX_dollarOk, _dollarAuto, fuzimports, _hasPUB, _anonFns);
    args.unshift(s_Node(expr));
    return createCall_6I9XL8Me("[]"_fu, (argFlags | F_OPERATOR), args, modid, _loc);
}
...
inline int get_3QSNqawK(fu::view<fu_STR> keys, fu::view<char> item, fu::view<int> extras)
{
    ...
    return 0;
                                ...
                                #ifndef DEF_get_97UJm6UE
                                #define DEF_get_97UJm6UE
inline int get_97UJm6UE(const s_Map_guWsCK25& _, fu::view<char> key)
{
    return get_3QSNqawK(_.keys, key, _.vals);
}
                                #endif

static s_Node createOr_ghkGmd4l(const s_Node& left, const s_Node& right, const int modid, const int _loc)
{
    return flattenIfSame_wt8l3tBV("or"_fu, left, right, modid, _loc);
}

static s_Node pipelineRight_u8aV7viy(const s_Node& left, /*MOV*/ s_Node&& right, fu::view<s_Token> tokens, const int _idx, fu::view<char> fname, const fu_STR& src)
{
...
static s_Node typeCast_jLozH5JS(const s_Node& actual, const s_Node& expect, const int modid, const int _loc)
{
    return make_ZhSDnjVw("typecast"_fu, fu_VEC<s_Node> { fu::slate<2, s_Node> { s_Node(actual), s_Node(expect) } }, 0, (*(const fu_STR*)fu::NIL), modid, _loc);
}

static s_Node tryParseBinary_wzqpZRvh(const s_Node& left, const fu_STR& op, const int p1, int& _precedence, int& _idx, int& _loc, int& _col0, fu::view<s_Token> tokens, fu_VEC<fu_STR>& warnings, const s_Options& options, const fu_STR& fname, const fu_STR& src, const int modid, int& _fnDepth, fu_VEC<fu_STR>& _dollars, bool& _TODO_FIX_dollarOk, int& _dollarAuto, fu_VEC<fu_STR>& fuzimports, bool& _hasPUB, int& _anonFns)
{
    ...
    if (mid)
        return createIf_vPWWRbaz(left, mid, right, modid, _loc);

    if (op == "||"_fu)
        return createOr_ghkGmd4l(left, right, modid, _loc);

    if (op == "&&"_fu)
        return createAnd_9b9wU7tg(left, right, modid, _loc);

    if ((left.kind == "and"_fu) || (left.kind == "or"_fu))
    {
        if (!(left.flags & F_PARENS))
            warn_MBVnJZGU((((("Unparenthesized `"_fu + left.kind) + "` on the left side of an `"_fu) + op) + "`."_fu), warnings, options, tokens, _idx, fname, src, _loc);

    };
    if (op == "|>"_fu)
        return pipelineRight_u8aV7viy(left, s_Node(right), tokens, _idx, fname, src);

    if (op == "<|"_fu)
        return pipelineLeft_pmCii9ji(s_Node(left), right, tokens, _idx, fname, src);

    if (op == "->"_fu)
        return typeCheck_a34PdnUn(left, right, modid, _loc);

    if (op == "=>"_fu)
        return typeCast_jLozH5JS(left, right, modid, _loc);

    return createCall_6I9XL8Me(op, (F_INFIX | F_OPERATOR), fu_VEC<s_Node> { fu::slate<2, s_Node> { s_Node(left), s_Node(right) } }, modid, _loc);
}
...
static s_Node tryParseExpressionTail_R95181Oi(const s_Node& head, const int mode, fu::view<s_Token> tokens, int& _idx, fu_VEC<fu_STR>& warnings, const s_Options& options, const fu_STR& fname, const fu_STR& src, int& _loc, const int modid, int& _precedence, int& _col0, int& _fnDepth, fu_VEC<fu_STR>& _dollars, bool& _TODO_FIX_dollarOk, int& _dollarAuto, fu_VEC<fu_STR>& fuzimports, bool& _hasPUB, int& _anonFns)
{
    ...
    if (token.kind == "op"_fu)
    {
        ...
        if (v == "."_fu)
            return ((void)lint_xOTRoYRd(mode, warnings, options, tokens, _idx, fname, src, _loc), parseAccessExpression_V26AGhef(head, tokens, _idx, fname, src, modid, _loc));

        if (v == "("_fu)
            return ((void)lint_xOTRoYRd(mode, warnings, options, tokens, _idx, fname, src, _loc), parseCallExpression_6ppKTM7y(head, tokens, _idx, fname, src, warnings, options, _loc, _precedence, _col0, modid, _fnDepth, _dollars, _TODO_FIX_dollarOk, _dollarAuto, fuzimports, _hasPUB, _anonFns));

        if (v == "["_fu)
            return ((void)lint_xOTRoYRd(mode, warnings, options, tokens, _idx, fname, src, _loc), parseIndexExpression_lK3iexuw(head, tokens, _idx, fname, src, warnings, options, _loc, _precedence, _col0, modid, _fnDepth, _dollars, _TODO_FIX_dollarOk, _dollarAuto, fuzimports, _hasPUB, _anonFns));

        const int p1 = get_97UJm6UE(BINOP.PRECEDENCE, v);
        if (p1)
            return ((void)_idx--, tryParseBinary_wzqpZRvh(head, v, p1, _precedence, _idx, _loc, _col0, tokens, warnings, options, fname, src, modid, _fnDepth, _dollars, _TODO_FIX_dollarOk, _dollarAuto, fuzimports, _hasPUB, _anonFns));

        if (has_tkmelWjn(POSTFIX, v))
            return createCall_6I9XL8Me((((v == "++"_fu) || (v == "--"_fu)) ? ("postfix"_fu + v) : fu_STR(v)), (F_POSTFIX | F_OPERATOR), fu_VEC<s_Node> { fu::slate<1, s_Node> { s_Node(head) } }, modid, _loc);

        if (v == "::"_fu)
            return parseQualifierChain_RjHK3USz(s_Node(head), _idx, tokens, fname, src, modid, _loc, fuzimports);
...
static s_Node parseExpression_YeBII3Si(const int p1, const int mode, int& _precedence, int& _loc, int& _idx, int& _col0, fu::view<s_Token> tokens, fu_VEC<fu_STR>& warnings, const s_Options& options, const fu_STR& fname, const fu_STR& src, const int modid, int& _fnDepth, fu_VEC<fu_STR>& _dollars, bool& _TODO_FIX_dollarOk, int& _dollarAuto, fu_VEC<fu_STR>& fuzimports, bool& _hasPUB, int& _anonFns)
{
...

    {
        ...
        int loc0 = (_loc = _idx);
        s_Node out {};
        while ((out = tryParseExpressionTail_R95181Oi(head, mode_1, tokens, _idx, warnings, options, fname, src, _loc, modid, _precedence, _col0, _fnDepth, _dollars, _TODO_FIX_dollarOk, _dollarAuto, fuzimports, _hasPUB, _anonFns)))
        {
...
static s_Node parseTypeAnnot_c1VMMa5D(const bool allowTypeUnions, int& _precedence, int& _loc, int& _idx, int& _col0, fu::view<s_Token> tokens, fu_VEC<fu_STR>& warnings, const s_Options& options, const fu_STR& fname, const fu_STR& src, const int modid, int& _fnDepth, fu_VEC<fu_STR>& _dollars, bool& _TODO_FIX_dollarOk, int& _dollarAuto, fu_VEC<fu_STR>& fuzimports, bool& _hasPUB, int& _anonFns)
{
    ...
    while (allowTypeUnions && tryConsume_KA4ZXnBr("id"_fu, "or"_fu, tokens, _idx))
    {
        if (res.kind != "typeunion"_fu)
            res = make_ZhSDnjVw("typeunion"_fu, fu_VEC<s_Node> { fu::slate<1, s_Node> { s_Node(res) } }, 0, (*(const fu_STR*)fu::NIL), modid, _loc);
...
{
    return (tryConsume_KA4ZXnBr("op"_fu, ":"_fu, tokens, _idx) ? parseTypeAnnot_c1VMMa5D(allowTypeUnions, _precedence, _loc, _idx, _col0, tokens, warnings, options, fname, src, modid, _fnDepth, _dollars, _TODO_FIX_dollarOk, _dollarAuto, fuzimports, _hasPUB, _anonFns) : miss_nvchsvdV());
}

static s_Node tryParseLetInit_NxmIiLZh(fu::view<s_Token> tokens, int& _idx, int& _precedence, int& _loc, int& _col0, fu_VEC<fu_STR>& warnings, const s_Options& options, const fu_STR& fname, const fu_STR& src, const int modid, int& _fnDepth, fu_VEC<fu_STR>& _dollars, bool& _TODO_FIX_dollarOk, int& _dollarAuto, fu_VEC<fu_STR>& fuzimports, bool& _hasPUB, int& _anonFns)
{
    return tryConsume_KA4ZXnBr("op"_fu, "="_fu, tokens, _idx) ? parseExpression_YeBII3Si(P_RESET, 0, _precedence, _loc, _idx, _col0, tokens, warnings, options, fname, src, modid, _fnDepth, _dollars, _TODO_FIX_dollarOk, _dollarAuto, fuzimports, _hasPUB, _anonFns) : s_Node{};
}
...
{
    int flags = 0;
    if (tryConsume_KA4ZXnBr("id"_fu, "using"_fu, tokens, _idx))
        flags |= F_USING;

    if (tryConsume_KA4ZXnBr("id"_fu, "implicit"_fu, tokens, _idx))
        flags |= F_IMPLICIT;

    if (tryConsume_KA4ZXnBr("id"_fu, "lax"_fu, tokens, _idx))
        flags |= F_LAX;

    if (tryConsume_KA4ZXnBr("id"_fu, "shadow"_fu, tokens, _idx))
        flags |= F_SHADOW;

    if (tryConsume_KA4ZXnBr("id"_fu, "mut"_fu, tokens, _idx))
        flags |= F_MUT;

    if (tryConsume_KA4ZXnBr("id"_fu, "ref"_fu, tokens, _idx))
        flags |= F_REF;

    const s_Token& sh_import = tryConsume_KA4ZXnBr("op"_fu, "::"_fu, tokens, _idx);
    fu_STR id { consume_9MEMifh3("id"_fu, fu::view<char>{}, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src).value };
    if (id == "_"_fu)
        flags |= F_LAX;

    if (xqmark && tryConsume_KA4ZXnBr("op"_fu, "!"_fu, tokens, _idx))
    {
        flags |= F_MUSTNAME;
        const fu_STR& inner_id = tryConsume_KA4ZXnBr("id"_fu, fu::view<char>{}, tokens, _idx).value;
        if (inner_id)
        {
            flags |= F_COMPOUND_ID;
            id += ("!"_fu + inner_id);
    ...
    {
        flags |= F_COMPOUND_ID;
        id += ("."_fu + consume_9MEMifh3("id"_fu, fu::view<char>{}, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src).value);
        while (tryConsume_KA4ZXnBr("op"_fu, "::"_fu, tokens, _idx))
            id += ("\t"_fu + consume_9MEMifh3("id"_fu, fu::view<char>{}, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src).value);
    ...
    const s_Token& optional = (xqmark ? tryConsume_KA4ZXnBr("op"_fu, "?"_fu, tokens, _idx) : (*(const s_Token*)fu::NIL));
    ...
    if ((flags & F_REF) && type)
    {
        ...
        {
            type = createPrefix_ABYm5yA1("&mut"_fu, s_Node(type), modid, _loc);
            flags &= ~F_REF;
        };
    };
    return createLet_kXyj3e6e(id, flags, type, init, modid, _loc);
}
...
{
    const s_Token& isPredicate = tryConsume_KA4ZXnBr("id"_fu, "true"_fu, tokens, _idx);
...
static s_Node parseEnumItem_NihMLCRj(fu::view<s_Token> tokens, int& _idx, const fu_STR& fname, const fu_STR& src, int& _precedence, int& _loc, int& _col0, fu_VEC<fu_STR>& warnings, const s_Options& options, const int modid, int& _fnDepth, fu_VEC<fu_STR>& _dollars, bool& _TODO_FIX_dollarOk, int& _dollarAuto, fu_VEC<fu_STR>& fuzimports, bool& _hasPUB, int& _anonFns)
{
    ...
    softSemi_qUCXLPGA(tokens, _idx, _col0, warnings, options, fname, src, _loc);
    return createLet_kXyj3e6e(id, 0, (*(const s_Node*)fu::NIL), init, modid, _loc);
}
...
{
    const s_Token* _0;
    const fu_STR& value = (tryConsume_KA4ZXnBr("op"_fu, ":"_fu, tokens, _idx) ? (*(_0 = &(tryConsume_KA4ZXnBr("id"_fu, "err"_fu, tokens, _idx))) ? *_0 : consume_9MEMifh3("id"_fu, "ok"_fu, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src)).value : (*(const fu_STR*)fu::NIL));
    if (!(_fnDepth > 0))
    {
        _idx--;
        fail_DFmt4Umh(fu_STR{}, tokens, _idx, fname, src);
    ...
    fu_VEC<s_Node> _1 {};
    return (_1 = fu_VEC<s_Node> { fu::slate<1, s_Node> { parseStatement_gygIW4zW(_loc, tokens, _idx, fname, src, _col0, warnings, options, fuzimports, modid, _precedence, _fnDepth, _dollars, _TODO_FIX_dollarOk, _dollarAuto, _hasPUB, _anonFns) } }, make_ZhSDnjVw("defer"_fu, static_cast<fu_VEC<s_Node>&&>(_1), 0, value, modid, _loc));
}
...
static fu_VEC<s_Node> parseBlockLike_3TimIhXP(fu::view<char> endKind, fu::view<char> endVal, const bool sTruct, const bool eNum, int& _idx, fu::view<s_Token> tokens, int& _col0, fu_VEC<fu_STR>& warnings, const s_Options& options, const fu_STR& fname, const fu_STR& src, int& _loc, fu_VEC<fu_STR>& fuzimports, const int modid, int& _precedence, int& _fnDepth, fu_VEC<fu_STR>& _dollars, bool& _TODO_FIX_dollarOk, int& _dollarAuto, bool& _hasPUB, int& _anonFns)
{
...
{
    consume_9MEMifh3("sof"_fu, "sof"_fu, (*(const fu_STR*)fu::NIL), tokens, _idx, fname, src);
    _loc = _idx;
    fu_VEC<s_Node> _0 {};
    /*MOV*/ s_Node out = (_0 = parseBlockLike_3TimIhXP("eof"_fu, "eof"_fu, false, false, _idx, tokens, _col0, warnings, options, fname, src, _loc, fuzimports, modid, _precedence, _fnDepth, _dollars, _TODO_FIX_dollarOk, _dollarAuto, _hasPUB, _anonFns), make_ZhSDnjVw("root"_fu, static_cast<fu_VEC<s_Node>&&>(_0), 0, (*(const fu_STR*)fu::NIL), modid, _loc));
    if (use_AUTOPUB && !_hasPUB)
    {
        for (int i = 0; i < out.items.size(); i++)
        {
            ...
            if (((k == "fn"_fu) || (k == "let"_fu) || (k == "typedef"_fu) || (k == "struct"_fu) || (k == "enum"_fu) || (k == "flags"_fu) || (k == "primitive"_fu)) && !(item.flags & F_SHADOW))
...
s_ParserOutput parse_J0V9lDrD(const int modid, const fu_STR& fname, const fu_STR& src, fu::view<s_Token> tokens, const s_Options& options)
{
    int _idx = 0;
    int _loc = 0;
    int _col0 = 0;
