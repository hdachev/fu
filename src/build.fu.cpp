...
inline constexpr s_BuildScheme s_BuildScheme_watch = s_BuildScheme(16u);
inline constexpr s_BuildScheme s_BuildScheme_debuggable = s_BuildScheme(32u);
inline constexpr s_BuildScheme s_BuildScheme_unoptimized = s_BuildScheme(64u);
inline constexpr s_BuildScheme s_BuildScheme_assertions = s_BuildScheme(128u);
inline constexpr s_BuildScheme s_BuildScheme_TODO_FIX_retail = s_BuildScheme(256u);
...
enum s_RunMode: fu::u8
{
    ...
    s_RunMode_CompilerTestcase = 2u,
    s_RunMode_EnsureExecutableButDontRun = 3u,
};
                                #endif
...
static const fu::str TODO_FIX_ignoredWarnings fu_INIT_PRIORITY(1006) = ((((""_fu + "-Wno-float-conversion "_fu) + "-Wno-unused-but-set-variable "_fu) + "-Wno-unknown-warning-option "_fu) + "-Wno-maybe-uninitialized -Wno-stringop-overflow -Wno-array-bounds -Wno-sequence-point -Wno-dangling-reference "_fu);
                                ...
                                #ifndef DEF___8iN1OlsRoOh
                                #define DEF___8iN1OlsRoOh
inline static int _8iN1OlsR()
{
    return -1;
}
                                #endif

                                #ifndef DEF_map_FIQudWbXQH2
                                #define DEF_map_FIQudWbXQH2
inline fu::vec<int> map_FIQudWbX(fu::view<s_Module> a)
{
    /*MOV*/ fu::vec<int> res {};
    res.grow<false>(a.size());
    for (int i = 0; i < a.size(); i++)
        res.mutref(i) = _8iN1OlsR();
...
inline bool add_eHVOG4pi(s_Set_6ARmtH0K78f& _, const fu::str& key)
{
    ...
    return true;
                                ...
                                #ifndef DEF___gj9ad8C5M9g
                                #define DEF___gj9ad8C5M9g
inline static bool _gj9ad8C5(const fu::str& incl, s_TranslationUnit& unit, fu::view<char> dir)
{
    return add_eHVOG4pi(unit.hacks.include_dirs, (starts_8EDTwZj1(incl, '.') ? join_qZI0kCzt(dir, incl) : fu::str(incl)));
}
                                #endif

                                #ifndef DEF_each_qfU2ceeALgj
                                #define DEF_each_qfU2ceeALgj
inline void each_qfU2ceeA(fu::view<fu::str> a, s_TranslationUnit& unit, fu::view<char> dir)
{
    for (int i = 0; i < a.size(); i++)
        _gj9ad8C5(a[i], unit, dir);
...
{
    /*MOV*/ s_DirWrk ret = s_DirWrk { (dir_wrk + "cpp/"_fu), (dir_wrk + "obj/"_fu), (dir_wrk + "bin/"_fu), (dir_wrk + "tmp/"_fu) };
...
inline static void link_each_pqmgoSko(const s_Set_6ARmtH0K78f& link, s_Set_6ARmtH0K78f& HACK_linkFlags, s_Set_6ARmtH0K78f& HACK_pkgConfig_libs)
{
    for (int i = 0; i < link.keys_asc.size(); i++)
    {
        ...
        _lZfmLzfl((isFlag ? item : (*(const fu::str*)fu::NIL)), (!isFlag ? item : (*(const fu::str*)fu::NIL)), HACK_linkFlags, HACK_pkgConfig_libs);
                                ...
                                #ifndef DEF___5jaGk1dFFj8
                                #define DEF___5jaGk1dFFj8
inline static void _5jaGk1dF(const s_TranslationUnit& unit, s_Set_6ARmtH0K78f& HACK_linkFlags, s_Set_6ARmtH0K78f& HACK_pkgConfig_libs, s_Set_6ARmtH0K78f& HACK_include_dirs, int& len_all, s_TEA& hash_all)
{
    ...
    link_each_pqmgoSko(unit.hacks.link, HACK_linkFlags, HACK_pkgConfig_libs);
                                ...
                                #ifndef DEF_each_A3bibyetYTj
                                #define DEF_each_A3bibyetYTj
inline void each_A3bibyet(fu::view<s_TranslationUnit> a, s_Set_6ARmtH0K78f& HACK_linkFlags, s_Set_6ARmtH0K78f& HACK_pkgConfig_libs, s_Set_6ARmtH0K78f& HACK_include_dirs, int& len_all, s_TEA& hash_all)
{
    for (int i = 0; i < a.size(); i++)
        _5jaGk1dF(a[i], HACK_linkFlags, HACK_pkgConfig_libs, HACK_include_dirs, len_all, hash_all);
...
static s_BuildError buildUnit_uGHE7p6t(s_TranslationUnit& unit, const int i, const s_RunMode runmode, const s_BuildScheme bscheme, fu::view<char> GCC_CMD, fu::view<char> INCLUDE, const s_DirWrk& dir_wrk)
{
    ...
    else
    {
        ...
        fu::str CMD = ((((((GCC_CMD + "-c"_fu) + INCLUDE_2) + " -o "_fu) + unit.tmp_file) + " "_fu) + F_cpp);
        /*MOV*/ fu::str stdout {};
        ...
        else
        {
            ...
            return s_BuildError{};
                                ...
                                #ifndef DEF___94Y1465rXcb
                                #define DEF___94Y1465rXcb
inline static const s_BuildError& _94Y1465r(const int i, fu::view_mut<s_TranslationUnit> arr, fu::view_mut<s_BuildError> result, const s_RunMode runmode, const s_BuildScheme bscheme, fu::view<char> GCC_CMD, fu::view<char> INCLUDE, const s_DirWrk& dir_wrk)
{
    ...
    return (result.mutref(i) = (_0 = &(arr.mutref(i)), buildUnit_uGHE7p6t(*_0, i, runmode, bscheme, GCC_CMD, INCLUDE, dir_wrk)));
                                ...
                                #ifndef DEF_parallel_for_TwAQoajS6tg
                                #define DEF_parallel_for_TwAQoajS6tg
inline static void parallel_for_TwAQoajS(const int min, int end, fu::view_mut<s_TranslationUnit> arr, fu::view_mut<s_BuildError> result, const s_RunMode runmode, const s_BuildScheme bscheme, fu::view<char> GCC_CMD, fu::view<char> INCLUDE, const s_DirWrk& dir_wrk)
{
    int start = (end & 0);
    (void) start;
    ...
    for (int i = start; i < end; i++)
        _94Y1465r(i, arr, result, runmode, bscheme, GCC_CMD, INCLUDE, dir_wrk);
                                ...
                                #ifndef DEF_map_HimxUFm08id
                                #define DEF_map_HimxUFm08id
inline fu::vec<s_BuildError> map_HimxUFm0(fu::view_mut<s_TranslationUnit> arr, const int min, const s_RunMode runmode, const s_BuildScheme bscheme, fu::view<char> GCC_CMD, fu::view<char> INCLUDE, const s_DirWrk& dir_wrk)
{
    /*MOV*/ fu::vec<s_BuildError> result {};
    result.grow<false>(arr.size());
    parallel_for_TwAQoajS(min, arr.size(), arr, result, runmode, bscheme, GCC_CMD, INCLUDE, dir_wrk);
    return /*NRVO*/ result;
}
                                #endif

                                #ifndef DEF___HyaVSMu4Za3
                                #define DEF___HyaVSMu4Za3
inline static s_CacheCleanup _HyaVSMu4(s_TranslationUnit& unit)
{
    return (unit.cache_cleanup &= s_CacheCleanup(~s_CacheCleanup_Cpp));
}
                                #endif

                                #ifndef DEF_each_4vETViFGWVl
                                #define DEF_each_4vETViFGWVl
inline void each_4vETViFG(fu::view_mut<s_TranslationUnit> a)
{
    for (int i = 0; i < a.size(); i++)
        _HyaVSMu4(a.mutref(i));

}
                                #endif

                                #ifndef DEF___vpVjNosB36j
                                #define DEF___vpVjNosB36j
inline static fu::view<char> _vpVjNosB(const s_TranslationUnit& unit, fu::str& explain)
{
    return (explain += (unit.human + "\n"_fu));
}
                                #endif

                                #ifndef DEF_each_9Qn9C619rV6
                                #define DEF_each_9Qn9C619rV6
inline void each_9Qn9C619(fu::view<s_TranslationUnit> a, fu::str& explain)
{
    for (int i = 0; i < a.size(); i++)
        _vpVjNosB(a[i], explain);

}
                                #endif

                                #ifndef DEF___IWNZeD9jEyg
                                #define DEF___IWNZeD9jEyg
inline static fu::view<char> _IWNZeD9j(const s_TranslationUnit& unit, fu::str& explain)
{
    return (explain += unit.src);
}
                                #endif

                                #ifndef DEF_each_Uktb5peVK5e
                                #define DEF_each_Uktb5peVK5e
inline void each_Uktb5peV(fu::view<s_TranslationUnit> a, fu::str& explain)
{
    for (int i = 0; i < a.size(); i++)
        _IWNZeD9j(a[i], explain);

}
                                #endif

[[noreturn]] static fu::never ERR_uGHE7p6t(fu::str&& cpp, fu::view_mut<s_TranslationUnit> units, const s_DEV_OnFail onfail, const int code, fu::str& stdout, const s_DirWrk& dir_wrk)
{
    // Hoisted:
    fu::str x {};
    ...
    stdout += x7E_3lDd4lqo("   EXIT code: "_fu, fu::i64dec(code));
    fu::str explain = ""_fu;
    if (onfail & s_DEV_OnFail_OnFail_PrintInput)
    {
        explain += "\n\n\tCOMPILER BUG or INCORRECT TESTCASE:\n\n"_fu;
        each_9Qn9C619(units, explain);
    };
    if (onfail & s_DEV_OnFail_OnFail_PrintOutput)
    {
        explain += "\n\n\tGenerated code:\n\n"_fu;
        each_Uktb5peV(units, explain);
    };
    fail_uGHE7p6t((stdout + explain));
}
...
static void READ_cachedTestOutput_uGHE7p6t(const fu::str& F_exe, s_TestOutput& output, s_ExitStatus& status)
{
    fu::str src {};
...
static void WRITE_cachedTestOutput_uGHE7p6t(const fu::str& F_exe, const s_TestOutput& output, const s_DirWrk& dir_wrk)
{
...
static s_BuildOutput buildTarget_uGHE7p6t(fu::view_mut<s_TranslationUnit> units, fu::view<s_FileInvariants> file_invariants, fu::view<fu::str> flags_cc, fu::view<fu::str> flags_ld, const s_DEV_OnFail onfail, const s_RunMode runmode, const int expect_exit, const s_BuildScheme bscheme, const fu::str& bin, fu::view<char> GCC_CMD, const s_Context& ctx, const s_DirWrk& dir_wrk)
{
    ...
    int len_all {};
    s_TEA hash_all {};
    each_A3bibyet(units, HACK_linkFlags, HACK_pkgConfig_libs, HACK_include_dirs, len_all, hash_all);
    ...
    fu::str LIBS = (((flags_ld ? (" "_fu + join_LLExut74(flags_ld, ' ')) : fu::str{}) + (HACK_linkFlags ? (" "_fu + join_roEBocCS(HACK_linkFlags.keys_asc, " "_fu)) : fu::str{})) + (HACK_pkgConfig_libs ? ((" $(pkg-config --libs "_fu + join_roEBocCS(HACK_pkgConfig_libs.keys_asc, " "_fu)) + ")"_fu) : fu::str{}));
    len_all += LIBS.size();
    hash_l6RUR9Sz(hash_all, LIBS);
    int code {};
    fu::str stdout {};
    uint64_t BL_5_v {};
    fu::str F_exe = x7E_3lDd4lqo(((dir_wrk.bin + digest16_lweHUmk8((__extension__ (
    {
        ...
        BL_5_v = ((uint64_t(tea.v0) | (uint64_t(tea.v1) << 32ull)));
    (void)0;}), BL_5_v), 0)) + "-"_fu), fu::i64dec(len_all));
    const int64_t old_size = (!s_BuildScheme((bscheme & s_BuildScheme_nocache)) ? size_VWJwj7Fs(fu::str(F_exe)) : 0ll);
    const int64_t old_size_1 = ((old_size != 4ll) ? old_size : 0ll);
    if ((old_size_1 < 1ll) && (bin || runmode))
    {
        fu::vec<s_BuildError> buildErrors = map_HimxUFm0(units, int{}, runmode, bscheme, GCC_CMD, INCLUDE, dir_wrk);
        for (int i_1 = 0; i_1 < buildErrors.size(); i_1++)
        {
            ...
            {
                stdout = err.stdout;
                ERR_uGHE7p6t(fu::str(err.cpp), units, onfail, code, stdout, dir_wrk);
            };
        };
        ...
        if (bscheme & s_BuildScheme_shared)
        {
            cmd += " -shared"_fu;
            fu::str soname = filename_qZI0kCzt(bin);
            if (fu::APPLE)
                cmd += (" -Wl,-install_name,@rpath/"_fu + soname);
            else
...

        {
            ...
            if (code)
            {
                fu::println((fu::slate<1, fu::str> { static_cast<fu::str&&>((x_1 = ((x7E_3lDd4lqo((("   FAIL "_fu + CMD) + " EXIT="_fu), fu::i64dec(code)) + "\n"_fu) + stdout), x_1)) }));
                ERR_uGHE7p6t(fu::str{}, units, onfail, code, stdout, dir_wrk);
            }
            else
            {
                const double t1 = hr_0pZhUWR4();
    ...
    {
        const bool OPTI_StatusCode = (runmode == s_RunMode_CompilerTestcase);
        s_ExitStatus status {};
        if (OPTI_StatusCode && looks_legit_6GsP67je(old_size_1))
            READ_cachedTestOutput_uGHE7p6t(F_exe, output, status);
        else
        {

            {
                ...
                code = int(spawn_0Hw8DqUB(fu::vec<fu::str> { fu::slate<1, fu::str> { fu::str(F_exe) } }, stdout_1, stdout_1, status, (runmode == s_RunMode_Normally)));
                output = from_6GsP67je(stdout_1, status);
                const double t1_1 = hr_0pZhUWR4();
                fu::println((fu::slate<6, fu::str> { static_cast<fu::str&&>((x_6 = "     OK "_fu, x_6)), static_cast<fu::str&&>((x_7 = fu::f64dec((t1_1 - t0_1)), x_7)), static_cast<fu::str&&>((x_8 = "s"_fu, x_8)), static_cast<fu::str&&>((x_9 = (signalled_BXrkWTfT(status) ? (x7E_3lDd4lqo(" signal("_fu, fu::i64dec(signal_BXrkWTfT(status))) + ")"_fu) : fu::str{}), x_9)), static_cast<fu::str&&>((x_10 = (exited_BXrkWTfT(status) ? (x7E_3lDd4lqo(" exit("_fu, fu::i64dec(exit_BXrkWTfT(status))) + ")"_fu) : fu::str{}), x_10)), static_cast<fu::str&&>((x_11 = (code ? (x7E_3lDd4lqo(" errno("_fu, fu::i64dec(code)) + ")"_fu) : fu::str{}), x_11)) }));
            };
            if (OPTI_StatusCode)
            {
                ...
                if (looks_legit_6GsP67je(new_size))
                    ...
                    WRITE_cachedTestOutput_uGHE7p6t(F_exe, output, dir_wrk);
...
s_BuildOutput build_uGHE7p6t(fu::str&& dir_wrk, fu::str&& fulib, const fu::str& bin, fu::str&& dir_obj, fu::str&& dir_src, fu::str&& dir_cpp, fu::view<char> unity, const s_DEV_OnFail onfail, const s_RunMode runmode, const int expect_exit, const s_BuildScheme bscheme, fu::view<fu::str> flags_cc, fu::view<fu::str> flags_ld, const s_Context& ctx)
{
    ...
    if (!s_BuildScheme((bscheme & s_BuildScheme_unoptimized)))
    ...
    {
        s_CodegenOutput fulib_cpp_1 = s_CodegenOutput { static_cast<fu::str&&>(fulib_cpp), s_Set_6ARmtH0K78f{}, s_BuildHacks{}, s_CGDefects{} };
        fu::vec<int> unit_indices = map_FIQudWbX(ctx.modules);
        ...
        for (int i = 0; i < dep_order.size(); i++)
        {
            ...
            if (!(!cpp.src))
            {
                ...
                units.push(s_TranslationUnit { static_cast<fu::str&&>(human), fu::str(cpp.src), static_cast<fu::str&&>(iquote), s_TEA{}, s_TEA{}, (fname + ".cpp"_fu), fu::str{}, s_TEA{}, fu::str{}, fu::str{}, s_CacheCleanup{}, s_BuildHacks{} });
                ...
                (void)0;}), BL_19_v); i_1++)
                {
                    ...
                    const uint64_t hash = getIncludeHash_uGHE7p6t((__extension__ (
                    {
                        const s_Set_6ARmtH0K78f& _ = cpp.includes_headers;
                        const int i_2 = i_1;
                        BL_22_v = &(_.keys_asc[i_2]);
                    (void)0;}), *BL_22_v), module.fname, file_invariants, include_hashes);
                    if (hash)
                ...
                if (cpp.hacks)
                {
                    ...
                    if (include_dirs)
                    {
                        ...
                        each_qfU2ceeA(include_dirs.keys_asc, unit, dir);
                    };
                };
            };
        };
        ...
        for (int i_1 = 0; i_1 < units.size(); i_1++)
        {
            ...
            hash_l6RUR9Sz(unit.self_src_hash, unit.src);
            fu_ASSERT(!unit.obj_hash);
            s_TEA& hash = (unit.obj_hash = unit.self_src_hash);
            uint64_t BL_28_v {};
            ...
            (void)0;}), BL_28_v), 0) + "-"_fu), fu::i64dec(cpp.size()));
            ...
            {
                const s_TEA& tea = hash;
                BL_29_v = ((uint64_t(tea.v0) | (uint64_t(tea.v1) << 32ull)));
            (void)0;}), BL_29_v), 0)) + ".o"_fu);
            unit.cpp_cache_file = ((dir_wrk_1.cpp + unit.cpp_cache_file) + ".cpp"_fu);
        };
        /*MOV*/ s_BuildOutput ret = buildTarget_uGHE7p6t(units, file_invariants, flags_cc, flags_ld, onfail, runmode, expect_exit, bscheme, bin, GCC_CMD, ctx, dir_wrk_1);
